...
quicktype --src="${SCHEMAS}/tracking_details.json" --out="${LIB_MODULES}/tracking_details.py"
quicktype --src="${SCHEMAS}/tracking_milestone.json" --out="${LIB_MODULES}/tracking_milestone.py"
