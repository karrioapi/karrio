...
class TestFedExShipment(unittest.TestCase):
    def setUp(self):
        ...
        self.ShipmentRequest.build(
            get_node_from_xml(ShipmentRequestXml, "ProcessShipmentRequest")
        )
    ...
    [
        {
            "carrier": "carrier_name",
            "code": "3380",
            "message": "Origin - Postal-City Mismatch",
        },
        {
            "carrier": "carrier_name",
            "code": "3053",
        ...
        },
        {
            "carrier": "carrier_name",
            "code": "3040",
            "message": "Shipper Postal-City Mismatch",
        },
        {
            "carrier": "carrier_name",
            "code": "8266",
            "message": "Origin Location-Postal Mismatch.",
        },
        {
            "carrier": "carrier_name",
            "code": "8231",
...
shipment_data = {
    ...
    "shipment": {
        ...
        "label": {
            "format": "COMMON2D",
            "type": "PNG",
            "extra": {"LabelStockType": "PAPER_7X4.75"},
        },
        "extra": {
            ...
            "Payor": {
                "ResponsibleParty": {
                    "person_name": "Input Your Information",
                    "tax_id": "213456",
                    "extra": {"ContactId": "12345", "TinType": "BUSINESS_STATE"},
                }
            },
            "ExportDetail": {"ExportComplianceStatement": "30.37(f)"},
