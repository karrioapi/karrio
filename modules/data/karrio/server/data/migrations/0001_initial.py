        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.base.uuid, *(), **{"prefix": "batch_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.base.uuid, *(), **{"prefix": "data_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
                ...
                (
                    "slug",
                    models.SlugField(max_length=25, validators=[django.core.validators.RegexValidator("^[a-z0-9_]+$")]),
                ),
