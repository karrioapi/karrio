...
@strawberry.type
class Query:
    data_template: types.DataTemplateType = strawberry.field(resolver=types.DataTemplateType.resolve)
...
class Mutation:
    ...
    @strawberry.mutation
    def delete_data_template(self, info: Info, input: base.inputs.DeleteMutationInput) -> base.mutations.DeleteMutation:
        return base.mutations.DeleteMutation.mutate(info, model=models.DataTemplate, **input.to_dict())
