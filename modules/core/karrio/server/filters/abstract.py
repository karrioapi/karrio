    ...
    def __init__(self, data=None, queryset=None, *, request=None, prefix=None):
        ...
        if isinstance(data, QueryDict):
            ...
            for key in data:
                ...
                elif base_filter is not None and isinstance(base_filter, django_filters.MultipleChoiceFilter):
            ...
            data = {
                **data,
                **{
                    key: (",".join(val) if self.base_filters.get(key).__class__ == CharInFilter else val)
