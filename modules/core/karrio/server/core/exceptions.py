...
def custom_exception_handler(exc, context):
    ...
    # Skip expected client errors (auth failures, permission denied) —
    # these are normal request lifecycle events, not bugs.
    _is_auth_error = isinstance(exc, (exceptions.AuthenticationFailed, exceptions.NotAuthenticated))
