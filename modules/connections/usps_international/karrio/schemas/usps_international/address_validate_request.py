...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/address_validate_request.py')
#
# Command line arguments:
#   ./schemas/AddressValidateRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/address_validate_request.py" ./schemas/AddressValidateRequest.xsd
#
...
#
class AddressValidateRequest(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, USERID=None, Revision=None, Address=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, AddressValidateRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if AddressValidateRequest.subclass:
            return AddressValidateRequest.subclass(*args_, **kwargs_)
        else:
            return AddressValidateRequest(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressValidateRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('AddressValidateRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'AddressValidateRequest':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='AddressValidateRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='AddressValidateRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='AddressValidateRequest'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressValidateRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class AddressValidateRequest
...
class AddressType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, FirmName=None, Address1=None, Address2=None, City=None, State=None, Urbanization=None, Zip5=None, Zip4=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'AddressValidateRequest'
        rootClass = AddressValidateRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from address_validate_request import *\n\n')
