...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/evsi_cancel_request.py')
#
# Command line arguments:
#   ./schemas/eVSICancelRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evsi_cancel_request.py" ./schemas/eVSICancelRequest.xsd
#
...
#
class eVSICancelRequest(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSICancelRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSICancelRequest.subclass:
            return eVSICancelRequest.subclass(*args_, **kwargs_)
        else:
            return eVSICancelRequest(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSICancelRequest', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='eVSICancelRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='eVSICancelRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='eVSICancelRequest'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSICancelRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'eVSICancelRequest'
        rootClass = eVSICancelRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from evsi_cancel_request import *\n\n')
