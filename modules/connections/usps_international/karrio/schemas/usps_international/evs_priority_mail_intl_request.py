...
#
# Generated Sat Oct 14 00:23:46 2023 by generateDS.py version 2.43.2.
# Python 3.10.12 (main, Jun 11 2023, 05:26:28) [GCC 11.4.0]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/evs_priority_mail_intl_request.py')
#
# Command line arguments:
#   ./schemas/eVSPriorityMailIntlRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evs_priority_mail_intl_request.py" ./schemas/eVSPriorityMailIntlRequest.xsd
#
...
#
class eVSPriorityMailIntlRequest(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSPriorityMailIntlRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSPriorityMailIntlRequest.subclass:
            return eVSPriorityMailIntlRequest.subclass(*args_, **kwargs_)
        else:
            return eVSPriorityMailIntlRequest(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSPriorityMailIntlRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSPriorityMailIntlRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'eVSPriorityMailIntlRequest':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='eVSPriorityMailIntlRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='eVSPriorityMailIntlRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='eVSPriorityMailIntlRequest'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSPriorityMailIntlRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Insured is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInsured>%s</%sInsured>%s' % (namespaceprefix_ , self.gds_format_boolean(self.Insured, input_name='Insured'), namespaceprefix_ , eol_))
        ...
        if self.InsuredAmount is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInsuredAmount>%s</%sInsuredAmount>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.InsuredAmount), input_name='InsuredAmount')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Option':
            ...
            sval_ = child_.text
            ival_ = self.gds_parse_boolean(sval_, node, 'Insured')
            ival_ = self.gds_validate_boolean(ival_, node, 'Insured')
            self.Insured = ival_
            self.Insured_nsprefix_ = child_.prefix
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'InsuredAmount')
            value_ = self.gds_validate_string(value_, node, 'InsuredAmount')
            self.InsuredAmount = value_
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Girth')
            value_ = self.gds_validate_string(value_, node, 'Girth')
            self.Girth = value_
...
# end class eVSPriorityMailIntlRequest
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'eVSPriorityMailIntlRequest'
        rootClass = eVSPriorityMailIntlRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from evs_priority_mail_intl_request import *\n\n')
