...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/standard_b_response.py')
#
# Command line arguments:
#   ./schemas/StandardBResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/standard_b_response.py" ./schemas/StandardBResponse.xsd
#
...
#
class StandardBResponse(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, StandardBResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if StandardBResponse.subclass:
            return StandardBResponse.subclass(*args_, **kwargs_)
        else:
            return StandardBResponse(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='StandardBResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('StandardBResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'StandardBResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='StandardBResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='StandardBResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StandardBResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='StandardBResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'StandardBResponse'
        rootClass = StandardBResponse
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from standard_b_response import *\n\n')
