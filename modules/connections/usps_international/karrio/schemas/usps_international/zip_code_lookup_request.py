...
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/zip_code_lookup_request.py" ./schemas/ZipCodeLookupRequest.xsd
#
...
class ZipCodeLookupRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, USERID=None, Address=None, gds_collector_=None, **kwargs_):
