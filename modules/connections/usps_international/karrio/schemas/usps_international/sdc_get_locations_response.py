...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/sdc_get_locations_response.py')
#
# Command line arguments:
#   ./schemas/SDCGetLocationsResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/sdc_get_locations_response.py" ./schemas/SDCGetLocationsResponse.xsd
#
