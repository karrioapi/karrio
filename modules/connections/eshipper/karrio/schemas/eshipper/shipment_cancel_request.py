...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper/shipment_cancel_request.py')
#
# Command line arguments:
#   ./vendor/schemas/shipment_cancel_request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper/shipment_cancel_request.py" ./vendor/schemas/shipment_cancel_request.xsd
#
