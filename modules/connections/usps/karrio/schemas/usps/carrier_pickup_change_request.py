...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/carrier_pickup_change_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupChangeRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_change_request.py" ./schemas/CarrierPickupChangeRequest.xsd
#
