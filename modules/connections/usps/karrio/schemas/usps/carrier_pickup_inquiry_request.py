...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/carrier_pickup_inquiry_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupInquiryRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_inquiry_request.py" ./schemas/CarrierPickupInquiryRequest.xsd
#
