...
class ShippingOption(lib.Enum):
    ...
    fedex_electronic_trade_documents = lib.OptionEnum("ELECTRONIC_TRADE_DOCUMENTS", bool, meta=dict(category="PAPERLESS", flow="doc_files"))
    ...
    fedex_bill_to = lib.OptionEnum(
        "bill_to",
        lib.units.create_enum("BillTo", ["sender", "recipient", "third_party"]),
        meta=dict(
    ...
    fedex_billing_account_number = lib.OptionEnum(
    ...
    fedex_billing_postal_code = lib.OptionEnum(
        "billing_postal_code",
        meta=dict(
            category="THIRD_PARTY_BILLING",
            configurable=True,
    ...
    fedex_billing_country_code = lib.OptionEnum(
    ...
    fedex_bill_duties_to = lib.OptionEnum(
        "bill_duties_to",
        lib.units.create_enum("BillDutiesTo", ["sender", "recipient", "third_party"]),
        meta=dict(
    ...
    fedex_duties_account_number = lib.OptionEnum(
    ...
    doc_references = lib.OptionEnum("doc_references", list[models.DocumentDetails], meta=dict(category="PAPERLESS"))
