...
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/patch/.venv/patch/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/ship_response.py" ./schemas/ship_response.xsd
#
