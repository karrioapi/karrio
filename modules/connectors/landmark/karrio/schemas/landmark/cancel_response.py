...
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/patch/.venv/patch/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/cancel_response.py" ./schemas/cancel_response.xsd
#
