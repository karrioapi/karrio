...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/landmark/cancel_response.py')
#
# Command line arguments:
#   ./schemas/cancel_response.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/cancel_response.py" ./schemas/cancel_response.xsd
#
...
#
class CancelResponse(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CancelResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CancelResponse.subclass:
            return CancelResponse.subclass(*args_, **kwargs_)
        else:
            return CancelResponse(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CancelResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CancelResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CancelResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CancelResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CancelResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ResultType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Success=None, ResultMessage=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            self.ResultMessage is not None
        ):
            return True
        else:
            return False
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'CancelResponse'
        rootClass = CancelResponse
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from cancel_response import *\n\n')
        sys.stdout.write('import cancel_response as model_\n\n')
