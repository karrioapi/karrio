...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/landmark/error_response.py')
#
# Command line arguments:
#   ./schemas/error_response.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/error_response.py" ./schemas/error_response.xsd
#
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from error_response import *\n\n')
        sys.stdout.write('import error_response as model_\n\n')
