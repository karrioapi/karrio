...
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/patch/.venv/patch/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/error_response.py" ./schemas/error_response.xsd
#
