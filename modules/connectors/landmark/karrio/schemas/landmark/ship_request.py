...
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/patch/.venv/patch/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/ship_request.py" ./schemas/ship_request.xsd
#
