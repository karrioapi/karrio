...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/landmark/import_response.py')
#
...
#
class ImportResponse(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ImportResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ImportResponse.subclass:
            return ImportResponse.subclass(*args_, **kwargs_)
        else:
            return ImportResponse(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ImportResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ImportResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ImportResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ImportResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ImportResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ImportResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ImportResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ResultType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Success=None, ResultMessage=None, Packages=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
class PackageType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, LabelLink=None, LabelImages=None, TrackingNumber=None, LandmarkTrackingNumber=None, PackageReference=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'ImportResponse'
        rootClass = ImportResponse
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from import_response import *\n\n')
        sys.stdout.write('import import_response as model_\n\n')
