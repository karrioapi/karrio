...
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/patch/.venv/patch/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/cancel_request.py" ./schemas/cancel_request.xsd
#
