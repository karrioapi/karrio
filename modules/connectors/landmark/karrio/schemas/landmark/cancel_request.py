...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/landmark/cancel_request.py')
#
# Command line arguments:
#   ./schemas/cancel_request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/cancel_request.py" ./schemas/cancel_request.xsd
#
...
#
class CancelRequest(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Login=None, Test=None, ClientID=None, Reference=None, TrackingNumber=None, DeleteShipment=None, Reason=None, gds_collector_=None, **kwargs_):
        ...
        self.DeleteShipment = DeleteShipment
        self.DeleteShipment_nsprefix_ = None
        self.Reason = Reason
        self.Reason_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CancelRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CancelRequest.subclass:
            return CancelRequest.subclass(*args_, **kwargs_)
        else:
            return CancelRequest(*args_, **kwargs_)
    ...
    def set_TrackingNumber(self, TrackingNumber):
        self.TrackingNumber = TrackingNumber
    def get_DeleteShipment(self):
        return self.DeleteShipment
    def set_DeleteShipment(self, DeleteShipment):
        self.DeleteShipment = DeleteShipment
    def get_Reason(self):
        return self.Reason
    ...
    def has__content(self):
        if (
            ...
            self.DeleteShipment is not None or
            self.Reason is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CancelRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CancelRequest':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CancelRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CancelRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CancelRequest'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.DeleteShipment is not None:
            namespaceprefix_ = self.DeleteShipment_nsprefix_ + ':' if (UseCapturedNS_ and self.DeleteShipment_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDeleteShipment>%s</%sDeleteShipment>%s' % (namespaceprefix_ , self.gds_format_boolean(self.DeleteShipment, input_name='DeleteShipment'), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'DeleteShipment':
            sval_ = child_.text
            ival_ = self.gds_parse_boolean(sval_, node, 'DeleteShipment')
            ival_ = self.gds_validate_boolean(ival_, node, 'DeleteShipment')
            self.DeleteShipment = ival_
            self.DeleteShipment_nsprefix_ = child_.prefix
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'CancelRequest'
        rootClass = CancelRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from cancel_request import *\n\n')
        sys.stdout.write('import cancel_request as model_\n\n')
