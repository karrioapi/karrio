...
#
# Generated Sat Oct  4 04:10:48 2025 by generateDS.py version 2.44.3.
# Python 3.12.11 (main, Jul 30 2025, 16:35:51) [Clang 17.0.0 (clang-1700.0.13.5)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/landmark/track_response.py')
#
# Command line arguments:
#   ./schemas/track_response.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/track_response.py" ./schemas/track_response.xsd
#
...
class TrackResponse(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Test=None, Result=None, gds_collector_=None, **kwargs_):
...
class ResultType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Success=None, ShipmentDetails=None, Packages=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Success':
            ...
            obj_ = ShipmentDetailsType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class ShipmentDetailsType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, EndDeliveryCarrier=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.EndDeliveryCarrier = EndDeliveryCarrier
        self.EndDeliveryCarrier_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_EndDeliveryCarrier(self):
        return self.EndDeliveryCarrier
    def set_EndDeliveryCarrier(self, EndDeliveryCarrier):
        self.EndDeliveryCarrier = EndDeliveryCarrier
    def has__content(self):
        if (
            self.EndDeliveryCarrier is not None
        ):
            return True
        else:
            return False
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ShipmentDetailsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.EndDeliveryCarrier is not None:
            namespaceprefix_ = self.EndDeliveryCarrier_nsprefix_ + ':' if (UseCapturedNS_ and self.EndDeliveryCarrier_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEndDeliveryCarrier>%s</%sEndDeliveryCarrier>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.EndDeliveryCarrier), input_name='EndDeliveryCarrier')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        pass
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'EndDeliveryCarrier':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'EndDeliveryCarrier')
            value_ = self.gds_validate_string(value_, node, 'EndDeliveryCarrier')
            self.EndDeliveryCarrier = value_
            self.EndDeliveryCarrier_nsprefix_ = child_.prefix
...
class PackageType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, TrackingNumber=None, LandmarkTrackingNumber=None, PackageReference=None, Events=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            self.PackageReference is not None or
...
class EventsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='EventsType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'EventsType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='EventsType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='EventsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='EventsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='EventsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class EventType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Status=None, DateTime=None, Location=None, EventCode=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            self.EventCode is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='EventType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='EventType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='EventType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='EventType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='EventType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.DateTime is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDateTime>%s</%sDateTime>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.DateTime), input_name='DateTime')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Status':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'DateTime')
            value_ = self.gds_validate_string(value_, node, 'DateTime')
            self.DateTime = value_
