...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/landmark/track_request.py')
#
# Command line arguments:
#   ./schemas/track_request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/landmark/track_request.py" ./schemas/track_request.xsd
#
...
# Start enum classes
#
class RetrievalTypeType(str, Enum):
    LAST='Last'
...
class TrackRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Login=None, Test=None, ClientID=None, Reference=None, TrackingNumber=None, PackageReference=None, RetrievalType=None, gds_collector_=None, **kwargs_):
        ...
        self.validate_RetrievalTypeType(self.RetrievalType)
        self.RetrievalType_nsprefix_ = None
    ...
    def set_PackageReference(self, PackageReference):
        self.PackageReference = PackageReference
    def get_RetrievalType(self):
        return self.RetrievalType
    def set_RetrievalType(self, RetrievalType):
        self.RetrievalType = RetrievalType
    def validate_RetrievalTypeType(self, value):
        result = True
        # Validate type RetrievalTypeType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            value = value
            enumerations = ['Last', 'Historical']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on RetrievalTypeType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def has__content(self):
        if (
            ...
            self.RetrievalType is not None
        ):
            return True
        else:
            return False
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TrackRequest', fromsubclass_=False, pretty_print=True):
        ...
        if self.RetrievalType is not None:
            namespaceprefix_ = self.RetrievalType_nsprefix_ + ':' if (UseCapturedNS_ and self.RetrievalType_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRetrievalType>%s</%sRetrievalType>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RetrievalType), input_name='RetrievalType')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'RetrievalType':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RetrievalType')
            value_ = self.gds_validate_string(value_, node, 'RetrievalType')
            self.RetrievalType = value_
            self.RetrievalType_nsprefix_ = child_.prefix
            # validate type RetrievalTypeType
            self.validate_RetrievalTypeType(self.RetrievalType)
