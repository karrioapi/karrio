"""Landmark return shipment wrapper.
...
import karrio.providers.landmark.shipment.create as create
...
def return_shipment_request(
    ...
    options = {
        **(payload.options or {}),
        "landmark_return_address_code": ((payload.options or {}).get("landmark_return_address_code") or "RETURN"),
    }
