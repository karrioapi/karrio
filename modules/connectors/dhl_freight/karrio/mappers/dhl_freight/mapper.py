...
class Mapper(mapper.Mapper):
    ...
    def create_rate_request(self, payload: models.RateRequest) -> lib.Serializable:
        # DHL Freight does not expose a live-rates endpoint in this API.
        # Rates are resolved against the configured service_levels CSV through
        # the universal rating provider (zone-based + weight bands).
