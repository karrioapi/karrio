...
<<<<<<< HEAD:modules/connectors/eshipper/karrio/providers/eshipper/utils.py
class Settings(core.Settings):
    """eShipper connection settings."""
=======
class Settings(BaseSettings):
    """eshipper_xml connection settings."""
>>>>>>> 3ccfd84c0 (feat: Rename legacy eshipper integration eshipper_xml):modules/connectors/eshipper_xml/karrio/providers/eshipper_xml/utils.py
