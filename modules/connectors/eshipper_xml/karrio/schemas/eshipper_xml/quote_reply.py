...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper_xml/quote_reply.py')
#
# Command line arguments:
#   ./vendor/schemas/quote_reply.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper_xml/quote_reply.py" ./vendor/schemas/quote_reply.xsd
#
...
__all__ = ["EShipper", "QuoteReplyType", "QuoteType", "SurchargeType"]
