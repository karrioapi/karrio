...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper_xml/shipment_cancel_request.py')
#
# Command line arguments:
#   ./vendor/schemas/shipment_cancel_request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper_xml/shipment_cancel_request.py" ./vendor/schemas/shipment_cancel_request.xsd
#
...
__all__ = ["EShipper", "OrderType", "ShipmentCancelRequestType"]
