<<<<<<< HEAD:modules/connectors/eshipper/karrio/schemas/eshipper/shipping_request.py
from attr import s
...
class ShippingRequestType:
    ...
    shippingrequestfrom: Optional[FromType] = JStruct[FromType]
...
#
# Generated Mon Oct 24 11:17:21 2022 by generateDS.py version 2.41.1.
# Python 3.10.6 (main, Aug 30 2022, 05:12:36) [Clang 13.1.6 (clang-1316.0.21.2.5)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper_xml/shipping_request.py')
#
# Command line arguments:
#   ./vendor/schemas/shipping_request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper_xml/shipping_request.py" ./vendor/schemas/shipping_request.xsd
#
...
class EShipper(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, EShipper)
    ...
    def export(
        ...
        self._exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="EShipper"
        )
        if self._hasContent():
    ...
    def _exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="EShipper"
    ):
    ...
    def _exportChildren(
        ...
        if self.ShippingRequest is not None:
            namespaceprefix_ = (
                self.ShippingRequest_nsprefix_ + ":"
                if (UseCapturedNS_ and self.ShippingRequest_nsprefix_)
                else ""
            )
            self.ShippingRequest.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="ShippingRequest",
                pretty_print=pretty_print,
            )
...
class ShippingRequestType(GeneratedsSuper):
    ...
    def __init__(
        self,
        serviceId=None,
        destinationCloseMin=None,
        destinationCloseHrs=None,
        originCloseTimeMin=None,
        originCloseTimeHrs=None,
        readyTimeMin=None,
        readyTimeHrs=None,
        SortandSegregateCharge=None,
        ...
        insideDelivery=None,
        deliveryAppointment=None,
        specialEquipment=None,
        holdForPickupRequired=None,
    ...
    def _exportAttributes(
        ...
        if (
            self.destinationCloseMin is not None
            and "destinationCloseMin" not in already_processed
        ):
            already_processed.add("destinationCloseMin")
            outfile.write(
                " destinationCloseMin=%s"
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.destinationCloseMin),
                            input_name="destinationCloseMin",
                        )
                    ),
                )
            )
        if (
            self.destinationCloseHrs is not None
            and "destinationCloseHrs" not in already_processed
        ):
            already_processed.add("destinationCloseHrs")
            outfile.write(
                " destinationCloseHrs=%s"
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.destinationCloseHrs),
                            input_name="destinationCloseHrs",
                        )
                    ),
                )
            )
        if (
            self.originCloseTimeMin is not None
            and "originCloseTimeMin" not in already_processed
        ):
            already_processed.add("originCloseTimeMin")
            outfile.write(
                " originCloseTimeMin=%s"
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.originCloseTimeMin),
                            input_name="originCloseTimeMin",
                        )
                    ),
                )
            )
        if (
            self.originCloseTimeHrs is not None
            and "originCloseTimeHrs" not in already_processed
        ):
            already_processed.add("originCloseTimeHrs")
            outfile.write(
                " originCloseTimeHrs=%s"
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.originCloseTimeHrs),
                            input_name="originCloseTimeHrs",
                        )
                    ),
                )
            )
        if self.readyTimeMin is not None and "readyTimeMin" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.readyTimeMin), input_name="readyTimeMin"
                        )
                    ),
                )
            )
        if self.readyTimeHrs is not None and "readyTimeHrs" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.readyTimeHrs), input_name="readyTimeHrs"
                        )
                    ),
                )
            )
        if (
            self.SortandSegregateCharge is not None
            and "SortandSegregateCharge" not in already_processed
        ):
            already_processed.add("SortandSegregateCharge")
            outfile.write(
                " SortandSegregateCharge=%s"
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.SortandSegregateCharge),
                            input_name="SortandSegregateCharge",
                        )
                    ),
                )
            )
        ...
        if self.insidePickup is not None and "insidePickup" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.insidePickup), input_name="insidePickup"
                        )
                    ),
                )
            )
        ...
        if (
            self.deliveryAppointment is not None
            and "deliveryAppointment" not in already_processed
        ):
            already_processed.add("deliveryAppointment")
            outfile.write(
                " deliveryAppointment=%s"
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.deliveryAppointment),
                            input_name="deliveryAppointment",
                        )
                    ),
                )
            )
        if (
            self.specialEquipment is not None
            and "specialEquipment" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.specialEquipment),
                            input_name="specialEquipment",
                        )
                    ),
                )
            )
        if (
            self.holdForPickupRequired is not None
            and "holdForPickupRequired" not in already_processed
        ):
            already_processed.add("holdForPickupRequired")
            outfile.write(
                " holdForPickupRequired=%s"
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.holdForPickupRequired),
                            input_name="holdForPickupRequired",
                        )
                    ),
                )
            )
        if (
            self.signatureRequired is not None
            and "signatureRequired" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.signatureRequired),
                            input_name="signatureRequired",
                        )
                    ),
                )
            )
    ...
    def _exportChildren(
        ...
        if self.CustomsInvoice is not None:
            ...
            self.CustomsInvoice.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="CustomsInvoice",
                pretty_print=pretty_print,
            )
...
class FromType(GeneratedsSuper):
    ...
    def _exportAttributes(
        ...
        if (
            self.confirmDelivery is not None
            and "confirmDelivery" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.confirmDelivery),
                            input_name="confirmDelivery",
                        )
                    ),
                )
            )
...
class ShipperType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, ShipperType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        ...
        already_processed = set()
        self._exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="ShipperType"
        )
        if self._hasContent():
            outfile.write(">")
            outfile.write(self.convert_unicode(self.valueOf_))
...
class PackageType(GeneratedsSuper):
    ...
    def _exportAttributes(
        ...
        if self.weightOz is not None and "weightOz" not in already_processed:
            ...
            outfile.write(
                ' weightOz="%s"'
                % self.gds_format_integer(self.weightOz, input_name="weightOz")
            )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(
        ...
        if self.freightClass is not None and "freightClass" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.freightClass), input_name="freightClass"
                        )
                    ),
                )
            )
        ...
        if self.nmfcCode is not None and "nmfcCode" not in already_processed:
            ...
            outfile.write(
                ' nmfcCode="%s"'
                % self.gds_format_integer(self.nmfcCode, input_name="nmfcCode")
            )
...
class PickupType(GeneratedsSuper):
    ...
    def _exportAttributes(
        ...
        if self.contactName is not None and "contactName" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.contactName), input_name="contactName"
                        )
                    ),
                )
            )
        if self.phoneNumber is not None and "phoneNumber" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.phoneNumber), input_name="phoneNumber"
                        )
                    ),
                )
            )
        if self.pickupDate is not None and "pickupDate" not in already_processed:
            ...
            outfile.write(
                ' pickupDate="%s"'
                % self.gds_format_date(self.pickupDate, input_name="pickupDate")
            )
        if self.pickupTime is not None and "pickupTime" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.pickupTime), input_name="pickupTime"
                        )
                    ),
                )
            )
        if self.closingTime is not None and "closingTime" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.closingTime), input_name="closingTime"
                        )
                    ),
                )
            )
...
class ReferenceType(GeneratedsSuper):
    ...
    def __init__(
        self, name=None, code=None, valueOf_=None, gds_collector_=None, **kwargs_
    ):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
...
class CustomsInvoiceType(GeneratedsSuper):
    ...
    def _hasContent(self):
        if (
            self.BillTo is not None
            or self.Contact is not None
            or self.Item
            or self.DutiesTaxes is not None
            or self.InBondManifest is not None
        ):
            return True
        else:
            return False
        ...
        if self.brokerName is not None and "brokerName" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.brokerName), input_name="brokerName"
                        )
                    ),
                )
            )
        if (
            self.contactCompany is not None
            and "contactCompany" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.contactCompany),
                            input_name="contactCompany",
                        )
                    ),
                )
            )
        if self.shipperTaxID is not None and "shipperTaxID" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.shipperTaxID), input_name="shipperTaxID"
                        )
                    ),
                )
            )
        if self.receiverTaxID is not None and "receiverTaxID" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.receiverTaxID), input_name="receiverTaxID"
                        )
                    ),
                )
            )
        ...
        if self.contactPhone is not None and "contactPhone" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.contactPhone), input_name="contactPhone"
                        )
                    ),
                )
            )
    ...
    def _exportChildren(
        ...
        if self.BillTo is not None:
            namespaceprefix_ = (
                self.BillTo_nsprefix_ + ":"
                if (UseCapturedNS_ and self.BillTo_nsprefix_)
                else ""
            )
            self.BillTo.export(
                outfile,
        ...
        if self.DutiesTaxes is not None:
            namespaceprefix_ = (
                self.DutiesTaxes_nsprefix_ + ":"
                if (UseCapturedNS_ and self.DutiesTaxes_nsprefix_)
                else ""
            )
            self.DutiesTaxes.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
        ...
        if self.InBondManifest is not None:
            namespaceprefix_ = (
                self.InBondManifest_nsprefix_ + ":"
                if (UseCapturedNS_ and self.InBondManifest_nsprefix_)
                else ""
            )
            self.InBondManifest.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="InBondManifest",
                pretty_print=pretty_print,
            )
...
class BillToType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, BillToType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        ...
        already_processed = set()
        self._exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="BillToType"
        )
        if self._hasContent():
            outfile.write(">")
            outfile.write(self.convert_unicode(self.valueOf_))
    ...
    def _exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="BillToType"
    ):
        if self.company is not None and "company" not in already_processed:
            already_processed.add("company")
            outfile.write(
...
class ContactType(GeneratedsSuper):
    ...
    def __init__(
        self, name=None, phone=None, valueOf_=None, gds_collector_=None, **kwargs_
    ):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
...
class ItemType(GeneratedsSuper):
    ...
    def export(
        ...
        already_processed = set()
        self._exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="ItemType"
        )
        if self._hasContent():
            outfile.write(">")
            outfile.write(self.convert_unicode(self.valueOf_))
    ...
    def _exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="ItemType"
    ):
        if self.code is not None and "code" not in already_processed:
            already_processed.add("code")
            outfile.write(
        ...
        if self.originCountry is not None and "originCountry" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.originCountry), input_name="originCountry"
                        )
                    ),
                )
            )
        ...
        if self.unitPrice is not None and "unitPrice" not in already_processed:
            ...
            outfile.write(
                ' unitPrice="%s"'
                % self.gds_format_float(self.unitPrice, input_name="unitPrice")
            )
        if self.skuCode is not None and "skuCode" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.skuCode), input_name="skuCode"
                        )
                    ),
                )
            )
...
class DutiesTaxesType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, DutiesTaxesType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        ...
        already_processed = set()
        self._exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="DutiesTaxesType"
        )
        if self._hasContent():
            outfile.write(">")
            outfile.write(self.convert_unicode(self.valueOf_))
    ...
    def _exportAttributes(
        ...
        if (
            self.consigneeAccount is not None
            and "consigneeAccount" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.consigneeAccount),
                            input_name="consigneeAccount",
                        )
                    ),
                )
            )
        if self.sedNumber is not None and "sedNumber" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.sedNumber), input_name="sedNumber"
                        )
                    ),
                )
            )
        if self.dutiable is not None and "dutiable" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.dutiable), input_name="dutiable"
                        )
                    ),
                )
            )
        if self.billTo is not None and "billTo" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.billTo), input_name="billTo"
                        )
                    ),
                )
            )
...
class InBondManifestType(GeneratedsSuper):
    ...
    def __init__(
        ...
        customsClearedBy=None,
        handlingInfo=None,
        previousCargoControlNum=None,
        weight=None,
        weightUOM=None,
        valueOf_=None,
        gds_collector_=None,
    ...
    def _exportAttributes(
        ...
        if (
            self.locationOfGoods is not None
            and "locationOfGoods" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.locationOfGoods),
                            input_name="locationOfGoods",
                        )
                    ),
                )
            )
        if self.nameOfCarrier is not None and "nameOfCarrier" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.nameOfCarrier), input_name="nameOfCarrier"
                        )
                    ),
                )
            )
        if (
            self.vehicleIdentification is not None
            and "vehicleIdentification" not in already_processed
        ):
            already_processed.add("vehicleIdentification")
            outfile.write(
                ' vehicleIdentification="%s"'
                % self.gds_format_integer(
                    self.vehicleIdentification, input_name="vehicleIdentification"
                )
            )
        if (
            self.customsClearedBy is not None
            and "customsClearedBy" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.customsClearedBy),
                            input_name="customsClearedBy",
                        )
                    ),
                )
            )
        if self.handlingInfo is not None and "handlingInfo" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.handlingInfo), input_name="handlingInfo"
                        )
                    ),
                )
            )
        if (
            self.previousCargoControlNum is not None
            and "previousCargoControlNum" not in already_processed
        ):
            already_processed.add("previousCargoControlNum")
            outfile.write(
                ' previousCargoControlNum="%s"'
                % self.gds_format_integer(
                    self.previousCargoControlNum, input_name="previousCargoControlNum"
                )
            )
        if self.weight is not None and "weight" not in already_processed:
            already_processed.add("weight")
        ...
        if self.weightUOM is not None and "weightUOM" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.weightUOM), input_name="weightUOM"
                        )
                    ),
                )
            )
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and "vehicleIdentification" not in already_processed:
            already_processed.add("vehicleIdentification")
            self.vehicleIdentification = self.gds_parse_integer(
                value, node, "vehicleIdentification"
            )
        ...
        if value is not None and "previousCargoControlNum" not in already_processed:
            ...
            self.previousCargoControlNum = self.gds_parse_integer(
                value, node, "previousCargoControlNum"
            )
        value = find_attr_value_("weight", node)
        if value is not None and "weight" not in already_processed:
            already_processed.add("weight")
...
>>>>>>> 3ccfd84c0 (feat: Rename legacy eshipper integration eshipper_xml):modules/connectors/eshipper_xml/karrio/schemas/eshipper_xml/shipping_request.py
