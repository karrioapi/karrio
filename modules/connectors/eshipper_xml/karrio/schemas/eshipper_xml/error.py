...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper_xml/error.py')
#
# Command line arguments:
#   ./vendor/schemas/error.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper_xml/error.py" ./vendor/schemas/error.xsd
#
