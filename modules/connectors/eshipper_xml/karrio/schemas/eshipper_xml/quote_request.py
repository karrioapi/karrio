...
#
# Generated Mon Oct 24 11:17:20 2022 by generateDS.py version 2.41.1.
# Python 3.10.6 (main, Aug 30 2022, 05:12:36) [Clang 13.1.6 (clang-1316.0.21.2.5)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper_xml/quote_request.py')
#
# Command line arguments:
#   ./vendor/schemas/quote_request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper_xml/quote_request.py" ./vendor/schemas/quote_request.xsd
#
...
class PackageType(GeneratedsSuper):
    ...
    def _exportAttributes(
        ...
        if self.weightOz is not None and "weightOz" not in already_processed:
            ...
            outfile.write(
                ' weightOz="%s"'
                % self.gds_format_float(self.weightOz, input_name="weightOz")
            )
