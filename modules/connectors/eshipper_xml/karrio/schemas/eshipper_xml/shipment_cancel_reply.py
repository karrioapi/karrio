...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper_xml/shipment_cancel_reply.py')
#
# Command line arguments:
#   ./vendor/schemas/shipment_cancel_reply.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper_xml/shipment_cancel_reply.py" ./vendor/schemas/shipment_cancel_reply.xsd
#
...
__all__ = ["EShipper", "OrderType", "ShipmentCancelReplyType", "StatusType"]
