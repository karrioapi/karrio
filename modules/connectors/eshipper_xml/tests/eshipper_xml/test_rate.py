...
<<<<<<< HEAD:modules/connectors/eshipper/tests/eshipper/test_rate.py
...
>>>>>>> 3ccfd84c0 (feat: Rename legacy eshipper integration eshipper_xml):modules/connectors/eshipper_xml/tests/eshipper_xml/test_rate.py
