"""Karrio Hermes shipment cancellation API implementation."""
import typing
...
def shipment_cancel_request(
    ...
    # import karrio.schemas.hermes.shipment_cancel_request as hermes_req
    #
    # request = hermes_req.ShipmentCancelRequestType(
