...
def pickup_request(
    ...
    """Create a Hermes pickup request. See SPECS.md (Pickup)."""
    ...
    request = hermes_req.PickupCreateRequestType(
        ...
        pickupName=hermes_req.PickupNameType(
            ...
            middlename=None,
            lastname=" ".join(address.person_name.split()[1:])
            if address.person_name and len(address.person_name.split()) > 1
            else address.person_name,
        ),
