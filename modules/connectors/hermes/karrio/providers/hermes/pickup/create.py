...
import karrio.schemas.hermes.pickup_request as hermes_req
import karrio.schemas.hermes.pickup_response as hermes_res
...
def _extract_details(
    ...
    pickup = lib.to_object(hermes_res.PickupResponseType, data)
...
def pickup_request(
    ...
    request = hermes_req.PickupRequestType(
