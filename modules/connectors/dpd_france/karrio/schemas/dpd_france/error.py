...
#
# Generated Fri Apr 17 19:24:11 2026 by generateDS.py version 2.44.3.
# Python 3.12.13 (main, Mar 21 2026, 20:40:49) [Clang 17.0.0 (clang-1700.6.3.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/dpd_france/error.py')
#
# Command line arguments:
#   ./schemas/error_response.xsd
#
# Command line:
#   /Users/anshdevnagar/Desktop/PROJECTS/shipping-platform/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/dpd_france/error.py" ./schemas/error_response.xsd
#
...
class Error(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ErrorId=None, ErrorMessage=None, gds_collector_=None, **kwargs_):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Error', fromsubclass_=False, pretty_print=True):
        ...
        if self.ErrorId is not None:
            namespaceprefix_ = self.ErrorId_nsprefix_ + ':' if (UseCapturedNS_ and self.ErrorId_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sErrorId>%s</%sErrorId>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ErrorId), input_name='ErrorId')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'ErrorId':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ErrorId')
            value_ = self.gds_validate_string(value_, node, 'ErrorId')
            self.ErrorId = value_
            self.ErrorId_nsprefix_ = child_.prefix
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:tns="http://www.cargonet.software/Error"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
NamespaceToDefMappings_ = {'http://www.cargonet.software/Error': [('Error',
                                         './schemas/error_response.xsd',
                                         'CT')]}
