...
def parse_error_response(
    ...
    **kwargs,
    ...
    errors = [
        ...
        *([response] if isinstance(response, dict) and isinstance(response.get("error"), str) else []),
        *(
    ...
    return [
        models.Message(
            ...
            message=lib.identity(error.get("message") or error.get("detail") or error.get("error_description", "")),
            details=lib.to_dict(
                {
                    **kwargs,
