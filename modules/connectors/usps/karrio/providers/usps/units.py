...
class ShippingOption(lib.Enum):
    ...
    usps_tracking_plus_signature_3_years = lib.OptionEnum("486", bool, meta=dict(category="SIGNATURE"))
    usps_tracking_plus_signature_5_years = lib.OptionEnum("487", bool, meta=dict(category="SIGNATURE"))
    usps_tracking_plus_signature_7_years = lib.OptionEnum("488", bool, meta=dict(category="SIGNATURE"))
    usps_tracking_plus_signature_10_years = lib.OptionEnum("489", bool, meta=dict(category="SIGNATURE"))
    usps_hazardous_materials_air_eligible_ethanol = lib.OptionEnum("810", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_1_toy_propellant_safety_fuse_package = lib.OptionEnum("811", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_3_flammable_and_combustible_liquids = lib.OptionEnum("812", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_7_radioactive_materials = lib.OptionEnum("813", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_8_air_eligible_corrosive_materials = lib.OptionEnum("814", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_8_nonspillable_wet_batteries = lib.OptionEnum("815", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_9_lithium_battery_marked_ground_only = lib.OptionEnum("816", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_9_lithium_battery_returns = lib.OptionEnum("817", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_9_marked_lithium_batteries = lib.OptionEnum("818", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_9_dry_ice = lib.OptionEnum("819", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_9_unmarked_lithium_batteries = lib.OptionEnum("820", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_class_9_magnetized_materials = lib.OptionEnum("821", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_division_4_1_mailable_flammable_solids_and_safety_matches = lib.OptionEnum("822", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_division_5_1_oxidizers = lib.OptionEnum("823", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_division_5_2_organic_peroxides = lib.OptionEnum("824", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_division_6_1_toxic_materials = lib.OptionEnum("825", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_division_6_2_biological_materials = lib.OptionEnum("826", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_excepted_quantity_provision = lib.OptionEnum("827", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_ground_only_hazardous_materials = lib.OptionEnum("828", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_air_eligible_id8000_consumer_commodity = lib.OptionEnum("829", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_lighters = lib.OptionEnum("830", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_limited_quantity_ground = lib.OptionEnum("831", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials_small_quantity_provision_markings_required = lib.OptionEnum("832", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_hazardous_materials = lib.OptionEnum("857", bool, meta=dict(category="DANGEROUS_GOOD"))
    usps_certified_mail = lib.OptionEnum("910", bool, meta=dict(category="SIGNATURE"))
    usps_certified_mail_restricted_delivery = lib.OptionEnum("911", bool, meta=dict(category="SIGNATURE"))
    usps_certified_mail_adult_signature_required = lib.OptionEnum("912", bool, meta=dict(category="SIGNATURE"))
    usps_certified_mail_adult_signature_restricted_delivery = lib.OptionEnum("913", bool, meta=dict(category="SIGNATURE"))
    usps_collect_on_delivery = lib.OptionEnum("915", float, meta=dict(category="COD"))
    usps_collect_on_delivery_restricted_delivery = lib.OptionEnum("917", bool, meta=dict(category="COD"))
    usps_tracking_electronic = lib.OptionEnum("920", bool)
    usps_signature_confirmation = lib.OptionEnum("921", bool, meta=dict(category="SIGNATURE"))
    usps_adult_signature_required = lib.OptionEnum("922", bool, meta=dict(category="SIGNATURE"))
    usps_adult_signature_restricted_delivery = lib.OptionEnum("923", bool, meta=dict(category="SIGNATURE"))
    usps_signature_confirmation_restricted_delivery = lib.OptionEnum("924", bool, meta=dict(category="SIGNATURE"))
    usps_priority_mail_express_merchandise_insurance = lib.OptionEnum("925", bool, meta=dict(category="INSURANCE"))
    ...
    usps_insurance_restricted_delivery = lib.OptionEnum("934", bool, meta=dict(category="INSURANCE"))
    usps_registered_mail = lib.OptionEnum("940", bool, meta=dict(category="SIGNATURE"))
    usps_registered_mail_restricted_delivery = lib.OptionEnum("941", bool, meta=dict(category="SIGNATURE"))
    usps_return_receipt = lib.OptionEnum("955", bool, meta=dict(category="RETURN"))
    usps_return_receipt_electronic = lib.OptionEnum("957", bool, meta=dict(category="RETURN"))
    usps_signature_requested_priority_mail_express_only = lib.OptionEnum("981", bool, meta=dict(category="SIGNATURE"))
    usps_parcel_locker_delivery = lib.OptionEnum("984", bool, meta=dict(category="LOCKER"))
    usps_po_to_addressee_priority_mail_express_only = lib.OptionEnum("986", bool, meta=dict(category="DELIVERY_OPTIONS"))
    usps_sunday_delivery = lib.OptionEnum("981", bool, meta=dict(category="DELIVERY_OPTIONS"))
