...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/express_mail_commitment_response.py')
#
# Command line arguments:
#   ./schemas/ExpressMailCommitmentResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/express_mail_commitment_response.py" ./schemas/ExpressMailCommitmentResponse.xsd
#
