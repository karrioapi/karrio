...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/carrier_pickup_cancel_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupCancelRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_cancel_request.py" ./schemas/CarrierPickupCancelRequest.xsd
#
