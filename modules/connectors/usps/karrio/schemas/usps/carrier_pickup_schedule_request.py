...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/carrier_pickup_schedule_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupScheduleRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_schedule_request.py" ./schemas/CarrierPickupScheduleRequest.xsd
#
