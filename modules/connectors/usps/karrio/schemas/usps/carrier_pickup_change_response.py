...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/carrier_pickup_change_response.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupChangeResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_change_response.py" ./schemas/CarrierPickupChangeResponse.xsd
#
