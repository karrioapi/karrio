...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/evs_express_mail_intl_response.py')
#
# Command line arguments:
#   ./schemas/eVSExpressMailIntlResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/evs_express_mail_intl_response.py" ./schemas/eVSExpressMailIntlResponse.xsd
#
