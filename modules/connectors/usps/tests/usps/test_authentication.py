...
class TestUSPSAuthentication(unittest.TestCase):
    def setUp(self):
        self.maxDiff = None
        self.fresh_gateway = karrio.gateway["usps"].create(
            dict(
                client_id="client_id",
    ...
    def test_authenticate(self):
        with patch("karrio.mappers.usps.proxy.lib.request") as mock:
            ...
            self.assertEqual(
                ...
                f"{self.fresh_gateway.settings.server_url}/oauth2/v3/token",
            )
...
LoginResponse = {
    ...
    "scope": "addresses international-prices",
    "expires_in": "14399",
    "refresh_count": "0",
    "status": "approved",
}
