...
#
# Generated Tue Apr  4 08:40:29 2023 by generateDS.py version 2.41.3.
...
#   ./schemas/pickupdatatypes_global.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./dhl_express_lib/pickupdatatypes_global.py" ./schemas/pickupdatatypes_global.xsd
#
...
class AccountTypeType(str, Enum):
    """AccountTypeType -- Valid values are D.    D =DHL
...
class AccountTypeType9(str, Enum):
    """AccountTypeType9 -- Valid values are D or C.    D =DHL
...
class DoorTo4(str, Enum):
    """DoorTo4 -- Defines the type of delivery service that applies to the shipment
...
class LocationTypeType(str, Enum):
    """LocationTypeType -- Type Of Location B=Business R=Residence  C= Business/Residence
...
class PickupType(str, Enum):
    """PickupType -- Type of pickup (G: Pickup for DHL Ground)
...
class LargestPiece(GeneratedsSuper):
    """LargestPiece -- Lists measurements of largest piece. This element is mandatory if the weight of shipment for ground service exceeds 50 pounds
    Width -- Required when requesting pickup for a ground shipment with weight exceeding 50 pounds
    Height -- Required when requesting pickup for a ground shipment with weight exceeding 50 pounds
    Depth -- Required when requesting pickup for a ground shipment with weight exceeding 50 pounds
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='LargestPiece', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='LargestPiece')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='LargestPiece', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='LargestPiece'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='LargestPiece', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Place1(GeneratedsSuper):
    """Place1 -- Pickup place
    LocationType -- Type Of Location B=Business R=Residence  C= Business/Residence
    CompanyName -- Unless location type is residence, company name is required
    PackageLocation -- Example : front desk
    StateCode -- two letter state code is required if location is within the  US
    CountryCode -- Two letter ISO country code
    PostalCode -- Required if country is US
    RouteCode -- Place route code, first 2 Uppercase charaters and follow by 2 digits
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Place1', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Place1')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Place1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Place1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Place1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Requestor(GeneratedsSuper):
    """AccountType -- Valid values are D.    D =DHL
    AccountNumber -- DHL Account Number Required only if Account Type is DHL
    RequestorContact -- Contact information for the requestor
    CompanyName -- Required if Contact Name and Contact Phone No.is given
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Requestor', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Requestor')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Requestor', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Requestor'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Requestor', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Pickup(GeneratedsSuper):
    ...
    ReadyByTime -- Time pickup must be ready by
    CloseTime -- Closing time of pickup location
    AfterHoursClosingTime -- If this is given, AfterHoursLocation also must be given
    AfterHoursLocation -- if this is given, AfterHoursClosingTime must also be given
    weight -- This is an optional segment
...
class RequestorContact(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RequestorContact', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RequestorContact')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RequestorContact', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RequestorContact'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RequestorContact', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Piece2(GeneratedsSuper):
    """Width -- required if height and depth are  specified. Also required when requesting pickup for a ground shipment with weight exceeding 50 pounds
    Height -- required if width and depth are specified. Also required when requesting pickup for a ground shipment with weight exceeding 50 pounds
    Depth -- required if width and height are specified. Also required when requesting pickup for a ground shipment with weight exceeding 50 pounds
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Piece2', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Piece2')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Piece2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Piece2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Piece2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ShipmentDetails3(GeneratedsSuper):
    """AccountType -- Valid values are D or C.    D =DHL
    AccountNumber -- DHL Account Number Required only if Account Type is DHL
    DimensionUnit -- If piece information is specified, DiemnsionUnit must be gievn
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ShipmentDetails3', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ShipmentDetails3')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ShipmentDetails3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ShipmentDetails3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ShipmentDetails3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
