...
#
# Generated Tue Apr  4 08:40:30 2023 by generateDS.py version 2.41.3.
...
#   ./schemas/pickup-res.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./dhl_express_lib/pickup_res.py" ./schemas/pickup-res.xsd
#
...
class AccountTypeType13(str, Enum):
    """AccountTypeType13 -- Valid values are D or C.    D =DHL
...
class PickupResponse(GeneratedsSuper):
    """PickupResponse -- Root element of Book Pickup Request
      
    * ConfirmationNumber -- Confirmation number of the pickup
      
    * ReadyByTime -- Time to be ready by. This field is not returned
      for cancel pickup request
      
    * SecondReadyByTime -- Second time to be ready. This field is not
      returned for cancel pickup request
      
    * NextPickupDate -- Next possible pickup date. This field is not
      returned for cancel pickup request
      
    * PickupCharge -- This field is not returned for cancel pickup
      request
      
    * CurrencyCode -- This field is not returned for cancel pickup
      request
      
    * CallInTime -- Time for calling in order. This field is not
      returned for cancel pickup request
      
    * SecondCallInTime -- Second time for calling in order. This field is
      not returned for cancel pickup request
      
    * OriginSvcArea -- Three letter code identifying the service area
    ...
    * CountryCode -- Two letter ISO country Code
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PickupResponse', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PickupResponse')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PickupResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PickupResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PickupResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class LargestPiece(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='LargestPiece', pretty_print=True):
        ...
        if self._hasContent():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='dhlPickup:', name_='LargestPiece'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='LargestPiece', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Place1(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='Place1', pretty_print=True):
        ...
        if self._hasContent():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='dhlPickup:', name_='Place1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='Place1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Requestor(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='Requestor', pretty_print=True):
        ...
        if self._hasContent():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='dhlPickup:', name_='Requestor'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='Requestor', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Pickup(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='Pickup', pretty_print=True):
        ...
        if self._hasContent():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='dhlPickup:', name_='Pickup'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='Pickup', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class contact(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='contact', pretty_print=True):
        ...
        if self._hasContent():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='dhlPickup:', name_='contact'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='contact', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class RequestorContact(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='RequestorContact', pretty_print=True):
        ...
        if self._hasContent():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='dhlPickup:', name_='RequestorContact'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='RequestorContact', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Piece2(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='Piece2', pretty_print=True):
        ...
        if self._hasContent():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='dhlPickup:', name_='Piece2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='Piece2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ShipmentDetails3(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='ShipmentDetails3', pretty_print=True):
        ...
        if self._hasContent():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='dhlPickup:', name_='ShipmentDetails3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='dhlPickup:', namespacedef_='', name_='ShipmentDetails3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
