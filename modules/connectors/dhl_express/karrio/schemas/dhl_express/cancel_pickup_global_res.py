...
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./dhl_express_lib/cancel_pickup_global_res.py" ./schemas/cancel-pickup-global-res.xsd
#
...
class CancelPUResponse(GeneratedsSuper):
    """CancelPUResponse -- Root element of Book Pickup Request
    ConfirmationNumber -- Confirmation number of the pickup
    ReadyByTime -- Time to be ready by. This field is not returned for cancel pickup request
    SecondReadyByTime -- Second time to be ready. This field is not returned for cancel pickup request
    NextPickupDate -- Next possible pickup date. This field is not returned for cancel pickup request
    PickupCharge -- This field is not returned for cancel pickup request
    CurrencyCode -- This field is not returned for cancel pickup request
    CallInTime -- Time for calling in order. This field is not returned for cancel pickup request
    SecondCallInTime -- Second time for calling in order. This field is not returned for cancel pickup request
    OriginSvcArea -- Three letter code identifying the service area of origin. This field is not returned for cancel pickup request
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelPUResponse', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CancelPUResponse')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CancelPUResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CancelPUResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelPUResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
