...
class ShippingOption(lib.Enum):
    chronopost_delivery_on_monday = OptionEnum(
        "1", meta=dict(category="DELIVERY_OPTIONS", configurable=True, service_level=True)
    )
    chronopost_delivery_on_saturday = OptionEnum(
        "6", meta=dict(category="DELIVERY_OPTIONS", configurable=True, service_level=True)
    )
    chronopost_delivery_normal = OptionEnum(
        "0", meta=dict(category="DELIVERY_OPTIONS", configurable=True, service_level=True)
    )
