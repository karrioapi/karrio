...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/evs_express_mail_intl_response.py" ./schemas/eVSExpressMailIntlResponse.xsd
#
