...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/sdc_get_locations_response.py" ./schemas/SDCGetLocationsResponse.xsd
#
