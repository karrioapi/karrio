...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/evs_cancel_request.py')
#
# Command line arguments:
#   ./schemas/eVSCancelRequest.xsd
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/evs_cancel_request.py" ./schemas/eVSCancelRequest.xsd
#
...
class eVSCancelRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, USERID=None, PASSWORD=None, BarcodeNumber=None, gds_collector_=None, **kwargs_):
