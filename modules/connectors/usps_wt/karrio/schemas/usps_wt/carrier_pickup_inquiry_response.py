...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_inquiry_response.py" ./schemas/CarrierPickupInquiryResponse.xsd
#
