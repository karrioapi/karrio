...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_change_request.py" ./schemas/CarrierPickupChangeRequest.xsd
#
