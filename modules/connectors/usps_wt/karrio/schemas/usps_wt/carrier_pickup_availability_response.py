...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_availability_response.py" ./schemas/CarrierPickupAvailabilityResponse.xsd
#
