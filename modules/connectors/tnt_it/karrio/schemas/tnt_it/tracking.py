...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/tnt_it/tracking.py')
#
# Command line arguments:
#   ./schemas/tracking.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/karrio/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/tnt_it/tracking.py" ./schemas/tracking.xsd
#
...
class Document(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Application=None, Version=None, Login=None, SearchCriteria=None, SearchParameters=None, ExtraDetails=None, gds_collector_=None, **kwargs_):
        ...
        self.SearchParameters_nsprefix_ = None
        self.ExtraDetails = ExtraDetails
        self.ExtraDetails_nsprefix_ = None
    ...
    def has__content(self):
        if (
            ...
            self.SearchParameters is not None or
            self.ExtraDetails is not None
        ):
            return True
        else:
            return False
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Document', fromsubclass_=False, pretty_print=True):
        ...
        if self.SearchParameters is not None:
            namespaceprefix_ = self.SearchParameters_nsprefix_ + ':' if (UseCapturedNS_ and self.SearchParameters_nsprefix_) else ''
            self.SearchParameters.export(outfile, level, namespaceprefix_, namespacedef_='', name_='SearchParameters', pretty_print=pretty_print)
        if self.ExtraDetails is not None:
            namespaceprefix_ = self.ExtraDetails_nsprefix_ + ':' if (UseCapturedNS_ and self.ExtraDetails_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sExtraDetails>%s</%sExtraDetails>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ExtraDetails), input_name='ExtraDetails')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'SearchCriteria':
            obj_ = SearchCriteriaType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.SearchCriteria = obj_
            obj_.original_tagname_ = 'SearchCriteria'
        elif nodeName_ == 'SearchParameters':
            obj_ = SearchParametersType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.SearchParameters = obj_
            obj_.original_tagname_ = 'SearchParameters'
        elif nodeName_ == 'ExtraDetails':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ExtraDetails')
            value_ = self.gds_validate_string(value_, node, 'ExtraDetails')
            self.ExtraDetails = value_
            self.ExtraDetails_nsprefix_ = child_.prefix
# end class Document
...
class SearchCriteriaType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ConNo=None, RTLSearch=None, AccountNo=None, StartDate=None, EndDate=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.ConNo = ConNo
        self.ConNo_nsprefix_ = None
        self.RTLSearch = RTLSearch
        self.RTLSearch_nsprefix_ = None
    ...
    def get_ConNo(self):
        return self.ConNo
    def set_ConNo(self, ConNo):
        self.ConNo = ConNo
    def get_RTLSearch(self):
        return self.RTLSearch
    def set_RTLSearch(self, RTLSearch):
        self.RTLSearch = RTLSearch
    ...
    def has__content(self):
        if (
            self.ConNo is not None or
            self.RTLSearch is not None or
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SearchCriteriaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.ConNo is not None:
            namespaceprefix_ = self.ConNo_nsprefix_ + ':' if (UseCapturedNS_ and self.ConNo_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sConNo>%s</%sConNo>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ConNo), input_name='ConNo')), namespaceprefix_ , eol_))
        if self.RTLSearch is not None:
            namespaceprefix_ = self.RTLSearch_nsprefix_ + ':' if (UseCapturedNS_ and self.RTLSearch_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRTLSearch>%s</%sRTLSearch>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RTLSearch), input_name='RTLSearch')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'ConNo':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ConNo')
            value_ = self.gds_validate_string(value_, node, 'ConNo')
            self.ConNo = value_
            self.ConNo_nsprefix_ = child_.prefix
        elif nodeName_ == 'RTLSearch':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RTLSearch')
            value_ = self.gds_validate_string(value_, node, 'RTLSearch')
            self.RTLSearch = value_
            self.RTLSearch_nsprefix_ = child_.prefix
...
class SearchParametersType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, SearchType=None, SearchOption=None, SearchKeyValue=None, SearchMethod=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.SearchKeyValue = SearchKeyValue
        self.SearchKeyValue_nsprefix_ = None
        self.SearchMethod = SearchMethod
        self.SearchMethod_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SearchParametersType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SearchParametersType.subclass:
            return SearchParametersType.subclass(*args_, **kwargs_)
        else:
            return SearchParametersType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_SearchOption(self, SearchOption):
        self.SearchOption = SearchOption
    def get_SearchKeyValue(self):
        return self.SearchKeyValue
    def set_SearchKeyValue(self, SearchKeyValue):
        self.SearchKeyValue = SearchKeyValue
    ...
    def has__content(self):
        if (
            ...
            self.SearchOption is not None or
            self.SearchKeyValue is not None or
            self.SearchMethod is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SearchParametersType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('SearchParametersType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'SearchParametersType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='SearchParametersType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SearchParametersType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SearchParametersType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SearchParametersType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.SearchOption is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSearchOption>%s</%sSearchOption>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.SearchOption), input_name='SearchOption')), namespaceprefix_ , eol_))
        if self.SearchKeyValue is not None:
            namespaceprefix_ = self.SearchKeyValue_nsprefix_ + ':' if (UseCapturedNS_ and self.SearchKeyValue_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSearchKeyValue>%s</%sSearchKeyValue>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.SearchKeyValue), input_name='SearchKeyValue')), namespaceprefix_ , eol_))
        if self.SearchMethod is not None:
            namespaceprefix_ = self.SearchMethod_nsprefix_ + ':' if (UseCapturedNS_ and self.SearchMethod_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSearchMethod>%s</%sSearchMethod>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.SearchMethod), input_name='SearchMethod')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'SearchOption':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'SearchOption')
            value_ = self.gds_validate_string(value_, node, 'SearchOption')
            self.SearchOption = value_
            self.SearchOption_nsprefix_ = child_.prefix
        elif nodeName_ == 'SearchKeyValue':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'SearchKeyValue')
            value_ = self.gds_validate_string(value_, node, 'SearchKeyValue')
            self.SearchKeyValue = value_
            self.SearchKeyValue_nsprefix_ = child_.prefix
        elif nodeName_ == 'SearchMethod':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'SearchMethod')
            value_ = self.gds_validate_string(value_, node, 'SearchMethod')
            self.SearchMethod = value_
            self.SearchMethod_nsprefix_ = child_.prefix
