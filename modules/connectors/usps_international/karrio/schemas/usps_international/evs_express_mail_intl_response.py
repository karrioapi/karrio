...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/evs_express_mail_intl_response.py')
#
# Command line arguments:
#   ./schemas/eVSExpressMailIntlResponse.xsd
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evs_express_mail_intl_response.py" ./schemas/eVSExpressMailIntlResponse.xsd
#
...
#
class eVSExpressMailIntlResponse(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSExpressMailIntlResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSExpressMailIntlResponse.subclass:
            return eVSExpressMailIntlResponse.subclass(*args_, **kwargs_)
        else:
            return eVSExpressMailIntlResponse(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSExpressMailIntlResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSExpressMailIntlResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'eVSExpressMailIntlResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='eVSExpressMailIntlResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='eVSExpressMailIntlResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='eVSExpressMailIntlResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSExpressMailIntlResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.SDRValue is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSDRValue>%s</%sSDRValue>%s' % (namespaceprefix_ , self.gds_format_float(self.SDRValue, input_name='SDRValue'), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'SDRValue' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_float(sval_, node, 'SDRValue')
            fval_ = self.gds_validate_float(fval_, node, 'SDRValue')
            self.SDRValue = fval_
...
# end class eVSExpressMailIntlResponse
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'eVSExpressMailIntlResponse'
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from evs_express_mail_intl_response import *\n\n')
