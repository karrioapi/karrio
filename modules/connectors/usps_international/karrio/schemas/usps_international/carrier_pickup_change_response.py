...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/carrier_pickup_change_response.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupChangeResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/carrier_pickup_change_response.py" ./schemas/CarrierPickupChangeResponse.xsd
#
...
#
class CarrierPickupChangeResponse(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CarrierPickupChangeResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CarrierPickupChangeResponse.subclass:
            return CarrierPickupChangeResponse.subclass(*args_, **kwargs_)
        else:
            return CarrierPickupChangeResponse(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CarrierPickupChangeResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CarrierPickupChangeResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CarrierPickupChangeResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CarrierPickupChangeResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CarrierPickupChangeResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CarrierPickupChangeResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CarrierPickupChangeResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class CarrierPickupChangeResponse
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'CarrierPickupChangeResponse'
        rootClass = CarrierPickupChangeResponse
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from carrier_pickup_change_response import *\n\n')
