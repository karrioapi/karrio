...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/evs_first_class_mail_intl_request.py')
#
# Command line arguments:
#   ./schemas/eVSFirstClassMailIntlRequest.xsd
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evs_first_class_mail_intl_request.py" ./schemas/eVSFirstClassMailIntlRequest.xsd
#
