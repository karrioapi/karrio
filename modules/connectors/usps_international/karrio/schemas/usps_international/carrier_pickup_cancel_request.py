...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/carrier_pickup_cancel_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupCancelRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/carrier_pickup_cancel_request.py" ./schemas/CarrierPickupCancelRequest.xsd
#
...
#
class CarrierPickupCancelRequest(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CarrierPickupCancelRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CarrierPickupCancelRequest.subclass:
            return CarrierPickupCancelRequest.subclass(*args_, **kwargs_)
        else:
            return CarrierPickupCancelRequest(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CarrierPickupCancelRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CarrierPickupCancelRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CarrierPickupCancelRequest':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CarrierPickupCancelRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CarrierPickupCancelRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CarrierPickupCancelRequest'):
...
# end class CarrierPickupCancelRequest
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'CarrierPickupCancelRequest'
        rootClass = CarrierPickupCancelRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from carrier_pickup_cancel_request import *\n\n')
