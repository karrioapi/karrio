...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/intl_rate_v2_request.py')
#
# Command line arguments:
#   ./schemas/IntlRateV2Request.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/intl_rate_v2_request.py" ./schemas/IntlRateV2Request.xsd
#
...
class IntlRateV2Request(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='IntlRateV2Request', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'IntlRateV2Request':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='IntlRateV2Request')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='IntlRateV2Request', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='IntlRateV2Request'):
...
class PackageType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, Pounds=None, Ounces=None, Machinable=True, MailType=None, GXG=None, ValueOfContents=None, Country=None, Container=None, Size=None, Width=None, Length=None, Height=None, Girth=None, OriginZip=None, CommercialFlag=None, CommercialPlusFlag=None, ExtraServices=None, AcceptanceDateTime=None, DestinationPostalCode=None, Content=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.CommercialFlag_nsprefix_ = None
        self.CommercialPlusFlag = CommercialPlusFlag
        self.CommercialPlusFlag_nsprefix_ = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PackageType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ValueOfContents is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValueOfContents>%s</%sValueOfContents>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ValueOfContents), input_name='ValueOfContents')), namespaceprefix_ , eol_))
        ...
        if self.CommercialFlag is not None:
            namespaceprefix_ = self.CommercialFlag_nsprefix_ + ':' if (UseCapturedNS_ and self.CommercialFlag_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.CommercialPlusFlag is not None:
            namespaceprefix_ = self.CommercialPlusFlag_nsprefix_ + ':' if (UseCapturedNS_ and self.CommercialPlusFlag_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.AcceptanceDateTime is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAcceptanceDateTime>%s</%sAcceptanceDateTime>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.AcceptanceDateTime), input_name='AcceptanceDateTime')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Pounds' and child_.text:
        ...
        elif nodeName_ == 'ValueOfContents':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ValueOfContents')
            value_ = self.gds_validate_string(value_, node, 'ValueOfContents')
            self.ValueOfContents = value_
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'CommercialFlag')
            value_ = self.gds_validate_string(value_, node, 'CommercialFlag')
            self.CommercialFlag = value_
            self.CommercialFlag_nsprefix_ = child_.prefix
        elif nodeName_ == 'CommercialPlusFlag':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'CommercialPlusFlag')
            value_ = self.gds_validate_string(value_, node, 'CommercialPlusFlag')
            self.CommercialPlusFlag = value_
            self.CommercialPlusFlag_nsprefix_ = child_.prefix
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'AcceptanceDateTime')
            value_ = self.gds_validate_string(value_, node, 'AcceptanceDateTime')
            self.AcceptanceDateTime = value_
...
class GXGType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GXGType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='GXGType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='GXGType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GXGType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GXGType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from intl_rate_v2_request import *\n\n')
