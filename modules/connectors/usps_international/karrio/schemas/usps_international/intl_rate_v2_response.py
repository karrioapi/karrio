...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/intl_rate_v2_response.py" ./schemas/IntlRateV2Response.xsd
#
