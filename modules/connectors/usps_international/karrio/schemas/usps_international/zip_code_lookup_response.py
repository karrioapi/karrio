...
#
# Generated Sat Oct 14 00:23:44 2023 by generateDS.py version 2.43.2.
# Python 3.10.12 (main, Jun 11 2023, 05:26:28) [GCC 11.4.0]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/zip_code_lookup_response.py')
#
# Command line arguments:
#   ./schemas/ZipCodeLookupResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/zip_code_lookup_response.py" ./schemas/ZipCodeLookupResponse.xsd
#
...
#
class ZipCodeLookupResponse(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ZipCodeLookupResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ZipCodeLookupResponse.subclass:
            return ZipCodeLookupResponse.subclass(*args_, **kwargs_)
        else:
            return ZipCodeLookupResponse(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ZipCodeLookupResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ZipCodeLookupResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ZipCodeLookupResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ZipCodeLookupResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ZipCodeLookupResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ZipCodeLookupResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ZipCodeLookupResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class ZipCodeLookupResponse
...
class AddressType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, Address1=None, Address2=None, City=None, FirmName=None, State=None, Urbanization=None, Zip5=None, Zip4=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Zip4 is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sZip4>%s</%sZip4>%s' % (namespaceprefix_ , self.gds_format_integer(self.Zip4, input_name='Zip4'), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'Zip5' and child_.text:
            sval_ = child_.text
        ...
        elif nodeName_ == 'Zip4' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'Zip4')
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'ZipCodeLookupResponse'
        rootClass = ZipCodeLookupResponse
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from zip_code_lookup_response import *\n\n')
