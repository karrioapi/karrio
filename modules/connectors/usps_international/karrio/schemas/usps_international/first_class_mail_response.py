...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/first_class_mail_response.py')
#
# Command line arguments:
#   ./schemas/FirstClassMailResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/first_class_mail_response.py" ./schemas/FirstClassMailResponse.xsd
#
...
#
class FirstClassMailResponse(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, OriginZip=None, DestinationZip=None, Days=None, Message=None, EffectiveAcceptanceDate=None, ScheduledDeliveryDate=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, FirstClassMailResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if FirstClassMailResponse.subclass:
            return FirstClassMailResponse.subclass(*args_, **kwargs_)
        else:
            return FirstClassMailResponse(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='FirstClassMailResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('FirstClassMailResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'FirstClassMailResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='FirstClassMailResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='FirstClassMailResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='FirstClassMailResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='FirstClassMailResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.EffectiveAcceptanceDate is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEffectiveAcceptanceDate>%s</%sEffectiveAcceptanceDate>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.EffectiveAcceptanceDate), input_name='EffectiveAcceptanceDate')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'OriginZip' and child_.text:
        ...
        elif nodeName_ == 'Days' and child_.text:
            sval_ = child_.text
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'EffectiveAcceptanceDate')
            value_ = self.gds_validate_string(value_, node, 'EffectiveAcceptanceDate')
            self.EffectiveAcceptanceDate = value_
...
# end class FirstClassMailResponse
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'FirstClassMailResponse'
        rootClass = FirstClassMailResponse
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from first_class_mail_response import *\n\n')
