...
import karrio.providers.deutschepost_international.error as error
...
def shipment_request(
    ...
    service = provider_units.ShippingService.map(
        payload.service
    ).value_or_key  # preprocess the request services
    ...
    request = None  # map data to convert karrio model to deutschepost_international specific type
