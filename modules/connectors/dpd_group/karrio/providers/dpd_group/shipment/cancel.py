"""Karrio DPD Group shipment cancellation API implementation."""
import typing
...
def shipment_cancel_request(
    ...
    # import karrio.schemas.dpd_group.shipment_cancel_request as dpd_group_req
    #
    # request = dpd_group_req.ShipmentCancelRequestType(
