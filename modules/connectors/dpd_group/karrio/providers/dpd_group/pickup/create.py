...
import karrio.schemas.dpd_group.pickup_create_request as dpd_req
import karrio.schemas.dpd_group.pickup_create_response as dpd_res
...
def pickup_request(
    ...
    request = dpd_req.PickupCreateRequestType(
        ...
        shipmentNumbers=payload.options.get("shipment_numbers", []) if payload.options else [],
