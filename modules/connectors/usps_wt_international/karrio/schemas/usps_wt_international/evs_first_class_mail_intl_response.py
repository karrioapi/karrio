...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/evs_first_class_mail_intl_response.py')
#
# Command line arguments:
#   ./schemas/eVSFirstClassMailIntlResponse.xsd
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evs_first_class_mail_intl_response.py" ./schemas/eVSFirstClassMailIntlResponse.xsd
#
...
#
class eVSFirstClassMailIntlResponse(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Postage=None, TotalValue=None, BarcodeNumber=None, LabelImage=None, Page2Image=None, Page3Image=None, Prohibitions=None, Restrictions=None, Observations=None, Regulations=None, AdditionalRestrictions=None, ExtraServices=None, RemainingBarcodes=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSFirstClassMailIntlResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSFirstClassMailIntlResponse.subclass:
            return eVSFirstClassMailIntlResponse.subclass(*args_, **kwargs_)
        else:
            return eVSFirstClassMailIntlResponse(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSFirstClassMailIntlResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSFirstClassMailIntlResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'eVSFirstClassMailIntlResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='eVSFirstClassMailIntlResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='eVSFirstClassMailIntlResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='eVSFirstClassMailIntlResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSFirstClassMailIntlResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class eVSFirstClassMailIntlResponse
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'eVSFirstClassMailIntlResponse'
        rootClass = eVSFirstClassMailIntlResponse
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from evs_first_class_mail_intl_response import *\n\n')
