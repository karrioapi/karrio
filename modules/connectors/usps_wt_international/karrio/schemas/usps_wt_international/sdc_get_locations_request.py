...
#
# Generated Wed Apr  3 21:09:08 2024 by generateDS.py version 2.43.3.
# Python 3.10.13 (main, Mar 21 2024, 17:51:02) [GCC 9.4.0]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/sdc_get_locations_request.py')
#
# Command line arguments:
#   ./schemas/SDCGetLocationsRequest.xsd
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/sdc_get_locations_request.py" ./schemas/SDCGetLocationsRequest.xsd
#
...
#
class SDCGetLocationsRequest(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, USERID=None, PASSWORD=None, MailClass=None, OriginZIP=None, DestinationZIP=None, AcceptDate=None, AcceptTime=None, NonExpeditedDetail=None, ClientType=None, gds_collector_=None, **kwargs_):
        ...
        self.NonExpeditedDetail = NonExpeditedDetail
        self.NonExpeditedDetail_nsprefix_ = None
        self.ClientType = ClientType
        self.ClientType_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SDCGetLocationsRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SDCGetLocationsRequest.subclass:
            return SDCGetLocationsRequest.subclass(*args_, **kwargs_)
        else:
            return SDCGetLocationsRequest(*args_, **kwargs_)
    ...
    def set_AcceptTime(self, AcceptTime):
        self.AcceptTime = AcceptTime
    def get_NonExpeditedDetail(self):
        return self.NonExpeditedDetail
    def set_NonExpeditedDetail(self, NonExpeditedDetail):
        self.NonExpeditedDetail = NonExpeditedDetail
    ...
    def has__content(self):
        if (
            ...
            self.NonExpeditedDetail is not None or
            self.ClientType is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SDCGetLocationsRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('SDCGetLocationsRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'SDCGetLocationsRequest':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='SDCGetLocationsRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SDCGetLocationsRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SDCGetLocationsRequest'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SDCGetLocationsRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.AcceptDate is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAcceptDate>%s</%sAcceptDate>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.AcceptDate), input_name='AcceptDate')), namespaceprefix_ , eol_))
        ...
        if self.NonExpeditedDetail is not None:
            namespaceprefix_ = self.NonExpeditedDetail_nsprefix_ + ':' if (UseCapturedNS_ and self.NonExpeditedDetail_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNonExpeditedDetail>%s</%sNonExpeditedDetail>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.NonExpeditedDetail), input_name='NonExpeditedDetail')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'MailClass' and child_.text:
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'AcceptDate')
            value_ = self.gds_validate_string(value_, node, 'AcceptDate')
            self.AcceptDate = value_
        ...
        elif nodeName_ == 'NonExpeditedDetail':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'NonExpeditedDetail')
            value_ = self.gds_validate_string(value_, node, 'NonExpeditedDetail')
            self.NonExpeditedDetail = value_
            self.NonExpeditedDetail_nsprefix_ = child_.prefix
...
# end class SDCGetLocationsRequest
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'SDCGetLocationsRequest'
        rootClass = SDCGetLocationsRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from sdc_get_locations_request import *\n\n')
