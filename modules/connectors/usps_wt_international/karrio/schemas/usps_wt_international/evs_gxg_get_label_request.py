...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/evs_gxg_get_label_request.py')
#
# Command line arguments:
#   ./schemas/eVSGXGGetLabelRequest.xsd
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evs_gxg_get_label_request.py" ./schemas/eVSGXGGetLabelRequest.xsd
#
...
class eVSGXGGetLabelRequest(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSGXGGetLabelRequest', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='eVSGXGGetLabelRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='eVSGXGGetLabelRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='eVSGXGGetLabelRequest'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSGXGGetLabelRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class RestrictionType(GeneratedsSuper):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RestrictionType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RestrictionType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
