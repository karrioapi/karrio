...
#
# Generated Wed Apr  3 21:09:11 2024 by generateDS.py version 2.43.3.
# Python 3.10.13 (main, Mar 21 2024, 17:51:02) [GCC 9.4.0]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/evs_express_mail_intl_request.py')
#
# Command line arguments:
#   ./schemas/eVSExpressMailIntlRequest.xsd
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evs_express_mail_intl_request.py" ./schemas/eVSExpressMailIntlRequest.xsd
#
...
class eVSExpressMailIntlRequest(GeneratedsSuper):
    ...
    def __init__(self, USERID=None, PASSWORD=None, Option=None, Revision=None, ImageParameters=None, FromFirstName=None, FromMiddleInitial=None, FromLastName=None, FromFirm=None, FromAddress1=None, FromAddress2=None, FromUrbanization=None, FromCity=None, FromState=None, FromZip5=None, FromZip4=None, FromPhone=None, FromCustomsReference=None, ToName=None, ToFirstName=None, ToLastName=None, ToFirm=None, ToAddress1=None, ToAddress2=None, ToAddress3=None, ToCity=None, ToProvince=None, ToCountry=None, ToPostalCode=None, ToPOBoxFlag=None, ToPhone=None, ToFax=None, ToEmail=None, ImportersReferenceNumber=None, NonDeliveryOption=None, RedirectName=None, RedirectEmail=None, RedirectSMS=None, RedirectAddress=None, RedirectCity=None, RedirectState=None, RedirectZipCode=None, RedirectZip4=None, Container=None, ShippingContents=None, InsuredNumber=None, InsuredAmount=None, Postage=None, GrossPounds=None, GrossOunces=None, ContentType=None, ContentTypeOther=None, Agreement=None, Comments=None, LicenseNumber=None, CertificateNumber=None, InvoiceNumber=None, ImageType=None, ImageLayout=None, CustomerRefNo=None, CustomerRefNo2=None, POZipCode=None, LabelDate=None, EMCAAccount=None, HoldForManifest=None, EELPFC=None, PriceOptions=None, Length=None, Width=None, Height=None, Girth=None, LabelTime=None, MeterPaymentFlag=None, ActionCode=None, OptOutOfSPE=None, PermitNumber=None, AccountZipCode=None, ImportersReferenceType=None, ImportersTelephoneNumber=None, ImportersFaxNumber=None, ImportersEmail=None, Machinable=None, DestinationRateIndicator=None, MID=None, LogisticsManagerMID=None, CRID=None, VendorCode=None, VendorProductVersionNumber=None, ePostageMailerReporting=None, SenderFirstName=None, SenderLastName=None, SenderBusinessName=None, SenderAddress1=None, SenderCity=None, SenderState=None, SenderZip5=None, SenderPhone=None, SenderEmail=None, gds_collector_=None, **kwargs_):
        ...
        self.FromCustomsReference = FromCustomsReference
        self.FromCustomsReference_nsprefix_ = None
        self.ToName = ToName
        ...
        self.ImportersReferenceNumber = ImportersReferenceNumber
        self.ImportersReferenceNumber_nsprefix_ = None
        self.NonDeliveryOption = NonDeliveryOption
        self.NonDeliveryOption_nsprefix_ = None
        self.RedirectName = RedirectName
        self.RedirectName_nsprefix_ = None
        self.RedirectEmail = RedirectEmail
        self.RedirectEmail_nsprefix_ = None
        self.RedirectSMS = RedirectSMS
        self.RedirectSMS_nsprefix_ = None
        self.RedirectAddress = RedirectAddress
        self.RedirectAddress_nsprefix_ = None
        self.RedirectCity = RedirectCity
        self.RedirectCity_nsprefix_ = None
        self.RedirectState = RedirectState
        self.RedirectState_nsprefix_ = None
        self.RedirectZipCode = RedirectZipCode
        self.RedirectZipCode_nsprefix_ = None
        self.RedirectZip4 = RedirectZip4
        self.RedirectZip4_nsprefix_ = None
        self.Container = Container
        ...
        self.InsuredNumber_nsprefix_ = None
        ...
        self.EMCAAccount = EMCAAccount
        self.EMCAAccount_nsprefix_ = None
        ...
        self.LabelTime_nsprefix_ = None
        self.MeterPaymentFlag = MeterPaymentFlag
        self.MeterPaymentFlag_nsprefix_ = None
        ...
        self.ImportersReferenceType = ImportersReferenceType
        self.ImportersReferenceType_nsprefix_ = None
        self.ImportersTelephoneNumber = ImportersTelephoneNumber
        self.ImportersTelephoneNumber_nsprefix_ = None
        self.ImportersFaxNumber = ImportersFaxNumber
        self.ImportersFaxNumber_nsprefix_ = None
        self.ImportersEmail = ImportersEmail
        self.ImportersEmail_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSExpressMailIntlRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSExpressMailIntlRequest.subclass:
            return eVSExpressMailIntlRequest.subclass(*args_, **kwargs_)
        else:
            return eVSExpressMailIntlRequest(*args_, **kwargs_)
    ...
    def set_FromPhone(self, FromPhone):
        self.FromPhone = FromPhone
    def get_FromCustomsReference(self):
        return self.FromCustomsReference
    def set_FromCustomsReference(self, FromCustomsReference):
        self.FromCustomsReference = FromCustomsReference
    def get_ToName(self):
        return self.ToName
    ...
    def set_ToEmail(self, ToEmail):
        self.ToEmail = ToEmail
    def get_ImportersReferenceNumber(self):
        return self.ImportersReferenceNumber
    def set_ImportersReferenceNumber(self, ImportersReferenceNumber):
        self.ImportersReferenceNumber = ImportersReferenceNumber
    def get_NonDeliveryOption(self):
        return self.NonDeliveryOption
    def set_NonDeliveryOption(self, NonDeliveryOption):
        self.NonDeliveryOption = NonDeliveryOption
    def get_RedirectName(self):
        return self.RedirectName
    def set_RedirectName(self, RedirectName):
        self.RedirectName = RedirectName
    def get_RedirectEmail(self):
        return self.RedirectEmail
    def set_RedirectEmail(self, RedirectEmail):
        self.RedirectEmail = RedirectEmail
    def get_RedirectSMS(self):
        return self.RedirectSMS
    def set_RedirectSMS(self, RedirectSMS):
        self.RedirectSMS = RedirectSMS
    def get_RedirectAddress(self):
        return self.RedirectAddress
    def set_RedirectAddress(self, RedirectAddress):
        self.RedirectAddress = RedirectAddress
    def get_RedirectCity(self):
        return self.RedirectCity
    def set_RedirectCity(self, RedirectCity):
        self.RedirectCity = RedirectCity
    def get_RedirectState(self):
        return self.RedirectState
    def set_RedirectState(self, RedirectState):
        self.RedirectState = RedirectState
    def get_RedirectZipCode(self):
        return self.RedirectZipCode
    def set_RedirectZipCode(self, RedirectZipCode):
        self.RedirectZipCode = RedirectZipCode
    def get_RedirectZip4(self):
        return self.RedirectZip4
    def set_RedirectZip4(self, RedirectZip4):
        self.RedirectZip4 = RedirectZip4
    ...
    def set_ShippingContents(self, ShippingContents):
        self.ShippingContents = ShippingContents
    def get_InsuredNumber(self):
        return self.InsuredNumber
    def set_InsuredNumber(self, InsuredNumber):
        self.InsuredNumber = InsuredNumber
    ...
    def set_LabelDate(self, LabelDate):
        self.LabelDate = LabelDate
    def get_EMCAAccount(self):
        return self.EMCAAccount
    def set_EMCAAccount(self, EMCAAccount):
        self.EMCAAccount = EMCAAccount
    ...
    def set_Girth(self, Girth):
        self.Girth = Girth
    def get_LabelTime(self):
        return self.LabelTime
    def set_LabelTime(self, LabelTime):
        self.LabelTime = LabelTime
    def get_MeterPaymentFlag(self):
        return self.MeterPaymentFlag
    def set_MeterPaymentFlag(self, MeterPaymentFlag):
        self.MeterPaymentFlag = MeterPaymentFlag
    ...
    def set_AccountZipCode(self, AccountZipCode):
        self.AccountZipCode = AccountZipCode
    def get_ImportersReferenceType(self):
        return self.ImportersReferenceType
    def set_ImportersReferenceType(self, ImportersReferenceType):
        self.ImportersReferenceType = ImportersReferenceType
    def get_ImportersTelephoneNumber(self):
        return self.ImportersTelephoneNumber
    def set_ImportersTelephoneNumber(self, ImportersTelephoneNumber):
        self.ImportersTelephoneNumber = ImportersTelephoneNumber
    def get_ImportersFaxNumber(self):
        return self.ImportersFaxNumber
    def set_ImportersFaxNumber(self, ImportersFaxNumber):
        self.ImportersFaxNumber = ImportersFaxNumber
    def get_ImportersEmail(self):
        return self.ImportersEmail
    def set_ImportersEmail(self, ImportersEmail):
        self.ImportersEmail = ImportersEmail
    ...
    def has__content(self):
        if (
            ...
            self.FromCustomsReference is not None or
            ...
            self.ImportersReferenceNumber is not None or
            self.NonDeliveryOption is not None or
            self.RedirectName is not None or
            self.RedirectEmail is not None or
            self.RedirectSMS is not None or
            self.RedirectAddress is not None or
            self.RedirectCity is not None or
            self.RedirectState is not None or
            self.RedirectZipCode is not None or
            self.RedirectZip4 is not None or
            self.Container is not None or
            self.ShippingContents is not None or
            self.InsuredNumber is not None or
            ...
            self.EMCAAccount is not None or
            ...
            self.LabelTime is not None or
            self.MeterPaymentFlag is not None or
            ...
            self.ImportersReferenceType is not None or
            self.ImportersTelephoneNumber is not None or
            self.ImportersFaxNumber is not None or
            self.ImportersEmail is not None or
            ...
            self.SenderEmail is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSExpressMailIntlRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSExpressMailIntlRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'eVSExpressMailIntlRequest':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='eVSExpressMailIntlRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='eVSExpressMailIntlRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='eVSExpressMailIntlRequest'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSExpressMailIntlRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.FromCustomsReference is not None:
            namespaceprefix_ = self.FromCustomsReference_nsprefix_ + ':' if (UseCapturedNS_ and self.FromCustomsReference_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sFromCustomsReference>%s</%sFromCustomsReference>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.FromCustomsReference), input_name='FromCustomsReference')), namespaceprefix_ , eol_))
        ...
        if self.ImportersReferenceNumber is not None:
            namespaceprefix_ = self.ImportersReferenceNumber_nsprefix_ + ':' if (UseCapturedNS_ and self.ImportersReferenceNumber_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sImportersReferenceNumber>%s</%sImportersReferenceNumber>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ImportersReferenceNumber), input_name='ImportersReferenceNumber')), namespaceprefix_ , eol_))
        ...
        if self.RedirectName is not None:
            namespaceprefix_ = self.RedirectName_nsprefix_ + ':' if (UseCapturedNS_ and self.RedirectName_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRedirectName>%s</%sRedirectName>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RedirectName), input_name='RedirectName')), namespaceprefix_ , eol_))
        if self.RedirectEmail is not None:
            namespaceprefix_ = self.RedirectEmail_nsprefix_ + ':' if (UseCapturedNS_ and self.RedirectEmail_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRedirectEmail>%s</%sRedirectEmail>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RedirectEmail), input_name='RedirectEmail')), namespaceprefix_ , eol_))
        if self.RedirectSMS is not None:
            namespaceprefix_ = self.RedirectSMS_nsprefix_ + ':' if (UseCapturedNS_ and self.RedirectSMS_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRedirectSMS>%s</%sRedirectSMS>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RedirectSMS), input_name='RedirectSMS')), namespaceprefix_ , eol_))
        if self.RedirectAddress is not None:
            namespaceprefix_ = self.RedirectAddress_nsprefix_ + ':' if (UseCapturedNS_ and self.RedirectAddress_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRedirectAddress>%s</%sRedirectAddress>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RedirectAddress), input_name='RedirectAddress')), namespaceprefix_ , eol_))
        if self.RedirectCity is not None:
            namespaceprefix_ = self.RedirectCity_nsprefix_ + ':' if (UseCapturedNS_ and self.RedirectCity_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRedirectCity>%s</%sRedirectCity>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RedirectCity), input_name='RedirectCity')), namespaceprefix_ , eol_))
        if self.RedirectState is not None:
            namespaceprefix_ = self.RedirectState_nsprefix_ + ':' if (UseCapturedNS_ and self.RedirectState_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRedirectState>%s</%sRedirectState>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RedirectState), input_name='RedirectState')), namespaceprefix_ , eol_))
        if self.RedirectZipCode is not None:
            namespaceprefix_ = self.RedirectZipCode_nsprefix_ + ':' if (UseCapturedNS_ and self.RedirectZipCode_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRedirectZipCode>%s</%sRedirectZipCode>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RedirectZipCode), input_name='RedirectZipCode')), namespaceprefix_ , eol_))
        if self.RedirectZip4 is not None:
            namespaceprefix_ = self.RedirectZip4_nsprefix_ + ':' if (UseCapturedNS_ and self.RedirectZip4_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRedirectZip4>%s</%sRedirectZip4>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RedirectZip4), input_name='RedirectZip4')), namespaceprefix_ , eol_))
        ...
        if self.InsuredNumber is not None:
            namespaceprefix_ = self.InsuredNumber_nsprefix_ + ':' if (UseCapturedNS_ and self.InsuredNumber_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInsuredNumber>%s</%sInsuredNumber>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.InsuredNumber), input_name='InsuredNumber')), namespaceprefix_ , eol_))
        ...
        if self.EMCAAccount is not None:
            namespaceprefix_ = self.EMCAAccount_nsprefix_ + ':' if (UseCapturedNS_ and self.EMCAAccount_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEMCAAccount>%s</%sEMCAAccount>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.EMCAAccount), input_name='EMCAAccount')), namespaceprefix_ , eol_))
        ...
        if self.LabelTime is not None:
            namespaceprefix_ = self.LabelTime_nsprefix_ + ':' if (UseCapturedNS_ and self.LabelTime_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sLabelTime>%s</%sLabelTime>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.LabelTime), input_name='LabelTime')), namespaceprefix_ , eol_))
        if self.MeterPaymentFlag is not None:
            namespaceprefix_ = self.MeterPaymentFlag_nsprefix_ + ':' if (UseCapturedNS_ and self.MeterPaymentFlag_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMeterPaymentFlag>%s</%sMeterPaymentFlag>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.MeterPaymentFlag), input_name='MeterPaymentFlag')), namespaceprefix_ , eol_))
        ...
        if self.ImportersReferenceType is not None:
            namespaceprefix_ = self.ImportersReferenceType_nsprefix_ + ':' if (UseCapturedNS_ and self.ImportersReferenceType_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sImportersReferenceType>%s</%sImportersReferenceType>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ImportersReferenceType), input_name='ImportersReferenceType')), namespaceprefix_ , eol_))
        if self.ImportersTelephoneNumber is not None:
            namespaceprefix_ = self.ImportersTelephoneNumber_nsprefix_ + ':' if (UseCapturedNS_ and self.ImportersTelephoneNumber_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sImportersTelephoneNumber>%s</%sImportersTelephoneNumber>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ImportersTelephoneNumber), input_name='ImportersTelephoneNumber')), namespaceprefix_ , eol_))
        if self.ImportersFaxNumber is not None:
            namespaceprefix_ = self.ImportersFaxNumber_nsprefix_ + ':' if (UseCapturedNS_ and self.ImportersFaxNumber_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sImportersFaxNumber>%s</%sImportersFaxNumber>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ImportersFaxNumber), input_name='ImportersFaxNumber')), namespaceprefix_ , eol_))
        if self.ImportersEmail is not None:
            namespaceprefix_ = self.ImportersEmail_nsprefix_ + ':' if (UseCapturedNS_ and self.ImportersEmail_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sImportersEmail>%s</%sImportersEmail>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ImportersEmail), input_name='ImportersEmail')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'FromCustomsReference':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'FromCustomsReference')
            value_ = self.gds_validate_string(value_, node, 'FromCustomsReference')
            self.FromCustomsReference = value_
            self.FromCustomsReference_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'ImportersReferenceNumber':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ImportersReferenceNumber')
            value_ = self.gds_validate_string(value_, node, 'ImportersReferenceNumber')
            self.ImportersReferenceNumber = value_
            self.ImportersReferenceNumber_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'RedirectName':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RedirectName')
            value_ = self.gds_validate_string(value_, node, 'RedirectName')
            self.RedirectName = value_
            self.RedirectName_nsprefix_ = child_.prefix
        elif nodeName_ == 'RedirectEmail':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RedirectEmail')
            value_ = self.gds_validate_string(value_, node, 'RedirectEmail')
            self.RedirectEmail = value_
            self.RedirectEmail_nsprefix_ = child_.prefix
        elif nodeName_ == 'RedirectSMS':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RedirectSMS')
            value_ = self.gds_validate_string(value_, node, 'RedirectSMS')
            self.RedirectSMS = value_
            self.RedirectSMS_nsprefix_ = child_.prefix
        elif nodeName_ == 'RedirectAddress':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RedirectAddress')
            value_ = self.gds_validate_string(value_, node, 'RedirectAddress')
            self.RedirectAddress = value_
            self.RedirectAddress_nsprefix_ = child_.prefix
        elif nodeName_ == 'RedirectCity':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RedirectCity')
            value_ = self.gds_validate_string(value_, node, 'RedirectCity')
            self.RedirectCity = value_
            self.RedirectCity_nsprefix_ = child_.prefix
        elif nodeName_ == 'RedirectState':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RedirectState')
            value_ = self.gds_validate_string(value_, node, 'RedirectState')
            self.RedirectState = value_
            self.RedirectState_nsprefix_ = child_.prefix
        elif nodeName_ == 'RedirectZipCode':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RedirectZipCode')
            value_ = self.gds_validate_string(value_, node, 'RedirectZipCode')
            self.RedirectZipCode = value_
            self.RedirectZipCode_nsprefix_ = child_.prefix
        elif nodeName_ == 'RedirectZip4':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RedirectZip4')
            value_ = self.gds_validate_string(value_, node, 'RedirectZip4')
            self.RedirectZip4 = value_
            self.RedirectZip4_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'InsuredNumber':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'InsuredNumber')
            value_ = self.gds_validate_string(value_, node, 'InsuredNumber')
            self.InsuredNumber = value_
            self.InsuredNumber_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'EMCAAccount':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'EMCAAccount')
            value_ = self.gds_validate_string(value_, node, 'EMCAAccount')
            self.EMCAAccount = value_
            self.EMCAAccount_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'LabelTime':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'LabelTime')
            value_ = self.gds_validate_string(value_, node, 'LabelTime')
            self.LabelTime = value_
            self.LabelTime_nsprefix_ = child_.prefix
        elif nodeName_ == 'MeterPaymentFlag':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'MeterPaymentFlag')
            value_ = self.gds_validate_string(value_, node, 'MeterPaymentFlag')
            self.MeterPaymentFlag = value_
            self.MeterPaymentFlag_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'ImportersReferenceType':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ImportersReferenceType')
            value_ = self.gds_validate_string(value_, node, 'ImportersReferenceType')
            self.ImportersReferenceType = value_
            self.ImportersReferenceType_nsprefix_ = child_.prefix
        elif nodeName_ == 'ImportersTelephoneNumber':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ImportersTelephoneNumber')
            value_ = self.gds_validate_string(value_, node, 'ImportersTelephoneNumber')
            self.ImportersTelephoneNumber = value_
            self.ImportersTelephoneNumber_nsprefix_ = child_.prefix
        elif nodeName_ == 'ImportersFaxNumber':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ImportersFaxNumber')
            value_ = self.gds_validate_string(value_, node, 'ImportersFaxNumber')
            self.ImportersFaxNumber = value_
            self.ImportersFaxNumber_nsprefix_ = child_.prefix
        elif nodeName_ == 'ImportersEmail':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ImportersEmail')
            value_ = self.gds_validate_string(value_, node, 'ImportersEmail')
            self.ImportersEmail = value_
            self.ImportersEmail_nsprefix_ = child_.prefix
...
# end class eVSExpressMailIntlRequest
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'eVSExpressMailIntlRequest'
        rootClass = eVSExpressMailIntlRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from evs_express_mail_intl_request import *\n\n')
