...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evs_cancel_response.py" ./schemas/eVSCancelResponse.xsd
#
