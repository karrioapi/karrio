...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/evsi_cancel_request.py" ./schemas/eVSICancelRequest.xsd
#
