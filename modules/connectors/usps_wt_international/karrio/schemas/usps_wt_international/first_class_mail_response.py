...
#
# Command line:
#   /workspaces/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/first_class_mail_response.py" ./schemas/FirstClassMailResponse.xsd
#
