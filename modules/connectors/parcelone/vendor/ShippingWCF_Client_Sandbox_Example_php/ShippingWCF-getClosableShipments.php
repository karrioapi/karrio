...
echo "<h2>getClosableShipments-Function</h2><hr>";

try {
	$result = $client->getClosableShipments(array('Mandator' => "",'Consigner' => "",'CEP' => ""));
	var_dump($result);
	$documentdata = $result->getClosableShipmentsResult->printDocumentsResult->Document;
	$decodeddata = base64_decode($documentdata);
	echo "<br><br><br>CSV-Liste<br>".$decodeddata;
	echo "<br><br><a href='data:application/csv;base64,".$documentdata."' target = 'Doc1'>CSV-Liste</a>";
}
