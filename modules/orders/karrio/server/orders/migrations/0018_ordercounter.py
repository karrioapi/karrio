        ...
        for org_data in orgs_with_orders:
            ...
            for test_mode in [False, True]:
                ...
                orders = Order.objects.filter(
                    id__in=order_ids, test_mode=test_mode, source="draft", order_id__startswith="1"
                )
                ...
                if max_counter > 0:
                    OrderCounter.objects.create(org_id=org_id, test_mode=test_mode, counter=max_counter)
    except LookupError:
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.base.uuid, *(), **{"prefix": "octx_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
            ...
            options={
                ...
                "indexes": [models.Index(fields=["org_id", "test_mode"], name="order_counter_org_idx")],
