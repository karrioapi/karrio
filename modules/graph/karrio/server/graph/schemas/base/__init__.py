...
class Query:
    ...
    tag_definitions: list[types.TagDefinitionType] = strawberry.field(
        resolver=types.TagDefinitionType.from_registry,
        description="Service-level tag registry (drives admin editor + derived badges).",
    )
