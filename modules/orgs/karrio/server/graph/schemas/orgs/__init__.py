...
@strawberry.type
class Query:
    organization: typing.Optional[types.OrganizationType] = strawberry.field(
    ...
    organization_invitation: typing.Optional[
        types.OrganizationInvitationType
    ] = strawberry.field(resolver=types.OrganizationInvitationType.resolve)
...
class Mutation:
    ...
    def delete_organization(
        ...
        return mutations.DeleteOrganizationMutation.mutate(info, **input.to_dict())
    ...
    def set_organization_user_roles(
        ...
        return mutations.SetOrganizationUserRolesMutation.mutate(
            info, **input.to_dict()
        )
    ...
    def accept_organization_invitation(
        ...
        return mutations.AcceptOrganizationInvitationMutation.mutate(
            info, **input.to_dict()
        )
    ...
    def remove_organization_member(
        self, info: Info, input: inputs.RemoveOrganizationMemberMutationInput
    ) -> mutations.RemoveOrganizationMemberMutation:
        return mutations.RemoveOrganizationMemberMutation.mutate(info, **input.to_dict())

    @strawberry.mutation
    def update_member_status(
        self, info: Info, input: inputs.UpdateMemberStatusMutationInput
    ) -> mutations.UpdateMemberStatusMutation:
        return mutations.UpdateMemberStatusMutation.mutate(info, **input.to_dict())

    @strawberry.mutation
    def resend_organization_invite(
        self, info: Info, input: inputs.ResendOrganizationInviteMutationInput
    ) -> mutations.ResendOrganizationInviteMutation:
        return mutations.ResendOrganizationInviteMutation.mutate(info, **input.to_dict())
