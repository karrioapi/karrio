        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.uuid, *(), **{"prefix": "adr_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.uuid, *(), **{"prefix": "cdt_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.uuid, *(), **{"prefix": "cst_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.uuid, *(), **{"prefix": "pcl_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.uuid, *(), **{"prefix": "pyt_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.uuid, *(), **{"prefix": "trk_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.uuid, *(), **{"prefix": "shp_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
                ...
                (
                    "shipment_parcels",
                    models.ManyToManyField(related_name="shipment_parcels", to="manager.Parcel"),
                ),
                (
                    "shipper",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.uuid, *(), **{"prefix": "pck_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
                ...
                (
                    "shipments",
                    models.ManyToManyField(related_name="pickup_shipments", to="manager.Shipment"),
                ),
                (
                    "user",
                    models.ForeignKey(
