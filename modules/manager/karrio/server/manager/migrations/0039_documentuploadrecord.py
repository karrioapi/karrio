        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=functools.partial(karrio.server.core.models.base.uuid, *(), **{"prefix": "uprec_"}),
                        editable=False,
                        max_length=50,
                        primary_key=True,
                        serialize=False,
                ...
                (
                    "upload_carrier",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="providers.carrier"),
                ),
            ],
            options={
