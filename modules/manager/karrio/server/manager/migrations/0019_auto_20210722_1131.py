...
def forwards_func(apps, schema_editor):
    ...
    Shipment.objects.using(db_alias).filter(status="transit").update(status="in-transit")

    Tracking.objects.using(db_alias).filter(delivered=True).update(status="delivered")
