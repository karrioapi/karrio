...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("pricing", "0074_alter_surcharge_carriers_alter_surcharge_services"),
    ]
        ...
        migrations.AlterField(
            ...
            field=karrio.server.core.fields.MultiChoiceField(
                ...
                choices=[
                    ...
                    ("dhl_parcel_de_kleinpaket", "dhl_parcel_de_kleinpaket"),
                    ...
                    (
                        "landmark_maxipak_scan_ddp_pudo",
                        "landmark_maxipak_scan_ddp_pudo",
                    ),
                    (
                        "landmark_maxipak_scan_premium_ups_express_ddp",
                        "landmark_maxipak_scan_premium_ups_express_ddp",
                    ),
                    (
                    ...
                    ("landmark_maxipak_scan_pddp", "landmark_maxipak_scan_pddp"),
                    ("locate2u_local_delivery", "locate2u_local_delivery"),
                    ("mydhl_express_worldwide", "mydhl_express_worldwide"),
                    ("mydhl_express_12_00", "mydhl_express_12_00"),
                    ("mydhl_express_9_00", "mydhl_express_9_00"),
                    ("mydhl_express_10_30", "mydhl_express_10_30"),
                    ("mydhl_express_easy", "mydhl_express_easy"),
                    ("mydhl_medical_express", "mydhl_medical_express"),
                    ("mydhl_jetline", "mydhl_jetline"),
                    ("mydhl_sprintline", "mydhl_sprintline"),
                    ("mydhl_globalmail", "mydhl_globalmail"),
                    ("mydhl_globalmail_business", "mydhl_globalmail_business"),
                    ("mydhl_express_domestic", "mydhl_express_domestic"),
                    ("mydhl_express_domestic_12_00", "mydhl_express_domestic_12_00"),
                    ("mydhl_express_domestic_9_00", "mydhl_express_domestic_9_00"),
                    ("mydhl_same_day", "mydhl_same_day"),
                    ("mydhl_economy_select", "mydhl_economy_select"),
                    ("mydhl_europack", "mydhl_europack"),
                    ("mydhl_breakbulk_express", "mydhl_breakbulk_express"),
                    ("mydhl_express_freight", "mydhl_express_freight"),
                    ("mydhl_express_worldwide_doc", "mydhl_express_worldwide_doc"),
                    ("mydhl_express_envelope", "mydhl_express_envelope"),
                    ("mydhl_express_worldwide_b2c", "mydhl_express_worldwide_b2c"),
                    ("mydhl_express_easy_b2c", "mydhl_express_easy_b2c"),
                    ...
                    ("teleship_expedited_pickup", "teleship_expedited_pickup"),
                    ("teleship_expedited_dropoff", "teleship_expedited_dropoff"),
                    ("teleship_standard_dropoff", "teleship_standard_dropoff"),
                    ("teleship_standard_pickup", "teleship_standard_pickup"),
                    ("teleship_postal_dropoff", "teleship_postal_dropoff"),
                    ("teleship_postal_pickup", "teleship_postal_pickup"),
