...
export const TENANT_API_DOMAIN = env(
  "NEXT_PUBLIC_KARRIO_PLATFORM_TENANT_API_DOMAIN",
);
export const TENANT_DASHBOARD_DOMAIN = env(
  "NEXT_PUBLIC_KARRIO_PLATFORM_TENANT_DASHBOARD_DOMAIN",
);
