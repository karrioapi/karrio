            ...
            field=karrio.server.core.fields.MultiChoiceField(
                base_field=models.CharField(
                    choices=[
                        ...
                        ("ALLOW_ADMIN_APPROVED_SIGNUP", "ALLOW_ADMIN_APPROVED_SIGNUP"),
                        ("ALLOW_MULTI_ACCOUNT", "ALLOW_MULTI_ACCOUNT"),
                        ...
                        ("CUSTOM_CARRIER_DEFINITION", "CUSTOM_CARRIER_DEFINITION"),
                        ("PERSIST_SDK_TRACING", "PERSIST_SDK_TRACING"),
                        ("ORG_LEVEL_BILLING", "ORG_LEVEL_BILLING"),
                        ("TENANT_LEVEL_BILLING", "TENANT_LEVEL_BILLING"),
                    ],
                    max_length=100,
                ),
                default=functools.partial(
