...
import karrio.server.apps.models as app
...
class Organization(AbstractOrganization):
    ...
    apps = models.ManyToManyField(app.App, related_name="org", through="AppLink")
    installations = models.ManyToManyField(
        app.AppInstallation, related_name="org", through="AppInstallationLink"
    )
...
class AppLink(models.Model):
    ...
    item = models.OneToOneField(app.App, on_delete=models.CASCADE, related_name="link")
...
class AppInstallationLink(models.Model):
    ...
    item = models.OneToOneField(
        app.AppInstallation, on_delete=models.CASCADE, related_name="link"
    )
