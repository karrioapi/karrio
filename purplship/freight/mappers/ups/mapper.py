...
from purplship.carriers.ups.freight import (
    freight_ship_request, parse_freight_ship_response,
    freight_rate_request, parse_freight_rate_response
)
...
class Mapper(BaseMapper):
    ...
    def create_rate_request(self, payload: RateRequest) -> Serializable[FreightRateRequest]:
    ...
    def create_shipment_request(self, payload: ShipmentRequest) -> Serializable[FreightShipRequest]:
