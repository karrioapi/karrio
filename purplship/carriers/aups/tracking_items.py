...
def parse_track_items_response(response: dict, settings: Settings) -> Tuple[List[TrackingDetails], List[Error]]:
...
def _extract_tracking(settings: Settings) -> Callable[[List[TrackingDetails], TrackingResult], List[TrackingDetails]]:
    def extract(tracking: List[TrackingDetails], tracking_result: TrackingResult) -> List[TrackingDetails]:
