...
class PackagePresets(Flag):
    ...
    dhl_express_standard_flyer = PackagePreset(
        weight=2, width=40.0, height=30.0, packaging_type="pak"
    )
    dhl_express_large_flyer = PackagePreset(
        weight=3, width=47.5, height=37.5, packaging_type="pack"
    )
    ...
    dhl_express_box_6 = PackagePreset(
        weight=15, width=41.7, height=35.9, length=36.9, packaging_type="large_box"
    )
    dhl_express_box_7 = PackagePreset(
        weight=20, width=48.1, height=40.4, length=38.9, packaging_type="large_box"
    )
    dhl_express_box_8 = PackagePreset(
        weight=25, width=54.2, height=44.4, length=40.9, packaging_type="large_box"
    )
    dhl_express_tube = PackagePreset(
        weight=5, width=96.0, height=15.0, length=15.0, packaging_type="tube"
    )
    ...
    dhl_jumbo_box_junior = PackagePreset(
        weight=20, width=39.9, height=34.0, length=24.1
    )
