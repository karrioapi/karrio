...
from purplship.core.models import (
    TrackingEvent, TrackingDetails, TrackingRequest, Error
)
...
def known_tracking_request(payload: TrackingRequest, settings: Settings) -> Serializable[KnownTrackingRequest]:
