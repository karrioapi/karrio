...
from purplship.carriers.canadapost.shipment.contract_shipment import parse_contract_shipment_response, contract_shipment_request
from purplship.carriers.canadapost.shipment.non_contract_shipment import parse_non_contract_shipment_response, non_contract_shipment_request
