...
from purplship.package.mappers.usps.settings import Settings
from purplship.core.utils.serializable import Serializable, Deserializable
from purplship.core.models import (
    RateRequest, TrackingRequest, TrackingDetails, RateDetails, Error,
)
from purplship.carriers.usps import (
    rate_request, parse_rate_request, track_field_request, parse_track_field_response
)
...
class Mapper(BaseMapper):
    ...
    def create_rate_request(self, payload: RateRequest) -> Serializable[Union[RateV4Request, IntlRateV2Request]]:
        return rate_request(payload, self.settings)

    def create_tracking_request(self, payload: TrackingRequest) -> Serializable[TrackFieldRequest]:
