...
class Mapper:
    ...
    def create_rate_request(self, payload: RateRequest) -> Serializable[T]:
    ...
    def parse_rate_response(self, response: Deserializable[S]) -> (List[RateDetails], List[Error]):
    ...
    def create_tracking_request(self, payload: TrackingRequest) -> Serializable[T]:
    ...
    def parse_tracking_response(self, response: Deserializable[S]) -> (List[TrackingDetails], List[Error]):
    ...
    def create_shipment_request(self, payload: ShipmentRequest) -> Serializable[T]:
    ...
    def parse_shipment_response(self, response: Deserializable[S]) -> (ShipmentDetails, List[Error]):
    ...
    def create_pickup_request(self, payload: PickupRequest) -> Serializable[T]:
    ...
    def parse_pickup_response(self, response: Deserializable[S]) -> (PickupDetails, List[Error]):
    ...
    def create_modify_pickup_request(self, payload: PickupUpdateRequest) -> Serializable[T]:
    ...
    def parse_modify_pickup_response(self, response: Deserializable[S]) -> (PickupDetails, List[Error]):
        """ Create a united API pickup result from carrier response  """
        raise MethodNotSupportedError(self.__class__.parse_modify_pickup_response.__name__, self.__class__.__name__)

    def create_cancel_pickup_request(self, payload: PickupCancellationRequest) -> Serializable[T]:
    ...
    def parse_cancel_pickup_response(self, response: Deserializable[S]) -> (dict, List[Error]):
