...
#
# Generated Tue Jun 12 20:59:14 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', 'pyfedex/DGLD_service_v1.py')
#
# Command line arguments:
#    /Fedex/FedExWebServicesAdvancedXSD/DGLDService_v1.xsd
#
# Command line:
#    generateDS --no-namespace-defs -o "pyfedex/DGLD_service_v1.py"  /Fedex/FedExWebServicesAdvancedXSD/DGLDService_v1.xsd
#
...
class ListDangerousGoodsDetail(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, TrackingNumbers=None, Description=None, Accessibility=None, Options=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns:', name_='ListDangerousGoodsDetail', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ListDangerousGoodsDetail')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns:', name_='ListDangerousGoodsDetail', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns:', name_='ListDangerousGoodsDetail'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns:', name_='ListDangerousGoodsDetail', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ListDangerousGoodsReply(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, HighestSeverity=None, Notifications=None, TransactionDetail=None, Version=None, Regulation=None, Accessibility=None, Options=None, Details=None):
        self.original_tagname_ = None
    ...
    def add_Details(self, value): self.Details.append(value)
    def insert_Details_at(self, index, value): self.Details.insert(index, value)
    def replace_Details_at(self, index, value): self.Details[index] = value
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns:', name_='ListDangerousGoodsReply', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ListDangerousGoodsReply')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns:', name_='ListDangerousGoodsReply', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns:', name_='ListDangerousGoodsReply'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns:', name_='ListDangerousGoodsReply', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for Details_ in self.Details:
            Details_.export(outfile, level, namespace_, name_='Details', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'HighestSeverity':
            ...
            obj_ = ListDangerousGoodsDetail.factory()
            obj_.build(child_)
...
class ListDangerousGoodsRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, WebAuthenticationDetail=None, ClientDetail=None, TransactionDetail=None, Version=None, Origin=None, Destination=None, CarrierCode=None, ServiceType=None, ShipDate=None, TrackingNumber=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns:', name_='ListDangerousGoodsRequest', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ListDangerousGoodsRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns:', name_='ListDangerousGoodsRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns:', name_='ListDangerousGoodsRequest'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns:', name_='ListDangerousGoodsRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
