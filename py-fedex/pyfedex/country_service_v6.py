...
#
# Generated Tue Jun 12 20:55:22 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', 'pyfedex/country_service_v6.py')
#
# Command line arguments:
#    /Fedex/FedExWebServicesStandardXSD/CountryService_v6.xsd
#
# Command line:
#    generateDS --no-namespace-defs -o "pyfedex/country_service_v6.py"  /Fedex/FedExWebServicesStandardXSD/CountryService_v6.xsd
#
...
class LocationDescription(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, LocationId=None, LocationNumber=None, CountryCode=None, StateOrProvinceCode=None, PostalCode=None, ServiceArea=None, AirportId=None, RestrictedPackageSpecialServices=None, RestrictedShipmentSpecialServices=None, FedExEuropeFirstOrigin=None):
        self.original_tagname_ = None
    ...
    def get_RestrictedPackageSpecialServices(self): return self.RestrictedPackageSpecialServices
    def set_RestrictedPackageSpecialServices(self, RestrictedPackageSpecialServices): self.RestrictedPackageSpecialServices = RestrictedPackageSpecialServices
    def add_RestrictedPackageSpecialServices(self, value): self.RestrictedPackageSpecialServices.append(value)
    def insert_RestrictedPackageSpecialServices_at(self, index, value): self.RestrictedPackageSpecialServices.insert(index, value)
    def replace_RestrictedPackageSpecialServices_at(self, index, value): self.RestrictedPackageSpecialServices[index] = value
    def get_RestrictedShipmentSpecialServices(self): return self.RestrictedShipmentSpecialServices
    def set_RestrictedShipmentSpecialServices(self, RestrictedShipmentSpecialServices): self.RestrictedShipmentSpecialServices = RestrictedShipmentSpecialServices
    def add_RestrictedShipmentSpecialServices(self, value): self.RestrictedShipmentSpecialServices.append(value)
    def insert_RestrictedShipmentSpecialServices_at(self, index, value): self.RestrictedShipmentSpecialServices.insert(index, value)
    def replace_RestrictedShipmentSpecialServices_at(self, index, value): self.RestrictedShipmentSpecialServices[index] = value
    def get_FedExEuropeFirstOrigin(self): return self.FedExEuropeFirstOrigin
    def set_FedExEuropeFirstOrigin(self, FedExEuropeFirstOrigin): self.FedExEuropeFirstOrigin = FedExEuropeFirstOrigin
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns:', name_='LocationDescription', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='LocationDescription')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns:', name_='LocationDescription', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns:', name_='LocationDescription'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns:', name_='LocationDescription', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for RestrictedPackageSpecialServices_ in self.RestrictedPackageSpecialServices:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns:RestrictedPackageSpecialServices>%s</ns:RestrictedPackageSpecialServices>%s' % (self.gds_encode(self.gds_format_string(quote_xml(RestrictedPackageSpecialServices_), input_name='RestrictedPackageSpecialServices')), eol_))
        for RestrictedShipmentSpecialServices_ in self.RestrictedShipmentSpecialServices:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns:RestrictedShipmentSpecialServices>%s</ns:RestrictedShipmentSpecialServices>%s' % (self.gds_encode(self.gds_format_string(quote_xml(RestrictedShipmentSpecialServices_), input_name='RestrictedShipmentSpecialServices')), eol_))
        if self.FedExEuropeFirstOrigin is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns:FedExEuropeFirstOrigin>%s</ns:FedExEuropeFirstOrigin>%s' % (self.gds_format_boolean(self.FedExEuropeFirstOrigin, input_name='FedExEuropeFirstOrigin'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'LocationId':
            ...
            RestrictedPackageSpecialServices_ = child_.text
            RestrictedPackageSpecialServices_ = self.gds_validate_string(RestrictedPackageSpecialServices_, node, 'RestrictedPackageSpecialServices')
            self.RestrictedPackageSpecialServices.append(RestrictedPackageSpecialServices_)
            ...
            RestrictedShipmentSpecialServices_ = child_.text
            RestrictedShipmentSpecialServices_ = self.gds_validate_string(RestrictedShipmentSpecialServices_, node, 'RestrictedShipmentSpecialServices')
            self.RestrictedShipmentSpecialServices.append(RestrictedShipmentSpecialServices_)
...
class PostalDetail(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, CountryCode=None, StateOrProvinceCode=None, CityFirstInitials=None, CleanedPostalCode=None, LocationDescriptions=None):
        self.original_tagname_ = None
        self.CountryCode = CountryCode
        self.StateOrProvinceCode = StateOrProvinceCode
    ...
    def get_StateOrProvinceCode(self): return self.StateOrProvinceCode
    def set_StateOrProvinceCode(self, StateOrProvinceCode): self.StateOrProvinceCode = StateOrProvinceCode
    def get_CityFirstInitials(self): return self.CityFirstInitials
    def set_CityFirstInitials(self, CityFirstInitials): self.CityFirstInitials = CityFirstInitials
    def get_CleanedPostalCode(self): return self.CleanedPostalCode
    def set_CleanedPostalCode(self, CleanedPostalCode): self.CleanedPostalCode = CleanedPostalCode
    def get_LocationDescriptions(self): return self.LocationDescriptions
    def set_LocationDescriptions(self, LocationDescriptions): self.LocationDescriptions = LocationDescriptions
    def add_LocationDescriptions(self, value): self.LocationDescriptions.append(value)
    def insert_LocationDescriptions_at(self, index, value): self.LocationDescriptions.insert(index, value)
    def replace_LocationDescriptions_at(self, index, value): self.LocationDescriptions[index] = value
    def hasContent_(self):
        if (
            self.CountryCode is not None or
            self.StateOrProvinceCode is not None or
            ...
            return False
    def export(self, outfile, level, namespace_='ns:', name_='PostalDetail', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PostalDetail')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns:', name_='PostalDetail', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns:', name_='PostalDetail'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns:', name_='PostalDetail', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CityFirstInitials is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns:CityFirstInitials>%s</ns:CityFirstInitials>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CityFirstInitials), input_name='CityFirstInitials')), eol_))
        if self.CleanedPostalCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns:CleanedPostalCode>%s</ns:CleanedPostalCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CleanedPostalCode), input_name='CleanedPostalCode')), eol_))
        for LocationDescriptions_ in self.LocationDescriptions:
            LocationDescriptions_.export(outfile, level, namespace_, name_='LocationDescriptions', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CountryCode':
            ...
            CityFirstInitials_ = child_.text
            CityFirstInitials_ = self.gds_validate_string(CityFirstInitials_, node, 'CityFirstInitials')
            self.CityFirstInitials = CityFirstInitials_
        elif nodeName_ == 'CleanedPostalCode':
            CleanedPostalCode_ = child_.text
            CleanedPostalCode_ = self.gds_validate_string(CleanedPostalCode_, node, 'CleanedPostalCode')
            self.CleanedPostalCode = CleanedPostalCode_
        elif nodeName_ == 'LocationDescriptions':
            obj_ = LocationDescription.factory()
            obj_.build(child_)
...
class ValidatePostalReply(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, HighestSeverity=None, Notifications=None, TransactionDetail=None, Version=None, PostalDetail=None):
        self.original_tagname_ = None
    ...
    def get_PostalDetail(self): return self.PostalDetail
    def set_PostalDetail(self, PostalDetail): self.PostalDetail = PostalDetail
    def validate_NotificationSeverityType(self, value):
        # Validate type NotificationSeverityType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns:', name_='ValidatePostalReply', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ValidatePostalReply')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns:', name_='ValidatePostalReply', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns:', name_='ValidatePostalReply'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns:', name_='ValidatePostalReply', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.PostalDetail is not None:
            self.PostalDetail.export(outfile, level, namespace_, name_='PostalDetail', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ValidatePostalRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, WebAuthenticationDetail=None, ClientDetail=None, TransactionDetail=None, Version=None, ShipDateTime=None, Address=None, RoutingCode=None, CheckForMismatch=None, CarrierCode=None):
        self.original_tagname_ = None
    ...
    def get_Version(self): return self.Version
    def set_Version(self, Version): self.Version = Version
    def get_ShipDateTime(self): return self.ShipDateTime
    def set_ShipDateTime(self, ShipDateTime): self.ShipDateTime = ShipDateTime
    def get_Address(self): return self.Address
    def set_Address(self, Address): self.Address = Address
    def get_RoutingCode(self): return self.RoutingCode
    def set_RoutingCode(self, RoutingCode): self.RoutingCode = RoutingCode
    def get_CheckForMismatch(self): return self.CheckForMismatch
    def set_CheckForMismatch(self, CheckForMismatch): self.CheckForMismatch = CheckForMismatch
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns:', name_='ValidatePostalRequest', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ValidatePostalRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns:', name_='ValidatePostalRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns:', name_='ValidatePostalRequest'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns:', name_='ValidatePostalRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ShipDateTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns:ShipDateTime>%s</ns:ShipDateTime>%s' % (self.gds_format_datetime(self.ShipDateTime, input_name='ShipDateTime'), eol_))
        if self.Address is not None:
            self.Address.export(outfile, level, namespace_, name_='Address', pretty_print=pretty_print)
        if self.RoutingCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns:RoutingCode>%s</ns:RoutingCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RoutingCode), input_name='RoutingCode')), eol_))
        if self.CheckForMismatch is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns:CheckForMismatch>%s</ns:CheckForMismatch>%s' % (self.gds_format_boolean(self.CheckForMismatch, input_name='CheckForMismatch'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'WebAuthenticationDetail':
            ...
            RoutingCode_ = child_.text
            RoutingCode_ = self.gds_validate_string(RoutingCode_, node, 'RoutingCode')
            self.RoutingCode = RoutingCode_
...
def parse(inFileName, silence=False):
    ...
    if not silence:
        ...
        rootObj.export(
            ...
            namespacedef_='xmlns:ns="http://fedex.com/ws/cnty/v6"',
            pretty_print=True)
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from country_service_v6 import *\n\n')
        sys.stdout.write('import country_service_v6 as model_\n\n')
