...
#   ('-o', '../python/AddressValidateRequest.xsd.py')
#
# Command line arguments:
#   AddressValidateRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/AddressValidateRequest.xsd.py" AddressValidateRequest.xsd
#
...
class AddressValidateRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, USERID=None, Revision=None, Address=None):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='AddressValidateRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='AddressValidateRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='AddressValidateRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='AddressValidateRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='AddressValidateRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class AddressType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ID=None, Address1=None, Address2=None, City=None, FirmName=None, State=None, Zip5=None, Zip4=None):
        self.original_tagname_ = None
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from AddressValidateRequest.xsd import *\n\n')
        sys.stdout.write('import AddressValidateRequest.xsd as model_\n\n')
