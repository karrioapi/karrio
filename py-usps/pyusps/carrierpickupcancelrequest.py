...
#   ('-o', '../python/CarrierPickupCancelRequest.xsd.py')
#
# Command line arguments:
#   CarrierPickupCancelRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/CarrierPickupCancelRequest.xsd.py" CarrierPickupCancelRequest.xsd
#
...
class CarrierPickupCancelRequest(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='CarrierPickupCancelRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CarrierPickupCancelRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='CarrierPickupCancelRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='CarrierPickupCancelRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CarrierPickupCancelRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from CarrierPickupCancelRequest.xsd import *\n\n')
        sys.stdout.write('import CarrierPickupCancelRequest.xsd as model_\n\n')
