...
#
# Generated Thu Dec 13 17:55:58 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/CarrierPickupChangeResponse.xsd.py')
#
# Command line arguments:
#   CarrierPickupChangeResponse.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/CarrierPickupChangeResponse.xsd.py" CarrierPickupChangeResponse.xsd
#
...
class CarrierPickupChangeResponse(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='CarrierPickupChangeResponse', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CarrierPickupChangeResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='CarrierPickupChangeResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='CarrierPickupChangeResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='CarrierPickupChangeResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from CarrierPickupChangeResponse.xsd import *\n\n')
        sys.stdout.write('import CarrierPickupChangeResponse.xsd as model_\n\n')
