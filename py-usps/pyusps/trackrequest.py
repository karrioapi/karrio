...
#
# Generated Thu Dec 13 17:56:12 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/TrackRequest.xsd.py')
#
# Command line arguments:
#   TrackRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/TrackRequest.xsd.py" TrackRequest.xsd
#
...
class TrackRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, USERID=None, TrackID=None):
    ...
    def add_TrackID(self, value): self.TrackID.append(value)
    def insert_TrackID_at(self, index, value): self.TrackID.insert(index, value)
    def replace_TrackID_at(self, index, value): self.TrackID[index] = value
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TrackRequest', fromsubclass_=False, pretty_print=True):
        ...
        for TrackID_ in self.TrackID:
            TrackID_.export(outfile, level, namespace_, name_='TrackID', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
class TrackIDType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TrackIDType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TrackIDType')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TrackIDType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TrackIDType'):
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            outfile.write(' ID=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.ID), input_name='ID')), ))
    def exportChildren(self, outfile, level, namespace_='', name_='TrackIDType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from TrackRequest.xsd import *\n\n')
        sys.stdout.write('import TrackRequest.xsd as model_\n\n')
