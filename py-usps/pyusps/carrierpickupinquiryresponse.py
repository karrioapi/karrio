...
#   ('-o', '../python/CarrierPickupInquiryResponse.xsd.py')
#
# Command line arguments:
#   CarrierPickupInquiryResponse.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/CarrierPickupInquiryResponse.xsd.py" CarrierPickupInquiryResponse.xsd
#
...
class CarrierPickupInquiryResponse(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='CarrierPickupInquiryResponse', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CarrierPickupInquiryResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='CarrierPickupInquiryResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='CarrierPickupInquiryResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='CarrierPickupInquiryResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from CarrierPickupInquiryResponse.xsd import *\n\n')
        sys.stdout.write('import CarrierPickupInquiryResponse.xsd as model_\n\n')
