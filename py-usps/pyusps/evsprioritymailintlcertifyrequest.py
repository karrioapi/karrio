...
#
# Generated Thu Dec 13 17:56:18 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/eVSPriorityMailIntlCertifyRequest.xsd.py')
#
# Command line arguments:
#   eVSPriorityMailIntlCertifyRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/eVSPriorityMailIntlCertifyRequest.xsd.py" eVSPriorityMailIntlCertifyRequest.xsd
#
...
class eVSPriorityMailIntlCertifyRequest(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSPriorityMailIntlCertifyRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSPriorityMailIntlCertifyRequest.subclass:
            return eVSPriorityMailIntlCertifyRequest.subclass(*args_, **kwargs_)
        else:
            return eVSPriorityMailIntlCertifyRequest(*args_, **kwargs_)
    ...
    def get_Insured(self): return self.Insured
    def set_Insured(self, Insured): self.Insured = Insured
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='eVSPriorityMailIntlCertifyRequest', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSPriorityMailIntlCertifyRequest')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='eVSPriorityMailIntlCertifyRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='eVSPriorityMailIntlCertifyRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='eVSPriorityMailIntlCertifyRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='eVSPriorityMailIntlCertifyRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Insured is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Insured>%s</Insured>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Insured), input_name='Insured')), eol_))
        ...
        if self.InsuredAmount is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<InsuredAmount>%s</InsuredAmount>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InsuredAmount), input_name='InsuredAmount')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Option':
            ...
            Insured_ = child_.text
            Insured_ = self.gds_validate_string(Insured_, node, 'Insured')
            self.Insured = Insured_
            ...
            InsuredAmount_ = child_.text
            InsuredAmount_ = self.gds_validate_string(InsuredAmount_, node, 'InsuredAmount')
            self.InsuredAmount = InsuredAmount_
...
# end class eVSPriorityMailIntlCertifyRequest
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'eVSPriorityMailIntlCertifyRequest'
        rootClass = eVSPriorityMailIntlCertifyRequest
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from eVSPriorityMailIntlCertifyRequest.xsd import *\n\n')
        sys.stdout.write('import eVSPriorityMailIntlCertifyRequest.xsd as model_\n\n')
