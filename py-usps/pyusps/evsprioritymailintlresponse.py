...
#
# Generated Thu Dec 13 17:56:19 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/eVSPriorityMailIntlResponse.xsd.py')
#
# Command line arguments:
#   eVSPriorityMailIntlResponse.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/eVSPriorityMailIntlResponse.xsd.py" eVSPriorityMailIntlResponse.xsd
#
...
class eVSPriorityMailIntlResponse(GeneratedsSuper):
    ...
    def get_SDRValue(self): return self.SDRValue
    def set_SDRValue(self, SDRValue): self.SDRValue = SDRValue
    def get_BarcodeNumber(self): return self.BarcodeNumber
    def set_BarcodeNumber(self, BarcodeNumber): self.BarcodeNumber = BarcodeNumber
    def get_LabelImage(self): return self.LabelImage
    def set_LabelImage(self, LabelImage): self.LabelImage = LabelImage
    def get_Page2Image(self): return self.Page2Image
    def set_Page2Image(self, Page2Image): self.Page2Image = Page2Image
    def get_Page3Image(self): return self.Page3Image
    def set_Page3Image(self, Page3Image): self.Page3Image = Page3Image
    def get_Page4Image(self): return self.Page4Image
    def set_Page4Image(self, Page4Image): self.Page4Image = Page4Image
    def get_Page5Image(self): return self.Page5Image
    def set_Page5Image(self, Page5Image): self.Page5Image = Page5Image
    def get_Page6Image(self): return self.Page6Image
    def set_Page6Image(self, Page6Image): self.Page6Image = Page6Image
    def get_Prohibitions(self): return self.Prohibitions
    def set_Prohibitions(self, Prohibitions): self.Prohibitions = Prohibitions
    ...
    def set_Observations(self, Observations): self.Observations = Observations
    def get_Regulations(self): return self.Regulations
    def set_Regulations(self, Regulations): self.Regulations = Regulations
    def get_AdditionalRestrictions(self): return self.AdditionalRestrictions
    def set_AdditionalRestrictions(self, AdditionalRestrictions): self.AdditionalRestrictions = AdditionalRestrictions
    def get_ParcelIndemnityCoverage(self): return self.ParcelIndemnityCoverage
    def set_ParcelIndemnityCoverage(self, ParcelIndemnityCoverage): self.ParcelIndemnityCoverage = ParcelIndemnityCoverage
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='eVSPriorityMailIntlResponse', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='eVSPriorityMailIntlResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='eVSPriorityMailIntlResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='eVSPriorityMailIntlResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='eVSPriorityMailIntlResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.TotalValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<TotalValue>%s</TotalValue>%s' % (self.gds_format_float(self.TotalValue, input_name='TotalValue'), eol_))
        if self.SDRValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<SDRValue>%s</SDRValue>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SDRValue), input_name='SDRValue')), eol_))
        if self.BarcodeNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BarcodeNumber>%s</BarcodeNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BarcodeNumber), input_name='BarcodeNumber')), eol_))
        ...
        if self.Page2Image is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Page2Image>%s</Page2Image>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Page2Image), input_name='Page2Image')), eol_))
        if self.Page3Image is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Page3Image>%s</Page3Image>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Page3Image), input_name='Page3Image')), eol_))
        if self.Page4Image is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Page4Image>%s</Page4Image>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Page4Image), input_name='Page4Image')), eol_))
        if self.Page5Image is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Page5Image>%s</Page5Image>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Page5Image), input_name='Page5Image')), eol_))
        if self.Page6Image is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Page6Image>%s</Page6Image>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Page6Image), input_name='Page6Image')), eol_))
        if self.Prohibitions is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Prohibitions>%s</Prohibitions>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Prohibitions), input_name='Prohibitions')), eol_))
        ...
        if self.Observations is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Observations>%s</Observations>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Observations), input_name='Observations')), eol_))
        if self.Regulations is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Regulations>%s</Regulations>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Regulations), input_name='Regulations')), eol_))
        if self.AdditionalRestrictions is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<AdditionalRestrictions>%s</AdditionalRestrictions>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AdditionalRestrictions), input_name='AdditionalRestrictions')), eol_))
        if self.ParcelIndemnityCoverage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ParcelIndemnityCoverage>%s</ParcelIndemnityCoverage>%s' % (self.gds_format_float(self.ParcelIndemnityCoverage, input_name='ParcelIndemnityCoverage'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Postage':
            ...
            SDRValue_ = child_.text
            SDRValue_ = self.gds_validate_string(SDRValue_, node, 'SDRValue')
            self.SDRValue = SDRValue_
        elif nodeName_ == 'BarcodeNumber':
            BarcodeNumber_ = child_.text
            BarcodeNumber_ = self.gds_validate_string(BarcodeNumber_, node, 'BarcodeNumber')
            self.BarcodeNumber = BarcodeNumber_
            ...
            Page2Image_ = child_.text
            Page2Image_ = self.gds_validate_string(Page2Image_, node, 'Page2Image')
            self.Page2Image = Page2Image_
        elif nodeName_ == 'Page3Image':
            Page3Image_ = child_.text
            Page3Image_ = self.gds_validate_string(Page3Image_, node, 'Page3Image')
            self.Page3Image = Page3Image_
        elif nodeName_ == 'Page4Image':
            Page4Image_ = child_.text
            Page4Image_ = self.gds_validate_string(Page4Image_, node, 'Page4Image')
            self.Page4Image = Page4Image_
        elif nodeName_ == 'Page5Image':
            Page5Image_ = child_.text
            Page5Image_ = self.gds_validate_string(Page5Image_, node, 'Page5Image')
            self.Page5Image = Page5Image_
        elif nodeName_ == 'Page6Image':
            Page6Image_ = child_.text
            Page6Image_ = self.gds_validate_string(Page6Image_, node, 'Page6Image')
            self.Page6Image = Page6Image_
            ...
            Regulations_ = child_.text
            Regulations_ = self.gds_validate_string(Regulations_, node, 'Regulations')
            self.Regulations = Regulations_
        ...
        elif nodeName_ == 'ParcelIndemnityCoverage':
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
...
class ExtraServicesType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ExtraServicesType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ExtraService is not None:
            self.ExtraService.export(outfile, level, namespace_, name_='ExtraService', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ExtraServiceType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ServiceID=None, ServiceName=None, Price=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ExtraServiceType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ExtraServiceType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ExtraServiceType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ExtraServiceType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ExtraServiceType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from eVSPriorityMailIntlResponse.xsd import *\n\n')
        sys.stdout.write('import eVSPriorityMailIntlResponse.xsd as model_\n\n')
