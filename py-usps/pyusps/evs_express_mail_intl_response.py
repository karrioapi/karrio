...
#   ('--no-namespace-defs', '')
#   ('-o', './pyusps/evs_express_mail_intl_response.py')
#
# Command line arguments:
#   ./schemas/eVSExpressMailIntlResponse.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./pyusps/evs_express_mail_intl_response.py" ./schemas/eVSExpressMailIntlResponse.xsd
#
...
class eVSExpressMailIntlResponse(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSExpressMailIntlResponse', fromsubclass_=False, pretty_print=True):
        ...
        if self.InsuranceFee is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInsuranceFee>%s</%sInsuranceFee>%s' % (namespaceprefix_ , self.gds_format_integer(self.InsuranceFee, input_name='InsuranceFee'), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Postage' and child_.text:
            ...
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'InsuranceFee')
