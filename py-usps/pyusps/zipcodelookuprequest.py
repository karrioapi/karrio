...
#
# Generated Thu Dec 13 17:56:13 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/ZipCodeLookupRequest.xsd.py')
#
# Command line arguments:
#   ZipCodeLookupRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/ZipCodeLookupRequest.xsd.py" ZipCodeLookupRequest.xsd
#
...
class ZipCodeLookupRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, USERID=None, Address=None):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ZipCodeLookupRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ZipCodeLookupRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ZipCodeLookupRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ZipCodeLookupRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ZipCodeLookupRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class AddressType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ID=None, Address1=None, Address2=None, FirmName=None, City=None, State=None, Zip5=None, Zip4=None):
        self.original_tagname_ = None
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='AddressType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Zip4 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Zip4>%s</Zip4>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Zip4), input_name='Zip4')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ZipCodeLookupRequest.xsd import *\n\n')
        sys.stdout.write('import ZipCodeLookupRequest.xsd as model_\n\n')
