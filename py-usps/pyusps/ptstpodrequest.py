...
#   ('-o', '../python/PTSTPodRequest.xsd.py')
#
# Command line arguments:
#   PTSTPodRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/PTSTPodRequest.xsd.py" PTSTPodRequest.xsd
#
...
class PTSTPodRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, USERID=None, TrackId=None, ClientIp=None, MpSuffix=None, MpDate=None, RequestType=None, FirstName=None, LastName=None, Email1=None, Email2=None, Email3=None, TableCode=None, CustRegID=None):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='PTSTPodRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PTSTPodRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='PTSTPodRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PTSTPodRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='PTSTPodRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from PTSTPodRequest.xsd import *\n\n')
        sys.stdout.write('import PTSTPodRequest.xsd as model_\n\n')
