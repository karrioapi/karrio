...
#   ('-o', '../python/eVSFirstClassMailIntlResponse.xsd.py')
#
# Command line arguments:
#   eVSFirstClassMailIntlResponse.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/eVSFirstClassMailIntlResponse.xsd.py" eVSFirstClassMailIntlResponse.xsd
#
...
class eVSFirstClassMailIntlResponse(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Postage=None, TotalValue=None, BarcodeNumber=None, LabelImage=None, Page2Image=None, Page3Image=None, Prohibitions=None, Restrictions=None, Observations=None, Regulations=None, AdditionalRestrictions=None, ExtraServices=None, RemainingBarcodes=None):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='eVSFirstClassMailIntlResponse', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='eVSFirstClassMailIntlResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='eVSFirstClassMailIntlResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='eVSFirstClassMailIntlResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='eVSFirstClassMailIntlResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from eVSFirstClassMailIntlResponse.xsd import *\n\n')
        sys.stdout.write('import eVSFirstClassMailIntlResponse.xsd as model_\n\n')
