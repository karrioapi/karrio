...
#   ('-o', '../python/ZipCodeLookupResponse.xsd.py')
#
# Command line arguments:
#   ZipCodeLookupResponse.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/ZipCodeLookupResponse.xsd.py" ZipCodeLookupResponse.xsd
#
...
class ZipCodeLookupResponse(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ZipCodeLookupResponse', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ZipCodeLookupResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ZipCodeLookupResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ZipCodeLookupResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ZipCodeLookupResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class AddressType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ID=None, Address1=None, Address2=None, City=None, FirmName=None, State=None, Urbanization=None, Zip5=None, Zip4=None):
        self.original_tagname_ = None
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ZipCodeLookupResponse.xsd import *\n\n')
        sys.stdout.write('import ZipCodeLookupResponse.xsd as model_\n\n')
