...
#   ('-o', '../python/eVSGXGGetLabelCertifyRequest.xsd.py')
#
# Command line arguments:
#   eVSGXGGetLabelCertifyRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/eVSGXGGetLabelCertifyRequest.xsd.py" eVSGXGGetLabelCertifyRequest.xsd
#
...
class eVSGXGGetLabelCertifyRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, USERID=None, PASSWORD=None, Option=None, Revision=None, ImageParameters=None, FromFirstName=None, FromMiddleInitial=None, FromLastName=None, FromFirm=None, FromAddress1=None, FromAddress2=None, FromUrbanization=None, FromCity=None, FromState=None, FromZIP5=None, FromZIP4=None, FromPhone=None, ShipFromZIP=None, ToFirstName=None, ToLastName=None, ToFirm=None, ToAddress1=None, ToAddress2=None, ToAddress3=None, ToDPID=None, ToProvince=None, ToTaxID=None, Container=None, ContentType=None, ShippingContents=None, Agreement=None, InsuredValue=None, GrossPounds=None, GrossOunces=None, Length=None, Width=None, Height=None, Girth=None, Shape=None, CIRequired=None, InvoiceDate=None, InvoiceNumber=None, CustOrderNumber=None, TermsDelivery=None, PackingCost=None, CountryUltDest=None, CIAgreement=None, ImageType=None, ImageLayout=None, ShipDate=None, HoldForManifest=None, PriceOptions=None, DestinationRateIndicator=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSGXGGetLabelCertifyRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSGXGGetLabelCertifyRequest.subclass:
            return eVSGXGGetLabelCertifyRequest.subclass(*args_, **kwargs_)
        else:
            return eVSGXGGetLabelCertifyRequest(*args_, **kwargs_)
    ...
    def get_ShipFromZIP(self): return self.ShipFromZIP
    def set_ShipFromZIP(self, ShipFromZIP): self.ShipFromZIP = ShipFromZIP
    ...
    def get_ToDPID(self): return self.ToDPID
    def set_ToDPID(self, ToDPID): self.ToDPID = ToDPID
    def get_ToProvince(self): return self.ToProvince
    def set_ToProvince(self, ToProvince): self.ToProvince = ToProvince
    def get_ToTaxID(self): return self.ToTaxID
    def set_ToTaxID(self, ToTaxID): self.ToTaxID = ToTaxID
    def get_Container(self): return self.Container
    def set_Container(self, Container): self.Container = Container
    ...
    def get_CIRequired(self): return self.CIRequired
    def set_CIRequired(self, CIRequired): self.CIRequired = CIRequired
    ...
    def get_CustOrderNumber(self): return self.CustOrderNumber
    def set_CustOrderNumber(self, CustOrderNumber): self.CustOrderNumber = CustOrderNumber
    def get_TermsDelivery(self): return self.TermsDelivery
    def set_TermsDelivery(self, TermsDelivery): self.TermsDelivery = TermsDelivery
    def get_PackingCost(self): return self.PackingCost
    def set_PackingCost(self, PackingCost): self.PackingCost = PackingCost
    def get_CountryUltDest(self): return self.CountryUltDest
    def set_CountryUltDest(self, CountryUltDest): self.CountryUltDest = CountryUltDest
    def get_CIAgreement(self): return self.CIAgreement
    def set_CIAgreement(self, CIAgreement): self.CIAgreement = CIAgreement
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='eVSGXGGetLabelCertifyRequest', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSGXGGetLabelCertifyRequest')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='eVSGXGGetLabelCertifyRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='eVSGXGGetLabelCertifyRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='eVSGXGGetLabelCertifyRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='eVSGXGGetLabelCertifyRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ShipFromZIP is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ShipFromZIP>%s</ShipFromZIP>%s' % (self.gds_format_integer(self.ShipFromZIP, input_name='ShipFromZIP'), eol_))
        ...
        if self.ToDPID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ToDPID>%s</ToDPID>%s' % (self.gds_format_integer(self.ToDPID, input_name='ToDPID'), eol_))
        ...
        if self.ToTaxID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ToTaxID>%s</ToTaxID>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ToTaxID), input_name='ToTaxID')), eol_))
        ...
        if self.InsuredValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<InsuredValue>%s</InsuredValue>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InsuredValue), input_name='InsuredValue')), eol_))
        ...
        if self.Shape is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Shape>%s</Shape>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Shape), input_name='Shape')), eol_))
        if self.CIRequired is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CIRequired>%s</CIRequired>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CIRequired), input_name='CIRequired')), eol_))
        ...
        if self.CustOrderNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CustOrderNumber>%s</CustOrderNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CustOrderNumber), input_name='CustOrderNumber')), eol_))
        if self.TermsDelivery is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<TermsDelivery>%s</TermsDelivery>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TermsDelivery), input_name='TermsDelivery')), eol_))
        if self.PackingCost is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<PackingCost>%s</PackingCost>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.PackingCost), input_name='PackingCost')), eol_))
        if self.CountryUltDest is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CountryUltDest>%s</CountryUltDest>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CountryUltDest), input_name='CountryUltDest')), eol_))
        if self.CIAgreement is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CIAgreement>%s</CIAgreement>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CIAgreement), input_name='CIAgreement')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Option':
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'ShipFromZIP')
            self.ShipFromZIP = ival_
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'ToDPID')
            self.ToDPID = ival_
            ...
            ToTaxID_ = child_.text
            ToTaxID_ = self.gds_validate_string(ToTaxID_, node, 'ToTaxID')
            self.ToTaxID = ToTaxID_
            ...
            InsuredValue_ = child_.text
            InsuredValue_ = self.gds_validate_string(InsuredValue_, node, 'InsuredValue')
            self.InsuredValue = InsuredValue_
            ...
            CIRequired_ = child_.text
            CIRequired_ = self.gds_validate_string(CIRequired_, node, 'CIRequired')
            self.CIRequired = CIRequired_
            ...
            CustOrderNumber_ = child_.text
            CustOrderNumber_ = self.gds_validate_string(CustOrderNumber_, node, 'CustOrderNumber')
            self.CustOrderNumber = CustOrderNumber_
        elif nodeName_ == 'TermsDelivery':
            TermsDelivery_ = child_.text
            TermsDelivery_ = self.gds_validate_string(TermsDelivery_, node, 'TermsDelivery')
            self.TermsDelivery = TermsDelivery_
        elif nodeName_ == 'PackingCost':
            PackingCost_ = child_.text
            PackingCost_ = self.gds_validate_string(PackingCost_, node, 'PackingCost')
            self.PackingCost = PackingCost_
        elif nodeName_ == 'CountryUltDest':
            CountryUltDest_ = child_.text
            CountryUltDest_ = self.gds_validate_string(CountryUltDest_, node, 'CountryUltDest')
            self.CountryUltDest = CountryUltDest_
        elif nodeName_ == 'CIAgreement':
            CIAgreement_ = child_.text
            CIAgreement_ = self.gds_validate_string(CIAgreement_, node, 'CIAgreement')
            self.CIAgreement = CIAgreement_
...
# end class eVSGXGGetLabelCertifyRequest
...
class ItemDetailType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Description=None, Commodity=None, Quantity=None, UnitValue=None, HSTariffNumber=None, CountryofManufacture=None):
        self.original_tagname_ = None
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ItemDetailType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Commodity is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Commodity>%s</Commodity>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Commodity), input_name='Commodity')), eol_))
        ...
        if self.UnitValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<UnitValue>%s</UnitValue>%s' % (self.gds_format_float(self.UnitValue, input_name='UnitValue'), eol_))
        ...
        if self.CountryofManufacture is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CountryofManufacture>%s</CountryofManufacture>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CountryofManufacture), input_name='CountryofManufacture')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Description':
            ...
            Commodity_ = child_.text
            Commodity_ = self.gds_validate_string(Commodity_, node, 'Commodity')
            self.Commodity = Commodity_
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'eVSGXGGetLabelCertifyRequest'
        rootClass = eVSGXGGetLabelCertifyRequest
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from eVSGXGGetLabelCertifyRequest.xsd import *\n\n')
        sys.stdout.write('import eVSGXGGetLabelCertifyRequest.xsd as model_\n\n')
