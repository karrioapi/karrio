...
#   ('-o', '../python/CarrierPickupAvailabilityRequest.xsd.py')
#
# Command line arguments:
#   CarrierPickupAvailabilityRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/CarrierPickupAvailabilityRequest.xsd.py" CarrierPickupAvailabilityRequest.xsd
#
...
class CarrierPickupAvailabilityRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, UserID=None, FirmName=None, SuiteOrApt=None, Address2=None, Urbanization=None, City=None, State=None, ZIP5=None, ZIP4=None):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='CarrierPickupAvailabilityRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CarrierPickupAvailabilityRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='CarrierPickupAvailabilityRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='CarrierPickupAvailabilityRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CarrierPickupAvailabilityRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from CarrierPickupAvailabilityRequest.xsd import *\n\n')
        sys.stdout.write('import CarrierPickupAvailabilityRequest.xsd as model_\n\n')
