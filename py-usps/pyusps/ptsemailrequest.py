...
#
# Generated Thu Dec 13 17:56:05 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/PTSEmailRequest.xsd.py')
#
# Command line arguments:
#   PTSEmailRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/PTSEmailRequest.xsd.py" PTSEmailRequest.xsd
#
...
class PTSEmailRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, USERID=None, TrackId=None, ClientIp=None, MpSuffix=None, MpDate=None, RequestType=None, FirstName=None, LastName=None, Email1=None, Email2=None, Email3=None):
    ...
    def add_RequestType(self, value): self.RequestType.append(value)
    def insert_RequestType_at(self, index, value): self.RequestType.insert(index, value)
    def replace_RequestType_at(self, index, value): self.RequestType[index] = value
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='PTSEmailRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PTSEmailRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='PTSEmailRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PTSEmailRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='PTSEmailRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for RequestType_ in self.RequestType:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RequestType>%s</RequestType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(RequestType_), input_name='RequestType')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TrackId':
            ...
            self.RequestType.append(RequestType_)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from PTSEmailRequest.xsd import *\n\n')
        sys.stdout.write('import PTSEmailRequest.xsd as model_\n\n')
