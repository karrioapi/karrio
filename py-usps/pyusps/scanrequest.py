...
#   ('-o', '../python/SCANRequest.xsd.py')
#
# Command line arguments:
#   SCANRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/SCANRequest.xsd.py" SCANRequest.xsd
#
...
class SCANRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, USERID=None, Option=None, FromName=None, FromFirm=None, FromAddress1=None, FromAddress2=None, FromCity=None, FromState=None, FromZip5=None, FromZip4=None, Shipment=None, MailDate=None, MailTime=None, EntryFacility=None, ImageType=None, CustomerRefNo=None):
    ...
    def get_MailDate(self): return self.MailDate
    def set_MailDate(self, MailDate): self.MailDate = MailDate
    def get_MailTime(self): return self.MailTime
    def set_MailTime(self, MailTime): self.MailTime = MailTime
    def get_EntryFacility(self): return self.EntryFacility
    def set_EntryFacility(self, EntryFacility): self.EntryFacility = EntryFacility
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='SCANRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SCANRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='SCANRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SCANRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SCANRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.MailDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<MailDate>%s</MailDate>%s' % (self.gds_format_integer(self.MailDate, input_name='MailDate'), eol_))
        if self.MailTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<MailTime>%s</MailTime>%s' % (self.gds_format_integer(self.MailTime, input_name='MailTime'), eol_))
        if self.EntryFacility is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<EntryFacility>%s</EntryFacility>%s' % (self.gds_format_integer(self.EntryFacility, input_name='EntryFacility'), eol_))
...
class OptionType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='OptionType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Form is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Form>%s</Form>%s' % (self.gds_format_integer(self.Form, input_name='Form'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ShipmentType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ShipmentType', fromsubclass_=False, pretty_print=True):
        ...
        if self.PackageDetail is not None:
            self.PackageDetail.export(outfile, level, namespace_, name_='PackageDetail', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PackageDetail':
            obj_ = PackageDetailType.factory()
            obj_.build(child_)
...
class PackageDetailType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, PkgBarcode=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_PkgBarcode(self): return self.PkgBarcode
    def set_PkgBarcode(self, PkgBarcode): self.PkgBarcode = PkgBarcode
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='PackageDetailType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PackageDetailType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='PackageDetailType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PackageDetailType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PackageDetailType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.PkgBarcode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<PkgBarcode>%s</PkgBarcode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.PkgBarcode), input_name='PkgBarcode')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PkgBarcode':
            PkgBarcode_ = child_.text
            PkgBarcode_ = self.gds_validate_string(PkgBarcode_, node, 'PkgBarcode')
            self.PkgBarcode = PkgBarcode_
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from SCANRequest.xsd import *\n\n')
        sys.stdout.write('import SCANRequest.xsd as model_\n\n')
