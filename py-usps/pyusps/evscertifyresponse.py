...
#   ('-o', '../python/eVSCertifyResponse.xsd.py')
#
# Command line arguments:
#   eVSCertifyResponse.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/eVSCertifyResponse.xsd.py" eVSCertifyResponse.xsd
#
...
class eVSCertifyResponse(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSCertifyResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSCertifyResponse.subclass:
            return eVSCertifyResponse.subclass(*args_, **kwargs_)
        else:
            return eVSCertifyResponse(*args_, **kwargs_)
    ...
    def get_Postnet(self): return self.Postnet
    def set_Postnet(self, Postnet): self.Postnet = Postnet
    def get_RDC(self): return self.RDC
    def set_RDC(self, RDC): self.RDC = RDC
    ...
    def get_InductionType(self): return self.InductionType
    def set_InductionType(self, InductionType): self.InductionType = InductionType
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='eVSCertifyResponse', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSCertifyResponse')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='eVSCertifyResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='eVSCertifyResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='eVSCertifyResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='eVSCertifyResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ToZip4 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ToZip4>%s</ToZip4>%s' % (self.gds_format_integer(self.ToZip4, input_name='ToZip4'), eol_))
        if self.Postnet is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Postnet>%s</Postnet>%s' % (self.gds_format_integer(self.Postnet, input_name='Postnet'), eol_))
        if self.RDC is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RDC>%s</RDC>%s' % (self.gds_format_integer(self.RDC, input_name='RDC'), eol_))
        ...
        if self.InductionType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<InductionType>%s</InductionType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InductionType), input_name='InductionType')), eol_))
        ...
        if self.Commitment is not None:
            self.Commitment.export(outfile, level, namespace_, name_='Commitment', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'BarcodeNumber':
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'RDC')
            self.RDC = ival_
            ...
            InductionType_ = child_.text
            InductionType_ = self.gds_validate_string(InductionType_, node, 'InductionType')
            self.InductionType = InductionType_
...
class CommitmentType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, CommitmentName=None, ScheduledDeliveryDate=None):
        self.original_tagname_ = None
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CommitmentType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ScheduledDeliveryDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ScheduledDeliveryDate>%s</ScheduledDeliveryDate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ScheduledDeliveryDate), input_name='ScheduledDeliveryDate')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CommitmentName':
            ...
            ScheduledDeliveryDate_ = child_.text
            ScheduledDeliveryDate_ = self.gds_validate_string(ScheduledDeliveryDate_, node, 'ScheduledDeliveryDate')
            self.ScheduledDeliveryDate = ScheduledDeliveryDate_
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'eVSCertifyResponse'
        rootClass = eVSCertifyResponse
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from eVSCertifyResponse.xsd import *\n\n')
        sys.stdout.write('import eVSCertifyResponse.xsd as model_\n\n')
