...
#
# Generated Thu Dec 13 17:56:15 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/eVSExpressMailIntlCertifyRequest.xsd.py')
#
# Command line arguments:
#   eVSExpressMailIntlCertifyRequest.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/eVSExpressMailIntlCertifyRequest.xsd.py" eVSExpressMailIntlCertifyRequest.xsd
#
...
class eVSExpressMailIntlCertifyRequest(GeneratedsSuper):
    ...
    def __init__(self, USERID=None, PASSWORD=None, Option=None, Revision=None, ImageParameters=None, FromFirstName=None, FromMiddleInitial=None, FromLastName=None, FromFirm=None, FromAddress1=None, FromAddress2=None, FromUrbanization=None, FromCity=None, FromState=None, FromZip5=None, FromZip4=None, FromPhone=None, FromCustomsReference=None, ToName=None, ToFirstName=None, ToLastName=None, ToFirm=None, ToAddress1=None, ToAddress2=None, ToAddress3=None, ToCity=None, ToProvince=None, ToCountry=None, ToPostalCode=None, ToPOBoxFlag=None, ToPhone=None, ToFax=None, ToEmail=None, ImportersReferenceNumber=None, NonDeliveryOption=None, RedirectName=None, RedirectEmail=None, RedirectSMS=None, RedirectAddress=None, RedirectCity=None, RedirectState=None, RedirectZIPCode=None, Container=None, ShippingContents=None, InsuredNumber=None, InsuredAmount=None, GrossPounds=None, GrossOunces=None, ContentType=None, ContentTypeOther=None, Agreement=None, Comments=None, LicenseNumber=None, CertificateNumber=None, InvoiceNumber=None, ImageType=None, ImageLayout=None, CustomerRefNo=None, CustomerRefNo2=None, POZipCode=None, LabelDate=None, HoldForManifest=None, PriceOptions=None, Size=None, Length=None, Width=None, Height=None, Girth=None, LabelTime=None, MeterPaymentFlag=None, DestinationRateIndicator=None):
        ...
        self.Height = Height
        self.Girth = Girth
        if isinstance(LabelTime, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(LabelTime, '%H:%M:%S').time()
        else:
            initvalue_ = LabelTime
        self.LabelTime = initvalue_
        self.MeterPaymentFlag = MeterPaymentFlag
        self.DestinationRateIndicator = DestinationRateIndicator
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSExpressMailIntlCertifyRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSExpressMailIntlCertifyRequest.subclass:
            return eVSExpressMailIntlCertifyRequest.subclass(*args_, **kwargs_)
        else:
            return eVSExpressMailIntlCertifyRequest(*args_, **kwargs_)
    ...
    def get_FromUrbanization(self): return self.FromUrbanization
    def set_FromUrbanization(self, FromUrbanization): self.FromUrbanization = FromUrbanization
    ...
    def get_FromCustomsReference(self): return self.FromCustomsReference
    def set_FromCustomsReference(self, FromCustomsReference): self.FromCustomsReference = FromCustomsReference
    ...
    def get_ImportersReferenceNumber(self): return self.ImportersReferenceNumber
    def set_ImportersReferenceNumber(self, ImportersReferenceNumber): self.ImportersReferenceNumber = ImportersReferenceNumber
    def get_NonDeliveryOption(self): return self.NonDeliveryOption
    def set_NonDeliveryOption(self, NonDeliveryOption): self.NonDeliveryOption = NonDeliveryOption
    def get_RedirectName(self): return self.RedirectName
    def set_RedirectName(self, RedirectName): self.RedirectName = RedirectName
    def get_RedirectEmail(self): return self.RedirectEmail
    def set_RedirectEmail(self, RedirectEmail): self.RedirectEmail = RedirectEmail
    def get_RedirectSMS(self): return self.RedirectSMS
    def set_RedirectSMS(self, RedirectSMS): self.RedirectSMS = RedirectSMS
    def get_RedirectAddress(self): return self.RedirectAddress
    def set_RedirectAddress(self, RedirectAddress): self.RedirectAddress = RedirectAddress
    def get_RedirectCity(self): return self.RedirectCity
    def set_RedirectCity(self, RedirectCity): self.RedirectCity = RedirectCity
    def get_RedirectState(self): return self.RedirectState
    def set_RedirectState(self, RedirectState): self.RedirectState = RedirectState
    def get_RedirectZIPCode(self): return self.RedirectZIPCode
    def set_RedirectZIPCode(self, RedirectZIPCode): self.RedirectZIPCode = RedirectZIPCode
    def get_Container(self): return self.Container
    def set_Container(self, Container): self.Container = Container
    ...
    def get_InsuredNumber(self): return self.InsuredNumber
    def set_InsuredNumber(self, InsuredNumber): self.InsuredNumber = InsuredNumber
    ...
    def get_ContentTypeOther(self): return self.ContentTypeOther
    def set_ContentTypeOther(self, ContentTypeOther): self.ContentTypeOther = ContentTypeOther
    ...
    def get_ImageLayout(self): return self.ImageLayout
    def set_ImageLayout(self, ImageLayout): self.ImageLayout = ImageLayout
    ...
    def get_CustomerRefNo2(self): return self.CustomerRefNo2
    def set_CustomerRefNo2(self, CustomerRefNo2): self.CustomerRefNo2 = CustomerRefNo2
    ...
    def get_LabelTime(self): return self.LabelTime
    def set_LabelTime(self, LabelTime): self.LabelTime = LabelTime
    def get_MeterPaymentFlag(self): return self.MeterPaymentFlag
    def set_MeterPaymentFlag(self, MeterPaymentFlag): self.MeterPaymentFlag = MeterPaymentFlag
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='eVSExpressMailIntlCertifyRequest', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSExpressMailIntlCertifyRequest')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='eVSExpressMailIntlCertifyRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='eVSExpressMailIntlCertifyRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='eVSExpressMailIntlCertifyRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='eVSExpressMailIntlCertifyRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.FromUrbanization is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<FromUrbanization>%s</FromUrbanization>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.FromUrbanization), input_name='FromUrbanization')), eol_))
        ...
        if self.FromCustomsReference is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<FromCustomsReference>%s</FromCustomsReference>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.FromCustomsReference), input_name='FromCustomsReference')), eol_))
        ...
        if self.ToPostalCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ToPostalCode>%s</ToPostalCode>%s' % (self.gds_format_integer(self.ToPostalCode, input_name='ToPostalCode'), eol_))
        ...
        if self.ToFax is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ToFax>%s</ToFax>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ToFax), input_name='ToFax')), eol_))
        ...
        if self.ImportersReferenceNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ImportersReferenceNumber>%s</ImportersReferenceNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ImportersReferenceNumber), input_name='ImportersReferenceNumber')), eol_))
        if self.NonDeliveryOption is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NonDeliveryOption>%s</NonDeliveryOption>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.NonDeliveryOption), input_name='NonDeliveryOption')), eol_))
        if self.RedirectName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RedirectName>%s</RedirectName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RedirectName), input_name='RedirectName')), eol_))
        if self.RedirectEmail is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RedirectEmail>%s</RedirectEmail>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RedirectEmail), input_name='RedirectEmail')), eol_))
        if self.RedirectSMS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RedirectSMS>%s</RedirectSMS>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RedirectSMS), input_name='RedirectSMS')), eol_))
        if self.RedirectAddress is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RedirectAddress>%s</RedirectAddress>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RedirectAddress), input_name='RedirectAddress')), eol_))
        if self.RedirectCity is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RedirectCity>%s</RedirectCity>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RedirectCity), input_name='RedirectCity')), eol_))
        if self.RedirectState is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RedirectState>%s</RedirectState>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RedirectState), input_name='RedirectState')), eol_))
        if self.RedirectZIPCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RedirectZIPCode>%s</RedirectZIPCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RedirectZIPCode), input_name='RedirectZIPCode')), eol_))
        ...
        if self.InsuredNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<InsuredNumber>%s</InsuredNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InsuredNumber), input_name='InsuredNumber')), eol_))
        ...
        if self.ContentTypeOther is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ContentTypeOther>%s</ContentTypeOther>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ContentTypeOther), input_name='ContentTypeOther')), eol_))
        ...
        if self.ImageLayout is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ImageLayout>%s</ImageLayout>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ImageLayout), input_name='ImageLayout')), eol_))
        ...
        if self.CustomerRefNo2 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CustomerRefNo2>%s</CustomerRefNo2>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CustomerRefNo2), input_name='CustomerRefNo2')), eol_))
        if self.POZipCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<POZipCode>%s</POZipCode>%s' % (self.gds_format_integer(self.POZipCode, input_name='POZipCode'), eol_))
        ...
        if self.LabelTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<LabelTime>%s</LabelTime>%s' % (self.gds_format_time(self.LabelTime, input_name='LabelTime'), eol_))
        if self.MeterPaymentFlag is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<MeterPaymentFlag>%s</MeterPaymentFlag>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.MeterPaymentFlag), input_name='MeterPaymentFlag')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Option':
            ...
            FromUrbanization_ = child_.text
            FromUrbanization_ = self.gds_validate_string(FromUrbanization_, node, 'FromUrbanization')
            self.FromUrbanization = FromUrbanization_
            ...
            FromCustomsReference_ = child_.text
            FromCustomsReference_ = self.gds_validate_string(FromCustomsReference_, node, 'FromCustomsReference')
            self.FromCustomsReference = FromCustomsReference_
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'ToPostalCode')
            self.ToPostalCode = ival_
            ...
            ToFax_ = child_.text
            ToFax_ = self.gds_validate_string(ToFax_, node, 'ToFax')
            self.ToFax = ToFax_
            ...
            ImportersReferenceNumber_ = child_.text
            ImportersReferenceNumber_ = self.gds_validate_string(ImportersReferenceNumber_, node, 'ImportersReferenceNumber')
            self.ImportersReferenceNumber = ImportersReferenceNumber_
        elif nodeName_ == 'NonDeliveryOption':
            NonDeliveryOption_ = child_.text
            NonDeliveryOption_ = self.gds_validate_string(NonDeliveryOption_, node, 'NonDeliveryOption')
            self.NonDeliveryOption = NonDeliveryOption_
        elif nodeName_ == 'RedirectName':
            RedirectName_ = child_.text
            RedirectName_ = self.gds_validate_string(RedirectName_, node, 'RedirectName')
            self.RedirectName = RedirectName_
        elif nodeName_ == 'RedirectEmail':
            RedirectEmail_ = child_.text
            RedirectEmail_ = self.gds_validate_string(RedirectEmail_, node, 'RedirectEmail')
            self.RedirectEmail = RedirectEmail_
        elif nodeName_ == 'RedirectSMS':
            RedirectSMS_ = child_.text
            RedirectSMS_ = self.gds_validate_string(RedirectSMS_, node, 'RedirectSMS')
            self.RedirectSMS = RedirectSMS_
        elif nodeName_ == 'RedirectAddress':
            RedirectAddress_ = child_.text
            RedirectAddress_ = self.gds_validate_string(RedirectAddress_, node, 'RedirectAddress')
            self.RedirectAddress = RedirectAddress_
        elif nodeName_ == 'RedirectCity':
            RedirectCity_ = child_.text
            RedirectCity_ = self.gds_validate_string(RedirectCity_, node, 'RedirectCity')
            self.RedirectCity = RedirectCity_
        elif nodeName_ == 'RedirectState':
            RedirectState_ = child_.text
            RedirectState_ = self.gds_validate_string(RedirectState_, node, 'RedirectState')
            self.RedirectState = RedirectState_
        elif nodeName_ == 'RedirectZIPCode':
            RedirectZIPCode_ = child_.text
            RedirectZIPCode_ = self.gds_validate_string(RedirectZIPCode_, node, 'RedirectZIPCode')
            self.RedirectZIPCode = RedirectZIPCode_
            ...
            InsuredNumber_ = child_.text
            InsuredNumber_ = self.gds_validate_string(InsuredNumber_, node, 'InsuredNumber')
            self.InsuredNumber = InsuredNumber_
            ...
            ContentTypeOther_ = child_.text
            ContentTypeOther_ = self.gds_validate_string(ContentTypeOther_, node, 'ContentTypeOther')
            self.ContentTypeOther = ContentTypeOther_
            ...
            ImageLayout_ = child_.text
            ImageLayout_ = self.gds_validate_string(ImageLayout_, node, 'ImageLayout')
            self.ImageLayout = ImageLayout_
            ...
            CustomerRefNo2_ = child_.text
            CustomerRefNo2_ = self.gds_validate_string(CustomerRefNo2_, node, 'CustomerRefNo2')
            self.CustomerRefNo2 = CustomerRefNo2_
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'POZipCode')
            self.POZipCode = ival_
            ...
            self.LabelTime = dval_
        elif nodeName_ == 'MeterPaymentFlag':
            MeterPaymentFlag_ = child_.text
            MeterPaymentFlag_ = self.gds_validate_string(MeterPaymentFlag_, node, 'MeterPaymentFlag')
            self.MeterPaymentFlag = MeterPaymentFlag_
...
# end class eVSExpressMailIntlCertifyRequest
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'eVSExpressMailIntlCertifyRequest'
        rootClass = eVSExpressMailIntlCertifyRequest
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from eVSExpressMailIntlCertifyRequest.xsd import *\n\n')
        sys.stdout.write('import eVSExpressMailIntlCertifyRequest.xsd as model_\n\n')
