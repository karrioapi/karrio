...
#
# Generated Thu Dec 13 17:55:56 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/CarrierPickupAvailabilityResponse.xsd.py')
#
# Command line arguments:
#   CarrierPickupAvailabilityResponse.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/CarrierPickupAvailabilityResponse.xsd.py" CarrierPickupAvailabilityResponse.xsd
#
...
class CarrierPickupAvailabilityResponse(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, FirmName=None, SuiteOrApt=None, Address2=None, Urbanization=None, City=None, State=None, ZIP5=None, ZIP4=None, DayOfWeek=None, Date=None, CarrierRoute=None):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='CarrierPickupAvailabilityResponse', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CarrierPickupAvailabilityResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='CarrierPickupAvailabilityResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='CarrierPickupAvailabilityResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='CarrierPickupAvailabilityResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from CarrierPickupAvailabilityResponse.xsd import *\n\n')
        sys.stdout.write('import CarrierPickupAvailabilityResponse.xsd as model_\n\n')
