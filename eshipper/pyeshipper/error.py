...
#   ('--no-namespace-defs', '')
#   ('-o', './pyeshipper/error.py')
#
# Command line arguments:
#   ./vendor/schemas/error.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-bridges/eshipper/.venv/eshipper/bin/generateDS --no-namespace-defs -o "./pyeshipper/error.py" ./vendor/schemas/error.xsd
#
