...
ParsedQuoteResponse = [[{'base_charge': 177.0, 'carrier_id': 'eshipper', 'carrier_name': 'eshipper', 'currency': 'CAD', 'extra_charges': [{'amount': 0.0, 'currency': 'CAD', 'name': 'Fuel surcharge'}], 'meta': {'carrier_name': 'purolator', 'service_name': 'Air'}, 'service': 'eshipper_purolator_air', 'total_charge': 177.0, 'transit_days': 1}, {'base_charge': 28.65, 'carrier_id': 'eshipper', 'carrier_name': 'eshipper', 'currency': 'CAD', 'extra_charges': [{'amount': 0.0, 'currency': 'CAD', 'name': 'Fuel surcharge'}], 'meta': {'carrier_name': 'purolator', 'service_name': 'Ground'}, 'service': 'eshipper_purolator_ground', 'total_charge': 28.65, 'transit_days': 1}, {'base_charge': 46.27, 'carrier_id': 'eshipper', 'carrier_name': 'eshipper', 'currency': 'CAD', 'extra_charges': [{'amount': 6.25, 'currency': 'CAD', 'name': 'Fuel surcharge'}], 'meta': {'carrier_name': 'federal express', 'service_name': 'Priority'}, 'service': 'eshipper_fedex_priority', 'total_charge': 52.52, 'transit_days': 0}, {'base_charge': 30.74, 'carrier_id': 'eshipper', 'carrier_name': 'eshipper', 'currency': 'CAD', 'extra_charges': [{'amount': 0.0, 'currency': 'CAD', 'name': 'Fuel surcharge'}, {'amount': 1.08, 'currency': 'CAD', 'name': 'Other'}], 'meta': {'carrier_name': 'federal express', 'service_name': 'Ground'}, 'service': 'eshipper_fedex_ground', 'total_charge': 31.82, 'transit_days': 0}, {'base_charge': 300.0, 'carrier_id': 'eshipper', 'carrier_name': 'eshipper', 'currency': 'CAD', 'extra_charges': [{'amount': 36.0, 'currency': 'CAD', 'name': 'Fuel surcharge'}], 'meta': {'carrier_name': 'canada worldwide', 'service_name': 'Air Freight'}, 'service': 'eshipper_canada_worldwide_air_freight', 'total_charge': 336.0, 'transit_days': 0}, {'base_charge': 165.0, 'carrier_id': 'eshipper', 'carrier_name': 'eshipper', 'currency': 'CAD', 'extra_charges': [{'amount': 19.8, 'currency': 'CAD', 'name': 'Fuel surcharge'}], 'meta': {'carrier_name': 'canada worldwide', 'service_name': 'Next Flight Out'}, 'service': 'eshipper_canada_worldwide_next_flight_out', 'total_charge': 184.8, 'transit_days': 0}], []]
