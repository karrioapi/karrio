...
class Option(Flag):
    easypost_additional_handling = Spec.asFlag("additional_handling")
    easypost_address_validation_level = Spec.asValue("address_validation_level")
    easypost_alcohol = Spec.asFlag("alcohol")
    easypost_bill_receiver_account = Spec.asValue("bill_receiver_account")
    easypost_bill_receiver_postal_code = Spec.asValue("bill_receiver_postal_code")
    easypost_bill_third_party_account = Spec.asValue("bill_third_party_account")
    easypost_bill_third_party_country = Spec.asValue("bill_third_party_country")
    easypost_bill_third_party_postal_code = Spec.asValue("bill_third_party_postal_code")
    easypost_by_drone = Spec.asFlag("by_drone")
    easypost_carbon_neutral = Spec.asFlag("carbon_neutral")
    easypost_cod_amount = Spec.asValue("cod_amount")
    easypost_cod_method = Spec.asValue("cod_method")
    easypost_cod_address_id = Spec.asValue("cod_address_id")
    easypost_currency = Spec.asValue("currency")
    easypost_delivery_confirmation = Spec.asValue("delivery_confirmation")
    easypost_dropoff_type = Spec.asValue("dropoff_type")
    easypost_dry_ice = Spec.asFlag("dry_ice")
    easypost_dry_ice_medical = Spec.asFlag("dry_ice_medical")
    easypost_dry_ice_weight = Spec.asValue("dry_ice_weight")
    easypost_endorsement = Spec.asValue("endorsement")
    easypost_freight_charge = Spec.asValue("freight_charge", float)
    easypost_handling_instructions = Spec.asValue("handling_instructions")
    easypost_hazmat = Spec.asValue("hazmat")
    easypost_hold_for_pickup = Spec.asFlag("hold_for_pickup")
    easypost_incoterm = Spec.asValue("incoterm")
    easypost_invoice_number = Spec.asValue("invoice_number")
    easypost_label_date = Spec.asValue("label_date")
    easypost_label_format = Spec.asFlag("label_format")
    easypost_machinable = Spec.asFlag("machinable")
    # easypost_payment = Spec.asValue("payment", dict)
    easypost_print_custom_1 = Spec.asValue("print_custom_1")
    easypost_print_custom_2 = Spec.asValue("print_custom_2")
    easypost_print_custom_3 = Spec.asValue("print_custom_3")
    easypost_print_custom_1_barcode = Spec.asFlag("print_custom_1_barcode")
    easypost_print_custom_2_barcode = Spec.asFlag("print_custom_2_barcode")
    easypost_print_custom_3_barcode = Spec.asFlag("print_custom_3_barcode")
    easypost_print_custom_1_code = Spec.asValue("print_custom_1_code")
    easypost_print_custom_2_code = Spec.asValue("print_custom_2_code")
    easypost_print_custom_3_code = Spec.asValue("print_custom_3_code")
    easypost_saturday_delivery = Spec.asFlag("saturday_delivery")
    easypost_special_rates_eligibility = Spec.asValue("special_rates_eligibility")
    easypost_smartpost_hub = Spec.asValue("smartpost_hub")
    easypost_smartpost_manifest = Spec.asValue("smartpost_manifest")
    easypost_billing_ref = Spec.asValue("billing_ref")
    easypost_certified_mail = Spec.asFlag("certified_mail")
    easypost_registered_mail = Spec.asFlag("registered_mail")
    easypost_registered_mail_amount = Spec.asValue("registered_mail_amount", float)
    easypost_return_receipt = Spec.asFlag("return_receipt")
