...
export const PickupsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cancel(body: PickupCancelRequest, carrier_name: string, test?: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
            ...
            if (carrier_name === null || carrier_name === undefined) {
                throw new RequiredError('carrier_name','Required parameter carrier_name was null or undefined when calling cancel.');
            }
         ...
         * @throws {RequiredError}
         */
        schedule(body: PickupRequest, carrier_name: string, test?: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        update(body: PickupUpdateRequest, carrier_name: string, test?: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling update.');
            }
            // verify required parameter 'carrier_name' is not null or undefined
            if (carrier_name === null || carrier_name === undefined) {
                throw new RequiredError('carrier_name','Required parameter carrier_name was null or undefined when calling update.');
            }
            const localVarPath = `/proxy/pickups/{carrier_name}`
                .replace(`{${"carrier_name"}}`, encodeURIComponent(String(carrier_name)));
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const PickupsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cancel(body: PickupCancelRequest, carrier_name: string, test?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<OperationResponse> {
            const localVarFetchArgs = PickupsApiFetchParamCreator(configuration).cancel(body, carrier_name, test, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        schedule(body: PickupRequest, carrier_name: string, test?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PickupResponse> {
         ...
         * @throws {RequiredError}
         */
        update(body: PickupUpdateRequest, carrier_name: string, test?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PickupResponse> {
            const localVarFetchArgs = PickupsApiFetchParamCreator(configuration).update(body, carrier_name, test, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const PickupsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        cancel(body: PickupCancelRequest, carrier_name: string, test?: boolean, options?: any) {
            return PickupsApiFp(configuration).cancel(body, carrier_name, test, options)(fetch, basePath);
        },
        /**
         * **[proxy]**  Schedule one or many parcels pickup
         * @summary Schedule a pickup
         ...
         * @throws {RequiredError}
         */
        schedule(body: PickupRequest, carrier_name: string, test?: boolean, options?: any) {
         ...
         * @throws {RequiredError}
         */
        update(body: PickupUpdateRequest, carrier_name: string, test?: boolean, options?: any) {
            return PickupsApiFp(configuration).update(body, carrier_name, test, options)(fetch, basePath);
        },
    };
};
...
export class PickupsApi extends BaseAPI {
     ...
     * @memberof PickupsApi
     */
    public cancel(body: PickupCancelRequest, carrier_name: string, test?: boolean, options?: any) {
        return PickupsApiFp(this.configuration).cancel(body, carrier_name, test, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof PickupsApi
     */
    public schedule(body: PickupRequest, carrier_name: string, test?: boolean, options?: any) {
     ...
     * @memberof PickupsApi
     */
    public update(body: PickupUpdateRequest, carrier_name: string, test?: boolean, options?: any) {
        return PickupsApiFp(this.configuration).update(body, carrier_name, test, options)(this.fetch, this.basePath);
    }
...
export const RatesApiFp = function(configuration?: Configuration) {
    return {
        ...
        fetch(body: RateRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<RateResponse> {
            const localVarFetchArgs = RatesApiFetchParamCreator(configuration).fetch(body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const RatesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        fetch(body: RateRequest, options?: any) {
            return RatesApiFp(configuration).fetch(body, options)(fetch, basePath);
        },
    };
};
 ...
 */
export class RatesApi extends AlternateBaseAPI {
    /**
     *  **[proxy]**  The Shipping process begins by fetching rates for your shipment. Use this service to fetch a shipping rates available. 
     * @summary Fetch shipment rates
     * @param {RateRequest} body 
    ...
    public fetch(body: RateRequest, options?: any) {
        return RatesApiFp(this.configuration).fetch(body, options)(this.fetchAPI, this.basePath);
    }
...
export const ShipmentsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        cancelPickup(body: PickupCancelData, id: string, options: any = {}): FetchArgs {
            ...
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling cancelPickup.');
            }
            const localVarPath = `/shipment_pickups/{id}/cancel`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        pickups(limit?: number, offset?: number, options: any = {}): FetchArgs {
            const localVarPath = `/shipment_pickups`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
        ...
        retrievePickup(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling retrievePickup.');
            }
            const localVarPath = `/shipment_pickups/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        schedulePickup(body: PickupData, carrier_name: string, test?: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
            ...
            const localVarPath = `/shipment_pickups/{carrier_name}/schedule`
                .replace(`{${"carrier_name"}}`, encodeURIComponent(String(carrier_name)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        track(carrier_name: string, tracking_number: string, test?: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'carrier_name' is not null or undefined
            if (carrier_name === null || carrier_name === undefined) {
                throw new RequiredError('carrier_name','Required parameter carrier_name was null or undefined when calling track.');
            }
            // verify required parameter 'tracking_number' is not null or undefined
            if (tracking_number === null || tracking_number === undefined) {
                throw new RequiredError('tracking_number','Required parameter tracking_number was null or undefined when calling track.');
            }
         ...
         * @throws {RequiredError}
         */
        trackingStatuses(limit?: number, offset?: number, options: any = {}): FetchArgs {
        ...
        updatePickup(body: PickupUpdateData, id: string, options: any = {}): FetchArgs {
            ...
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling updatePickup.');
            }
            const localVarPath = `/shipment_pickups/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const ShipmentsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cancelPickup(body: PickupCancelData, id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<OperationConfirmation> {
            const localVarFetchArgs = ShipmentsApiFetchParamCreator(configuration).cancelPickup(body, id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        pickups(limit?: number, offset?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Pickup>> {
            const localVarFetchArgs = ShipmentsApiFetchParamCreator(configuration).pickups(limit, offset, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        retrievePickup(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Pickup> {
            const localVarFetchArgs = ShipmentsApiFetchParamCreator(configuration).retrievePickup(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        schedulePickup(body: PickupData, carrier_name: string, test?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Pickup> {
            const localVarFetchArgs = ShipmentsApiFetchParamCreator(configuration).schedulePickup(body, carrier_name, test, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        track(carrier_name: string, tracking_number: string, test?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<TrackingStatus> {
            const localVarFetchArgs = ShipmentsApiFetchParamCreator(configuration).track(carrier_name, tracking_number, test, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        trackingStatuses(limit?: number, offset?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<TrackingStatus>> {
            const localVarFetchArgs = ShipmentsApiFetchParamCreator(configuration).trackingStatuses(limit, offset, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        updatePickup(body: PickupUpdateData, id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<OperationConfirmation> {
            const localVarFetchArgs = ShipmentsApiFetchParamCreator(configuration).updatePickup(body, id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ShipmentsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        cancelPickup(body: PickupCancelData, id: string, options?: any) {
            return ShipmentsApiFp(configuration).cancelPickup(body, id, options)(fetch, basePath);
        },
        /**
         * Create a new shipment instance.
         * @summary Create a shipment
         ...
         * @throws {RequiredError}
         */
        pickups(limit?: number, offset?: number, options?: any) {
            return ShipmentsApiFp(configuration).pickups(limit, offset, options)(fetch, basePath);
        },
        /**
         * Select your preferred rates to buy a shipment label.
         * @summary Buy a shipment label
         ...
         * @throws {RequiredError}
         */
        retrievePickup(id: string, options?: any) {
            return ShipmentsApiFp(configuration).retrievePickup(id, options)(fetch, basePath);
        },
        /**
         * Schedule a pickup for one or many shipments with labels already purchased.
         * @summary Schedule a pickup
         ...
         * @throws {RequiredError}
         */
        schedulePickup(body: PickupData, carrier_name: string, test?: boolean, options?: any) {
            return ShipmentsApiFp(configuration).schedulePickup(body, carrier_name, test, options)(fetch, basePath);
        },
        /**
         * Add one or many options to your shipment.<br/> **eg:**<br/> - add shipment **insurance** - specify the preferred transaction **currency** - setup a **cash collected on delivery** option  ```json {     \"insurance\": 120,     \"currency\": \"USD\" } ```  And many more, check additional options available in the [reference](#operation/all_references).
         * @summary Add shipment options
         ...
         * @throws {RequiredError}
         */
        track(carrier_name: string, tracking_number: string, test?: boolean, options?: any) {
            return ShipmentsApiFp(configuration).track(carrier_name, tracking_number, test, options)(fetch, basePath);
        },
        /**
         * Retrieve all tracking statuses.
         * @summary List all tracking statuses
         ...
         * @throws {RequiredError}
         */
        trackingStatuses(limit?: number, offset?: number, options?: any) {
            return ShipmentsApiFp(configuration).trackingStatuses(limit, offset, options)(fetch, basePath);
        },
        /**
         * Modify a pickup for one or many shipments with labels already purchased.
         * @summary Update a pickup
         ...
         * @throws {RequiredError}
         */
        updatePickup(body: PickupUpdateData, id: string, options?: any) {
            return ShipmentsApiFp(configuration).updatePickup(body, id, options)(fetch, basePath);
        },
    };
};
...
export class ShipmentsApi extends BaseAPI {
     ...
     * @memberof ShipmentsApi
     */
    public cancelPickup(body: PickupCancelData, id: string, options?: any) {
        return ShipmentsApiFp(this.configuration).cancelPickup(body, id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ShipmentsApi
     */
    public pickups(limit?: number, offset?: number, options?: any) {
        return ShipmentsApiFp(this.configuration).pickups(limit, offset, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ShipmentsApi
     */
    public retrievePickup(id: string, options?: any) {
        return ShipmentsApiFp(this.configuration).retrievePickup(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ShipmentsApi
     */
    public schedulePickup(body: PickupData, carrier_name: string, test?: boolean, options?: any) {
        return ShipmentsApiFp(this.configuration).schedulePickup(body, carrier_name, test, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ShipmentsApi
     */
    public track(carrier_name: string, tracking_number: string, test?: boolean, options?: any) {
        return ShipmentsApiFp(this.configuration).track(carrier_name, tracking_number, test, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ShipmentsApi
     */
    public trackingStatuses(limit?: number, offset?: number, options?: any) {
        return ShipmentsApiFp(this.configuration).trackingStatuses(limit, offset, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ShipmentsApi
     */
    public updatePickup(body: PickupUpdateData, id: string, options?: any) {
        return ShipmentsApiFp(this.configuration).updatePickup(body, id, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const ShippingApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
...
export const ShippingApiFp = function(configuration?: Configuration) {
    return {
        ...
        buyLabel(body: ShippingRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Shipment> {
            const localVarFetchArgs = ShippingApiFetchParamCreator(configuration).buyLabel(body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        voidLabel(body: ShipmentCancelRequest, carrier_name: string, test?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<OperationResponse> {
            const localVarFetchArgs = ShippingApiFetchParamCreator(configuration).voidLabel(body, carrier_name, test, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const ShippingApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * **[proxy]**  Once the shipping rates are retrieved, provide the required info to submit the shipment by specifying your preferred rate.
         * @summary Buy a shipment label
        ...
        buyLabel(body: ShippingRequest, options?: any) {
            return ShippingApiFp(configuration).buyLabel(body, options)(fetch, basePath);
        },
        /**
         * **[proxy]**  Cancel a shipment and the label previously created
         * @summary Void a shipment label
        ...
        voidLabel(body: ShipmentCancelRequest, carrier_name: string, test?: boolean, options?: any) {
            return ShippingApiFp(configuration).voidLabel(body, carrier_name, test, options)(fetch, basePath);
        },
    };
};
...
export class ShippingApi extends BaseAPI {
    ...
    public buyLabel(body: ShippingRequest, options?: any) {
        return ShippingApiFp(this.configuration).buyLabel(body, options)(this.fetch, this.basePath);
    }
    ...
    public voidLabel(body: ShipmentCancelRequest, carrier_name: string, test?: boolean, options?: any) {
        return ShippingApiFp(this.configuration).voidLabel(body, carrier_name, test, options)(this.fetch, this.basePath);
    }
...
export const TrackingApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        fetch(carrier_name: string, tracking_number: string, test?: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'carrier_name' is not null or undefined
            if (carrier_name === null || carrier_name === undefined) {
                throw new RequiredError('carrier_name','Required parameter carrier_name was null or undefined when calling fetch.');
            }
            // verify required parameter 'tracking_number' is not null or undefined
            if (tracking_number === null || tracking_number === undefined) {
                throw new RequiredError('tracking_number','Required parameter tracking_number was null or undefined when calling fetch.');
            }
...
export const TrackingApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        fetch(carrier_name: string, tracking_number: string, test?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<TrackingResponse> {
            const localVarFetchArgs = TrackingApiFetchParamCreator(configuration).fetch(carrier_name, tracking_number, test, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const TrackingApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        fetch(carrier_name: string, tracking_number: string, test?: boolean, options?: any) {
            return TrackingApiFp(configuration).fetch(carrier_name, tracking_number, test, options)(fetch, basePath);
        },
    };
};
 ...
 * @extends {AlternateBaseAPI}
 */
export class TrackingApi extends AlternateBaseAPI {
    /**
     * **[proxy]**  You can track a shipment by specifying the carrier and the shipment tracking number.
     * @summary Track a shipment
     * @param {string} carrier_name 
     ...
     */
    public fetch(carrier_name: string, tracking_number: string, test?: boolean, options?: any) {
        return TrackingApiFp(this.configuration).fetch(carrier_name, tracking_number, test, options)(this.fetchAPI, this.basePath);
    }
