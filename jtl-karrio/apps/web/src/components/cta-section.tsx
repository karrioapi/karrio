    ...
    <section className="py-24 relative bg-[#0f0826] text-white">
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-0 max-w-6xl space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          {/* Karrio OSS Card */}
          <div className="bg-[#1A1630] rounded-xl overflow-hidden border border-white/5 text-white shadow-md relative group min-h-[380px] flex flex-col">
            <div className="p-6 md:p-8 space-y-5 md:space-y-6 relative z-10 w-full md:max-w-[75%] flex-1">
              <div className="w-12 md:w-14 h-12 md:h-14 flex items-center justify-center rounded-xl bg-white/10">
            ...
            <div className="absolute right-0 bottom-0 w-[45%] md:w-[50%] h-[70%] md:h-[80%] overflow-hidden pointer-events-none">
              <div className="relative w-full h-full flex items-center justify-center">
                <div className="absolute top-1/4 left-1/4 w-16 md:w-24 h-16 md:h-24 rounded-full bg-[#30D9B7]/30 blur-xl"></div>
                <div className="absolute bottom-1/4 right-1/4 w-14 md:w-20 h-14 md:h-20 rounded-full bg-[#5722cc]/30 blur-xl"></div>
                <svg className="w-40 md:w-52 h-40 md:h-52" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="100" cy="100" r="80" stroke="var(--color-circle, #30D9B7)" strokeWidth="3" style={{ "--color-circle": "#30D9B7" } as React.CSSProperties} />
                  <path d="M60 100C60 77.9086 77.9086 60 100 60C122.091 60 140 77.9086 140 100C140 122.091 122.091 140 100 140" stroke="var(--color-path, #5722cc)" strokeWidth="3" style={{ "--color-path": "#5722cc" } as React.CSSProperties} />
