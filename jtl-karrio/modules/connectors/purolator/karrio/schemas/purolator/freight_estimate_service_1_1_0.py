...
class Shipment(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, SenderInformation=None, ReceiverInformation=None, PaymentInformation=None, ShipmentDetails=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'SenderInformation':
            ...
            obj_ = EstimateInformation.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class GetEstimateRequest(Request):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GetEstimateRequest', fromsubclass_=False, pretty_print=True):
        ...
        if self.Estimate is not None:
            namespaceprefix_ = self.Estimate_nsprefix_ + ':' if (UseCapturedNS_ and self.Estimate_nsprefix_) else ''
            self.Estimate.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Estimate', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
