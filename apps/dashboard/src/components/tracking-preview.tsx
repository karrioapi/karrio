import { formatAddressRegion, formatDayDate, formatRef, isNone, useLocation } from '@karrio/lib';
import { TrackerStatusEnum, TrackerType, TrackingEventType } from '@karrio/types';
...
export const TrackingPreview: React.FC<TrackingPreviewComponent> = ({ children }) => {
        ...
        {!isNone(tracker) && <div className="modal-card">
          <section className="modal-card-body">
            ...
            {!isNone(tracker?.info) && (
              <>
                <hr />
                <p className="has-text-weight-bold my-4 is-size-6">Additional Information</p>
