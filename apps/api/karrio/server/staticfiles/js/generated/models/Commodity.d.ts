 ...
 * @export
 */
export declare const CommodityWeightUnitEnum: {
    readonly Kg: "KG";
    readonly Lb: "LB";
};
 ...
 * @export
 */
export declare const CommodityValueCurrencyEnum: {
    readonly Eur: "EUR";
    readonly Aed: "AED";
    readonly Usd: "USD";
    readonly Xcd: "XCD";
 ...
 * @export
 */
export declare const CommodityOriginCountryEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfCommodity(value: object): boolean;
export declare function CommodityFromJSON(json: any): Commodity;
export declare function CommodityFromJSONTyped(json: any, ignoreDiscriminator: boolean): Commodity;
export declare function CommodityToJSON(value?: Commodity | null): any;
