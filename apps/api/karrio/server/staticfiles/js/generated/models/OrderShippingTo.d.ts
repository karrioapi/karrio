 ...
 * @export
 */
export declare const OrderShippingToCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfOrderShippingTo(value: object): boolean;
export declare function OrderShippingToFromJSON(json: any): OrderShippingTo;
export declare function OrderShippingToFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderShippingTo;
export declare function OrderShippingToToJSON(value?: OrderShippingTo | null): any;
