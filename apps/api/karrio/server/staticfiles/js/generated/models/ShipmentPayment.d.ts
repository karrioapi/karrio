 ...
 * @export
 */
export declare const ShipmentPaymentPaidByEnum: {
 ...
 * @export
 */
export declare const ShipmentPaymentCurrencyEnum: {
    readonly Eur: "EUR";
    readonly Aed: "AED";
    readonly Usd: "USD";
    readonly Xcd: "XCD";
 ...
 */
export declare function instanceOfShipmentPayment(value: object): boolean;
export declare function ShipmentPaymentFromJSON(json: any): ShipmentPayment;
export declare function ShipmentPaymentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShipmentPayment;
export declare function ShipmentPaymentToJSON(value?: ShipmentPayment | null): any;
