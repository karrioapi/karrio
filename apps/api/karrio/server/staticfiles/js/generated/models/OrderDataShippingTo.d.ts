 ...
 * @export
 */
export declare const OrderDataShippingToCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfOrderDataShippingTo(value: object): boolean;
export declare function OrderDataShippingToFromJSON(json: any): OrderDataShippingTo;
export declare function OrderDataShippingToFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderDataShippingTo;
export declare function OrderDataShippingToToJSON(value?: OrderDataShippingTo | null): any;
