 ...
 * @export
 */
export declare const CustomsDutyBillingAddressCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
...
/**
 * Check if a given object implements the CustomsDutyBillingAddress interface.
 */
export declare function instanceOfCustomsDutyBillingAddress(value: object): boolean;
export declare function CustomsDutyBillingAddressFromJSON(json: any): CustomsDutyBillingAddress;
export declare function CustomsDutyBillingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomsDutyBillingAddress;
export declare function CustomsDutyBillingAddressToJSON(value?: CustomsDutyBillingAddress | null): any;
