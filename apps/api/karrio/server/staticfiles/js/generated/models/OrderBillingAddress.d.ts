 ...
 * @export
 */
export declare const OrderBillingAddressCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfOrderBillingAddress(value: object): boolean;
export declare function OrderBillingAddressFromJSON(json: any): OrderBillingAddress;
export declare function OrderBillingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderBillingAddress;
export declare function OrderBillingAddressToJSON(value?: OrderBillingAddress | null): any;
