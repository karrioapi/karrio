 ...
 * @export
 */
export declare const OrderDataShippingFromCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfOrderDataShippingFrom(value: object): boolean;
export declare function OrderDataShippingFromFromJSON(json: any): OrderDataShippingFrom;
export declare function OrderDataShippingFromFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderDataShippingFrom;
export declare function OrderDataShippingFromToJSON(value?: OrderDataShippingFrom | null): any;
