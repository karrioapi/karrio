 ...
 * @export
 */
export declare const ShipmentDataShipperCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfShipmentDataShipper(value: object): boolean;
export declare function ShipmentDataShipperFromJSON(json: any): ShipmentDataShipper;
export declare function ShipmentDataShipperFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShipmentDataShipper;
export declare function ShipmentDataShipperToJSON(value?: ShipmentDataShipper | null): any;
