 ...
 * @export
 */
export declare const ShipmentDataBillingAddressCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
...
/**
 * Check if a given object implements the ShipmentDataBillingAddress interface.
 */
export declare function instanceOfShipmentDataBillingAddress(value: object): boolean;
export declare function ShipmentDataBillingAddressFromJSON(json: any): ShipmentDataBillingAddress;
export declare function ShipmentDataBillingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShipmentDataBillingAddress;
export declare function ShipmentDataBillingAddressToJSON(value?: ShipmentDataBillingAddress | null): any;
