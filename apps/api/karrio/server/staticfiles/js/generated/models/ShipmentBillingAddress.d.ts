 ...
 * @export
 */
export declare const ShipmentBillingAddressCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
...
/**
 * Check if a given object implements the ShipmentBillingAddress interface.
 */
export declare function instanceOfShipmentBillingAddress(value: object): boolean;
export declare function ShipmentBillingAddressFromJSON(json: any): ShipmentBillingAddress;
export declare function ShipmentBillingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShipmentBillingAddress;
export declare function ShipmentBillingAddressToJSON(value?: ShipmentBillingAddress | null): any;
