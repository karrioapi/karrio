 ...
 * @export
 */
export declare const ShipmentShipperCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfShipmentShipper(value: object): boolean;
export declare function ShipmentShipperFromJSON(json: any): ShipmentShipper;
export declare function ShipmentShipperFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShipmentShipper;
export declare function ShipmentShipperToJSON(value?: ShipmentShipper | null): any;
