 ...
 * @export
 */
export declare const PickupCancelRequestAddressCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfPickupCancelRequestAddress(value: object): boolean;
export declare function PickupCancelRequestAddressFromJSON(json: any): PickupCancelRequestAddress;
export declare function PickupCancelRequestAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PickupCancelRequestAddress;
export declare function PickupCancelRequestAddressToJSON(value?: PickupCancelRequestAddress | null): any;
