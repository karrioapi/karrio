 ...
 * @export
 */
export declare const OrderShippingFromCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfOrderShippingFrom(value: object): boolean;
export declare function OrderShippingFromFromJSON(json: any): OrderShippingFrom;
export declare function OrderShippingFromFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderShippingFrom;
export declare function OrderShippingFromToJSON(value?: OrderShippingFrom | null): any;
