 ...
 * @export
 */
export declare const PickupAddressCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfPickupAddress(value: object): boolean;
export declare function PickupAddressFromJSON(json: any): PickupAddress;
export declare function PickupAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PickupAddress;
export declare function PickupAddressToJSON(value?: PickupAddress | null): any;
