 ...
 * @export
 */
export declare const LineItemWeightUnitEnum: {
    readonly Kg: "KG";
    readonly Lb: "LB";
};
 ...
 * @export
 */
export declare const LineItemValueCurrencyEnum: {
    readonly Eur: "EUR";
    readonly Aed: "AED";
    readonly Usd: "USD";
    readonly Xcd: "XCD";
 ...
 * @export
 */
export declare const LineItemOriginCountryEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfLineItem(value: object): boolean;
