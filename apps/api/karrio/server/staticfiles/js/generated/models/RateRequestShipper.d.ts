 ...
 * @export
 */
export declare const RateRequestShipperCountryCodeEnum: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
 ...
 */
export declare function instanceOfRateRequestShipper(value: object): boolean;
export declare function RateRequestShipperFromJSON(json: any): RateRequestShipper;
export declare function RateRequestShipperFromJSONTyped(json: any, ignoreDiscriminator: boolean): RateRequestShipper;
export declare function RateRequestShipperToJSON(value?: RateRequestShipper | null): any;
