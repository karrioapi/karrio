var Karrio = (function () {
    ...
    ***************************************************************************** */
    ...
    /* tslint:disable */
    function DocumentTemplateDataToJSON(value) {
        if (value == null) {
            return value;
        }
        return {
    ...
    var DocumentsApi = /** @class */ (function (_super) {
         ...
         * List all upload records
         */
        DocumentsApi.prototype.uploads = function (requestParameters, initOverrides) {
            if (requestParameters === void 0) { requestParameters = {}; }
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
