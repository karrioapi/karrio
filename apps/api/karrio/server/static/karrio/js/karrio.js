var Karrio = (function () {
    ...
    ***************************************************************************** */
     ...
     */
    /**
     * Check if a given object implements the Asendia interface.
     */
    function instanceOfAsendia(value) {
        if (!('username' in value) || value['username'] === undefined)
            return false;
        if (!('password' in value) || value['password'] === undefined)
            return false;
    ...
    function AsendiaToJSON(json) {
        return AsendiaToJSONTyped(json);
    }
    function AsendiaToJSONTyped(value, ignoreDiscriminator) {
        if (value == null) {
            return value;
        }
        return {
    ...
    function CustomsDataFromJSONTyped(json, ignoreDiscriminator) {
        ...
        return {
            'commodities': (json['commodities'].map(CommodityDataFromJSON)),
            'duty': json['duty'] == null ? undefined : DutyFromJSON(json['duty']),
            'duty_billing_address': json['duty_billing_address'] == null ? undefined : AddressDataFromJSON(json['duty_billing_address']),
     ...
     * @export
     */
    function BatchWebhookResendRequestToJSON(json) {
        return BatchWebhookResendRequestToJSONTyped(json);
    }
    function BatchWebhookResendRequestToJSONTyped(value, ignoreDiscriminator) {
        if (value == null) {
            return value;
        }
        return {
     ...
     * @export
     */
    function BatchWebhookResourceFromJSON(json) {
        return BatchWebhookResourceFromJSONTyped(json);
    }
    function BatchWebhookResourceFromJSONTyped(json, ignoreDiscriminator) {
        if (json == null) {
            return json;
        }
        return {
     ...
     * Do not edit the class manually.
     */
    function BatchWebhookResendResponseFromJSON(json) {
        return BatchWebhookResendResponseFromJSONTyped(json);
    }
    function BatchWebhookResendResponseFromJSONTyped(json, ignoreDiscriminator) {
        if (json == null) {
            return json;
        }
        return {
            'object_type': json['object_type'],
            'resources': (json['resources'].map(BatchWebhookResourceFromJSON)),
            'count': json['count'],
            'test_mode': json['test_mode'],
            'created_at': (new Date(json['created_at'])),
        };
    ...
    function ConnectionCredentialsFieldToJSONTyped(value, ignoreDiscriminator) {
        ...
        if (instanceOfAsendia(value)) {
            return AsendiaToJSON(value);
        }
     ...
     */
    /**
     * Check if a given object implements the ShippingDocument interface.
     */
    function ShippingDocumentFromJSON(json) {
        return ShippingDocumentFromJSONTyped(json);
    }
    function ShippingDocumentFromJSONTyped(json, ignoreDiscriminator) {
        if (json == null) {
            return json;
        }
        return {
            ...
            'format': json['format'],
            'print_format': json['print_format'] == null ? undefined : json['print_format'],
    ...
    function ShipmentFromJSONTyped(json, ignoreDiscriminator) {
        ...
        return {
            ...
            'customs': json['customs'] == null ? undefined : CustomsDataFromJSON(json['customs']),
            ...
            'test_mode': json['test_mode'],
            'is_return': json['is_return'] == null ? undefined : json['is_return'],
            'label_url': json['label_url'] == null ? undefined : json['label_url'],
            'invoice_url': json['invoice_url'] == null ? undefined : json['invoice_url'],
            'shipping_documents': json['shipping_documents'] == null ? undefined : (json['shipping_documents'].map(ShippingDocumentFromJSON)),
        };
    }
    ...
    function PickupFromJSONTyped(json, ignoreDiscriminator) {
        ...
        return {
            ...
            'pickup_type': json['pickup_type'] == null ? undefined : json['pickup_type'],
            'recurrence': json['recurrence'] == null ? undefined : json['recurrence'],
            'metadata': json['metadata'] == null ? undefined : json['metadata'],
            'meta': json['meta'] == null ? undefined : json['meta'],
            'carrier_code': json['carrier_code'] == null ? undefined : json['carrier_code'],
            'address': AddressFromJSON(json['address']),
            'parcels': (json['parcels'].map(ParcelFromJSON)),
            'parcels_count': json['parcels_count'] == null ? undefined : json['parcels_count'],
    ...
    function PickupDataToJSONTyped(value, ignoreDiscriminator) {
        ...
        return {
            ...
            'pickup_date': value['pickup_date'],
            'address': AddressDataToJSON(value['address']),
            'parcels_count': value['parcels_count'],
    ...
    function PickupRequestToJSONTyped(value, ignoreDiscriminator) {
        ...
        return {
            ...
            'pickup_date': value['pickup_date'],
            'address': AddressDataToJSON(value['address']),
            'parcels': value['parcels'] == null ? undefined : (value['parcels'].map(ParcelDataToJSON)),
            'parcels_count': value['parcels_count'],
            'ready_time': value['ready_time'],
            'closing_time': value['closing_time'],
            'instruction': value['instruction'],
    ...
    function TrackingEventToJSON(json) {
        return TrackingEventToJSONTyped(json);
    }
    function TrackingEventToJSONTyped(value, ignoreDiscriminator) {
        if (value == null) {
            return value;
        }
        return {
     ...
     * Do not edit the class manually.
     */
    function TrackerEventInjectRequestToJSON(json) {
        return TrackerEventInjectRequestToJSONTyped(json);
    }
    function TrackerEventInjectRequestToJSONTyped(value, ignoreDiscriminator) {
        if (value == null) {
            return value;
        }
        return {
            'events': (value['events'].map(TrackingEventToJSON)),
            'status': value['status'],
            'delivered': value['delivered'],
            'estimated_delivery': value['estimated_delivery'] == null ? value['estimated_delivery'] : value['estimated_delivery'].toISOString().substring(0, 10),
        };
    }
    ...
    var AddressesApi = /** @class */ (function (_super) {
         ...
         */
        AddressesApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
        ...
        AddressesApi.prototype.createRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.createRequestOpts(requestParameters)];
                        case 1:
        ...
        /**
         * Creates request options for discard without sending the request
         */
        AddressesApi.prototype.discardRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        AddressesApi.prototype.discardRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.discardRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         */
        AddressesApi.prototype.listRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        AddressesApi.prototype.listRaw = function (initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.listRequestOpts()];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for retrieve without sending the request
         */
        AddressesApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        AddressesApi.prototype.retrieveRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.retrieveRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         */
        AddressesApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        AddressesApi.prototype.updateRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.updateRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
    ...
    var APIApi = /** @class */ (function (_super) {
        ...
        /**
         * Creates request options for data without sending the request
         */
        APIApi.prototype.dataRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
        ...
        APIApi.prototype.dataRaw = function (initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.dataRequestOpts()];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         */
        APIApi.prototype.pingRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, urlPath;
                return __generator(this, function (_a) {
                    queryParameters = {};
        ...
        APIApi.prototype.pingRaw = function (initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.pingRequestOpts()];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
    ...
    var CarriersApi = /** @class */ (function (_super) {
        ...
        /**
         * Creates request options for getDetails without sending the request
         */
        CarriersApi.prototype.getDetailsRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, urlPath;
                return __generator(this, function (_a) {
        ...
        CarriersApi.prototype.getDetailsRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getDetailsRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         */
        CarriersApi.prototype.getOptionsRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, urlPath;
                return __generator(this, function (_a) {
                    if (requestParameters['carrierName'] == null) {
        ...
        CarriersApi.prototype.getOptionsRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getOptionsRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         */
        CarriersApi.prototype.getServicesRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, urlPath;
                return __generator(this, function (_a) {
                    if (requestParameters['carrierName'] == null) {
        ...
        CarriersApi.prototype.getServicesRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getServicesRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for list without sending the request
         */
        CarriersApi.prototype.listRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, urlPath;
                return __generator(this, function (_a) {
                    queryParameters = {};
    ...
    var ConnectionsApi = /** @class */ (function (_super) {
         ...
         */
        ConnectionsApi.prototype.addRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ConnectionsApi.prototype.addRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.addRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for list without sending the request
         */
        ConnectionsApi.prototype.listRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ConnectionsApi.prototype.listRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.listRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         */
        ConnectionsApi.prototype.removeRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ConnectionsApi.prototype.removeRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.removeRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for retrieve without sending the request
         */
        ConnectionsApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for update without sending the request
         */
        ConnectionsApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
    ...
    var ParcelsApi = /** @class */ (function (_super) {
         ...
         * Creates request options for create without sending the request
         */
        ParcelsApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for discard without sending the request
         */
        ParcelsApi.prototype.discardRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for list without sending the request
         */
        ParcelsApi.prototype.listRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for retrieve without sending the request
         */
        ParcelsApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for update without sending the request
         */
        ParcelsApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
    ...
    var PickupsApi = /** @class */ (function (_super) {
         ...
         */
        PickupsApi.prototype.cancelRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        PickupsApi.prototype.cancelRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.cancelRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for create without sending the request
         */
        PickupsApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            if (requestParameters['pickupData'] == null) {
                                throw new RequiredError('pickupData', 'Required parameter "pickupData" was null or undefined when calling create().');
                            }
                            queryParameters = {};
                            headerParameters = {};
                            headerParameters['Content-Type'] = 'application/json';
         ...
         * Schedule a pickup
         */
        PickupsApi.prototype.createRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var requestOptions, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         * Schedule a pickup
         */
        PickupsApi.prototype.create = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         * Creates request options for list without sending the request
         */
        PickupsApi.prototype.listRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            ...
                            if (requestParameters['confirmationNumber'] != null) {
                                queryParameters['confirmation_number'] = requestParameters['confirmationNumber'];
                            }
                            ...
                            if (requestParameters['pickupDateAfter'] != null) {
                                queryParameters['pickup_date_after'] = requestParameters['pickupDateAfter'].toISOString().substring(0, 10);
                            }
                            if (requestParameters['pickupDateBefore'] != null) {
                                queryParameters['pickup_date_before'] = requestParameters['pickupDateBefore'].toISOString().substring(0, 10);
                            }
         ...
         * List shipment pickups
         */
        PickupsApi.prototype.list = function () {
            return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
                var response;
                if (requestParameters === void 0) { requestParameters = {}; }
                return __generator(this, function (_a) {
         ...
         * Creates request options for retrieve without sending the request
         */
        PickupsApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        /**
         * Creates request options for schedule without sending the request
         * @deprecated
         */
        PickupsApi.prototype.scheduleRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        PickupsApi.prototype.scheduleRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.scheduleRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for update without sending the request
         */
        PickupsApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
    ...
    var ProxyApi = /** @class */ (function (_super) {
        ...
        /**
         * Creates request options for buyLabel without sending the request
         */
        ProxyApi.prototype.buyLabelRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.buyLabelRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.buyLabelRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for cancelPickup without sending the request
         */
        ProxyApi.prototype.cancelPickupRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.cancelPickupRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.cancelPickupRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for fetchRates without sending the request
         */
        ProxyApi.prototype.fetchRatesRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.fetchRatesRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.fetchRatesRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for generateManifest without sending the request
         */
        ProxyApi.prototype.generateManifestRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.generateManifestRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.generateManifestRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         */
        ProxyApi.prototype.getTrackingRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.getTrackingRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getTrackingRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for schedulePickup without sending the request
         */
        ProxyApi.prototype.schedulePickupRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.schedulePickupRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.schedulePickupRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * @deprecated
         */
        ProxyApi.prototype.trackShipmentRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.trackShipmentRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.trackShipmentRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for updatePickup without sending the request
         */
        ProxyApi.prototype.updatePickupRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.updatePickupRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.updatePickupRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for voidLabel without sending the request
         */
        ProxyApi.prototype.voidLabelRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ProxyApi.prototype.voidLabelRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.voidLabelRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
    ...
    var ShipmentsApi = /** @class */ (function (_super) {
         ...
         * Creates request options for cancel without sending the request
         */
        ShipmentsApi.prototype.cancelRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for create without sending the request
         */
        ShipmentsApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        /**
         * Creates request options for document without sending the request
         */
        ShipmentsApi.prototype.documentRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            if (requestParameters['doc'] == null) {
                                throw new RequiredError('doc', 'Required parameter "doc" was null or undefined when calling document().');
                            }
                            if (requestParameters['id'] == null) {
                        ...
                        case 5:
                            ...
                            _g.label = 6;
                        case 6:
                            urlPath = "/v1/shipments/{id}/documents/{doc}";
                            urlPath = urlPath.replace("{".concat("doc", "}"), encodeURIComponent(String(requestParameters['doc'])));
                            urlPath = urlPath.replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id'])));
                            return [2 /*return*/, {
                                    path: urlPath,
                                    method: 'POST',
         ...
         */
        ShipmentsApi.prototype.documentRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var requestOptions, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.documentRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
                            response = _a.sent();
                            return [2 /*return*/, new JSONApiResponse(response, function (jsonValue) { return ShippingDocumentFromJSON(jsonValue); })];
                    }
                });
            });
        };
         ...
         * Retrieve a shipment document
         */
        ShipmentsApi.prototype.document = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.documentRaw(requestParameters, initOverrides)];
                        case 1:
                            response = _a.sent();
                            return [4 /*yield*/, response.value()];
                        case 2: return [2 /*return*/, _a.sent()];
         ...
         * Creates request options for list without sending the request
         */
        ShipmentsApi.prototype.listRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            ...
                            if (requestParameters['isReturn'] != null) {
                                queryParameters['is_return'] = requestParameters['isReturn'];
                            }
                            if (requestParameters['keyword'] != null) {
                                queryParameters['keyword'] = requestParameters['keyword'];
                            }
        ...
        /**
         * Creates request options for purchase without sending the request
         */
        ShipmentsApi.prototype.purchaseRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ShipmentsApi.prototype.purchaseRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.purchaseRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         */
        ShipmentsApi.prototype.ratesRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        ShipmentsApi.prototype.ratesRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ratesRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for retrieve without sending the request
         */
        ShipmentsApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for update without sending the request
         */
        ShipmentsApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
    ...
    var TrackersApi = /** @class */ (function (_super) {
         ...
         * Creates request options for add without sending the request
         */
        TrackersApi.prototype.addRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * @deprecated
         */
        TrackersApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        /**
         * Creates request options for inject without sending the request
         */
        TrackersApi.prototype.injectRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            if (requestParameters['trackerId'] == null) {
                                throw new RequiredError('trackerId', 'Required parameter "trackerId" was null or undefined when calling inject().');
                            }
                            if (requestParameters['trackerEventInjectRequest'] == null) {
                                throw new RequiredError('trackerEventInjectRequest', 'Required parameter "trackerEventInjectRequest" was null or undefined when calling inject().');
                            }
                            queryParameters = {};
                            headerParameters = {};
                            headerParameters['Content-Type'] = 'application/json';
                        ...
                        case 5:
                            ...
                            _g.label = 6;
                        case 6:
                            urlPath = "/v1/trackers/{tracker_id}/inject-events";
                            urlPath = urlPath.replace("{".concat("tracker_id", "}"), encodeURIComponent(String(requestParameters['trackerId'])));
                            return [2 /*return*/, {
                                    path: urlPath,
                                    method: 'POST',
                                    headers: headerParameters,
                                    query: queryParameters,
                                    body: TrackerEventInjectRequestToJSON(requestParameters['trackerEventInjectRequest']),
                                }];
                    }
                });
            });
         ...
         */
        TrackersApi.prototype.injectRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var requestOptions, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.injectRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Inject tracking events
         */
        TrackersApi.prototype.inject = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.injectRaw(requestParameters, initOverrides)];
                        case 1:
                            response = _a.sent();
                            return [4 /*yield*/, response.value()];
                        case 2: return [2 /*return*/, _a.sent()];
         ...
         * Creates request options for list without sending the request
         */
        TrackersApi.prototype.listRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for remove without sending the request
         */
        TrackersApi.prototype.removeRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for retrieve without sending the request
         */
        TrackersApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for update without sending the request
         */
        TrackersApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
    ...
    var WebhooksApi = /** @class */ (function (_super) {
         ...
         * Creates request options for create without sending the request
         */
        WebhooksApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for list without sending the request
         */
        WebhooksApi.prototype.listRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for remove without sending the request
         */
        WebhooksApi.prototype.removeRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for retrieve without sending the request
         */
        WebhooksApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         */
        WebhooksApi.prototype.testRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        WebhooksApi.prototype.testRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.testRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for update without sending the request
         */
        WebhooksApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
    ...
    var OrdersApi = /** @class */ (function (_super) {
         ...
         * Creates request options for cancel without sending the request
         */
        OrdersApi.prototype.cancelRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for create without sending the request
         */
        OrdersApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * @deprecated
         */
        OrdersApi.prototype.dismissRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        OrdersApi.prototype.dismissRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.dismissRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for list without sending the request
         */
        OrdersApi.prototype.listRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for retrieve without sending the request
         */
        OrdersApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for update without sending the request
         */
        OrdersApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
    ...
    var BatchesApi = /** @class */ (function (_super) {
         ...
         */
        BatchesApi.prototype.createOrdersRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        BatchesApi.prototype.createOrdersRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.createOrdersRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for createShipments without sending the request
         */
        BatchesApi.prototype.createShipmentsRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        BatchesApi.prototype.createShipmentsRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.createShipmentsRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for createTrackers without sending the request
         */
        BatchesApi.prototype.createTrackersRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        BatchesApi.prototype.createTrackersRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.createTrackersRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for exportFile without sending the request
         */
        BatchesApi.prototype.exportFileRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        BatchesApi.prototype.exportFileRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.exportFileRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for importFile without sending the request
         */
        BatchesApi.prototype.importFileRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, consumes, canConsumeForm$1, formParams, useForm, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            queryParameters = {};
        ...
        BatchesApi.prototype.importFileRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.importFileRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for list without sending the request
         */
        BatchesApi.prototype.listRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        /**
         * Creates request options for resendWebhooks without sending the request
         */
        BatchesApi.prototype.resendWebhooksRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            if (requestParameters['batchWebhookResendRequest'] == null) {
                                throw new RequiredError('batchWebhookResendRequest', 'Required parameter "batchWebhookResendRequest" was null or undefined when calling resendWebhooks().');
                            }
                            queryParameters = {};
                            headerParameters = {};
                            headerParameters['Content-Type'] = 'application/json';
                        ...
                        case 5:
                            ...
                            _g.label = 6;
                        case 6:
                            urlPath = "/v1/batches/webhooks";
                            return [2 /*return*/, {
                                    path: urlPath,
                                    method: 'POST',
                                    headers: headerParameters,
                                    query: queryParameters,
                                    body: BatchWebhookResendRequestToJSON(requestParameters['batchWebhookResendRequest']),
                                }];
                    }
                });
            });
         ...
         * Resend webhooks
         */
        BatchesApi.prototype.resendWebhooksRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var requestOptions, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.resendWebhooksRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
                            response = _a.sent();
                            return [2 /*return*/, new JSONApiResponse(response, function (jsonValue) { return BatchWebhookResendResponseFromJSON(jsonValue); })];
                    }
                });
            });
        };
         ...
         * Resend webhooks
         */
        BatchesApi.prototype.resendWebhooks = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.resendWebhooksRaw(requestParameters, initOverrides)];
                        case 1:
                            response = _a.sent();
                            return [4 /*yield*/, response.value()];
                        case 2: return [2 /*return*/, _a.sent()];
         ...
         * Creates request options for retrieve without sending the request
         */
        BatchesApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
    ...
    var DocumentsApi = /** @class */ (function (_super) {
         ...
         * Creates request options for create without sending the request
         */
        DocumentsApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for discard without sending the request
         */
        DocumentsApi.prototype.discardRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        /**
         * Creates request options for generateDocument without sending the request
         */
        DocumentsApi.prototype.generateDocumentRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        DocumentsApi.prototype.generateDocumentRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.generateDocumentRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for list without sending the request
         */
        DocumentsApi.prototype.listRequestOpts = function () {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for retrieve without sending the request
         */
        DocumentsApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        /**
         * Creates request options for retrieveUpload without sending the request
         */
        DocumentsApi.prototype.retrieveUploadRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        DocumentsApi.prototype.retrieveUploadRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.retrieveUploadRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
         ...
         * Creates request options for update without sending the request
         */
        DocumentsApi.prototype.updateRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         */
        DocumentsApi.prototype.uploadRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        DocumentsApi.prototype.uploadRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.uploadRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
        ...
        /**
         * Creates request options for uploads without sending the request
         */
        DocumentsApi.prototype.uploadsRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
        ...
        DocumentsApi.prototype.uploadsRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.uploadsRequestOpts(requestParameters)];
                        case 1:
                            requestOptions = _a.sent();
                            return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                        case 2:
    ...
    var ManifestsApi = /** @class */ (function (_super) {
         ...
         * Creates request options for create without sending the request
         */
        ManifestsApi.prototype.createRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for document without sending the request
         */
        ManifestsApi.prototype.documentRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 5:
                            ...
                            _g.label = 6;
                        case 6:
                            urlPath = "/v1/manifests/{id}/document";
                            urlPath = urlPath.replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id'])));
                            return [2 /*return*/, {
                                    path: urlPath,
                                    method: 'POST',
         ...
         */
        ManifestsApi.prototype.documentRaw = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var requestOptions, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         * Retrieve a manifest document
         */
        ManifestsApi.prototype.document = function (requestParameters, initOverrides) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         * Creates request options for list without sending the request
         */
        ManifestsApi.prototype.listRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
         ...
         * Creates request options for retrieve without sending the request
         */
        ManifestsApi.prototype.retrieveRequestOpts = function (requestParameters) {
            return __awaiter(this, void 0, void 0, function () {
                var queryParameters, headerParameters, _a, _b, _c, _d, _e, _f, urlPath;
                return __generator(this, function (_g) {
                    switch (_g.label) {
