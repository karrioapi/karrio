...
description: Connect to 30+ shipping carriers worldwide through a single, unified API
...
Every Karrio project comes with comprehensive carrier connection management, providing seamless integration with 30+ shipping carriers worldwide through a unified API interface, automated credential management, and real-time connection monitoring.

Karrio's Carrier Connections provide a unified API to integrate with 30+ shipping carriers worldwide. Manage all your carrier accounts, credentials, and configurations in one place while maintaining consistent interfaces across different shipping providers.

## Overview

Instead of integrating with dozens of different carrier APIs, each with their own authentication methods, data formats, and business logic, Karrio provides a single, standardized interface.
Whether you're shipping with FedEx, UPS, DHL, or any other supported carrier, the integration process remains consistent.

<div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 my-6">
  <div className="text-sm text-gray-600 dark:text-gray-400 mb-2">
    Carrier Connections Dashboard
  </div>
  <div className="bg-white dark:bg-gray-800 rounded border overflow-hidden">
    <img
      src="/docs/karrio-connections.png"
      alt="Carrier Connections Dashboard"
...
**Need help connecting a carrier?** Join our [community Discord](https://discord.gg/gS88uE7sEx) or check our [carrier-specific guides](/docs/carriers).
