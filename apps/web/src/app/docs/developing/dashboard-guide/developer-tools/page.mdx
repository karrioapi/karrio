...
<div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 my-6">
  ...
  <div className="bg-white dark:bg-gray-800 rounded border overflow-hidden">
    <img
      src="/docs/karrio-developer-navigation.png"
      alt="Developer navigation menu showing all available tools and sections"
      className="w-full h-auto"
    />
  </div>
</div>
...
<div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 my-6">
  ...
  <div className="bg-white dark:bg-gray-800 rounded border overflow-hidden">
    <img
      src="/docs/karrio-api-keys.png"
      alt="API key management showing active keys with usage statistics"
      className="w-full h-auto"
    />
  </div>
</div>
...
<div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 my-6">
  ...
  <div className="bg-white dark:bg-gray-800 rounded border overflow-hidden">
    <img
      src="/docs/karrio-api-logs.png"
      alt="API logs dashboard showing request history with detailed information"
      className="w-full h-auto"
    />
  </div>
</div>
...
<div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 my-6">
  ...
  <div className="bg-white dark:bg-gray-800 rounded border overflow-hidden">
    <img
      src="/docs/karrio-graphiql.png"
      alt="GraphiQL interface showing query builder and response viewer"
      className="w-full h-auto"
    />
  </div>
</div>
