...
```json filename="Response"
{
  ...
  "label_url": "/v1/shipments/ship_a1b2c3d4e5f6/label.pdf",
  "invoice_url": null,
  "label_type": "PDF",
  "service": "canadapost_priority",
  "selected_rate": {
  ...
  "shipping_documents": [
    {
      "category": "label",
      "format": "PDF",
      "url": "/v1/shipments/ship_a1b2c3d4e5f6/label.pdf",
      "base64": "JVBERi0xLjQKJeLjz9MKNSAwIG9iago8PC9..."
    }
  ],
  "meta": {
    "service_name": "CANADAPOST PRIORITY",
...
```json filename="Response"
{
  ...
  "carrier_name": "canadapost",
  "tracking_number": "123456789012",
  "label_url": "/v1/shipments/ship_b2c3d4e5f6g7/label.pdf",
  "invoice_url": null,
  "service": "canadapost_priority",
  "reference": "ORDER-5002",
  "shipping_documents": [
    {
      "category": "label",
      "format": "PDF",
      "url": "/v1/shipments/ship_b2c3d4e5f6g7/label.pdf",
      "base64": "JVBERi0xLjQKJeLjz9MKNSAwIG9iago8PC9..."
    }
  ]
}
...
```json
{
  "shipping_documents": [
    ...
    },
    {
      "category": "invoice",
      "format": "PDF",
      "url": "/v1/shipments/ship_xxxxx/invoice.pdf",
      "base64": "JVBERi0xLjQKMCAwIG9iag..."
    }
  ]
}
```
