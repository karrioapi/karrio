...
| **Manifest**  | `test_create_manifest_request`, `test_create_manifest`, `test_parse_manifest_response`, `test_parse_error_response`                      |
| **Duties**    | `test_create_duties_request`, `test_calculate_duties`, `test_parse_duties_response`, `test_parse_error_response`                         |
| **Insurance** | `test_create_insurance_request`, `test_apply_insurance`, `test_parse_insurance_response`, `test_parse_error_response`                    |
| **Webhook**   | `test_create_webhook_registration_request`, `test_register_webhook`, `test_deregister_webhook`, `test_parse_error_response`              |
...
Remember: Testing is not optional. It's the primary way Karrio ensures consistency across 30+ carrier integrations.
