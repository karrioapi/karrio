...
#
# Generated Tue Jun 12 21:52:59 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/modify_pickup_global_req_2.0.py')
#
# Command line arguments:
#   /py_dhl/xsd/modify-pickup-global-req-2.0.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/modify_pickup_global_req_2.0.py" /py_dhl/xsd/modify-pickup-global-req-2.0.xsd
#
...
class ModifyPURequest(GeneratedsSuper):
    """Root element of modify Pickup Request"""
    subclass = None
    superclass = None
    def __init__(self, schemaVersion=2.0, Request=None, RegionCode=None, ConfirmationNumber=None, Requestor=None, Place=None, Pickup=None, PickupContact=None, OriginSvcArea=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ModifyPURequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ModifyPURequest.subclass:
            return ModifyPURequest.subclass(*args_, **kwargs_)
        else:
            return ModifyPURequest(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            self.OriginSvcArea is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='ModifyPURequest', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ModifyPURequest')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ModifyPURequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ModifyPURequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ModifyPURequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ModifyPURequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ModifyPURequest'
        rootClass = ModifyPURequest
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from modify_pickup_global_req_2.0 import *\n\n')
        sys.stdout.write('import modify_pickup_global_req_2.0 as model_\n\n')
