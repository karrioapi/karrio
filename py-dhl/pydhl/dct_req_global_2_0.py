...
#   ('--no-namespace-defs', '')
#   ('-o', './python/dct_req_global_2_0.py')
#
# Command line arguments:
#   ./schemas/DCT-req_global-2.0.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/dct_req_global_2_0.py" ./schemas/DCT-req_global-2.0.xsd
#
