...
#
# Generated Fri Mar  6 18:34:43 2020 by generateDS.py version 2.35.15.
# Python 3.8.1 (v3.8.1:1b293b6006, Dec 18 2019, 14:08:53)  [Clang 6.0 (clang-600.0.57)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './python/ship_val_global_res.py')
#
# Command line arguments:
#   ./schemas/ship-val-global-res.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/ship_val_global_res.py" ./schemas/ship-val-global-res.xsd
#
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from ship_val_global_res import *\n\n')
        sys.stdout.write('import ship_val_global_res as model_\n\n')
