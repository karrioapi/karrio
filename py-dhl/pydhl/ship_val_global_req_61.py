...
#
# Generated Tue Jun 12 21:55:12 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/ship_val_global_req_6.1.py')
#
# Command line arguments:
#   /py_dhl/xsd/ship-val-global-req-6.1.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/ship_val_global_req_6.1.py" /py_dhl/xsd/ship-val-global-req-6.1.xsd
#
...
class ShipmentRequest(GeneratedsSuper):
    ...
    def get_PiecesEnabled(self): return self.PiecesEnabled
    def set_PiecesEnabled(self, PiecesEnabled): self.PiecesEnabled = PiecesEnabled
    def get_LatinResponseInd(self): return self.LatinResponseInd
    def set_LatinResponseInd(self, LatinResponseInd): self.LatinResponseInd = LatinResponseInd
    ...
    def get_UseDHLInvoice(self): return self.UseDHLInvoice
    def set_UseDHLInvoice(self, UseDHLInvoice): self.UseDHLInvoice = UseDHLInvoice
    def get_DHLInvoiceLanguageCode(self): return self.DHLInvoiceLanguageCode
    def set_DHLInvoiceLanguageCode(self, DHLInvoiceLanguageCode): self.DHLInvoiceLanguageCode = DHLInvoiceLanguageCode
    def get_DHLInvoiceType(self): return self.DHLInvoiceType
    def set_DHLInvoiceType(self, DHLInvoiceType): self.DHLInvoiceType = DHLInvoiceType
    ...
    def get_EProcShip(self): return self.EProcShip
    def set_EProcShip(self, EProcShip): self.EProcShip = EProcShip
    def get_Airwaybill(self): return self.Airwaybill
    def set_Airwaybill(self, Airwaybill): self.Airwaybill = Airwaybill
    def get_DocImages(self): return self.DocImages
    def set_DocImages(self, DocImages): self.DocImages = DocImages
    ...
    def get_RequestArchiveDoc(self): return self.RequestArchiveDoc
    def set_RequestArchiveDoc(self, RequestArchiveDoc): self.RequestArchiveDoc = RequestArchiveDoc
    def get_NumberOfArchiveDoc(self): return self.NumberOfArchiveDoc
    def set_NumberOfArchiveDoc(self, NumberOfArchiveDoc): self.NumberOfArchiveDoc = NumberOfArchiveDoc
    def get_Label(self): return self.Label
    def set_Label(self, Label): self.Label = Label
    def get_ODDLinkReq(self): return self.ODDLinkReq
    def set_ODDLinkReq(self, ODDLinkReq): self.ODDLinkReq = ODDLinkReq
    ...
    def validate_LanguageCode(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 2:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on LanguageCode' % {"value" : value.encode("utf-8")} )
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on PiecesEnabled' % {"value" : value.encode("utf-8")} )
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on InvLanguageCode' % {"value" : value.encode("utf-8")} )
            if len(value) > 2:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on InvLanguageCode' % {"value" : value.encode("utf-8")} )
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on InvoiceType' % {"value" : value.encode("utf-8")} )
            if len(value) > 3:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on InvoiceType' % {"value" : value.encode("utf-8")} )
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on LabelImageFormat' % {"value" : value.encode("utf-8")} )
            if len(value) > 4:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on LabelImageFormat' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on LabelImageFormat' % {"value" : value.encode("utf-8")} )
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on NumberOfArchiveDoc' % {"value" : value.encode("utf-8")} )
            if value > 2:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on NumberOfArchiveDoc' % {"value" : value} )
    def hasContent_(self):
        if (
            ...
            self.DGs is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='ShipmentRequest', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='', name_='ShipmentRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ShipmentRequest'):
        if self.schemaVersion != 6.1 and 'schemaVersion' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ShipmentRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.RequestedPickupTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RequestedPickupTime>%s</RequestedPickupTime>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RequestedPickupTime), input_name='RequestedPickupTime')), eol_))
        ...
        if self.LanguageCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<LanguageCode>%s</LanguageCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LanguageCode), input_name='LanguageCode')), eol_))
        if self.PiecesEnabled is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<PiecesEnabled>%s</PiecesEnabled>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.PiecesEnabled), input_name='PiecesEnabled')), eol_))
        if self.LatinResponseInd is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<LatinResponseInd>%s</LatinResponseInd>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LatinResponseInd), input_name='LatinResponseInd')), eol_))
        ...
        if self.UseDHLInvoice != "N":
            showIndent(outfile, level, pretty_print)
            outfile.write('<UseDHLInvoice>%s</UseDHLInvoice>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.UseDHLInvoice), input_name='UseDHLInvoice')), eol_))
        if self.DHLInvoiceLanguageCode != "en":
            showIndent(outfile, level, pretty_print)
            outfile.write('<DHLInvoiceLanguageCode>%s</DHLInvoiceLanguageCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DHLInvoiceLanguageCode), input_name='DHLInvoiceLanguageCode')), eol_))
        if self.DHLInvoiceType != "CMI":
            showIndent(outfile, level, pretty_print)
            outfile.write('<DHLInvoiceType>%s</DHLInvoiceType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DHLInvoiceType), input_name='DHLInvoiceType')), eol_))
        ...
        if self.Place is not None:
            self.Place.export(outfile, level, namespace_, name_='Place', pretty_print=pretty_print)
        if self.EProcShip is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<EProcShip>%s</EProcShip>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EProcShip), input_name='EProcShip')), eol_))
        if self.Airwaybill is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Airwaybill>%s</Airwaybill>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Airwaybill), input_name='Airwaybill')), eol_))
        if self.DocImages is not None:
            self.DocImages.export(outfile, level, namespace_, name_='DocImages', pretty_print=pretty_print)
        if self.LabelImageFormat is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<LabelImageFormat>%s</LabelImageFormat>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LabelImageFormat), input_name='LabelImageFormat')), eol_))
        if self.RequestArchiveDoc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RequestArchiveDoc>%s</RequestArchiveDoc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RequestArchiveDoc), input_name='RequestArchiveDoc')), eol_))
        if self.NumberOfArchiveDoc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NumberOfArchiveDoc>%s</NumberOfArchiveDoc>%s' % (self.gds_format_integer(self.NumberOfArchiveDoc, input_name='NumberOfArchiveDoc'), eol_))
        if self.Label is not None:
            self.Label.export(outfile, level, namespace_, name_='Label', pretty_print=pretty_print)
        if self.ODDLinkReq is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ODDLinkReq>%s</ODDLinkReq>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ODDLinkReq), input_name='ODDLinkReq')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Request':
            ...
            RequestedPickupTime_ = child_.text
            RequestedPickupTime_ = self.gds_validate_string(RequestedPickupTime_, node, 'RequestedPickupTime')
            self.RequestedPickupTime = RequestedPickupTime_
            # validate type YesNo
            self.validate_YesNo(self.RequestedPickupTime)
            ...
            PiecesEnabled_ = child_.text
            PiecesEnabled_ = self.gds_validate_string(PiecesEnabled_, node, 'PiecesEnabled')
            self.PiecesEnabled = PiecesEnabled_
            # validate type PiecesEnabled
            self.validate_PiecesEnabled(self.PiecesEnabled)
        elif nodeName_ == 'LatinResponseInd':
            LatinResponseInd_ = child_.text
            LatinResponseInd_ = self.gds_validate_string(LatinResponseInd_, node, 'LatinResponseInd')
            self.LatinResponseInd = LatinResponseInd_
            # validate type YesNo
            self.validate_YesNo(self.LatinResponseInd)
            ...
            UseDHLInvoice_ = child_.text
            UseDHLInvoice_ = self.gds_validate_string(UseDHLInvoice_, node, 'UseDHLInvoice')
            self.UseDHLInvoice = UseDHLInvoice_
            # validate type YesNo
            self.validate_YesNo(self.UseDHLInvoice)
        elif nodeName_ == 'DHLInvoiceLanguageCode':
            DHLInvoiceLanguageCode_ = child_.text
            DHLInvoiceLanguageCode_ = self.gds_validate_string(DHLInvoiceLanguageCode_, node, 'DHLInvoiceLanguageCode')
            self.DHLInvoiceLanguageCode = DHLInvoiceLanguageCode_
            # validate type InvLanguageCode
            self.validate_InvLanguageCode(self.DHLInvoiceLanguageCode)
        elif nodeName_ == 'DHLInvoiceType':
            DHLInvoiceType_ = child_.text
            DHLInvoiceType_ = self.gds_validate_string(DHLInvoiceType_, node, 'DHLInvoiceType')
            self.DHLInvoiceType = DHLInvoiceType_
            ...
            EProcShip_ = child_.text
            EProcShip_ = self.gds_validate_string(EProcShip_, node, 'EProcShip')
            self.EProcShip = EProcShip_
            # validate type YesNo
            self.validate_YesNo(self.EProcShip)
        elif nodeName_ == 'Airwaybill':
            Airwaybill_ = child_.text
            Airwaybill_ = self.gds_validate_string(Airwaybill_, node, 'Airwaybill')
            self.Airwaybill = Airwaybill_
            # validate type AWBNumber
            self.validate_AWBNumber(self.Airwaybill)
        elif nodeName_ == 'DocImages':
            obj_ = DocImages.factory()
            obj_.build(child_)
            self.DocImages = obj_
            obj_.original_tagname_ = 'DocImages'
        elif nodeName_ == 'LabelImageFormat':
            LabelImageFormat_ = child_.text
            LabelImageFormat_ = self.gds_validate_string(LabelImageFormat_, node, 'LabelImageFormat')
            self.LabelImageFormat = LabelImageFormat_
            # validate type LabelImageFormat
            self.validate_LabelImageFormat(self.LabelImageFormat)
        elif nodeName_ == 'RequestArchiveDoc':
            RequestArchiveDoc_ = child_.text
            RequestArchiveDoc_ = self.gds_validate_string(RequestArchiveDoc_, node, 'RequestArchiveDoc')
            self.RequestArchiveDoc = RequestArchiveDoc_
            # validate type YesNo
            self.validate_YesNo(self.RequestArchiveDoc)
        elif nodeName_ == 'NumberOfArchiveDoc':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            ...
            ODDLinkReq_ = child_.text
            ODDLinkReq_ = self.gds_validate_string(ODDLinkReq_, node, 'ODDLinkReq')
            self.ODDLinkReq = ODDLinkReq_
            # validate type YesNo
            self.validate_YesNo(self.ODDLinkReq)
        elif nodeName_ == 'DGs':
            obj_ = DGs.factory()
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ship_val_global_req_6.1 import *\n\n')
        sys.stdout.write('import ship_val_global_req_6.1 as model_\n\n')
