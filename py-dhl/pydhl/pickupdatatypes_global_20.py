...
#
# Generated Tue Jun 12 21:24:01 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', 'pydhl/pickupdatatypes_global_2.0.py')
#
# Command line arguments:
#   ./xsd/pickupdatatypes_global-2.0.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "pydhl/pickupdatatypes_global_2.0.py" ./xsd/pickupdatatypes_global-2.0.xsd
#
...
class Place(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, LocationType=None, CompanyName=None, Address1=None, Address2=None, PackageLocation=None, City=None, StateCode=None, DivisionName=None, CountryCode=None, PostalCode=None, RouteCode=None, Suburb=None):
        self.original_tagname_ = None
    ...
    def get_StateCode(self): return self.StateCode
    def set_StateCode(self, StateCode): self.StateCode = StateCode
    def get_DivisionName(self): return self.DivisionName
    def set_DivisionName(self, DivisionName): self.DivisionName = DivisionName
    ...
    def get_RouteCode(self): return self.RouteCode
    def set_RouteCode(self, RouteCode): self.RouteCode = RouteCode
    ...
    def validate_LocationTypeType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on LocationTypeType' % {"value" : value.encode("utf-8")} )
            if len(value) > 1:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on LocationTypeType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on LocationTypeType' % {"value" : value.encode("utf-8")} )
    ...
    def validate_Address1Type(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on Address1Type' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on Address1Type' % {"value" : value.encode("utf-8")} )
    def validate_Address2Type(self, value):
        # Validate type Address2Type, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on Address2Type' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on Address2Type' % {"value" : value.encode("utf-8")} )
    def validate_PackageLocationType(self, value):
        # Validate type PackageLocationType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on PackageLocationType' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on PackageLocationType' % {"value" : value.encode("utf-8")} )
    ...
    def validate_RouteCodeType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 4:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on RouteCodeType' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on RouteCodeType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_RouteCodeType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_RouteCodeType_patterns_, ))
    validate_RouteCodeType_patterns_ = [['^([A-Z0-9]{4})$']]
    ...
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Place', fromsubclass_=False, pretty_print=True):
        ...
        if self.LocationType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LocationType>%s</dhlPickup:LocationType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LocationType), input_name='LocationType')), eol_))
        ...
        if self.Address1 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Address1>%s</dhlPickup:Address1>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Address1), input_name='Address1')), eol_))
        if self.Address2 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Address2>%s</dhlPickup:Address2>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Address2), input_name='Address2')), eol_))
        ...
        if self.StateCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:StateCode>%s</dhlPickup:StateCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.StateCode), input_name='StateCode')), eol_))
        if self.DivisionName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DivisionName>%s</dhlPickup:DivisionName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DivisionName), input_name='DivisionName')), eol_))
        ...
        if self.RouteCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:RouteCode>%s</dhlPickup:RouteCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RouteCode), input_name='RouteCode')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'LocationType':
            ...
            StateCode_ = child_.text
            StateCode_ = self.gds_validate_string(StateCode_, node, 'StateCode')
            self.StateCode = StateCode_
            # validate type DivisionCode
            self.validate_DivisionCode(self.StateCode)
        elif nodeName_ == 'DivisionName':
            DivisionName_ = child_.text
            DivisionName_ = self.gds_validate_string(DivisionName_, node, 'DivisionName')
            self.DivisionName = DivisionName_
            ...
            RouteCode_ = child_.text
            RouteCode_ = self.gds_validate_string(RouteCode_, node, 'RouteCode')
            self.RouteCode = RouteCode_
...
class Requestor(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, AccountType=None, AccountNumber=None, RequestorContact=None, CompanyName=None, Address1=None, Address2=None, City=None, CountryCode=None, DivisionName=None, PostalCode=None):
        self.original_tagname_ = None
        ...
        self.Address1 = Address1
        self.validate_Address1Type1(self.Address1)
        self.Address2 = Address2
        self.validate_Address2Type2(self.Address2)
        self.City = City
        self.validate_City(self.City)
        self.CountryCode = CountryCode
        self.validate_CountryCode(self.CountryCode)
    ...
    def validate_Address1Type1(self, value):
        # Validate type Address1Type1, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on Address1Type1' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on Address1Type1' % {"value" : value.encode("utf-8")} )
    def validate_Address2Type2(self, value):
        # Validate type Address2Type2, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on Address2Type2' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on Address2Type2' % {"value" : value.encode("utf-8")} )
    def validate_City(self, value):
        # Validate type City, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'AccountType':
            ...
            Address1_ = self.gds_validate_string(Address1_, node, 'Address1')
            self.Address1 = Address1_
            # validate type Address1Type1
            self.validate_Address1Type1(self.Address1)
        elif nodeName_ == 'Address2':
            Address2_ = child_.text
            Address2_ = self.gds_validate_string(Address2_, node, 'Address2')
            self.Address2 = Address2_
            # validate type Address2Type2
            self.validate_Address2Type2(self.Address2)
        elif nodeName_ == 'City':
            City_ = child_.text
            City_ = self.gds_validate_string(City_, node, 'City')
...
class Pickup(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, PickupDate=None, ReadyByTime=None, CloseTime=None, AfterHoursClosingTime=None, AfterHoursLocation=None, Pieces=None, RemotePickupFlag=None, weight=None, SpecialInstructions=None):
        self.original_tagname_ = None
        ...
        self.validate_YesNo(self.RemotePickupFlag)
        self.weight = weight
    ...
    def validate_TimeHM(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) != 5:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on TimeHM' % {"value" : value} )
            if not self.gds_validate_simple_patterns(
                    self.validate_TimeHM_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_TimeHM_patterns_, ))
    validate_TimeHM_patterns_ = [['^([0-1][0-9]$|^2[0-3]):([0-5][0-9])$']]
    ...
    def hasContent_(self):
        if (
            ...
            self.RemotePickupFlag is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Pickup', fromsubclass_=False, pretty_print=True):
        ...
        if self.ReadyByTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ReadyByTime>%s</dhlPickup:ReadyByTime>%s' % (self.gds_format_time(self.ReadyByTime, input_name='ReadyByTime'), eol_))
        if self.CloseTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CloseTime>%s</dhlPickup:CloseTime>%s' % (self.gds_format_time(self.CloseTime, input_name='CloseTime'), eol_))
        if self.AfterHoursClosingTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:AfterHoursClosingTime>%s</dhlPickup:AfterHoursClosingTime>%s' % (self.gds_format_time(self.AfterHoursClosingTime, input_name='AfterHoursClosingTime'), eol_))
        ...
        if self.RemotePickupFlag is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:RemotePickupFlag>%s</dhlPickup:RemotePickupFlag>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RemotePickupFlag), input_name='RemotePickupFlag')), eol_))
...
class RequestorContact(GeneratedsSuper):
    ...
    def __init__(self, PersonName=None, Phone=None, PhoneExtension=None):
        self.original_tagname_ = None
        self.PersonName = PersonName
        self.validate_PersonNameType3(self.PersonName)
        self.Phone = Phone
        self.validate_PhoneType4(self.Phone)
        self.PhoneExtension = PhoneExtension
        self.validate_PhoneExtensionType5(self.PhoneExtension)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_PhoneExtension(self): return self.PhoneExtension
    def set_PhoneExtension(self, PhoneExtension): self.PhoneExtension = PhoneExtension
    def validate_PersonNameType3(self, value):
        # Validate type PersonNameType3, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on PersonNameType3' % {"value" : value.encode("utf-8")} )
    def validate_PhoneType4(self, value):
        # Validate type PhoneType4, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 25:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on PhoneType4' % {"value" : value.encode("utf-8")} )
    def validate_PhoneExtensionType5(self, value):
        # Validate type PhoneExtensionType5, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 5:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on PhoneExtensionType5' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            self.PersonName is not None or
            self.Phone is not None or
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PersonName':
            ...
            PersonName_ = self.gds_validate_string(PersonName_, node, 'PersonName')
            self.PersonName = PersonName_
            # validate type PersonNameType3
            self.validate_PersonNameType3(self.PersonName)
        elif nodeName_ == 'Phone':
            Phone_ = child_.text
            Phone_ = self.gds_validate_string(Phone_, node, 'Phone')
            self.Phone = Phone_
            # validate type PhoneType4
            self.validate_PhoneType4(self.Phone)
        elif nodeName_ == 'PhoneExtension':
            PhoneExtension_ = child_.text
            PhoneExtension_ = self.gds_validate_string(PhoneExtension_, node, 'PhoneExtension')
            self.PhoneExtension = PhoneExtension_
            # validate type PhoneExtensionType5
            self.validate_PhoneExtensionType5(self.PhoneExtension)
...
class Piece(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Weight=None, Width=None, Height=None, Depth=None):
        self.original_tagname_ = None
        self.Weight = Weight
...
class ShipmentDetails(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, AccountType=None, AccountNumber=None, BillToAccountNumber=None, AWBNumber=None, NumberOfPieces=None, Weight=None, WeightUnit=None, GlobalProductCode=None, LocalProductCode=None, DestinationServiceAreaCode=None, DoorTo=None, DimensionUnit=None, InsuredAmount=None, InsuredCurrencyCode=None, Pieces=None, SpecialService=None):
        self.original_tagname_ = None
        self.AccountType = AccountType
        self.validate_AccountTypeType6(self.AccountType)
        self.AccountNumber = AccountNumber
        self.validate_AccountNumber(self.AccountNumber)
        ...
        self.DestinationServiceAreaCode = DestinationServiceAreaCode
        self.validate_DestinationServiceAreaCode(self.DestinationServiceAreaCode)
        self.DoorTo = DoorTo
    ...
    def get_AccountNumber(self): return self.AccountNumber
    def set_AccountNumber(self, AccountNumber): self.AccountNumber = AccountNumber
    def get_BillToAccountNumber(self): return self.BillToAccountNumber
    def set_BillToAccountNumber(self, BillToAccountNumber): self.BillToAccountNumber = BillToAccountNumber
    ...
    def get_DestinationServiceAreaCode(self): return self.DestinationServiceAreaCode
    def set_DestinationServiceAreaCode(self, DestinationServiceAreaCode): self.DestinationServiceAreaCode = DestinationServiceAreaCode
    ...
    def get_InsuredCurrencyCode(self): return self.InsuredCurrencyCode
    def set_InsuredCurrencyCode(self, InsuredCurrencyCode): self.InsuredCurrencyCode = InsuredCurrencyCode
    def get_Pieces(self): return self.Pieces
    def set_Pieces(self, Pieces): self.Pieces = Pieces
    ...
    def validate_AccountTypeType6(self, value):
        # Validate type AccountTypeType6, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['D']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on AccountTypeType6' % {"value" : value.encode("utf-8")} )
            if len(value) > 1:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on AccountTypeType6' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on AccountTypeType6' % {"value" : value.encode("utf-8")} )
    def validate_AccountNumber(self, value):
        # Validate type AccountNumber, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 12:
    ...
    def validate_DestinationServiceAreaCode(self, value):
        # Validate type DestinationServiceAreaCode, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 3:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on DestinationServiceAreaCode' % {"value" : value.encode("utf-8")} )
    ...
    def hasContent_(self):
        if (
            ...
            self.DestinationServiceAreaCode is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ShipmentDetails', fromsubclass_=False, pretty_print=True):
        ...
        if self.BillToAccountNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:BillToAccountNumber>%s</dhlPickup:BillToAccountNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToAccountNumber), input_name='BillToAccountNumber')), eol_))
        if self.AWBNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:AWBNumber>%s</dhlPickup:AWBNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AWBNumber), input_name='AWBNumber')), eol_))
        ...
        if self.DestinationServiceAreaCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DestinationServiceAreaCode>%s</dhlPickup:DestinationServiceAreaCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DestinationServiceAreaCode), input_name='DestinationServiceAreaCode')), eol_))
        ...
        if self.InsuredCurrencyCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:InsuredCurrencyCode>%s</dhlPickup:InsuredCurrencyCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InsuredCurrencyCode), input_name='InsuredCurrencyCode')), eol_))
        if self.Pieces is not None:
        ...
        for SpecialService_ in self.SpecialService:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:SpecialService>%s</dhlPickup:SpecialService>%s' % (self.gds_encode(self.gds_format_string(quote_xml(SpecialService_), input_name='SpecialService')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'AccountType':
            ...
            AccountType_ = self.gds_validate_string(AccountType_, node, 'AccountType')
            self.AccountType = AccountType_
            # validate type AccountTypeType6
            self.validate_AccountTypeType6(self.AccountType)
        elif nodeName_ == 'AccountNumber':
            AccountNumber_ = child_.text
            AccountNumber_ = self.gds_validate_string(AccountNumber_, node, 'AccountNumber')
            ...
            BillToAccountNumber_ = child_.text
            BillToAccountNumber_ = self.gds_validate_string(BillToAccountNumber_, node, 'BillToAccountNumber')
            self.BillToAccountNumber = BillToAccountNumber_
            # validate type AccountNumber
            self.validate_AccountNumber(self.BillToAccountNumber)
            ...
            self.validate_LocalProductCode(self.LocalProductCode)
        elif nodeName_ == 'DestinationServiceAreaCode':
            DestinationServiceAreaCode_ = child_.text
            DestinationServiceAreaCode_ = self.gds_validate_string(DestinationServiceAreaCode_, node, 'DestinationServiceAreaCode')
            self.DestinationServiceAreaCode = DestinationServiceAreaCode_
            # validate type DestinationServiceAreaCode
            self.validate_DestinationServiceAreaCode(self.DestinationServiceAreaCode)
            ...
            InsuredCurrencyCode_ = child_.text
            InsuredCurrencyCode_ = self.gds_validate_string(InsuredCurrencyCode_, node, 'InsuredCurrencyCode')
            self.InsuredCurrencyCode = InsuredCurrencyCode_
...
class ConsigneeDetails(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, CompanyName=None, AddressLine=None, City=None, CountryCode=None, PostalCode=None, Contact=None):
        self.original_tagname_ = None
        self.CompanyName = CompanyName
        self.validate_CompanyNameValidator(self.CompanyName)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsigneeDetails)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsigneeDetails.subclass:
            return ConsigneeDetails.subclass(*args_, **kwargs_)
        else:
            return ConsigneeDetails(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_CompanyName(self): return self.CompanyName
    def set_CompanyName(self, CompanyName): self.CompanyName = CompanyName
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ConsigneeDetails', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ConsigneeDetails')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ConsigneeDetails')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ConsigneeDetails', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ConsigneeDetails'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ConsigneeDetails', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class ConsigneeDetails


class Contact(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, PersonName=None, Phone=None, Email=None):
        self.original_tagname_ = None
        self.PersonName = PersonName
        self.validate_PersonName(self.PersonName)
        self.Phone = Phone
        self.validate_PhoneNumber(self.Phone)
        self.Email = Email
    ...
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Contact', fromsubclass_=False, pretty_print=True):
        ...
        if self.Email is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Email>%s</dhlPickup:Email>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Email), input_name='Email')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class DataTypes(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='DataTypes', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='DataTypes', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='DataTypes'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='DataTypes', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class Billing(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Billing', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Billing', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Billing'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Billing', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ShipperAccountNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipperAccountNumber>%s</dhlPickup:ShipperAccountNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipperAccountNumber), input_name='ShipperAccountNumber')), eol_))
        if self.ShippingPaymentType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShippingPaymentType>%s</dhlPickup:ShippingPaymentType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShippingPaymentType), input_name='ShippingPaymentType')), eol_))
        if self.BillingAccountNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:BillingAccountNumber>%s</dhlPickup:BillingAccountNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillingAccountNumber), input_name='BillingAccountNumber')), eol_))
        if self.DutyPaymentType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DutyPaymentType>%s</dhlPickup:DutyPaymentType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DutyPaymentType), input_name='DutyPaymentType')), eol_))
        if self.DutyAccountNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DutyAccountNumber>%s</dhlPickup:DutyAccountNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DutyAccountNumber), input_name='DutyAccountNumber')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Commodity(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Commodity', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Commodity', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Commodity'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Commodity', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.CommodityCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CommodityCode>%s</dhlPickup:CommodityCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CommodityCode), input_name='CommodityCode')), eol_))
        if self.CommodityName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CommodityName>%s</dhlPickup:CommodityName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CommodityName), input_name='CommodityName')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Consignee(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Consignee', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Consignee', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Consignee'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Consignee', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.SuiteDepartmentName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:SuiteDepartmentName>%s</dhlPickup:SuiteDepartmentName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SuiteDepartmentName), input_name='SuiteDepartmentName')), eol_))
        for AddressLine_ in self.AddressLine:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:AddressLine>%s</dhlPickup:AddressLine>%s' % (self.gds_encode(self.gds_format_string(quote_xml(AddressLine_), input_name='AddressLine')), eol_))
        if self.City is not None:
        ...
        if self.CountryName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CountryName>%s</dhlPickup:CountryName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CountryName), input_name='CountryName')), eol_))
        if self.FederalTaxId is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:FederalTaxId>%s</dhlPickup:FederalTaxId>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.FederalTaxId), input_name='FederalTaxId')), eol_))
        if self.StateTaxId is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:StateTaxId>%s</dhlPickup:StateTaxId>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.StateTaxId), input_name='StateTaxId')), eol_))
        if self.Contact is not None:
            self.Contact.export(outfile, level, namespace_, name_='Contact', pretty_print=pretty_print)
        if self.Suburb is not None:
            showIndent(outfile, level, pretty_print)
...
class Dutiable(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Dutiable', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Dutiable', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Dutiable'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Dutiable', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.DeclaredValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DeclaredValue>%s</dhlPickup:DeclaredValue>%s' % (self.gds_format_float(self.DeclaredValue, input_name='DeclaredValue'), eol_))
        if self.DeclaredCurrency is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DeclaredCurrency>%s</dhlPickup:DeclaredCurrency>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DeclaredCurrency), input_name='DeclaredCurrency')), eol_))
        if self.ScheduleB is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ScheduleB>%s</dhlPickup:ScheduleB>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ScheduleB), input_name='ScheduleB')), eol_))
        if self.ExportLicense is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ExportLicense>%s</dhlPickup:ExportLicense>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ExportLicense), input_name='ExportLicense')), eol_))
        if self.ShipperEIN is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipperEIN>%s</dhlPickup:ShipperEIN>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipperEIN), input_name='ShipperEIN')), eol_))
        if self.ShipperIDType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipperIDType>%s</dhlPickup:ShipperIDType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipperIDType), input_name='ShipperIDType')), eol_))
        if self.ConsigneeIDType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ConsigneeIDType>%s</dhlPickup:ConsigneeIDType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ConsigneeIDType), input_name='ConsigneeIDType')), eol_))
        if self.ImportLicense is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ImportLicense>%s</dhlPickup:ImportLicense>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ImportLicense), input_name='ImportLicense')), eol_))
        if self.ConsigneeEIN is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ConsigneeEIN>%s</dhlPickup:ConsigneeEIN>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ConsigneeEIN), input_name='ConsigneeEIN')), eol_))
        if self.TermsOfTrade is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:TermsOfTrade>%s</dhlPickup:TermsOfTrade>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TermsOfTrade), input_name='TermsOfTrade')), eol_))
        if self.CommerceLicensed is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CommerceLicensed>%s</dhlPickup:CommerceLicensed>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CommerceLicensed), input_name='CommerceLicensed')), eol_))
...
class Filing(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Filing', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Filing', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Filing'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Filing', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.FilingType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:FilingType>%s</dhlPickup:FilingType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.FilingType), input_name='FilingType')), eol_))
        if self.FTSR is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:FTSR>%s</dhlPickup:FTSR>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.FTSR), input_name='FTSR')), eol_))
        if self.ITN is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ITN>%s</dhlPickup:ITN>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ITN), input_name='ITN')), eol_))
        if self.AES4EIN is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:AES4EIN>%s</dhlPickup:AES4EIN>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AES4EIN), input_name='AES4EIN')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ExportDeclaration(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ExportDeclaration', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ExportDeclaration', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ExportDeclaration'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ExportDeclaration', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.InterConsignee is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:InterConsignee>%s</dhlPickup:InterConsignee>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InterConsignee), input_name='InterConsignee')), eol_))
        if self.IsPartiesRelation is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:IsPartiesRelation>%s</dhlPickup:IsPartiesRelation>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.IsPartiesRelation), input_name='IsPartiesRelation')), eol_))
        if self.ECCN is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ECCN>%s</dhlPickup:ECCN>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ECCN), input_name='ECCN')), eol_))
        if self.SignatureName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:SignatureName>%s</dhlPickup:SignatureName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SignatureName), input_name='SignatureName')), eol_))
        if self.SignatureTitle is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:SignatureTitle>%s</dhlPickup:SignatureTitle>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SignatureTitle), input_name='SignatureTitle')), eol_))
        if self.ExportReason is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ExportReason>%s</dhlPickup:ExportReason>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ExportReason), input_name='ExportReason')), eol_))
        if self.ExportReasonCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ExportReasonCode>%s</dhlPickup:ExportReasonCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ExportReasonCode), input_name='ExportReasonCode')), eol_))
        if self.SedNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:SedNumber>%s</dhlPickup:SedNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SedNumber), input_name='SedNumber')), eol_))
        if self.SedNumberType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:SedNumberType>%s</dhlPickup:SedNumberType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SedNumberType), input_name='SedNumberType')), eol_))
        if self.MxStateCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:MxStateCode>%s</dhlPickup:MxStateCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.MxStateCode), input_name='MxStateCode')), eol_))
...
class ExportLineItem(GeneratedsSuper):
    ...
    def __init__(self, LineNumber=None, Quantity=None, QuantityUnit=None, Description=None, Value=None, IsDomestic=None, CommodityCode=None, ScheduleB=None, ECCN=None, Weight=None, License=None, LicenseSymbol=None, ManufactureCountryCode=None):
        ...
        self.validate_ScheduleB(self.ScheduleB)
        self.ECCN = ECCN
        self.validate_ECCNType7(self.ECCN)
        self.Weight = Weight
    ...
    def validate_ScheduleB(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on ScheduleB' % {"value" : value.encode("utf-8")} )
    def validate_ECCNType7(self, value):
        # Validate type ECCNType7, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 11:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on ECCNType7' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on ECCNType7' % {"value" : value.encode("utf-8")} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ExportLineItem', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ExportLineItem', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ExportLineItem'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ExportLineItem', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.LineNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LineNumber>%s</dhlPickup:LineNumber>%s' % (self.gds_format_integer(self.LineNumber, input_name='LineNumber'), eol_))
        if self.Quantity is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Quantity>%s</dhlPickup:Quantity>%s' % (self.gds_format_integer(self.Quantity, input_name='Quantity'), eol_))
        if self.QuantityUnit is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:QuantityUnit>%s</dhlPickup:QuantityUnit>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.QuantityUnit), input_name='QuantityUnit')), eol_))
        if self.Description is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Description>%s</dhlPickup:Description>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Description), input_name='Description')), eol_))
        if self.Value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Value>%s</dhlPickup:Value>%s' % (self.gds_format_float(self.Value, input_name='Value'), eol_))
        if self.IsDomestic is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:IsDomestic>%s</dhlPickup:IsDomestic>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.IsDomestic), input_name='IsDomestic')), eol_))
        if self.CommodityCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CommodityCode>%s</dhlPickup:CommodityCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CommodityCode), input_name='CommodityCode')), eol_))
        if self.ScheduleB is not None:
        ...
        if self.LicenseSymbol is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LicenseSymbol>%s</dhlPickup:LicenseSymbol>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LicenseSymbol), input_name='LicenseSymbol')), eol_))
        if self.ManufactureCountryCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ManufactureCountryCode>%s</dhlPickup:ManufactureCountryCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ManufactureCountryCode), input_name='ManufactureCountryCode')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Pieces(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Pieces', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Pieces', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Pieces'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Pieces', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ShipValResponsePiece(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ShipValResponsePiece', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ShipValResponsePiece', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ShipValResponsePiece'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ShipValResponsePiece', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.PieceNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:PieceNumber>%s</dhlPickup:PieceNumber>%s' % (self.gds_format_integer(self.PieceNumber, input_name='PieceNumber'), eol_))
        if self.Depth is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Depth>%s</dhlPickup:Depth>%s' % (self.gds_format_integer(self.Depth, input_name='Depth'), eol_))
        if self.Width is not None:
        ...
        if self.DataIdentifier is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DataIdentifier>%s</dhlPickup:DataIdentifier>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DataIdentifier), input_name='DataIdentifier')), eol_))
        if self.LicensePlate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LicensePlate>%s</dhlPickup:LicensePlate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LicensePlate), input_name='LicensePlate')), eol_))
        if self.LicensePlateBarCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LicensePlateBarCode>%s</dhlPickup:LicensePlateBarCode>%s' % (self.gds_format_base64(self.LicensePlateBarCode, input_name='LicensePlateBarCode'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ShipValResponsePieces(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ShipValResponsePieces', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ShipValResponsePieces', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ShipValResponsePieces'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ShipValResponsePieces', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Reference(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Reference', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Reference', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Reference'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Reference', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ReferenceID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ReferenceID>%s</dhlPickup:ReferenceID>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ReferenceID), input_name='ReferenceID')), eol_))
        if self.ReferenceType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ReferenceType>%s</dhlPickup:ReferenceType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ReferenceType), input_name='ReferenceType')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class AdditionalProtection(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='AdditionalProtection', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='AdditionalProtection', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='AdditionalProtection'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='AdditionalProtection', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Code is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Code>%s</dhlPickup:Code>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Code), input_name='Code')), eol_))
        if self.Value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Value>%s</dhlPickup:Value>%s' % (self.gds_format_float(self.Value, input_name='Value'), eol_))
    def build(self, node):
...
class Shipment(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Shipment', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Shipment', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Shipment'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Shipment', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.AirwarBillNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:AirwarBillNumber>%s</dhlPickup:AirwarBillNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AirwarBillNumber), input_name='AirwarBillNumber')), eol_))
        if self.AccountType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:AccountType>%s</dhlPickup:AccountType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AccountType), input_name='AccountType')), eol_))
        if self.ProductType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ProductType>%s</dhlPickup:ProductType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ProductType), input_name='ProductType')), eol_))
        if self.GlobalProductType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:GlobalProductType>%s</dhlPickup:GlobalProductType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.GlobalProductType), input_name='GlobalProductType')), eol_))
        if self.LocalProductType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LocalProductType>%s</dhlPickup:LocalProductType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LocalProductType), input_name='LocalProductType')), eol_))
        ...
        if self.InsuredValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:InsuredValue>%s</dhlPickup:InsuredValue>%s' % (self.gds_format_float(self.InsuredValue, input_name='InsuredValue'), eol_))
        if self.InsuredCurrency is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:InsuredCurrency>%s</dhlPickup:InsuredCurrency>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InsuredCurrency), input_name='InsuredCurrency')), eol_))
        if self.DimensionalUnit is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DimensionalUnit>%s</dhlPickup:DimensionalUnit>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DimensionalUnit), input_name='DimensionalUnit')), eol_))
        if self.DimensionalWeight is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DimensionalWeight>%s</dhlPickup:DimensionalWeight>%s' % (self.gds_format_float(self.DimensionalWeight, input_name='DimensionalWeight'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Shipper(GeneratedsSuper):
    ...
    def __init__(self, ShipperID=None, CompanyName=None, SuiteDepartmentName=None, RegisteredAccount=None, AddressLine=None, City=None, Division=None, DivisionCode=None, PostalCode=None, OriginServiceAreaCode=None, OriginFacilityCode=None, CountryCode=None, CountryName=None, FederalTaxId=None, StateTaxId=None, Contact=None, Suburb=None):
        ...
        self.validate_CountryName(self.CountryName)
        self.FederalTaxId = FederalTaxId
        self.validate_FederalTaxIdType8(self.FederalTaxId)
        self.StateTaxId = StateTaxId
        self.validate_StateTaxIdType9(self.StateTaxId)
        self.Contact = Contact
        self.Suburb = Suburb
        self.validate_Suburb(self.Suburb)
    def factory(*args_, **kwargs_):
    ...
    def validate_CountryName(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on CountryName' % {"value" : value.encode("utf-8")} )
    def validate_FederalTaxIdType8(self, value):
        # Validate type FederalTaxIdType8, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on FederalTaxIdType8' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on FederalTaxIdType8' % {"value" : value.encode("utf-8")} )
    def validate_StateTaxIdType9(self, value):
        # Validate type StateTaxIdType9, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on StateTaxIdType9' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on StateTaxIdType9' % {"value" : value.encode("utf-8")} )
    def validate_Suburb(self, value):
        # Validate type Suburb, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Shipper', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Shipper', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Shipper'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Shipper', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ShipperID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipperID>%s</dhlPickup:ShipperID>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipperID), input_name='ShipperID')), eol_))
        if self.CompanyName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CompanyName>%s</dhlPickup:CompanyName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CompanyName), input_name='CompanyName')), eol_))
        if self.SuiteDepartmentName is not None:
        ...
        if self.RegisteredAccount is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:RegisteredAccount>%s</dhlPickup:RegisteredAccount>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RegisteredAccount), input_name='RegisteredAccount')), eol_))
        for AddressLine_ in self.AddressLine:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:AddressLine>%s</dhlPickup:AddressLine>%s' % (self.gds_encode(self.gds_format_string(quote_xml(AddressLine_), input_name='AddressLine')), eol_))
        if self.City is not None:
        ...
        if self.OriginServiceAreaCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:OriginServiceAreaCode>%s</dhlPickup:OriginServiceAreaCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.OriginServiceAreaCode), input_name='OriginServiceAreaCode')), eol_))
        if self.OriginFacilityCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:OriginFacilityCode>%s</dhlPickup:OriginFacilityCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.OriginFacilityCode), input_name='OriginFacilityCode')), eol_))
        if self.CountryCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CountryCode>%s</dhlPickup:CountryCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CountryCode), input_name='CountryCode')), eol_))
        if self.CountryName is not None:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ShipperID':
            ...
            FederalTaxId_ = self.gds_validate_string(FederalTaxId_, node, 'FederalTaxId')
            self.FederalTaxId = FederalTaxId_
            # validate type FederalTaxIdType8
            self.validate_FederalTaxIdType8(self.FederalTaxId)
        elif nodeName_ == 'StateTaxId':
            StateTaxId_ = child_.text
            StateTaxId_ = self.gds_validate_string(StateTaxId_, node, 'StateTaxId')
            self.StateTaxId = StateTaxId_
            # validate type StateTaxIdType9
            self.validate_StateTaxIdType9(self.StateTaxId)
        elif nodeName_ == 'Contact':
            obj_ = Contact.factory()
            obj_.build(child_)
...
class SpecialService(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='SpecialService', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='SpecialService', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='SpecialService'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='SpecialService', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.SpecialServiceType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:SpecialServiceType>%s</dhlPickup:SpecialServiceType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SpecialServiceType), input_name='SpecialServiceType')), eol_))
        if self.CommunicationAddress is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CommunicationAddress>%s</dhlPickup:CommunicationAddress>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CommunicationAddress), input_name='CommunicationAddress')), eol_))
        if self.CommunicationType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CommunicationType>%s</dhlPickup:CommunicationType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CommunicationType), input_name='CommunicationType')), eol_))
        if self.ChargeValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ChargeValue>%s</dhlPickup:ChargeValue>%s' % (self.gds_format_float(self.ChargeValue, input_name='ChargeValue'), eol_))
        ...
        if self.IsWaived is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:IsWaived>%s</dhlPickup:IsWaived>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.IsWaived), input_name='IsWaived')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class WeightSeg(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='WeightSeg', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='WeightSeg', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='WeightSeg'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='WeightSeg', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Request(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Request', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Request', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Request'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Request', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ServiceHeader(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ServiceHeader', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ServiceHeader', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ServiceHeader'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ServiceHeader', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.MessageTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:MessageTime>%s</dhlPickup:MessageTime>%s' % (self.gds_format_datetime(self.MessageTime, input_name='MessageTime'), eol_))
        if self.MessageReference is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:MessageReference>%s</dhlPickup:MessageReference>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.MessageReference), input_name='MessageReference')), eol_))
        if self.SiteID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:SiteID>%s</dhlPickup:SiteID>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SiteID), input_name='SiteID')), eol_))
        if self.Password is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Password>%s</dhlPickup:Password>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Password), input_name='Password')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Response(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Response', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Response', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Response'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Response', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ResponseServiceHeader(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ResponseServiceHeader', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ResponseServiceHeader', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ResponseServiceHeader'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ResponseServiceHeader', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Status(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Status', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Status', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Status'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Status', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ActionStatus is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ActionStatus>%s</dhlPickup:ActionStatus>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ActionStatus), input_name='ActionStatus')), eol_))
...
class Note(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Note', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Note', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Note'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Note', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ActionNote is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ActionNote>%s</dhlPickup:ActionNote>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ActionNote), input_name='ActionNote')), eol_))
        for Condition_ in self.Condition:
            Condition_.export(outfile, level, namespace_, name_='Condition', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
class Condition(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Condition', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Condition', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Condition'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Condition', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ConditionCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ConditionCode>%s</dhlPickup:ConditionCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ConditionCode), input_name='ConditionCode')), eol_))
        if self.ConditionData is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ConditionData>%s</dhlPickup:ConditionData>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ConditionData), input_name='ConditionData')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Customer(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Customer', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Customer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Customer'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Customer', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.CustomerID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CustomerID>%s</dhlPickup:CustomerID>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CustomerID), input_name='CustomerID')), eol_))
        if self.Name is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Name>%s</dhlPickup:Name>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Name), input_name='Name')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class BarCodes(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='BarCodes', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='BarCodes', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='BarCodes'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='BarCodes', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for BarCode_ in self.BarCode:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:BarCode>%s</dhlPickup:BarCode>%s' % (self.gds_format_base64(BarCode_, input_name='BarCode'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class DestinationServiceArea(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='DestinationServiceArea', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='DestinationServiceArea', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='DestinationServiceArea'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='DestinationServiceArea', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ServiceAreaCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ServiceAreaCode>%s</dhlPickup:ServiceAreaCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ServiceAreaCode), input_name='ServiceAreaCode')), eol_))
        if self.Description is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Description>%s</dhlPickup:Description>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Description), input_name='Description')), eol_))
        if self.InboundSortCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:InboundSortCode>%s</dhlPickup:InboundSortCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InboundSortCode), input_name='InboundSortCode')), eol_))
        if self.FacilityCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:FacilityCode>%s</dhlPickup:FacilityCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.FacilityCode), input_name='FacilityCode')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class OriginServiceArea(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='OriginServiceArea', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='OriginServiceArea', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='OriginServiceArea'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='OriginServiceArea', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.OutboundSortCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:OutboundSortCode>%s</dhlPickup:OutboundSortCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.OutboundSortCode), input_name='OutboundSortCode')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ServiceArea(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ServiceArea', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ServiceArea', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ServiceArea'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ServiceArea', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ServiceEvent(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ServiceEvent', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ServiceEvent', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ServiceEvent'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ServiceEvent', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.EventCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:EventCode>%s</dhlPickup:EventCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EventCode), input_name='EventCode')), eol_))
        if self.Description is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Description>%s</dhlPickup:Description>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Description), input_name='Description')), eol_))
    def build(self, node):
...
class ShipmentDate(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ShipmentDate', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ShipmentDate', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ShipmentDate'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ShipmentDate', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ShipmentDateFrom is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipmentDateFrom>%s</dhlPickup:ShipmentDateFrom>%s' % (self.gds_format_date(self.ShipmentDateFrom, input_name='ShipmentDateFrom'), eol_))
        if self.ShipmentDateTo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipmentDateTo>%s</dhlPickup:ShipmentDateTo>%s' % (self.gds_format_date(self.ShipmentDateTo, input_name='ShipmentDateTo'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class AWBInfo(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='AWBInfo', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='AWBInfo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='AWBInfo'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='AWBInfo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ShipmentInfo(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ShipmentInfo', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ShipmentInfo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ShipmentInfo'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ShipmentInfo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ShipperName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipperName>%s</dhlPickup:ShipperName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipperName), input_name='ShipperName')), eol_))
        if self.ShipperAccountNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipperAccountNumber>%s</dhlPickup:ShipperAccountNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipperAccountNumber), input_name='ShipperAccountNumber')), eol_))
        if self.ConsigneeName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ConsigneeName>%s</dhlPickup:ConsigneeName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ConsigneeName), input_name='ConsigneeName')), eol_))
        if self.ShipmentDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShipmentDate>%s</dhlPickup:ShipmentDate>%s' % (self.gds_format_datetime(self.ShipmentDate, input_name='ShipmentDate'), eol_))
        if self.Pieces is not None:
            self.Pieces.export(outfile, level, namespace_, name_='Pieces', pretty_print=pretty_print)
        if self.Weight is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Weight>%s</dhlPickup:Weight>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Weight), input_name='Weight')), eol_))
        if self.WeightUnit is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:WeightUnit>%s</dhlPickup:WeightUnit>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.WeightUnit), input_name='WeightUnit')), eol_))
        if self.EstDlvyDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:EstDlvyDate>%s</dhlPickup:EstDlvyDate>%s' % (self.gds_format_datetime(self.EstDlvyDate, input_name='EstDlvyDate'), eol_))
...
class ErrorResponse(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ErrorResponse', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ErrorResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ErrorResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ErrorResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ShipmentEvent(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='ShipmentEvent', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='ShipmentEvent', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='ShipmentEvent'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='ShipmentEvent', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Time is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Time>%s</dhlPickup:Time>%s' % (self.gds_format_time(self.Time, input_name='Time'), eol_))
        ...
        if self.Signatory is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Signatory>%s</dhlPickup:Signatory>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Signatory), input_name='Signatory')), eol_))
...
class PieceInfo(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='PieceInfo', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='PieceInfo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='PieceInfo'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='PieceInfo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PieceEvent(GeneratedsSuper):
    ...
    def __init__(self, Date=None, Time=None, ServiceEvent=None, Signatory=None, ServiceArea=None):
        ...
        self.ServiceEvent = ServiceEvent
        self.Signatory = Signatory
        self.validate_SignatoryType10(self.Signatory)
        self.ServiceArea = ServiceArea
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_ServiceArea(self): return self.ServiceArea
    def set_ServiceArea(self, ServiceArea): self.ServiceArea = ServiceArea
    def validate_SignatoryType10(self, value):
        # Validate type SignatoryType10, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='PieceEvent', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='PieceEvent', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='PieceEvent'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='PieceEvent', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PieceDetails(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='PieceDetails', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='PieceDetails', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='PieceDetails'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='PieceDetails', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.DimWeight is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DimWeight>%s</dhlPickup:DimWeight>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DimWeight), input_name='DimWeight')), eol_))
        if self.Width is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Width>%s</dhlPickup:Width>%s' % (self.gds_format_integer(self.Width, input_name='Width'), eol_))
        if self.Height is not None:
...
class TrackingPieces(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='TrackingPieces', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='TrackingPieces', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='TrackingPieces'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='TrackingPieces', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Fault(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Fault', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Fault', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Fault'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Fault', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PieceFault(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='PieceFault', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='PieceFault', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='PieceFault'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='PieceFault', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DocImages(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='DocImages', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='DocImages', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='DocImages'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='DocImages', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DocImage(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='DocImage', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='DocImage', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='DocImage'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='DocImage', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Type is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Type>%s</dhlPickup:Type>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Type), input_name='Type')), eol_))
        if self.Image is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Image>%s</dhlPickup:Image>%s' % (self.gds_format_base64(self.Image, input_name='Image'), eol_))
        if self.ImageFormat is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ImageFormat>%s</dhlPickup:ImageFormat>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ImageFormat), input_name='ImageFormat')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class QtdSInAdCur(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='QtdSInAdCur', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='QtdSInAdCur', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='QtdSInAdCur'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='QtdSInAdCur', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CurrencyRoleTypeCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:CurrencyRoleTypeCode>%s</dhlPickup:CurrencyRoleTypeCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CurrencyRoleTypeCode), input_name='CurrencyRoleTypeCode')), eol_))
        if self.PackageCharge is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:PackageCharge>%s</dhlPickup:PackageCharge>%s' % (self.gds_format_float(self.PackageCharge, input_name='PackageCharge'), eol_))
        if self.ShippingCharge is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ShippingCharge>%s</dhlPickup:ShippingCharge>%s' % (self.gds_format_float(self.ShippingCharge, input_name='ShippingCharge'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class LabelImage(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='LabelImage', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='LabelImage', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='LabelImage'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='LabelImage', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.OutputFormat is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:OutputFormat>%s</dhlPickup:OutputFormat>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.OutputFormat), input_name='OutputFormat')), eol_))
        if self.OutputImage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:OutputImage>%s</dhlPickup:OutputImage>%s' % (self.gds_format_base64(self.OutputImage, input_name='OutputImage'), eol_))
        ...
        if self.OutputImageNPC is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:OutputImageNPC>%s</dhlPickup:OutputImageNPC>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.OutputImageNPC), input_name='OutputImageNPC')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class MultiLabels(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='MultiLabels', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='MultiLabels', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='MultiLabels'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='MultiLabels', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Notification(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Notification', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Notification', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Notification'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Notification', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.EmailAddress is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:EmailAddress>%s</dhlPickup:EmailAddress>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EmailAddress), input_name='EmailAddress')), eol_))
        if self.Message is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Message>%s</dhlPickup:Message>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Message), input_name='Message')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Label(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='Label', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='Label', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='Label'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Label', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.HideAccount is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:HideAccount>%s</dhlPickup:HideAccount>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.HideAccount), input_name='HideAccount')), eol_))
        if self.LabelTemplate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LabelTemplate>%s</dhlPickup:LabelTemplate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LabelTemplate), input_name='LabelTemplate')), eol_))
        if self.ReceiptTemplate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ReceiptTemplate>%s</dhlPickup:ReceiptTemplate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ReceiptTemplate), input_name='ReceiptTemplate')), eol_))
        if self.DocDetach is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DocDetach>%s</dhlPickup:DocDetach>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DocDetach), input_name='DocDetach')), eol_))
        if self.Logo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Logo>%s</dhlPickup:Logo>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Logo), input_name='Logo')), eol_))
        ...
        if self.Resolution is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Resolution>%s</dhlPickup:Resolution>%s' % (self.gds_format_integer(self.Resolution, input_name='Resolution'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class CustomerLogo(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='CustomerLogo', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='CustomerLogo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='CustomerLogo'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='CustomerLogo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.LogoImage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LogoImage>%s</dhlPickup:LogoImage>%s' % (self.gds_format_base64(self.LogoImage, input_name='LogoImage'), eol_))
        if self.LogoImageFormat is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LogoImageFormat>%s</dhlPickup:LogoImageFormat>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LogoImageFormat), input_name='LogoImageFormat')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class WeightType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='WeightType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='WeightType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='WeightType'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='WeightType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class LicenseType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='LicenseType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='LicenseType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='LicenseType'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='LicenseType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.LicenseNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:LicenseNumber>%s</dhlPickup:LicenseNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LicenseNumber), input_name='LicenseNumber')), eol_))
        if self.ExpiryDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:ExpiryDate>%s</dhlPickup:ExpiryDate>%s' % (self.gds_format_date(self.ExpiryDate, input_name='ExpiryDate'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class MultiLabelType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='dhlPickup:', name_='MultiLabelType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='dhlPickup:', name_='MultiLabelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='dhlPickup:', name_='MultiLabelType'):
        pass
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='MultiLabelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.DocName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DocName>%s</dhlPickup:DocName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DocName), input_name='DocName')), eol_))
        if self.DocFormat is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DocFormat>%s</dhlPickup:DocFormat>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DocFormat), input_name='DocFormat')), eol_))
        if self.DocImage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:DocImage>%s</dhlPickup:DocImage>%s' % (self.gds_format_base64(self.DocImage, input_name='DocImage'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from pickupdatatypes_global_2.0 import *\n\n')
        sys.stdout.write('import pickupdatatypes_global_2.0 as model_\n\n')
