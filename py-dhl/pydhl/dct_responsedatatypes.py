...
#
# Generated Fri Mar  6 18:34:08 2020 by generateDS.py version 2.35.15.
# Python 3.8.1 (v3.8.1:1b293b6006, Dec 18 2019, 14:08:53)  [Clang 6.0 (clang-600.0.57)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './python/dct_responsedatatypes.py')
#
# Command line arguments:
#   ./schemas/DCTResponsedatatypes.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/dct_responsedatatypes.py" ./schemas/DCTResponsedatatypes.xsd
#
...
class BkgDetailsType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, OriginServiceArea=None, DestinationServiceArea=None, QtdShp=None, CalcNextDayInd=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.CalcNextDayInd = CalcNextDayInd
        self.validate_CalcNextDayIndType(self.CalcNextDayInd)
        self.CalcNextDayInd_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_CalcNextDayInd(self):
        return self.CalcNextDayInd
    def set_CalcNextDayInd(self, CalcNextDayInd):
        self.CalcNextDayInd = CalcNextDayInd
    def validate_CalcNextDayIndType(self, value):
        result = True
        # Validate type CalcNextDayIndType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) != 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd length restriction on CalcNextDayIndType' % {"value": encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def hasContent_(self):
        if (
            ...
            self.QtdShp or
            self.CalcNextDayInd is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BkgDetailsType', fromsubclass_=False, pretty_print=True):
        ...
        if self.CalcNextDayInd is not None:
            namespaceprefix_ = self.CalcNextDayInd_nsprefix_ + ':' if (UseCapturedNS_ and self.CalcNextDayInd_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCalcNextDayInd>%s</%sCalcNextDayInd>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.CalcNextDayInd), input_name='CalcNextDayInd')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'CalcNextDayInd':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'CalcNextDayInd')
            value_ = self.gds_validate_string(value_, node, 'CalcNextDayInd')
            self.CalcNextDayInd = value_
            self.CalcNextDayInd_nsprefix_ = child_.prefix
            # validate type CalcNextDayIndType
            self.validate_CalcNextDayIndType(self.CalcNextDayInd)
...
class ProdType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, VldSrvComb=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
class QtdShpType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, GlobalProductCode=None, LocalProductCode=None, ProductShortName=None, LocalProductName=None, NetworkTypeCode=None, POfferedCustAgreement=None, TransInd=None, PickupDate=None, PickupCutoffTime=None, BookingTime=None, CurrencyCode=None, ExchangeRate=None, WeightCharge=None, WeightChargeTax=None, weightChargeTaxRate=None, TotalTransitDays=None, PickupPostalLocAddDays=None, DeliveryPostalLocAddDays=None, PickupNonDHLCourierCode=None, DeliveryNonDHLCourierCode=None, DeliveryCheckpointReturn=None, DeliveryDate=None, DeliveryTime=None, DeliveryTimeGMTOffset=None, DimensionalWeight=None, WeightUnit=None, PickupDayOfWeekNum=None, DestinationDayOfWeekNum=None, QtdShpExChrg=None, PricingDate=None, ShippingCharge=None, TotalTaxAmount=None, QtdSInAdCur=None, WeightChargeTaxDet=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.validate_PickupCutoffTimeType(self.PickupCutoffTime)
        ...
        self.PickupNonDHLCourierCode = PickupNonDHLCourierCode
        self.validate_PickupNonDHLCourierCodeType(self.PickupNonDHLCourierCode)
        self.PickupNonDHLCourierCode_nsprefix_ = None
        self.DeliveryNonDHLCourierCode = DeliveryNonDHLCourierCode
        self.validate_DeliveryNonDHLCourierCodeType(self.DeliveryNonDHLCourierCode)
        self.DeliveryNonDHLCourierCode_nsprefix_ = None
        self.DeliveryCheckpointReturn = DeliveryCheckpointReturn
        self.validate_DeliveryCheckpointReturnType(self.DeliveryCheckpointReturn)
        self.DeliveryCheckpointReturn_nsprefix_ = None
    ...
    def set_DeliveryPostalLocAddDays(self, DeliveryPostalLocAddDays):
        self.DeliveryPostalLocAddDays = DeliveryPostalLocAddDays
    def get_PickupNonDHLCourierCode(self):
        return self.PickupNonDHLCourierCode
    def set_PickupNonDHLCourierCode(self, PickupNonDHLCourierCode):
        self.PickupNonDHLCourierCode = PickupNonDHLCourierCode
    def get_DeliveryNonDHLCourierCode(self):
        return self.DeliveryNonDHLCourierCode
    def set_DeliveryNonDHLCourierCode(self, DeliveryNonDHLCourierCode):
        self.DeliveryNonDHLCourierCode = DeliveryNonDHLCourierCode
    def get_DeliveryCheckpointReturn(self):
        return self.DeliveryCheckpointReturn
    def set_DeliveryCheckpointReturn(self, DeliveryCheckpointReturn):
        self.DeliveryCheckpointReturn = DeliveryCheckpointReturn
    ...
    def validate_PickupDateType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            pass
        return result
    def validate_PickupCutoffTimeType(self, value):
        result = True
        # Validate type PickupCutoffTimeType, a restriction on xsd:duration.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
    ...
    def validate_DeliveryPostalLocAddDaysType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            pass
        return result
    def validate_PickupNonDHLCourierCodeType(self, value):
        result = True
        # Validate type PickupNonDHLCourierCodeType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) != 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd length restriction on PickupNonDHLCourierCodeType' % {"value": encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_DeliveryNonDHLCourierCodeType(self, value):
        result = True
        # Validate type DeliveryNonDHLCourierCodeType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) != 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd length restriction on DeliveryNonDHLCourierCodeType' % {"value": encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_DeliveryCheckpointReturnType(self, value):
        result = True
        # Validate type DeliveryCheckpointReturnType, a restriction on xsd:duration.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            pass
        return result
    def validate_DeliveryDateType(self, value):
        result = True
        # Validate type DeliveryDateType, a restriction on xsd:date.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.date):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (datetime_.date)' % {"value": value, "lineno": lineno, })
    ...
    def hasContent_(self):
        if (
            ...
            self.PickupNonDHLCourierCode is not None or
            self.DeliveryNonDHLCourierCode is not None or
            self.DeliveryCheckpointReturn is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='QtdShpType', fromsubclass_=False, pretty_print=True):
        ...
        if self.PickupNonDHLCourierCode is not None:
            namespaceprefix_ = self.PickupNonDHLCourierCode_nsprefix_ + ':' if (UseCapturedNS_ and self.PickupNonDHLCourierCode_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPickupNonDHLCourierCode>%s</%sPickupNonDHLCourierCode>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.PickupNonDHLCourierCode), input_name='PickupNonDHLCourierCode')), namespaceprefix_ , eol_))
        if self.DeliveryNonDHLCourierCode is not None:
            namespaceprefix_ = self.DeliveryNonDHLCourierCode_nsprefix_ + ':' if (UseCapturedNS_ and self.DeliveryNonDHLCourierCode_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDeliveryNonDHLCourierCode>%s</%sDeliveryNonDHLCourierCode>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.DeliveryNonDHLCourierCode), input_name='DeliveryNonDHLCourierCode')), namespaceprefix_ , eol_))
        if self.DeliveryCheckpointReturn is not None:
            namespaceprefix_ = self.DeliveryCheckpointReturn_nsprefix_ + ':' if (UseCapturedNS_ and self.DeliveryCheckpointReturn_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDeliveryCheckpointReturn>%s</%sDeliveryCheckpointReturn>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.DeliveryCheckpointReturn), input_name='DeliveryCheckpointReturn')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'GlobalProductCode':
            ...
            # validate type PickupCutoffTimeType
            self.validate_PickupCutoffTimeType(self.PickupCutoffTime)
            ...
            self.validate_DeliveryPostalLocAddDaysType(self.DeliveryPostalLocAddDays)
        elif nodeName_ == 'PickupNonDHLCourierCode':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'PickupNonDHLCourierCode')
            value_ = self.gds_validate_string(value_, node, 'PickupNonDHLCourierCode')
            self.PickupNonDHLCourierCode = value_
            self.PickupNonDHLCourierCode_nsprefix_ = child_.prefix
            # validate type PickupNonDHLCourierCodeType
            self.validate_PickupNonDHLCourierCodeType(self.PickupNonDHLCourierCode)
        elif nodeName_ == 'DeliveryNonDHLCourierCode':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'DeliveryNonDHLCourierCode')
            value_ = self.gds_validate_string(value_, node, 'DeliveryNonDHLCourierCode')
            self.DeliveryNonDHLCourierCode = value_
            self.DeliveryNonDHLCourierCode_nsprefix_ = child_.prefix
            # validate type DeliveryNonDHLCourierCodeType
            self.validate_DeliveryNonDHLCourierCodeType(self.DeliveryNonDHLCourierCode)
        elif nodeName_ == 'DeliveryCheckpointReturn':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'DeliveryCheckpointReturn')
            value_ = self.gds_validate_string(value_, node, 'DeliveryCheckpointReturn')
            self.DeliveryCheckpointReturn = value_
            self.DeliveryCheckpointReturn_nsprefix_ = child_.prefix
            # validate type DeliveryCheckpointReturnType
            self.validate_DeliveryCheckpointReturnType(self.DeliveryCheckpointReturn)
            ...
            # validate type DeliveryDateType
            self.validate_DeliveryDateType(self.DeliveryDate)
            ...
            obj_ = QtdSInAdCurType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from dct_responsedatatypes import *\n\n')
        sys.stdout.write('import dct_responsedatatypes as model_\n\n')
