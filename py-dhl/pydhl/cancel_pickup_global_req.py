...
#
# Generated Fri Mar  6 18:34:19 2020 by generateDS.py version 2.35.15.
# Python 3.8.1 (v3.8.1:1b293b6006, Dec 18 2019, 14:08:53)  [Clang 6.0 (clang-600.0.57)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './python/cancel_pickup_global_req.py')
#
# Command line arguments:
#   ./schemas/cancel-pickup-global-req.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/cancel_pickup_global_req.py" ./schemas/cancel-pickup-global-req.xsd
#
...
class CancelPURequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, schemaVersion=1.0, Request=None, RegionCode=None, ConfirmationNumber=None, RequestorName=None, CountryCode=None, OriginSvcArea=None, Reason=None, PickupDate=None, CancelTime=None, gds_collector_=None, **kwargs_):
        ...
        if isinstance(CancelTime, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(CancelTime, '%H:%M:%S').time()
        else:
            initvalue_ = CancelTime
        self.CancelTime = initvalue_
        self.CancelTime_nsprefix_ = None
    ...
    def validate_RequestorNameType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 35:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on RequestorNameType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    ...
    def validate_ReasonType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on ReasonType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) > 3:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on ReasonType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 3:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on ReasonType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelPURequest', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CancelPURequest':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CancelPURequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CancelPURequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CancelPURequest'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelPURequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CancelTime is not None:
            namespaceprefix_ = self.CancelTime_nsprefix_ + ':' if (UseCapturedNS_ and self.CancelTime_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCancelTime>%s</%sCancelTime>%s' % (namespaceprefix_ , self.gds_format_time(self.CancelTime, input_name='CancelTime'), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Request':
            ...
            self.CancelTime = dval_
            self.CancelTime_nsprefix_ = child_.prefix
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from cancel_pickup_global_req import *\n\n')
        sys.stdout.write('import cancel_pickup_global_req as model_\n\n')
