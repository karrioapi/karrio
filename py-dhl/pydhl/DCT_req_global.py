...
#   ('--no-namespace-defs', '')
#   ('-o', './lib/DCT_req_global.py')
#
# Command line arguments:
#   ./xsd/DCT-req_global.xsd
#
...
class DCTRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, schemaVersion=None, GetQuote=None, GetCapability=None):
    ...
    def get_GetQuote(self): return self.GetQuote
    def set_GetQuote(self, GetQuote): self.GetQuote = GetQuote
    def get_GetCapability(self): return self.GetCapability
    def set_GetCapability(self, GetCapability): self.GetCapability = GetCapability
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='DCTRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DCTRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='DCTRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DCTRequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='DCTRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.GetQuote is not None:
            self.GetQuote.export(outfile, level, namespace_, name_='GetQuote', pretty_print=pretty_print)
        if self.GetCapability is not None:
            self.GetCapability.export(outfile, level, namespace_, name_='GetCapability', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
class BkgDetailsType(GeneratedsSuper):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on WeightUnitType5' % {"value" : value.encode("utf-8")} )
            if len(value) > 3:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on WeightUnitType5' % {"value" : value.encode("utf-8")} )
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PaymentCountryCode':
            ...
            self.validate_NumberOfPiecesType6(self.NumberOfPieces[-1])
...
class DCTTo(GeneratedsSuper):
    ...
    def validate_CountryCodeType7(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) != 2:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on CountryCodeType7' % {"value" : value.encode("utf-8")} )
    def validate_PostalcodeType8(self, value):
        # Validate type PostalcodeType8, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 12:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on PostalcodeType8' % {"value" : value.encode("utf-8")} )
    def validate_CityType9(self, value):
        # Validate type CityType9, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 45:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on CityType9' % {"value" : value.encode("utf-8")} )
    def validate_SuburbType10(self, value):
        # Validate type SuburbType10, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 45:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on SuburbType10' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            self.CountryCode is not None or
            self.Postalcode is not None or
...
class PieceType(GeneratedsSuper):
    ...
    def validate_WeightType11(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on WeightType11' % {"value" : value} )
    def hasContent_(self):
        if (
            self.PieceID is not None or
...
class GetQuoteType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Request=None, From=None, BkgDetails=None, To=None, Dutiable=None, GenReq=None):
        self.original_tagname_ = None
    ...
    def get_GenReq(self): return self.GenReq
    def set_GenReq(self, GenReq): self.GenReq = GenReq
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='GetQuoteType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GetQuoteType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='GetQuoteType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='GetQuoteType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='GetQuoteType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.BkgDetails is not None:
            self.BkgDetails.export(outfile, level, namespace_, name_='BkgDetails', pretty_print=pretty_print)
        ...
        if self.GenReq is not None:
            self.GenReq.export(outfile, level, namespace_, name_='GenReq', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class GetCapabilityType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='GetCapabilityType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GetCapabilityType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='GetCapabilityType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='GetCapabilityType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='GetCapabilityType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from DCT_req_global import *\n\n')
        sys.stdout.write('import DCT_req_global as model_\n\n')
