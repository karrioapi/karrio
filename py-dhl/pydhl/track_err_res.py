...
#
# Generated Thu Jun 21 22:31:10 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/track-err-res.py')
#
# Command line arguments:
#   ../xsd/track-err-res.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS --no-namespace-defs -o "./pydhl/track-err-res.py" ../xsd/track-err-res.xsd
#
...
class ShipmentTrackingErrorResponse(GeneratedsSuper):
    """Shipment tracking error response root element"""
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ShipmentTrackingErrorResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ShipmentTrackingErrorResponse.subclass:
            return ShipmentTrackingErrorResponse.subclass(*args_, **kwargs_)
        else:
            return ShipmentTrackingErrorResponse(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ShipmentTrackingErrorResponse', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ShipmentTrackingErrorResponse')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ShipmentTrackingErrorResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ShipmentTrackingErrorResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ShipmentTrackingErrorResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ShipmentTrackingErrorResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Response':
            obj_ = ErrorResponse.factory()
            obj_.build(child_)
            self.Response = obj_
            obj_.original_tagname_ = 'Response'
# end class ShipmentTrackingErrorResponse
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ShipmentTrackingErrorResponse'
        rootClass = ShipmentTrackingErrorResponse
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from track-err-res import *\n\n')
        sys.stdout.write('import track-err-res as model_\n\n')
