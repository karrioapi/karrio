...
#
# Generated Fri Mar  6 18:34:35 2020 by generateDS.py version 2.35.15.
# Python 3.8.1 (v3.8.1:1b293b6006, Dec 18 2019, 14:08:53)  [Clang 6.0 (clang-600.0.57)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './python/routing_global_req.py')
#
# Command line arguments:
#   ./schemas/routing-global-req.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/routing_global_req.py" ./schemas/routing-global-req.xsd
#
...
class RouteRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, schemaVersion=1.0, Request=None, RegionCode=None, RequestType=None, Address1=None, Address2=None, Address3=None, PostalCode=None, City=None, Division=None, CountryCode=None, CountryName=None, OriginCountryCode=None, gds_collector_=None, **kwargs_):
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from routing_global_req import *\n\n')
        sys.stdout.write('import routing_global_req as model_\n\n')
