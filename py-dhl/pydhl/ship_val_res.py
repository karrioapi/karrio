...
#
# Generated Fri Mar  6 18:34:44 2020 by generateDS.py version 2.35.15.
# Python 3.8.1 (v3.8.1:1b293b6006, Dec 18 2019, 14:08:53)  [Clang 6.0 (clang-600.0.57)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './python/ship_val_res.py')
#
# Command line arguments:
#   ./schemas/ship-val-res.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/ship_val_res.py" ./schemas/ship-val-res.xsd
#
...
class ShipmentValidateResponse(GeneratedsSuper):
    ...
    def __init__(self, Response=None, Note=None, AirwayBillNumber=None, BillingCode=None, CurrencyCode=None, CourierMessage=None, DestinationServiceArea=None, OriginServiceArea=None, DHLRoutingCode=None, DHLRoutingDataId=None, ProductContentCode=None, ProductShortName=None, InternalServiceCode=None, DeliveryDateCode=None, DeliveryTimeCode=None, Pieces=None, PackageCharge=None, Rated=None, ShippingCharge=None, ShippingChargeInUSD=None, InsuredAmount=None, WeightUnit=None, ChargeableWeight=None, DimensionalWeight=None, ReadyByTime=None, PickupCharge=None, CallInTime=None, DaysAdvanceNotice=None, ConversionRate=None, CountryCode=None, Barcodes=None, Piece=None, Contents=None, Reference=None, Consignee=None, Shipper=None, AccountNumber=None, CustomerID=None, ShipmentDate=None, GlobalProductCode=None, SpecialService=None, Billing=None, Dutiable=None, ExportDeclaration=None, NewShipper=None, SDeliveryDt=None, EDeliveryDt=None, LHPOrigCd=None, LHPDestCd=None, PLTStatus=None, QtdSInAdCur=None, LabelImage=None, CustData=None, gds_collector_=None, **kwargs_):
        ...
        self.ShippingChargeInUSD_nsprefix_ = None
    ...
    def set_ShippingCharge(self, ShippingCharge):
        self.ShippingCharge = ShippingCharge
    def get_ShippingChargeInUSD(self):
        return self.ShippingChargeInUSD
    def set_ShippingChargeInUSD(self, ShippingChargeInUSD):
        self.ShippingChargeInUSD = ShippingChargeInUSD
    ...
    def set_NewShipper(self, NewShipper):
        self.NewShipper = NewShipper
    def get_SDeliveryDt(self):
        return self.SDeliveryDt
    def set_SDeliveryDt(self, SDeliveryDt):
        self.SDeliveryDt = SDeliveryDt
    def get_EDeliveryDt(self):
        return self.EDeliveryDt
    def set_EDeliveryDt(self, EDeliveryDt):
        self.EDeliveryDt = EDeliveryDt
    def get_LHPOrigCd(self):
        return self.LHPOrigCd
    def set_LHPOrigCd(self, LHPOrigCd):
        self.LHPOrigCd = LHPOrigCd
    def get_LHPDestCd(self):
        return self.LHPDestCd
    def set_LHPDestCd(self, LHPDestCd):
        self.LHPDestCd = LHPDestCd
    ...
    def validate_SDeliveryDtType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on SDeliveryDtType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_EDeliveryDtType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on EDeliveryDtType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_LHPOrigCdType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on LHPOrigCdType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_LHPDestCdType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on LHPDestCdType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ShipmentValidateResponse', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ShipmentValidateResponse':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ShipmentValidateResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ShipmentValidateResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ShipmentValidateResponse'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ShipmentValidateResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ShippingChargeInUSD is not None:
            namespaceprefix_ = self.ShippingChargeInUSD_nsprefix_ + ':' if (UseCapturedNS_ and self.ShippingChargeInUSD_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sShippingChargeInUSD>%s</%sShippingChargeInUSD>%s' % (namespaceprefix_ , self.gds_format_float(self.ShippingChargeInUSD, input_name='ShippingChargeInUSD'), namespaceprefix_ , eol_))
        ...
        if self.SDeliveryDt is not None:
            namespaceprefix_ = self.SDeliveryDt_nsprefix_ + ':' if (UseCapturedNS_ and self.SDeliveryDt_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSDeliveryDt>%s</%sSDeliveryDt>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.SDeliveryDt), input_name='SDeliveryDt')), namespaceprefix_ , eol_))
        if self.EDeliveryDt is not None:
            namespaceprefix_ = self.EDeliveryDt_nsprefix_ + ':' if (UseCapturedNS_ and self.EDeliveryDt_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEDeliveryDt>%s</%sEDeliveryDt>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.EDeliveryDt), input_name='EDeliveryDt')), namespaceprefix_ , eol_))
        if self.LHPOrigCd is not None:
            namespaceprefix_ = self.LHPOrigCd_nsprefix_ + ':' if (UseCapturedNS_ and self.LHPOrigCd_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sLHPOrigCd>%s</%sLHPOrigCd>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.LHPOrigCd), input_name='LHPOrigCd')), namespaceprefix_ , eol_))
        if self.LHPDestCd is not None:
            namespaceprefix_ = self.LHPDestCd_nsprefix_ + ':' if (UseCapturedNS_ and self.LHPDestCd_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sLHPDestCd>%s</%sLHPDestCd>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.LHPDestCd), input_name='LHPDestCd')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Response':
            ...
            # validate type Money
            self.validate_Money(self.ShippingCharge)
        elif nodeName_ == 'ShippingChargeInUSD' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_float(sval_, node, 'ShippingChargeInUSD')
            fval_ = self.gds_validate_float(fval_, node, 'ShippingChargeInUSD')
            self.ShippingChargeInUSD = fval_
            self.ShippingChargeInUSD_nsprefix_ = child_.prefix
            # validate type Money
            self.validate_Money(self.ShippingChargeInUSD)
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'SDeliveryDt')
            value_ = self.gds_validate_string(value_, node, 'SDeliveryDt')
            self.SDeliveryDt = value_
            self.SDeliveryDt_nsprefix_ = child_.prefix
            # validate type SDeliveryDtType
            self.validate_SDeliveryDtType(self.SDeliveryDt)
        elif nodeName_ == 'EDeliveryDt':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'EDeliveryDt')
            value_ = self.gds_validate_string(value_, node, 'EDeliveryDt')
            self.EDeliveryDt = value_
            self.EDeliveryDt_nsprefix_ = child_.prefix
            # validate type EDeliveryDtType
            self.validate_EDeliveryDtType(self.EDeliveryDt)
        elif nodeName_ == 'LHPOrigCd':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'LHPOrigCd')
            value_ = self.gds_validate_string(value_, node, 'LHPOrigCd')
            self.LHPOrigCd = value_
            self.LHPOrigCd_nsprefix_ = child_.prefix
            # validate type LHPOrigCdType
            self.validate_LHPOrigCdType(self.LHPOrigCd)
        elif nodeName_ == 'LHPDestCd':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'LHPDestCd')
            value_ = self.gds_validate_string(value_, node, 'LHPDestCd')
            self.LHPDestCd = value_
            self.LHPDestCd_nsprefix_ = child_.prefix
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from ship_val_res import *\n\n')
        sys.stdout.write('import ship_val_res as model_\n\n')
