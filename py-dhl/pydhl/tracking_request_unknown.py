...
#
# Generated Tue Jun 12 21:57:44 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/tracking_request_unknown.py')
#
# Command line arguments:
#   /py_dhl/xsd/TrackingRequestUnknown.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/tracking_request_unknown.py" /py_dhl/xsd/TrackingRequestUnknown.xsd
#
...
class UnknownTrackingRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Request=None, LanguageCode=None, AccountNumber=None, ShipperReference=None, ShipmentDate=None, CountryCode=None):
    ...
    def add_ShipperReference(self, value): self.ShipperReference.append(value)
    def insert_ShipperReference_at(self, index, value): self.ShipperReference.insert(index, value)
    def replace_ShipperReference_at(self, index, value): self.ShipperReference[index] = value
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='UnknownTrackingRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='UnknownTrackingRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='UnknownTrackingRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='UnknownTrackingRequest'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='UnknownTrackingRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for ShipperReference_ in self.ShipperReference:
            ShipperReference_.export(outfile, level, namespace_, name_='ShipperReference', pretty_print=pretty_print)
        if self.ShipmentDate is not None:
            self.ShipmentDate.export(outfile, level, namespace_, name_='ShipmentDate', pretty_print=pretty_print)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from tracking_request_unknown import *\n\n')
        sys.stdout.write('import tracking_request_unknown as model_\n\n')
