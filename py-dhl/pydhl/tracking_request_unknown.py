...
#
# Generated Fri Mar  6 18:34:11 2020 by generateDS.py version 2.35.15.
# Python 3.8.1 (v3.8.1:1b293b6006, Dec 18 2019, 14:08:53)  [Clang 6.0 (clang-600.0.57)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './python/tracking_request_unknown.py')
#
# Command line arguments:
#   ./schemas/TrackingRequestUnknown.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/tracking_request_unknown.py" ./schemas/TrackingRequestUnknown.xsd
#
...
class UnknownTrackingRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Request=None, LanguageCode=None, AccountNumber=None, ShipperReference=None, ShipmentDate=None, CountryCode=None, gds_collector_=None, **kwargs_):
