...
#
# Generated Fri Mar  6 18:34:05 2020 by generateDS.py version 2.35.15.
...
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/dct_req.py" ./schemas/DCT-req.xsd
#
...
class DCTRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, GetQuote=None, GetCapability=None, gds_collector_=None, **kwargs_):
...
class DCTTo(GeneratedsSuper):
    ...
    def __init__(self, CountryCode=None, Postalcode=None, City=None, Suburb=None, VatNo=None, gds_collector_=None, **kwargs_):
        ...
        self.Suburb_nsprefix_ = None
        self.VatNo = VatNo
        self.validate_VatNoType10(self.VatNo)
        self.VatNo_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def validate_SuburbType9(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 45:
                ...
                result = False
        return result
    def validate_VatNoType10(self, value):
        result = True
        # Validate type VatNoType10, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 35:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on VatNoType10' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def hasContent_(self):
        if (
...
class GetQuoteType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Request=None, From=None, BkgDetails=None, To=None, Dutiable=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from dct_req import *\n\n')
        sys.stdout.write('import dct_req as model_\n\n')
