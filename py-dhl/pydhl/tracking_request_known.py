...
#   ('--no-namespace-defs', '')
#   ('-o', './python/tracking_request_known.py')
#
# Command line arguments:
#   ./schemas/TrackingRequestKnown.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/tracking_request_known.py" ./schemas/TrackingRequestKnown.xsd
#
...
class PiecesEnabledType(Enum):
    """S for Only shipment Details,B for Both Shipment and Piece Details,P for
    only Piece Details"""
    S='S'
    B='B'
    P='P'
...
class KnownTrackingRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Request=None, LanguageCode=None, AWBNumber=None, LPNumber=None, LevelOfDetails=None, PiecesEnabled=None, CountryCode=None, gds_collector_=None, **kwargs_):
