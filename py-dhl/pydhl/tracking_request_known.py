...
#
# Generated Tue Jun 12 21:57:26 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/tracking_request_known.py')
#
# Command line arguments:
#   /py_dhl/xsd/TrackingRequestKnown.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/tracking_request_known.py" /py_dhl/xsd/TrackingRequestKnown.xsd
#
...
class KnownTrackingRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Request=None, LanguageCode=None, AWBNumber=None, LPNumber=None, LevelOfDetails=None, PiecesEnabled=None, CountryCode=None):
    ...
    def add_AWBNumber(self, value): self.AWBNumber.append(value)
    def insert_AWBNumber_at(self, index, value): self.AWBNumber.insert(index, value)
    def replace_AWBNumber_at(self, index, value): self.AWBNumber[index] = value
    def get_LPNumber(self): return self.LPNumber
    def set_LPNumber(self, LPNumber): self.LPNumber = LPNumber
    def add_LPNumber(self, value): self.LPNumber.append(value)
    def insert_LPNumber_at(self, index, value): self.LPNumber.insert(index, value)
    def replace_LPNumber_at(self, index, value): self.LPNumber[index] = value
    def get_LevelOfDetails(self): return self.LevelOfDetails
    def set_LevelOfDetails(self, LevelOfDetails): self.LevelOfDetails = LevelOfDetails
    ...
    def validate_LevelOfDetails(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on LevelOfDetails' % {"value" : value.encode("utf-8")} )
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on PiecesEnabledType' % {"value" : value.encode("utf-8")} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='KnownTrackingRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='KnownTrackingRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='KnownTrackingRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='KnownTrackingRequest'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='KnownTrackingRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for AWBNumber_ in self.AWBNumber:
            showIndent(outfile, level, pretty_print)
            outfile.write('<AWBNumber>%s</AWBNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(AWBNumber_), input_name='AWBNumber')), eol_))
        for LPNumber_ in self.LPNumber:
            showIndent(outfile, level, pretty_print)
            outfile.write('<LPNumber>%s</LPNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(LPNumber_), input_name='LPNumber')), eol_))
        if self.LevelOfDetails is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<LevelOfDetails>%s</LevelOfDetails>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LevelOfDetails), input_name='LevelOfDetails')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Request':
            ...
            self.AWBNumber.append(AWBNumber_)
            # validate type AWBNumber
            self.validate_AWBNumber(self.AWBNumber[-1])
        elif nodeName_ == 'LPNumber':
            LPNumber_ = child_.text
            LPNumber_ = self.gds_validate_string(LPNumber_, node, 'LPNumber')
            self.LPNumber.append(LPNumber_)
            # validate type TrackingPieceID
            self.validate_TrackingPieceID(self.LPNumber[-1])
        elif nodeName_ == 'LevelOfDetails':
            LevelOfDetails_ = child_.text
            LevelOfDetails_ = self.gds_validate_string(LevelOfDetails_, node, 'LevelOfDetails')
            self.LevelOfDetails = LevelOfDetails_
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from tracking_request_known import *\n\n')
        sys.stdout.write('import tracking_request_known as model_\n\n')
