...
#
# Generated Tue Jun 12 21:55:23 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/ship_val_global_res_6.1.py')
#
# Command line arguments:
#   /py_dhl/xsd/ship-val-global-res-6.1.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/ship_val_global_res_6.1.py" /py_dhl/xsd/ship-val-global-res-6.1.xsd
#
...
class ShipmentResponse(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Response=None, RegionCode=None, Note=None, AirwayBillNumber=None, BillingCode=None, CurrencyCode=None, CourierMessage=None, DestinationServiceArea=None, OriginServiceArea=None, PackageCharge=None, Rated=None, ShippingCharge=None, InsuredAmount=None, WeightUnit=None, ChargeableWeight=None, DimensionalWeight=None, ReadyByTime=None, PickupCharge=None, CallInTime=None, DaysAdvanceNotice=None, ConversionRate=None, CountryCode=None, Pieces=None, Barcodes=None, Piece=None, Contents=None, Reference=None, Consignee=None, Shipper=None, AccountNumber=None, CustomerID=None, ShipmentDate=None, GlobalProductCode=None, DHLRoutingCode=None, DHLRoutingDataId=None, ProductContentCode=None, ProductShortName=None, InternalServiceCode=None, DeliveryDateCode=None, DeliveryTimeCode=None, SpecialService=None, Billing=None, Dutiable=None, ExportDeclaration=None, NewShipper=None, PLTStatus=None, QtdSInAdCur=None, LabelImage=None, CustData=None, ShipmentCharges=None, ODDURLLink=None, DGs=None, Label=None):
    ...
    def get_AirwayBillNumber(self): return self.AirwayBillNumber
    def set_AirwayBillNumber(self, AirwayBillNumber): self.AirwayBillNumber = AirwayBillNumber
    ...
    def get_CourierMessage(self): return self.CourierMessage
    def set_CourierMessage(self, CourierMessage): self.CourierMessage = CourierMessage
    ...
    def set_Rated(self, Rated): self.Rated = Rated
    ...
    def get_DaysAdvanceNotice(self): return self.DaysAdvanceNotice
    def set_DaysAdvanceNotice(self, DaysAdvanceNotice): self.DaysAdvanceNotice = DaysAdvanceNotice
    ...
    def get_DHLRoutingCode(self): return self.DHLRoutingCode
    def set_DHLRoutingCode(self, DHLRoutingCode): self.DHLRoutingCode = DHLRoutingCode
    def get_DHLRoutingDataId(self): return self.DHLRoutingDataId
    def set_DHLRoutingDataId(self, DHLRoutingDataId): self.DHLRoutingDataId = DHLRoutingDataId
    def get_ProductContentCode(self): return self.ProductContentCode
    def set_ProductContentCode(self, ProductContentCode): self.ProductContentCode = ProductContentCode
    ...
    def get_InternalServiceCode(self): return self.InternalServiceCode
    def set_InternalServiceCode(self, InternalServiceCode): self.InternalServiceCode = InternalServiceCode
    def add_InternalServiceCode(self, value): self.InternalServiceCode.append(value)
    def insert_InternalServiceCode_at(self, index, value): self.InternalServiceCode.insert(index, value)
    def replace_InternalServiceCode_at(self, index, value): self.InternalServiceCode[index] = value
    def get_DeliveryDateCode(self): return self.DeliveryDateCode
    def set_DeliveryDateCode(self, DeliveryDateCode): self.DeliveryDateCode = DeliveryDateCode
    def get_DeliveryTimeCode(self): return self.DeliveryTimeCode
    def set_DeliveryTimeCode(self, DeliveryTimeCode): self.DeliveryTimeCode = DeliveryTimeCode
    ...
    def get_Billing(self): return self.Billing
    def set_Billing(self, Billing): self.Billing = Billing
    def get_Dutiable(self): return self.Dutiable
    def set_Dutiable(self, Dutiable): self.Dutiable = Dutiable
    def get_ExportDeclaration(self): return self.ExportDeclaration
    def set_ExportDeclaration(self, ExportDeclaration): self.ExportDeclaration = ExportDeclaration
    def get_NewShipper(self): return self.NewShipper
    def set_NewShipper(self, NewShipper): self.NewShipper = NewShipper
    def get_PLTStatus(self): return self.PLTStatus
    def set_PLTStatus(self, PLTStatus): self.PLTStatus = PLTStatus
    def get_QtdSInAdCur(self): return self.QtdSInAdCur
    def set_QtdSInAdCur(self, QtdSInAdCur): self.QtdSInAdCur = QtdSInAdCur
    def add_QtdSInAdCur(self, value): self.QtdSInAdCur.append(value)
    def insert_QtdSInAdCur_at(self, index, value): self.QtdSInAdCur.insert(index, value)
    def replace_QtdSInAdCur_at(self, index, value): self.QtdSInAdCur[index] = value
    def get_LabelImage(self): return self.LabelImage
    def set_LabelImage(self, LabelImage): self.LabelImage = LabelImage
    def add_LabelImage(self, value): self.LabelImage.append(value)
    def insert_LabelImage_at(self, index, value): self.LabelImage.insert(index, value)
    def replace_LabelImage_at(self, index, value): self.LabelImage[index] = value
    ...
    def get_ODDURLLink(self): return self.ODDURLLink
    def set_ODDURLLink(self, ODDURLLink): self.ODDURLLink = ODDURLLink
    def get_DGs(self): return self.DGs
    def set_DGs(self, DGs): self.DGs = DGs
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on BillCode' % {"value" : value.encode("utf-8")} )
            if len(value) > 3:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on BillCode' % {"value" : value.encode("utf-8")} )
            if len(value) < 2:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on BillCode' % {"value" : value.encode("utf-8")} )
    def validate_CurrencyCode(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_CurrencyCode_patterns_, ))
    validate_CurrencyCode_patterns_ = [['^[^ ].*[^ ]$']]
    def validate_CourierMsg(self, value):
        # Validate type CourierMsg, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 90:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on CourierMsg' % {"value" : value.encode("utf-8")} )
    ...
    def validate_WeightUnitType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on WeightUnitType' % {"value" : value.encode("utf-8")} )
    ...
    def validate_AdvanceDaysNotice(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_AdvanceDaysNotice_patterns_, ))
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on PLTStatus' % {"value" : value.encode("utf-8")} )
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on PLTStatus' % {"value" : value.encode("utf-8")} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ShipmentResponse', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='', name_='ShipmentResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ShipmentResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ShipmentResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.AirwayBillNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<AirwayBillNumber>%s</AirwayBillNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AirwayBillNumber), input_name='AirwayBillNumber')), eol_))
        if self.BillingCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillingCode>%s</BillingCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillingCode), input_name='BillingCode')), eol_))
        ...
        if self.CourierMessage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CourierMessage>%s</CourierMessage>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CourierMessage), input_name='CourierMessage')), eol_))
        ...
        if self.Rated is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Rated>%s</Rated>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Rated), input_name='Rated')), eol_))
        ...
        if self.ChargeableWeight is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ChargeableWeight>%s</ChargeableWeight>%s' % (self.gds_format_float(self.ChargeableWeight, input_name='ChargeableWeight'), eol_))
        ...
        if self.ReadyByTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ReadyByTime>%s</ReadyByTime>%s' % (self.gds_format_time(self.ReadyByTime, input_name='ReadyByTime'), eol_))
        ...
        if self.CallInTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CallInTime>%s</CallInTime>%s' % (self.gds_format_time(self.CallInTime, input_name='CallInTime'), eol_))
        if self.DaysAdvanceNotice is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DaysAdvanceNotice>%s</DaysAdvanceNotice>%s' % (self.gds_format_integer(self.DaysAdvanceNotice, input_name='DaysAdvanceNotice'), eol_))
        if self.ConversionRate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ConversionRate>%s</ConversionRate>%s' % (self.gds_format_float(self.ConversionRate, input_name='ConversionRate'), eol_))
        ...
        if self.Piece is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Piece>%s</Piece>%s' % (self.gds_format_integer(self.Piece, input_name='Piece'), eol_))
        ...
        if self.ShipmentDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ShipmentDate>%s</ShipmentDate>%s' % (self.gds_format_date(self.ShipmentDate, input_name='ShipmentDate'), eol_))
        ...
        if self.DHLRoutingCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DHLRoutingCode>%s</DHLRoutingCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DHLRoutingCode), input_name='DHLRoutingCode')), eol_))
        if self.DHLRoutingDataId is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DHLRoutingDataId>%s</DHLRoutingDataId>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DHLRoutingDataId), input_name='DHLRoutingDataId')), eol_))
        if self.ProductContentCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ProductContentCode>%s</ProductContentCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ProductContentCode), input_name='ProductContentCode')), eol_))
        ...
        for InternalServiceCode_ in self.InternalServiceCode:
            showIndent(outfile, level, pretty_print)
            outfile.write('<InternalServiceCode>%s</InternalServiceCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(InternalServiceCode_), input_name='InternalServiceCode')), eol_))
        if self.DeliveryDateCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DeliveryDateCode>%s</DeliveryDateCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DeliveryDateCode), input_name='DeliveryDateCode')), eol_))
        if self.DeliveryTimeCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DeliveryTimeCode>%s</DeliveryTimeCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DeliveryTimeCode), input_name='DeliveryTimeCode')), eol_))
        ...
        if self.Billing is not None:
            self.Billing.export(outfile, level, namespace_, name_='Billing', pretty_print=pretty_print)
        if self.Dutiable is not None:
            self.Dutiable.export(outfile, level, namespace_, name_='Dutiable', pretty_print=pretty_print)
        if self.ExportDeclaration is not None:
            self.ExportDeclaration.export(outfile, level, namespace_, name_='ExportDeclaration', pretty_print=pretty_print)
        if self.NewShipper is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NewShipper>%s</NewShipper>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.NewShipper), input_name='NewShipper')), eol_))
        if self.PLTStatus is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<PLTStatus>%s</PLTStatus>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.PLTStatus), input_name='PLTStatus')), eol_))
        for QtdSInAdCur_ in self.QtdSInAdCur:
            QtdSInAdCur_.export(outfile, level, namespace_, name_='QtdSInAdCur', pretty_print=pretty_print)
        for LabelImage_ in self.LabelImage:
            LabelImage_.export(outfile, level, namespace_, name_='LabelImage', pretty_print=pretty_print)
        ...
        if self.ODDURLLink is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ODDURLLink>%s</ODDURLLink>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ODDURLLink), input_name='ODDURLLink')), eol_))
        if self.DGs is not None:
            self.DGs.export(outfile, level, namespace_, name_='DGs', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Response':
            ...
            AirwayBillNumber_ = child_.text
            AirwayBillNumber_ = self.gds_validate_string(AirwayBillNumber_, node, 'AirwayBillNumber')
            self.AirwayBillNumber = AirwayBillNumber_
            ...
            CourierMessage_ = child_.text
            CourierMessage_ = self.gds_validate_string(CourierMessage_, node, 'CourierMessage')
            self.CourierMessage = CourierMessage_
            # validate type CourierMsg
            self.validate_CourierMsg(self.CourierMessage)
        elif nodeName_ == 'DestinationServiceArea':
            obj_ = DestinationServiceArea.factory()
            obj_.build(child_)
            self.DestinationServiceArea = obj_
            obj_.original_tagname_ = 'DestinationServiceArea'
        elif nodeName_ == 'OriginServiceArea':
            obj_ = OriginServiceArea.factory()
            obj_.build(child_)
            ...
            Rated_ = child_.text
            Rated_ = self.gds_validate_string(Rated_, node, 'Rated')
            self.Rated = Rated_
            # validate type YesNo
            self.validate_YesNo(self.Rated)
            ...
            try:
                ...
                raise_parse_error(child_, 'requires float or double: %s' % exp)
            fval_ = self.gds_validate_float(fval_, node, 'ChargeableWeight')
        ...
        elif nodeName_ == 'DaysAdvanceNotice':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
            ...
            DHLRoutingCode_ = child_.text
            DHLRoutingCode_ = self.gds_validate_string(DHLRoutingCode_, node, 'DHLRoutingCode')
            self.DHLRoutingCode = DHLRoutingCode_
            # validate type DHLRoutingCode
            self.validate_DHLRoutingCode(self.DHLRoutingCode)
        elif nodeName_ == 'DHLRoutingDataId':
            DHLRoutingDataId_ = child_.text
            DHLRoutingDataId_ = self.gds_validate_string(DHLRoutingDataId_, node, 'DHLRoutingDataId')
            self.DHLRoutingDataId = DHLRoutingDataId_
            # validate type DHLRoutingCode
            self.validate_DHLRoutingCode(self.DHLRoutingDataId)
        elif nodeName_ == 'ProductContentCode':
            ProductContentCode_ = child_.text
            ProductContentCode_ = self.gds_validate_string(ProductContentCode_, node, 'ProductContentCode')
            self.ProductContentCode = ProductContentCode_
            ...
            InternalServiceCode_ = child_.text
            InternalServiceCode_ = self.gds_validate_string(InternalServiceCode_, node, 'InternalServiceCode')
            self.InternalServiceCode.append(InternalServiceCode_)
            ...
            DeliveryDateCode_ = child_.text
            DeliveryDateCode_ = self.gds_validate_string(DeliveryDateCode_, node, 'DeliveryDateCode')
            self.DeliveryDateCode = DeliveryDateCode_
        elif nodeName_ == 'DeliveryTimeCode':
            DeliveryTimeCode_ = child_.text
            DeliveryTimeCode_ = self.gds_validate_string(DeliveryTimeCode_, node, 'DeliveryTimeCode')
            self.DeliveryTimeCode = DeliveryTimeCode_
        elif nodeName_ == 'SpecialService':
            obj_ = SpecialService.factory()
            obj_.build(child_)
            self.SpecialService.append(obj_)
            obj_.original_tagname_ = 'SpecialService'
        elif nodeName_ == 'Billing':
            obj_ = Billing.factory()
            obj_.build(child_)
            self.Billing = obj_
            obj_.original_tagname_ = 'Billing'
        elif nodeName_ == 'Dutiable':
            obj_ = Dutiable.factory()
            obj_.build(child_)
            self.Dutiable = obj_
            obj_.original_tagname_ = 'Dutiable'
        elif nodeName_ == 'ExportDeclaration':
            obj_ = ExportDeclaration.factory()
            obj_.build(child_)
            self.ExportDeclaration = obj_
            obj_.original_tagname_ = 'ExportDeclaration'
        elif nodeName_ == 'NewShipper':
            NewShipper_ = child_.text
            NewShipper_ = self.gds_validate_string(NewShipper_, node, 'NewShipper')
            self.NewShipper = NewShipper_
            # validate type YesNo
            self.validate_YesNo(self.NewShipper)
        elif nodeName_ == 'PLTStatus':
            PLTStatus_ = child_.text
            PLTStatus_ = self.gds_validate_string(PLTStatus_, node, 'PLTStatus')
            self.PLTStatus = PLTStatus_
            # validate type PLTStatus
            self.validate_PLTStatus(self.PLTStatus)
        elif nodeName_ == 'QtdSInAdCur':
            obj_ = QtdSInAdCur.factory()
            obj_.build(child_)
            self.QtdSInAdCur.append(obj_)
            obj_.original_tagname_ = 'QtdSInAdCur'
        elif nodeName_ == 'LabelImage':
            obj_ = LabelImage.factory()
            obj_.build(child_)
            ...
            ODDURLLink_ = child_.text
            ODDURLLink_ = self.gds_validate_string(ODDURLLink_, node, 'ODDURLLink')
            self.ODDURLLink = ODDURLLink_
        elif nodeName_ == 'DGs':
            obj_ = DGs.factory()
            obj_.build(child_)
            self.DGs = obj_
...
class Contact(GeneratedsSuper):
    ...
    def validate_PersonName(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if len(value) < 2:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on PersonName' % {"value" : value.encode("utf-8")} )
    def validate_PhoneNumber(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on PhoneNumber' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TermsOfTrade' % {"value" : value.encode("utf-8")} )
            if len(value) > 3:
...
class ExportDeclaration(GeneratedsSuper):
    ...
    def get_BillToCompanyName(self): return self.BillToCompanyName
    def set_BillToCompanyName(self, BillToCompanyName): self.BillToCompanyName = BillToCompanyName
    def get_BillToContanctName(self): return self.BillToContanctName
    def set_BillToContanctName(self, BillToContanctName): self.BillToContanctName = BillToContanctName
    def get_BillToAddressLine(self): return self.BillToAddressLine
    def set_BillToAddressLine(self, BillToAddressLine): self.BillToAddressLine = BillToAddressLine
    def add_BillToAddressLine(self, value): self.BillToAddressLine.append(value)
    def insert_BillToAddressLine_at(self, index, value): self.BillToAddressLine.insert(index, value)
    def replace_BillToAddressLine_at(self, index, value): self.BillToAddressLine[index] = value
    def get_BillToCity(self): return self.BillToCity
    def set_BillToCity(self, BillToCity): self.BillToCity = BillToCity
    def get_BillToPostcode(self): return self.BillToPostcode
    def set_BillToPostcode(self, BillToPostcode): self.BillToPostcode = BillToPostcode
    def get_BillToSuburb(self): return self.BillToSuburb
    def set_BillToSuburb(self, BillToSuburb): self.BillToSuburb = BillToSuburb
    def get_BillToState(self): return self.BillToState
    def set_BillToState(self, BillToState): self.BillToState = BillToState
    def get_BillToCountryName(self): return self.BillToCountryName
    def set_BillToCountryName(self, BillToCountryName): self.BillToCountryName = BillToCountryName
    def get_BillToPhoneNumber(self): return self.BillToPhoneNumber
    def set_BillToPhoneNumber(self, BillToPhoneNumber): self.BillToPhoneNumber = BillToPhoneNumber
    def get_BillToPhoneNumberExtn(self): return self.BillToPhoneNumberExtn
    def set_BillToPhoneNumberExtn(self, BillToPhoneNumberExtn): self.BillToPhoneNumberExtn = BillToPhoneNumberExtn
    def get_BillToFaxNumber(self): return self.BillToFaxNumber
    def set_BillToFaxNumber(self, BillToFaxNumber): self.BillToFaxNumber = BillToFaxNumber
    def get_BillToFederalTaxID(self): return self.BillToFederalTaxID
    def set_BillToFederalTaxID(self, BillToFederalTaxID): self.BillToFederalTaxID = BillToFederalTaxID
    def get_Remarks(self): return self.Remarks
    def set_Remarks(self, Remarks): self.Remarks = Remarks
    def get_OtherCharges1(self): return self.OtherCharges1
    def set_OtherCharges1(self, OtherCharges1): self.OtherCharges1 = OtherCharges1
    def get_OtherCharges2(self): return self.OtherCharges2
    def set_OtherCharges2(self, OtherCharges2): self.OtherCharges2 = OtherCharges2
    def get_OtherCharges3(self): return self.OtherCharges3
    def set_OtherCharges3(self, OtherCharges3): self.OtherCharges3 = OtherCharges3
    ...
    def get_PayerGSTVAT(self): return self.PayerGSTVAT
    def set_PayerGSTVAT(self, PayerGSTVAT): self.PayerGSTVAT = PayerGSTVAT
    ...
    def get_ReceiverReference(self): return self.ReceiverReference
    def set_ReceiverReference(self, ReceiverReference): self.ReceiverReference = ReceiverReference
    def get_ExporterId(self): return self.ExporterId
    def set_ExporterId(self, ExporterId): self.ExporterId = ExporterId
    def get_ExporterCode(self): return self.ExporterCode
    def set_ExporterCode(self, ExporterCode): self.ExporterCode = ExporterCode
    def get_PackageMarks(self): return self.PackageMarks
    def set_PackageMarks(self, PackageMarks): self.PackageMarks = PackageMarks
    def get_OtherRemarks2(self): return self.OtherRemarks2
    def set_OtherRemarks2(self, OtherRemarks2): self.OtherRemarks2 = OtherRemarks2
    def get_OtherRemarks3(self): return self.OtherRemarks3
    def set_OtherRemarks3(self, OtherRemarks3): self.OtherRemarks3 = OtherRemarks3
    def get_RUBankINN(self): return self.RUBankINN
    def set_RUBankINN(self, RUBankINN): self.RUBankINN = RUBankINN
    def get_RUBankKPP(self): return self.RUBankKPP
    def set_RUBankKPP(self, RUBankKPP): self.RUBankKPP = RUBankKPP
    def get_RUBankOKPO(self): return self.RUBankOKPO
    def set_RUBankOKPO(self, RUBankOKPO): self.RUBankOKPO = RUBankOKPO
    def get_RUBankOGRN(self): return self.RUBankOGRN
    def set_RUBankOGRN(self, RUBankOGRN): self.RUBankOGRN = RUBankOGRN
    def get_RUBankSettlementAcctNumUSDEUR(self): return self.RUBankSettlementAcctNumUSDEUR
    def set_RUBankSettlementAcctNumUSDEUR(self, RUBankSettlementAcctNumUSDEUR): self.RUBankSettlementAcctNumUSDEUR = RUBankSettlementAcctNumUSDEUR
    def get_RUBankSettlementAcctNumRUR(self): return self.RUBankSettlementAcctNumRUR
    def set_RUBankSettlementAcctNumRUR(self, RUBankSettlementAcctNumRUR): self.RUBankSettlementAcctNumRUR = RUBankSettlementAcctNumRUR
    def get_RUBankName(self): return self.RUBankName
    def set_RUBankName(self, RUBankName): self.RUBankName = RUBankName
    def get_AddDeclText1(self): return self.AddDeclText1
    def set_AddDeclText1(self, AddDeclText1): self.AddDeclText1 = AddDeclText1
    def get_AddDeclText2(self): return self.AddDeclText2
    def set_AddDeclText2(self, AddDeclText2): self.AddDeclText2 = AddDeclText2
    def get_AddDeclText3(self): return self.AddDeclText3
    def set_AddDeclText3(self, AddDeclText3): self.AddDeclText3 = AddDeclText3
    ...
    def validate_ExportReasonType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on ExportReasonType' % {"value" : value.encode("utf-8")} )
    ...
    def validate_SignatureImage(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 1048576:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on SignatureImage' % {"value" : value} )
    def validate_AddDeclText1Type(self, value):
        # Validate type AddDeclText1Type, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 300:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on AddDeclText1Type' % {"value" : value.encode("utf-8")} )
    def validate_AddDeclText(self, value):
        # Validate type AddDeclText, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 140:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on AddDeclText' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ExportDeclaration', fromsubclass_=False, pretty_print=True):
        ...
        if self.InvoiceDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<InvoiceDate>%s</InvoiceDate>%s' % (self.gds_format_date(self.InvoiceDate, input_name='InvoiceDate'), eol_))
        if self.BillToCompanyName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToCompanyName>%s</BillToCompanyName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToCompanyName), input_name='BillToCompanyName')), eol_))
        if self.BillToContanctName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToContanctName>%s</BillToContanctName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToContanctName), input_name='BillToContanctName')), eol_))
        for BillToAddressLine_ in self.BillToAddressLine:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToAddressLine>%s</BillToAddressLine>%s' % (self.gds_encode(self.gds_format_string(quote_xml(BillToAddressLine_), input_name='BillToAddressLine')), eol_))
        if self.BillToCity is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToCity>%s</BillToCity>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToCity), input_name='BillToCity')), eol_))
        if self.BillToPostcode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToPostcode>%s</BillToPostcode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToPostcode), input_name='BillToPostcode')), eol_))
        if self.BillToSuburb is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToSuburb>%s</BillToSuburb>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToSuburb), input_name='BillToSuburb')), eol_))
        if self.BillToState is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToState>%s</BillToState>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToState), input_name='BillToState')), eol_))
        if self.BillToCountryName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToCountryName>%s</BillToCountryName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToCountryName), input_name='BillToCountryName')), eol_))
        if self.BillToPhoneNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToPhoneNumber>%s</BillToPhoneNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToPhoneNumber), input_name='BillToPhoneNumber')), eol_))
        if self.BillToPhoneNumberExtn is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToPhoneNumberExtn>%s</BillToPhoneNumberExtn>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToPhoneNumberExtn), input_name='BillToPhoneNumberExtn')), eol_))
        if self.BillToFaxNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToFaxNumber>%s</BillToFaxNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToFaxNumber), input_name='BillToFaxNumber')), eol_))
        if self.BillToFederalTaxID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BillToFederalTaxID>%s</BillToFederalTaxID>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BillToFederalTaxID), input_name='BillToFederalTaxID')), eol_))
        if self.Remarks is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Remarks>%s</Remarks>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Remarks), input_name='Remarks')), eol_))
        if self.OtherCharges1 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OtherCharges1>%s</OtherCharges1>%s' % (self.gds_format_float(self.OtherCharges1, input_name='OtherCharges1'), eol_))
        if self.OtherCharges2 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OtherCharges2>%s</OtherCharges2>%s' % (self.gds_format_float(self.OtherCharges2, input_name='OtherCharges2'), eol_))
        if self.OtherCharges3 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OtherCharges3>%s</OtherCharges3>%s' % (self.gds_format_float(self.OtherCharges3, input_name='OtherCharges3'), eol_))
        if self.DestinationPort is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DestinationPort>%s</DestinationPort>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DestinationPort), input_name='DestinationPort')), eol_))
        ...
        if self.PayerGSTVAT is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<PayerGSTVAT>%s</PayerGSTVAT>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.PayerGSTVAT), input_name='PayerGSTVAT')), eol_))
        if self.SignatureImage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<SignatureImage>%s</SignatureImage>%s' % (self.gds_format_base64(self.SignatureImage, input_name='SignatureImage'), eol_))
        if self.ReceiverReference is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ReceiverReference>%s</ReceiverReference>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ReceiverReference), input_name='ReceiverReference')), eol_))
        if self.ExporterId is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ExporterId>%s</ExporterId>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ExporterId), input_name='ExporterId')), eol_))
        if self.ExporterCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ExporterCode>%s</ExporterCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ExporterCode), input_name='ExporterCode')), eol_))
        if self.PackageMarks is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<PackageMarks>%s</PackageMarks>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.PackageMarks), input_name='PackageMarks')), eol_))
        if self.OtherRemarks2 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OtherRemarks2>%s</OtherRemarks2>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.OtherRemarks2), input_name='OtherRemarks2')), eol_))
        if self.OtherRemarks3 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OtherRemarks3>%s</OtherRemarks3>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.OtherRemarks3), input_name='OtherRemarks3')), eol_))
        if self.RUBankINN is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RUBankINN>%s</RUBankINN>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RUBankINN), input_name='RUBankINN')), eol_))
        if self.RUBankKPP is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RUBankKPP>%s</RUBankKPP>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RUBankKPP), input_name='RUBankKPP')), eol_))
        if self.RUBankOKPO is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RUBankOKPO>%s</RUBankOKPO>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RUBankOKPO), input_name='RUBankOKPO')), eol_))
        if self.RUBankOGRN is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RUBankOGRN>%s</RUBankOGRN>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RUBankOGRN), input_name='RUBankOGRN')), eol_))
        if self.RUBankSettlementAcctNumUSDEUR is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RUBankSettlementAcctNumUSDEUR>%s</RUBankSettlementAcctNumUSDEUR>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RUBankSettlementAcctNumUSDEUR), input_name='RUBankSettlementAcctNumUSDEUR')), eol_))
        if self.RUBankSettlementAcctNumRUR is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RUBankSettlementAcctNumRUR>%s</RUBankSettlementAcctNumRUR>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RUBankSettlementAcctNumRUR), input_name='RUBankSettlementAcctNumRUR')), eol_))
        if self.RUBankName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RUBankName>%s</RUBankName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RUBankName), input_name='RUBankName')), eol_))
        if self.AddDeclText1 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<AddDeclText1>%s</AddDeclText1>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AddDeclText1), input_name='AddDeclText1')), eol_))
        if self.AddDeclText2 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<AddDeclText2>%s</AddDeclText2>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AddDeclText2), input_name='AddDeclText2')), eol_))
        if self.AddDeclText3 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<AddDeclText3>%s</AddDeclText3>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AddDeclText3), input_name='AddDeclText3')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'InterConsignee':
            ...
            BillToCompanyName_ = child_.text
            BillToCompanyName_ = self.gds_validate_string(BillToCompanyName_, node, 'BillToCompanyName')
            self.BillToCompanyName = BillToCompanyName_
        elif nodeName_ == 'BillToContanctName':
            BillToContanctName_ = child_.text
            BillToContanctName_ = self.gds_validate_string(BillToContanctName_, node, 'BillToContanctName')
            self.BillToContanctName = BillToContanctName_
        elif nodeName_ == 'BillToAddressLine':
            BillToAddressLine_ = child_.text
            BillToAddressLine_ = self.gds_validate_string(BillToAddressLine_, node, 'BillToAddressLine')
            self.BillToAddressLine.append(BillToAddressLine_)
            # validate type AddressLine
            self.validate_AddressLine(self.BillToAddressLine[-1])
        elif nodeName_ == 'BillToCity':
            BillToCity_ = child_.text
            BillToCity_ = self.gds_validate_string(BillToCity_, node, 'BillToCity')
            self.BillToCity = BillToCity_
        elif nodeName_ == 'BillToPostcode':
            BillToPostcode_ = child_.text
            BillToPostcode_ = self.gds_validate_string(BillToPostcode_, node, 'BillToPostcode')
            self.BillToPostcode = BillToPostcode_
        elif nodeName_ == 'BillToSuburb':
            BillToSuburb_ = child_.text
            BillToSuburb_ = self.gds_validate_string(BillToSuburb_, node, 'BillToSuburb')
            self.BillToSuburb = BillToSuburb_
        elif nodeName_ == 'BillToState':
            BillToState_ = child_.text
            BillToState_ = self.gds_validate_string(BillToState_, node, 'BillToState')
            self.BillToState = BillToState_
        elif nodeName_ == 'BillToCountryName':
            BillToCountryName_ = child_.text
            BillToCountryName_ = self.gds_validate_string(BillToCountryName_, node, 'BillToCountryName')
            self.BillToCountryName = BillToCountryName_
        elif nodeName_ == 'BillToPhoneNumber':
            BillToPhoneNumber_ = child_.text
            BillToPhoneNumber_ = self.gds_validate_string(BillToPhoneNumber_, node, 'BillToPhoneNumber')
            self.BillToPhoneNumber = BillToPhoneNumber_
        elif nodeName_ == 'BillToPhoneNumberExtn':
            BillToPhoneNumberExtn_ = child_.text
            BillToPhoneNumberExtn_ = self.gds_validate_string(BillToPhoneNumberExtn_, node, 'BillToPhoneNumberExtn')
            self.BillToPhoneNumberExtn = BillToPhoneNumberExtn_
        elif nodeName_ == 'BillToFaxNumber':
            BillToFaxNumber_ = child_.text
            BillToFaxNumber_ = self.gds_validate_string(BillToFaxNumber_, node, 'BillToFaxNumber')
            self.BillToFaxNumber = BillToFaxNumber_
        elif nodeName_ == 'BillToFederalTaxID':
            BillToFederalTaxID_ = child_.text
            BillToFederalTaxID_ = self.gds_validate_string(BillToFederalTaxID_, node, 'BillToFederalTaxID')
            self.BillToFederalTaxID = BillToFederalTaxID_
        elif nodeName_ == 'Remarks':
            Remarks_ = child_.text
            Remarks_ = self.gds_validate_string(Remarks_, node, 'Remarks')
            self.Remarks = Remarks_
        elif nodeName_ == 'OtherCharges1':
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
            ...
            PayerGSTVAT_ = child_.text
            PayerGSTVAT_ = self.gds_validate_string(PayerGSTVAT_, node, 'PayerGSTVAT')
            self.PayerGSTVAT = PayerGSTVAT_
            ...
            ReceiverReference_ = child_.text
            ReceiverReference_ = self.gds_validate_string(ReceiverReference_, node, 'ReceiverReference')
            self.ReceiverReference = ReceiverReference_
        elif nodeName_ == 'ExporterId':
            ExporterId_ = child_.text
            ExporterId_ = self.gds_validate_string(ExporterId_, node, 'ExporterId')
            self.ExporterId = ExporterId_
        elif nodeName_ == 'ExporterCode':
            ExporterCode_ = child_.text
            ExporterCode_ = self.gds_validate_string(ExporterCode_, node, 'ExporterCode')
            self.ExporterCode = ExporterCode_
        elif nodeName_ == 'PackageMarks':
            PackageMarks_ = child_.text
            PackageMarks_ = self.gds_validate_string(PackageMarks_, node, 'PackageMarks')
            self.PackageMarks = PackageMarks_
        elif nodeName_ == 'OtherRemarks2':
            OtherRemarks2_ = child_.text
            OtherRemarks2_ = self.gds_validate_string(OtherRemarks2_, node, 'OtherRemarks2')
            self.OtherRemarks2 = OtherRemarks2_
        elif nodeName_ == 'OtherRemarks3':
            OtherRemarks3_ = child_.text
            OtherRemarks3_ = self.gds_validate_string(OtherRemarks3_, node, 'OtherRemarks3')
            self.OtherRemarks3 = OtherRemarks3_
        elif nodeName_ == 'RUBankINN':
            RUBankINN_ = child_.text
            RUBankINN_ = self.gds_validate_string(RUBankINN_, node, 'RUBankINN')
            self.RUBankINN = RUBankINN_
        elif nodeName_ == 'RUBankKPP':
            RUBankKPP_ = child_.text
            RUBankKPP_ = self.gds_validate_string(RUBankKPP_, node, 'RUBankKPP')
            self.RUBankKPP = RUBankKPP_
        elif nodeName_ == 'RUBankOKPO':
            RUBankOKPO_ = child_.text
            RUBankOKPO_ = self.gds_validate_string(RUBankOKPO_, node, 'RUBankOKPO')
            self.RUBankOKPO = RUBankOKPO_
        elif nodeName_ == 'RUBankOGRN':
            RUBankOGRN_ = child_.text
            RUBankOGRN_ = self.gds_validate_string(RUBankOGRN_, node, 'RUBankOGRN')
            self.RUBankOGRN = RUBankOGRN_
        elif nodeName_ == 'RUBankSettlementAcctNumUSDEUR':
            RUBankSettlementAcctNumUSDEUR_ = child_.text
            RUBankSettlementAcctNumUSDEUR_ = self.gds_validate_string(RUBankSettlementAcctNumUSDEUR_, node, 'RUBankSettlementAcctNumUSDEUR')
            self.RUBankSettlementAcctNumUSDEUR = RUBankSettlementAcctNumUSDEUR_
        elif nodeName_ == 'RUBankSettlementAcctNumRUR':
            RUBankSettlementAcctNumRUR_ = child_.text
            RUBankSettlementAcctNumRUR_ = self.gds_validate_string(RUBankSettlementAcctNumRUR_, node, 'RUBankSettlementAcctNumRUR')
            self.RUBankSettlementAcctNumRUR = RUBankSettlementAcctNumRUR_
        elif nodeName_ == 'RUBankName':
            RUBankName_ = child_.text
            RUBankName_ = self.gds_validate_string(RUBankName_, node, 'RUBankName')
            self.RUBankName = RUBankName_
        elif nodeName_ == 'AddDeclText1':
            AddDeclText1_ = child_.text
            AddDeclText1_ = self.gds_validate_string(AddDeclText1_, node, 'AddDeclText1')
            self.AddDeclText1 = AddDeclText1_
            # validate type AddDeclText1Type
            self.validate_AddDeclText1Type(self.AddDeclText1)
        elif nodeName_ == 'AddDeclText2':
            AddDeclText2_ = child_.text
            AddDeclText2_ = self.gds_validate_string(AddDeclText2_, node, 'AddDeclText2')
            self.AddDeclText2 = AddDeclText2_
            # validate type AddDeclText
            self.validate_AddDeclText(self.AddDeclText2)
        elif nodeName_ == 'AddDeclText3':
            AddDeclText3_ = child_.text
            AddDeclText3_ = self.gds_validate_string(AddDeclText3_, node, 'AddDeclText3')
            self.AddDeclText3 = AddDeclText3_
            # validate type AddDeclText
            self.validate_AddDeclText(self.AddDeclText3)
...
class ExportLineItem(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, LineNumber=None, Quantity=None, QuantityUnit=None, Description=None, Value=None, IsDomestic=None, CommodityCode=None, ScheduleB=None, ECCN=None, Weight=None, GrossWeight=None, License=None, LicenseSymbol=None, ManufactureCountryCode=None, ManufactureCountryName=None):
        self.original_tagname_ = None
    ...
    def get_ManufactureCountryName(self): return self.ManufactureCountryName
    def set_ManufactureCountryName(self, ManufactureCountryName): self.ManufactureCountryName = ManufactureCountryName
    ...
    def validate_QuantityUnit(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['UOM', 'BOX', '2GM', '2M', '2M3', '3M3', 'M3', 'DPR', 'DOZ', '2NO', 'PCS', 'GM', 'GRS', 'KG', 'L', 'M', '3GM', '3L', 'X', 'NO', '2KG', 'PRS', '2L', '3KG', 'CM2', '2M2', '3M2', 'M2', '4M2', '3M']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    enumeration_respectee = True
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on QuantityUnit' % {"value" : value.encode("utf-8")} )
            if len(value) > 8:
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ExportLineItem', fromsubclass_=False, pretty_print=True):
        ...
        if self.ManufactureCountryName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ManufactureCountryName>%s</ManufactureCountryName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ManufactureCountryName), input_name='ManufactureCountryName')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'LineNumber':
            ...
            ManufactureCountryName_ = child_.text
            ManufactureCountryName_ = self.gds_validate_string(ManufactureCountryName_, node, 'ManufactureCountryName')
            self.ManufactureCountryName = ManufactureCountryName_
            # validate type CountryName
            self.validate_CountryName(self.ManufactureCountryName)
...
class Shipper(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ShipperID=None, CompanyName=None, SuiteDepartmentName=None, RegisteredAccount=None, AddressLine=None, City=None, Division=None, DivisionCode=None, PostalCode=None, OriginServiceAreaCode=None, OriginFacilityCode=None, CountryCode=None, CountryName=None, FederalTaxId=None, StateTaxId=None, EORI_No=None, Contact=None, Suburb=None):
        self.original_tagname_ = None
    ...
    def get_StateTaxId(self): return self.StateTaxId
    def set_StateTaxId(self, StateTaxId): self.StateTaxId = StateTaxId
    def get_EORI_No(self): return self.EORI_No
    def set_EORI_No(self, EORI_No): self.EORI_No = EORI_No
    def get_Contact(self): return self.Contact
    def set_Contact(self, Contact): self.Contact = Contact
    def get_Suburb(self): return self.Suburb
    def set_Suburb(self, Suburb): self.Suburb = Suburb
    ...
    def validate_EORI_NoType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on EORI_NoType' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on EORI_NoType' % {"value" : value.encode("utf-8")} )
    def validate_Suburb(self, value):
        # Validate type Suburb, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='Shipper', fromsubclass_=False, pretty_print=True):
        ...
        if self.EORI_No is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<EORI_No>%s</EORI_No>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EORI_No), input_name='EORI_No')), eol_))
        if self.Contact is not None:
            self.Contact.export(outfile, level, namespace_, name_='Contact', pretty_print=pretty_print)
        if self.Suburb is not None:
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ShipperID':
            ...
            EORI_No_ = child_.text
            EORI_No_ = self.gds_validate_string(EORI_No_, node, 'EORI_No')
            self.EORI_No = EORI_No_
...
class Request(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ServiceHeader=None, MetaData=None):
        self.original_tagname_ = None
...
class MetaData(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, SoftwareName=None, SoftwareVersion=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_SoftwareName(self): return self.SoftwareName
    def set_SoftwareName(self, SoftwareName): self.SoftwareName = SoftwareName
    ...
    def validate_SoftwareNameType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on SoftwareNameType' % {"value" : value.encode("utf-8")} )
    def validate_SoftwareVersionType(self, value):
        # Validate type SoftwareVersionType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 10:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on SoftwareVersionType' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='MetaData', fromsubclass_=False, pretty_print=True):
        ...
        if self.SoftwareName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<SoftwareName>%s</SoftwareName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SoftwareName), input_name='SoftwareName')), eol_))
        if self.SoftwareVersion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<SoftwareVersion>%s</SoftwareVersion>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SoftwareVersion), input_name='SoftwareVersion')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on WeightUnitType4' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            self.OriginServiceArea is not None or
            self.DestinationServiceArea is not None or
...
class LabelImage(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, OutputFormat=None, OutputImage=None, MultiLabels=None):
        self.original_tagname_ = None
...
class Label(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, HideAccount=None, LabelTemplate=None, ReceiptTemplate=None, DocDetach=None, Logo=None, CustomerLogo=None, Resolution=None, CustomerBarcodeType=None, CustomerBarcodeCode=None, CustomerBarcodeText=None):
        self.original_tagname_ = None
    ...
    def get_CustomerBarcodeType(self): return self.CustomerBarcodeType
    def set_CustomerBarcodeType(self, CustomerBarcodeType): self.CustomerBarcodeType = CustomerBarcodeType
    def get_CustomerBarcodeCode(self): return self.CustomerBarcodeCode
    def set_CustomerBarcodeCode(self, CustomerBarcodeCode): self.CustomerBarcodeCode = CustomerBarcodeCode
    def get_CustomerBarcodeText(self): return self.CustomerBarcodeText
    def set_CustomerBarcodeText(self, CustomerBarcodeText): self.CustomerBarcodeText = CustomerBarcodeText
    def validate_YesNo(self, value):
        # Validate type YesNo, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='Label', fromsubclass_=False, pretty_print=True):
        ...
        if self.CustomerBarcodeType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CustomerBarcodeType>%s</CustomerBarcodeType>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CustomerBarcodeType), input_name='CustomerBarcodeType')), eol_))
        if self.CustomerBarcodeCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CustomerBarcodeCode>%s</CustomerBarcodeCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CustomerBarcodeCode), input_name='CustomerBarcodeCode')), eol_))
        if self.CustomerBarcodeText is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CustomerBarcodeText>%s</CustomerBarcodeText>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CustomerBarcodeText), input_name='CustomerBarcodeText')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'HideAccount':
            ...
            CustomerBarcodeType_ = child_.text
            CustomerBarcodeType_ = self.gds_validate_string(CustomerBarcodeType_, node, 'CustomerBarcodeType')
            self.CustomerBarcodeType = CustomerBarcodeType_
        elif nodeName_ == 'CustomerBarcodeCode':
            CustomerBarcodeCode_ = child_.text
            CustomerBarcodeCode_ = self.gds_validate_string(CustomerBarcodeCode_, node, 'CustomerBarcodeCode')
            self.CustomerBarcodeCode = CustomerBarcodeCode_
        elif nodeName_ == 'CustomerBarcodeText':
            CustomerBarcodeText_ = child_.text
            CustomerBarcodeText_ = self.gds_validate_string(CustomerBarcodeText_, node, 'CustomerBarcodeText')
            self.CustomerBarcodeText = CustomerBarcodeText_
# end class Label
...
class DGs(GeneratedsSuper):
    ...
    factory = staticmethod(factory)
    def get_DG(self): return self.DG
    def set_DG(self, DG): self.DG = DG
    def add_DG(self, value): self.DG.append(value)
    def insert_DG_at(self, index, value): self.DG.insert(index, value)
    def replace_DG_at(self, index, value): self.DG[index] = value
    def hasContent_(self):
        if (
            self.DG
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='DGs', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DGs')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='DGs', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DGs'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='DGs', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for DG_ in self.DG:
            DG_.export(outfile, level, namespace_, name_='DG', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class DG(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, DG_ContentID=None, DG_LabelDesc=None, DG_NetWeight=None, DG_UOM=None, DG_UNCode=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_DG_ContentID(self): return self.DG_ContentID
    def set_DG_ContentID(self, DG_ContentID): self.DG_ContentID = DG_ContentID
    def get_DG_LabelDesc(self): return self.DG_LabelDesc
    def set_DG_LabelDesc(self, DG_LabelDesc): self.DG_LabelDesc = DG_LabelDesc
    def get_DG_NetWeight(self): return self.DG_NetWeight
    def set_DG_NetWeight(self, DG_NetWeight): self.DG_NetWeight = DG_NetWeight
    def get_DG_UOM(self): return self.DG_UOM
    def set_DG_UOM(self, DG_UOM): self.DG_UOM = DG_UOM
    def get_DG_UNCode(self): return self.DG_UNCode
    def set_DG_UNCode(self, DG_UNCode): self.DG_UNCode = DG_UNCode
    def validate_Weight(self, value):
        # Validate type Weight, a restriction on xsd:decimal.
        if value is not None and Validate_simpletypes_:
            if value < 0.000:
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on DG_UOM' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='DG', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DG')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='DG', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DG'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='DG', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.DG_ContentID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DG_ContentID>%s</DG_ContentID>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DG_ContentID), input_name='DG_ContentID')), eol_))
        if self.DG_LabelDesc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DG_LabelDesc>%s</DG_LabelDesc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DG_LabelDesc), input_name='DG_LabelDesc')), eol_))
        if self.DG_NetWeight is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DG_NetWeight>%s</DG_NetWeight>%s' % (self.gds_format_float(self.DG_NetWeight, input_name='DG_NetWeight'), eol_))
        if self.DG_UOM is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DG_UOM>%s</DG_UOM>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DG_UOM), input_name='DG_UOM')), eol_))
        if self.DG_UNCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DG_UNCode>%s</DG_UNCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DG_UNCode), input_name='DG_UNCode')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'DG_ContentID':
            DG_ContentID_ = child_.text
            DG_ContentID_ = self.gds_validate_string(DG_ContentID_, node, 'DG_ContentID')
            self.DG_ContentID = DG_ContentID_
        elif nodeName_ == 'DG_LabelDesc':
            DG_LabelDesc_ = child_.text
            DG_LabelDesc_ = self.gds_validate_string(DG_LabelDesc_, node, 'DG_LabelDesc')
            self.DG_LabelDesc = DG_LabelDesc_
        elif nodeName_ == 'DG_NetWeight':
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires float or double: %s' % exp)
            fval_ = self.gds_validate_float(fval_, node, 'DG_NetWeight')
            self.DG_NetWeight = fval_
            # validate type Weight
            self.validate_Weight(self.DG_NetWeight)
        elif nodeName_ == 'DG_UOM':
            DG_UOM_ = child_.text
            DG_UOM_ = self.gds_validate_string(DG_UOM_, node, 'DG_UOM')
            self.DG_UOM = DG_UOM_
            # validate type DG_UOM
            self.validate_DG_UOM(self.DG_UOM)
        elif nodeName_ == 'DG_UNCode':
            DG_UNCode_ = child_.text
            DG_UNCode_ = self.gds_validate_string(DG_UNCode_, node, 'DG_UNCode')
            self.DG_UNCode = DG_UNCode_
# end class DG
...
class BarcodesType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, AWBBarCode=None, OriginDestnBarcode=None, ClientIDBarCode=None, BarCode2D=None, DHLRoutingBarCode=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_AWBBarCode(self): return self.AWBBarCode
    def set_AWBBarCode(self, AWBBarCode): self.AWBBarCode = AWBBarCode
    def get_OriginDestnBarcode(self): return self.OriginDestnBarcode
    def set_OriginDestnBarcode(self, OriginDestnBarcode): self.OriginDestnBarcode = OriginDestnBarcode
    def get_ClientIDBarCode(self): return self.ClientIDBarCode
    def set_ClientIDBarCode(self, ClientIDBarCode): self.ClientIDBarCode = ClientIDBarCode
    def get_BarCode2D(self): return self.BarCode2D
    def set_BarCode2D(self, BarCode2D): self.BarCode2D = BarCode2D
    def get_DHLRoutingBarCode(self): return self.DHLRoutingBarCode
    def set_DHLRoutingBarCode(self, DHLRoutingBarCode): self.DHLRoutingBarCode = DHLRoutingBarCode
    def validate_BarCode(self, value):
        # Validate type BarCode, a restriction on xsd:base64Binary.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='BarcodesType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='BarcodesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='BarcodesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='BarcodesType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='BarcodesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.AWBBarCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<AWBBarCode>%s</AWBBarCode>%s' % (self.gds_format_base64(self.AWBBarCode, input_name='AWBBarCode'), eol_))
        if self.OriginDestnBarcode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OriginDestnBarcode>%s</OriginDestnBarcode>%s' % (self.gds_format_base64(self.OriginDestnBarcode, input_name='OriginDestnBarcode'), eol_))
        if self.ClientIDBarCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ClientIDBarCode>%s</ClientIDBarCode>%s' % (self.gds_format_base64(self.ClientIDBarCode, input_name='ClientIDBarCode'), eol_))
        if self.BarCode2D is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BarCode2D>%s</BarCode2D>%s' % (self.gds_format_base64(self.BarCode2D, input_name='BarCode2D'), eol_))
        if self.DHLRoutingBarCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DHLRoutingBarCode>%s</DHLRoutingBarCode>%s' % (self.gds_format_base64(self.DHLRoutingBarCode, input_name='DHLRoutingBarCode'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class GrossWeightType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='GrossWeightType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GrossWeightType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='GrossWeightType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='GrossWeightType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='GrossWeightType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ship_val_global_res_6.1 import *\n\n')
        sys.stdout.write('import ship_val_global_res_6.1 as model_\n\n')
