...
#
# Generated Tue Jun 12 21:53:28 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/cancel_pickup_global_req_2.0.py')
#
# Command line arguments:
#   /py_dhl/xsd/cancel-pickup-global-req-2.0.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/cancel_pickup_global_req_2.0.py" /py_dhl/xsd/cancel-pickup-global-req-2.0.xsd
#
...
class CancelPURequest(GeneratedsSuper):
    """Root element of Cancel Pickup Request"""
    subclass = None
    superclass = None
    def __init__(self, schemaVersion=2.0, Request=None, RegionCode=None, ConfirmationNumber=None, RequestorName=None, CountryCode=None, OriginSvcArea=None, Reason=None, PickupDate=None, CancelTime=None):
        ...
        self.validate_RequestorNameType(self.RequestorName)
        ...
        self.Reason = Reason
        self.validate_ReasonType(self.Reason)
        ...
        self.validate_TimeHM(self.CancelTime)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CancelPURequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CancelPURequest.subclass:
            return CancelPURequest.subclass(*args_, **kwargs_)
        else:
            return CancelPURequest(*args_, **kwargs_)
    ...
    def get_CancelTime(self): return self.CancelTime
    def set_CancelTime(self, CancelTime): self.CancelTime = CancelTime
    ...
    def validate_RequestorNameType(self, value):
        # Validate type RequestorNameType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on RequestorNameType' % {"value" : value.encode("utf-8")} )
    ...
    def validate_ReasonType(self, value):
        # Validate type ReasonType, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['001', '002', '003', '004', '005', '006', '007', '008']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    enumeration_respectee = True
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on ReasonType' % {"value" : value.encode("utf-8")} )
            if len(value) > 3:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on ReasonType' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on ReasonType' % {"value" : value.encode("utf-8")} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='CancelPURequest', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CancelPURequest')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CancelPURequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='CancelPURequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='CancelPURequest'):
        if self.schemaVersion != 2.0 and 'schemaVersion' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CancelPURequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.RequestorName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RequestorName>%s</RequestorName>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RequestorName), input_name='RequestorName')), eol_))
        ...
        if self.Reason is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Reason>%s</Reason>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Reason), input_name='Reason')), eol_))
        ...
        if self.CancelTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CancelTime>%s</CancelTime>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CancelTime), input_name='CancelTime')), eol_))
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Request':
            ...
            # validate type RequestorNameType
            self.validate_RequestorNameType(self.RequestorName)
...
class Contact(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='dhlPickup:', name_='Contact', fromsubclass_=False, pretty_print=True):
        ...
        if self.PhoneNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:PhoneNumber>%s</dhlPickup:PhoneNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.PhoneNumber), input_name='PhoneNumber')), eol_))
        ...
        if self.FaxNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:FaxNumber>%s</dhlPickup:FaxNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.FaxNumber), input_name='FaxNumber')), eol_))
        if self.Telex is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:Telex>%s</dhlPickup:Telex>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Telex), input_name='Telex')), eol_))
        ...
        if self.MobilePhoneNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dhlPickup:MobilePhoneNumber>%s</dhlPickup:MobilePhoneNumber>%s' % (self.gds_format_integer(self.MobilePhoneNumber, input_name='MobilePhoneNumber'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Requestor(GeneratedsSuper):
    ...
    def __init__(self, AccountType=None, AccountNumber=None, RequestorContact=None, CompanyName=None, Address1=None, Address2=None, City=None, CountryCode=None, DivisionName=None, PostalCode=None):
        ...
        self.validate_Address1Type5(self.Address1)
        self.Address2 = Address2
        self.validate_Address2Type6(self.Address2)
        self.City = City
        self.validate_City(self.City)
        self.CountryCode = CountryCode
        self.validate_CountryCode(self.CountryCode)
    ...
    def validate_CompanyNameValidator(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on CompanyNameValidator' % {"value" : value.encode("utf-8")} )
    def validate_Address1Type5(self, value):
        # Validate type Address1Type5, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on Address1Type5' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on Address1Type5' % {"value" : value.encode("utf-8")} )
    def validate_Address2Type6(self, value):
        # Validate type Address2Type6, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on Address2Type6' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on Address2Type6' % {"value" : value.encode("utf-8")} )
    def validate_City(self, value):
        # Validate type City, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
...
class RequestorContact(GeneratedsSuper):
    ...
    def __init__(self, PersonName=None, Phone=None, PhoneExtension=None):
        self.original_tagname_ = None
        self.PersonName = PersonName
        self.validate_PersonNameType7(self.PersonName)
        self.Phone = Phone
        self.validate_PhoneType8(self.Phone)
        self.PhoneExtension = PhoneExtension
        self.validate_PhoneExtensionType9(self.PhoneExtension)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_PhoneExtension(self): return self.PhoneExtension
    def set_PhoneExtension(self, PhoneExtension): self.PhoneExtension = PhoneExtension
    def validate_PersonNameType7(self, value):
        # Validate type PersonNameType7, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 35:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on PersonNameType7' % {"value" : value.encode("utf-8")} )
    def validate_PhoneType8(self, value):
        # Validate type PhoneType8, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 25:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on PhoneType8' % {"value" : value.encode("utf-8")} )
    def validate_PhoneExtensionType9(self, value):
        # Validate type PhoneExtensionType9, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 5:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on PhoneExtensionType9' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            self.PersonName is not None or
            self.Phone is not None or
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PersonName':
            ...
            PersonName_ = self.gds_validate_string(PersonName_, node, 'PersonName')
            self.PersonName = PersonName_
            # validate type PersonNameType7
            self.validate_PersonNameType7(self.PersonName)
        elif nodeName_ == 'Phone':
            Phone_ = child_.text
            Phone_ = self.gds_validate_string(Phone_, node, 'Phone')
            self.Phone = Phone_
            # validate type PhoneType8
            self.validate_PhoneType8(self.Phone)
        elif nodeName_ == 'PhoneExtension':
            PhoneExtension_ = child_.text
            PhoneExtension_ = self.gds_validate_string(PhoneExtension_, node, 'PhoneExtension')
            self.PhoneExtension = PhoneExtension_
            # validate type PhoneExtensionType9
            self.validate_PhoneExtensionType9(self.PhoneExtension)
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'CancelPURequest'
        rootClass = CancelPURequest
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from cancel_pickup_global_req_2.0 import *\n\n')
        sys.stdout.write('import cancel_pickup_global_req_2.0 as model_\n\n')
