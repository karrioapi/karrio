...
#   ('--no-namespace-defs', '')
#   ('-o', './python/routing_err_res.py')
#
# Command line arguments:
#   ./schemas/routing-err-res.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/routing_err_res.py" ./schemas/routing-err-res.xsd
#
