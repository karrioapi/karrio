...
#
# Generated Tue Jun 12 21:58:05 2018 by generateDS.py version 2.29.14.
...
#   /py_dhl/xsd/TrackingResponse.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/tracking_response.py" /py_dhl/xsd/TrackingResponse.xsd
#
...
class TrackingResponse(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Response=None, AWBInfo=None, Fault=None, LanguageCode=None):
    ...
    def get_AWBInfo(self): return self.AWBInfo
    def set_AWBInfo(self, AWBInfo): self.AWBInfo = AWBInfo
    def add_AWBInfo(self, value): self.AWBInfo.append(value)
    def insert_AWBInfo_at(self, index, value): self.AWBInfo.insert(index, value)
    def replace_AWBInfo_at(self, index, value): self.AWBInfo[index] = value
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TrackingResponse', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='', name_='TrackingResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TrackingResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='TrackingResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for AWBInfo_ in self.AWBInfo:
            AWBInfo_.export(outfile, level, namespace_, name_='AWBInfo', pretty_print=pretty_print)
