...
#
# Generated Fri Mar  6 18:34:14 2020 by generateDS.py version 2.35.15.
# Python 3.8.1 (v3.8.1:1b293b6006, Dec 18 2019, 14:08:53)  [Clang 6.0 (clang-600.0.57)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './python/book_pickup_global_req.py')
#
# Command line arguments:
#   ./schemas/book-pickup-global-req.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/book_pickup_global_req.py" ./schemas/book-pickup-global-req.xsd
#
...
class BookPURequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, schemaVersion=1.0, Request=None, RegionCode=None, Requestor=None, Place=None, Pickup=None, PickupContact=None, ShipmentDetails=None, gds_collector_=None, **kwargs_):
    ...
    def set_ShipmentDetails(self, ShipmentDetails):
        self.ShipmentDetails = ShipmentDetails
    def add_ShipmentDetails(self, value):
        self.ShipmentDetails.append(value)
    def insert_ShipmentDetails_at(self, index, value):
        self.ShipmentDetails.insert(index, value)
    def replace_ShipmentDetails_at(self, index, value):
        self.ShipmentDetails[index] = value
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BookPURequest', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'BookPURequest':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='BookPURequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='BookPURequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='BookPURequest'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BookPURequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for ShipmentDetails_ in self.ShipmentDetails:
            ...
            ShipmentDetails_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='ShipmentDetails', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Request':
            ...
            obj_ = Requestor.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Requestor = obj_
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from book_pickup_global_req import *\n\n')
        sys.stdout.write('import book_pickup_global_req as model_\n\n')
