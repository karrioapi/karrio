...
#
# Generated Fri Mar  6 18:34:27 2020 by generateDS.py version 2.35.15.
# Python 3.8.1 (v3.8.1:1b293b6006, Dec 18 2019, 14:08:53)  [Clang 6.0 (clang-600.0.57)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './python/modify_pickup_global_req.py')
#
# Command line arguments:
#   ./schemas/modify-pickup-global-req.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.env/bin/generateDS --no-namespace-defs -o "./python/modify_pickup_global_req.py" ./schemas/modify-pickup-global-req.xsd
#
...
class ModifyPURequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, schemaVersion=1.0, Request=None, RegionCode=None, ConfirmationNumber=None, Requestor=None, Place=None, Pickup=None, PickupContact=None, OriginSvcArea=None, gds_collector_=None, **kwargs_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ModifyPURequest', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ModifyPURequest':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ModifyPURequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ModifyPURequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ModifyPURequest'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ModifyPURequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from modify_pickup_global_req import *\n\n')
        sys.stdout.write('import modify_pickup_global_req as model_\n\n')
