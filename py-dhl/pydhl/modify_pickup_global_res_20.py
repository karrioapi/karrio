...
#
# Generated Tue Jun 12 21:52:36 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/modify_pickup_global_res_2.0.py')
#
# Command line arguments:
#   /py_dhl/xsd/modify-pickup-global-res-2.0.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/modify_pickup_global_res_2.0.py" /py_dhl/xsd/modify-pickup-global-res-2.0.xsd
#
...
class ModifyPUResponse(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ModifyPUResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ModifyPUResponse.subclass:
            return ModifyPUResponse.subclass(*args_, **kwargs_)
        else:
            return ModifyPUResponse(*args_, **kwargs_)
    ...
    def validate_ConfirmationNumberType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if value < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on ConfirmationNumberType' % {"value" : value} )
            if value > 999999999:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on ConfirmationNumberType' % {"value" : value} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ModifyPUResponse', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ModifyPUResponse')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ModifyPUResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ModifyPUResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ModifyPUResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ModifyPUResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ConfirmationNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ConfirmationNumber>%s</ConfirmationNumber>%s' % (self.gds_format_integer(self.ConfirmationNumber, input_name='ConfirmationNumber'), eol_))
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ModifyPUResponse'
        rootClass = ModifyPUResponse
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from modify_pickup_global_res_2.0 import *\n\n')
        sys.stdout.write('import modify_pickup_global_res_2.0 as model_\n\n')
