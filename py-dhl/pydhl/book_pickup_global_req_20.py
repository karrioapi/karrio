...
#
# Generated Tue Jun 12 21:51:59 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pydhl/book_pickup_global_req_2.0.py')
#
# Command line arguments:
#   /py_dhl/xsd/book-pickup-global-req-2.0.xsd
#
# Command line:
#   generateDS --no-namespace-defs -o "./pydhl/book_pickup_global_req_2.0.py" /py_dhl/xsd/book-pickup-global-req-2.0.xsd
#
...
class BookPURequest(GeneratedsSuper):
    """Root element of Book Pickup Request"""
    subclass = None
    superclass = None
    def __init__(self, schemaVersion=2.0, Request=None, RegionCode=None, Requestor=None, Place=None, Pickup=None, PickupContact=None, ShipmentDetails=None, ConsigneeDetails=None):
        ...
        if ShipmentDetails is None:
            self.ShipmentDetails = []
        else:
            self.ShipmentDetails = ShipmentDetails
        self.ConsigneeDetails = ConsigneeDetails
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, BookPURequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if BookPURequest.subclass:
            return BookPURequest.subclass(*args_, **kwargs_)
        else:
            return BookPURequest(*args_, **kwargs_)
    ...
    def add_ShipmentDetails(self, value): self.ShipmentDetails.append(value)
    def insert_ShipmentDetails_at(self, index, value): self.ShipmentDetails.insert(index, value)
    def replace_ShipmentDetails_at(self, index, value): self.ShipmentDetails[index] = value
    def get_ConsigneeDetails(self): return self.ConsigneeDetails
    def set_ConsigneeDetails(self, ConsigneeDetails): self.ConsigneeDetails = ConsigneeDetails
    ...
    def hasContent_(self):
        if (
            ...
            self.ShipmentDetails or
            self.ConsigneeDetails is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='BookPURequest', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('BookPURequest')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='BookPURequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='BookPURequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='BookPURequest'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='BookPURequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for ShipmentDetails_ in self.ShipmentDetails:
            ShipmentDetails_.export(outfile, level, namespace_, name_='ShipmentDetails', pretty_print=pretty_print)
        if self.ConsigneeDetails is not None:
            self.ConsigneeDetails.export(outfile, level, namespace_, name_='ConsigneeDetails', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Request':
            ...
            obj_.build(child_)
            self.ShipmentDetails.append(obj_)
            obj_.original_tagname_ = 'ShipmentDetails'
        elif nodeName_ == 'ConsigneeDetails':
            obj_ = ConsigneeDetails.factory()
            obj_.build(child_)
            self.ConsigneeDetails = obj_
            obj_.original_tagname_ = 'ConsigneeDetails'
# end class BookPURequest
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'BookPURequest'
        rootClass = BookPURequest
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from book_pickup_global_req_2.0 import *\n\n')
        sys.stdout.write('import book_pickup_global_req_2.0 as model_\n\n')
