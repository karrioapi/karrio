...
#
# Generated Tue Jun 12 20:20:51 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', 'pyups/label_recovery.py')
#
# Command line arguments:
#    /UPS/Shipping_Pkg_Gnd/ShippingPACKAGE/PACKAGEWebServices/SCHEMA-WSDLs/LBRecovery.xsd
#
# Command line:
#    generateDS --no-namespace-defs -o "pyups/label_recovery.py"  /UPS/Shipping_Pkg_Gnd/ShippingPACKAGE/PACKAGEWebServices/SCHEMA-WSDLs/LBRecovery.xsd
#
...
class LabelRecoveryRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Request=None, LabelSpecification=None, Translate=None, LabelDelivery=None, TrackingNumber=None, ReferenceValues=None):
    ...
    def get_Translate(self): return self.Translate
    def set_Translate(self, Translate): self.Translate = Translate
    ...
    def get_ReferenceValues(self): return self.ReferenceValues
    def set_ReferenceValues(self, ReferenceValues): self.ReferenceValues = ReferenceValues
    def hasContent_(self):
        if (
            ...
            self.ReferenceValues is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='LabelRecoveryRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='LabelRecoveryRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='LabelRecoveryRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='LabelRecoveryRequest'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='LabelRecoveryRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Translate is not None:
            self.Translate.export(outfile, level, namespace_, name_='Translate', pretty_print=pretty_print)
        ...
        if self.TrackingNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:TrackingNumber>%s</lbrec:TrackingNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TrackingNumber), input_name='TrackingNumber')), eol_))
        if self.ReferenceValues is not None:
            self.ReferenceValues.export(outfile, level, namespace_, name_='ReferenceValues', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Request':
            ...
            obj_ = ReferenceValuesType.factory()
            obj_.build(child_)
...
class ReferenceValuesType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ReferenceNumber=None, ShipperNumber=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='ReferenceValuesType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ReferenceValuesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='ReferenceValuesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='ReferenceValuesType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='ReferenceValuesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ShipperNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:ShipperNumber>%s</lbrec:ShipperNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipperNumber), input_name='ShipperNumber')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ReferenceNumberType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='ReferenceNumberType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='ReferenceNumberType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='ReferenceNumberType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='ReferenceNumberType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:Value>%s</lbrec:Value>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Value), input_name='Value')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class LabelSpecificationType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, HTTPUserAgent=None, LabelImageFormat=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
            ...
            self.LabelImageFormat is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='LabelSpecificationType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='LabelSpecificationType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='LabelSpecificationType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='LabelSpecificationType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.HTTPUserAgent is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:HTTPUserAgent>%s</lbrec:HTTPUserAgent>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.HTTPUserAgent), input_name='HTTPUserAgent')), eol_))
...
class LabelImageFormatType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='LabelImageFormatType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='LabelImageFormatType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='LabelImageFormatType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='LabelImageFormatType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Code is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:Code>%s</lbrec:Code>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Code), input_name='Code')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class TranslateType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, LanguageCode=None, DialectCode=None, Code=None):
        self.original_tagname_ = None
    ...
    def get_DialectCode(self): return self.DialectCode
    def set_DialectCode(self, DialectCode): self.DialectCode = DialectCode
    def get_Code(self): return self.Code
    def set_Code(self, Code): self.Code = Code
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='TranslateType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TranslateType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='TranslateType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='TranslateType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='TranslateType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.LanguageCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:LanguageCode>%s</lbrec:LanguageCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LanguageCode), input_name='LanguageCode')), eol_))
        if self.DialectCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:DialectCode>%s</lbrec:DialectCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DialectCode), input_name='DialectCode')), eol_))
        if self.Code is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:Code>%s</lbrec:Code>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Code), input_name='Code')), eol_))
    def build(self, node):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'LanguageCode':
            ...
            DialectCode_ = child_.text
            DialectCode_ = self.gds_validate_string(DialectCode_, node, 'DialectCode')
            self.DialectCode = DialectCode_
        elif nodeName_ == 'Code':
            Code_ = child_.text
            Code_ = self.gds_validate_string(Code_, node, 'Code')
            self.Code = Code_
...
class LabelDeliveryType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, LabelLinkIndicator=None, ResendEMailIndicator=None, EMailMessage=None):
        self.original_tagname_ = None
        self.LabelLinkIndicator = LabelLinkIndicator
        self.ResendEMailIndicator = ResendEMailIndicator
    ...
    factory = staticmethod(factory)
    def get_LabelLinkIndicator(self): return self.LabelLinkIndicator
    def set_LabelLinkIndicator(self, LabelLinkIndicator): self.LabelLinkIndicator = LabelLinkIndicator
    def get_ResendEMailIndicator(self): return self.ResendEMailIndicator
    def set_ResendEMailIndicator(self, ResendEMailIndicator): self.ResendEMailIndicator = ResendEMailIndicator
    def get_EMailMessage(self): return self.EMailMessage
    def set_EMailMessage(self, EMailMessage): self.EMailMessage = EMailMessage
    def hasContent_(self):
        if (
            self.LabelLinkIndicator is not None or
            self.ResendEMailIndicator is not None or
            self.EMailMessage is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='LabelDeliveryType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='LabelDeliveryType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='LabelDeliveryType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='LabelDeliveryType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.LabelLinkIndicator is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:LabelLinkIndicator>%s</lbrec:LabelLinkIndicator>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LabelLinkIndicator), input_name='LabelLinkIndicator')), eol_))
        if self.ResendEMailIndicator is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:ResendEMailIndicator>%s</lbrec:ResendEMailIndicator>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ResendEMailIndicator), input_name='ResendEMailIndicator')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'LabelLinkIndicator':
            LabelLinkIndicator_ = child_.text
            LabelLinkIndicator_ = self.gds_validate_string(LabelLinkIndicator_, node, 'LabelLinkIndicator')
            self.LabelLinkIndicator = LabelLinkIndicator_
        elif nodeName_ == 'ResendEMailIndicator':
            ResendEMailIndicator_ = child_.text
            ResendEMailIndicator_ = self.gds_validate_string(ResendEMailIndicator_, node, 'ResendEMailIndicator')
            self.ResendEMailIndicator = ResendEMailIndicator_
        elif nodeName_ == 'EMailMessage':
            obj_ = EMailMessageType.factory()
            obj_.build(child_)
...
class EMailMessageType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, EMailMessageType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if EMailMessageType.subclass:
            return EMailMessageType.subclass(*args_, **kwargs_)
        else:
            return EMailMessageType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='EMailMessageType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('EMailMessageType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='EMailMessageType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='EMailMessageType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='EMailMessageType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='EMailMessageType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.EMailAddress is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:EMailAddress>%s</lbrec:EMailAddress>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EMailAddress), input_name='EMailAddress')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
# end class EMailMessageType


class LabelRecoveryResponse(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Response=None, ShipmentIdentificationNumber=None, CODTurnInPage=None, LabelResults=None, TrackingCandidate=None):
        self.original_tagname_ = None
    ...
    def get_LabelResults(self): return self.LabelResults
    def set_LabelResults(self, LabelResults): self.LabelResults = LabelResults
    def add_LabelResults(self, value): self.LabelResults.append(value)
    def insert_LabelResults_at(self, index, value): self.LabelResults.insert(index, value)
    def replace_LabelResults_at(self, index, value): self.LabelResults[index] = value
    def get_TrackingCandidate(self): return self.TrackingCandidate
    def set_TrackingCandidate(self, TrackingCandidate): self.TrackingCandidate = TrackingCandidate
    def add_TrackingCandidate(self, value): self.TrackingCandidate.append(value)
    def insert_TrackingCandidate_at(self, index, value): self.TrackingCandidate.insert(index, value)
    def replace_TrackingCandidate_at(self, index, value): self.TrackingCandidate[index] = value
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='LabelRecoveryResponse', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='LabelRecoveryResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='LabelRecoveryResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='LabelRecoveryResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='LabelRecoveryResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ShipmentIdentificationNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:ShipmentIdentificationNumber>%s</lbrec:ShipmentIdentificationNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipmentIdentificationNumber), input_name='ShipmentIdentificationNumber')), eol_))
        ...
        for LabelResults_ in self.LabelResults:
            LabelResults_.export(outfile, level, namespace_, name_='LabelResults', pretty_print=pretty_print)
        for TrackingCandidate_ in self.TrackingCandidate:
            TrackingCandidate_.export(outfile, level, namespace_, name_='TrackingCandidate', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class LabelResultsType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, TrackingNumber=None, LabelImage=None, Receipt=None):
        self.original_tagname_ = None
        self.TrackingNumber = TrackingNumber
    ...
    def get_Receipt(self): return self.Receipt
    def set_Receipt(self, Receipt): self.Receipt = Receipt
    def hasContent_(self):
        if (
            self.TrackingNumber is not None or
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='LabelResultsType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='LabelResultsType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='LabelResultsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='LabelResultsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='LabelResultsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.LabelImage is not None:
            self.LabelImage.export(outfile, level, namespace_, name_='LabelImage', pretty_print=pretty_print)
        if self.Receipt is not None:
            self.Receipt.export(outfile, level, namespace_, name_='Receipt', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class LabelImageType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, LabelImageFormat=None, GraphicImage=None, HTMLImage=None, PDF417=None, InternationalSignatureGraphicImage=None, URL=None):
        self.original_tagname_ = None
        self.LabelImageFormat = LabelImageFormat
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='LabelImageType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='LabelImageType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='LabelImageType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='LabelImageType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='LabelImageType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.GraphicImage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:GraphicImage>%s</lbrec:GraphicImage>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.GraphicImage), input_name='GraphicImage')), eol_))
        if self.HTMLImage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:HTMLImage>%s</lbrec:HTMLImage>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.HTMLImage), input_name='HTMLImage')), eol_))
        if self.PDF417 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:PDF417>%s</lbrec:PDF417>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.PDF417), input_name='PDF417')), eol_))
        if self.InternationalSignatureGraphicImage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:InternationalSignatureGraphicImage>%s</lbrec:InternationalSignatureGraphicImage>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InternationalSignatureGraphicImage), input_name='InternationalSignatureGraphicImage')), eol_))
        if self.URL is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:URL>%s</lbrec:URL>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.URL), input_name='URL')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ReceiptType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, HTMLImage=None, Image=None, URL=None):
        self.original_tagname_ = None
        self.HTMLImage = HTMLImage
        self.Image = Image
        self.URL = URL
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='ReceiptType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='ReceiptType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='ReceiptType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='ReceiptType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ImageType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='ImageType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='ImageType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='ImageType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='ImageType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TrackingCandidateType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, TrackingNumber=None, DestinationPostalCode=None, DestinationCountryCode=None, PickupDateRange=None):
        self.original_tagname_ = None
        self.TrackingNumber = TrackingNumber
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='TrackingCandidateType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TrackingCandidateType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='TrackingCandidateType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='TrackingCandidateType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='TrackingCandidateType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.DestinationPostalCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:DestinationPostalCode>%s</lbrec:DestinationPostalCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DestinationPostalCode), input_name='DestinationPostalCode')), eol_))
        if self.DestinationCountryCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:DestinationCountryCode>%s</lbrec:DestinationCountryCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DestinationCountryCode), input_name='DestinationCountryCode')), eol_))
...
class PickupDateRangeType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='PickupDateRangeType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='PickupDateRangeType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='PickupDateRangeType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='PickupDateRangeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.BeginDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:BeginDate>%s</lbrec:BeginDate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BeginDate), input_name='BeginDate')), eol_))
        if self.EndDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:EndDate>%s</lbrec:EndDate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EndDate), input_name='EndDate')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ResponseImageType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='ResponseImageType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ResponseImageType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='ResponseImageType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='ResponseImageType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='ResponseImageType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Image':
            obj_ = ResponseImageDetailType.factory()
            obj_.build(child_)
            self.Image = obj_
            obj_.original_tagname_ = 'Image'
...
class ResponseImageDetailType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='ResponseImageDetailType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ResponseImageDetailType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='ResponseImageDetailType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='ResponseImageDetailType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='ResponseImageDetailType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ImageFormat':
            obj_ = ImageFormatCodeType.factory()
            obj_.build(child_)
            self.ImageFormat = obj_
            obj_.original_tagname_ = 'ImageFormat'
        elif nodeName_ == 'GraphicImage':
...
class ImageFormatCodeType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='ImageFormatCodeType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ImageFormatCodeType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='ImageFormatCodeType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='ImageFormatCodeType'):
        pass
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='ImageFormatCodeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Description is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<lbrec:Description>%s</lbrec:Description>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Description), input_name='Description')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class PropertyType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='lbrec:', name_='PropertyType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='lbrec:', name_='PropertyType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='lbrec:', name_='PropertyType'):
        if self.Key is not None and 'Key' not in already_processed:
            already_processed.add('Key')
            outfile.write(' Key=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Key), input_name='Key')), ))
    def exportChildren(self, outfile, level, namespace_='lbrec:', name_='PropertyType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from label_recovery import *\n\n')
        sys.stdout.write('import label_recovery as model_\n\n')
