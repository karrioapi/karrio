...
#
# Generated Tue Jun 12 20:21:24 2018 by generateDS.py version 2.29.14.
...
#    /UPS/Shipping_Pkg_Gnd/ShippingPACKAGE/PACKAGEWebServices/SCHEMA-WSDLs/VoidWebServiceSchema.xsd
#
# Command line:
#    generateDS --no-namespace-defs -o "pyups/void.py"  /UPS/Shipping_Pkg_Gnd/ShippingPACKAGE/PACKAGEWebServices/SCHEMA-WSDLs/VoidWebServiceSchema.xsd
#
...
class VoidShipmentRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Request=None, VoidShipment=None):
    ...
    def get_VoidShipment(self): return self.VoidShipment
    def set_VoidShipment(self, VoidShipment): self.VoidShipment = VoidShipment
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='void:', name_='VoidShipmentRequest', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='VoidShipmentRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='void:', name_='VoidShipmentRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='void:', name_='VoidShipmentRequest'):
        pass
    def exportChildren(self, outfile, level, namespace_='void:', name_='VoidShipmentRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.VoidShipment is not None:
            self.VoidShipment.export(outfile, level, namespace_, name_='VoidShipment', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
class VoidShipmentResponse(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Response=None, SummaryResult=None, PackageLevelResult=None):
        self.original_tagname_ = None
    ...
    def get_SummaryResult(self): return self.SummaryResult
    def set_SummaryResult(self, SummaryResult): self.SummaryResult = SummaryResult
    def get_PackageLevelResult(self): return self.PackageLevelResult
    def set_PackageLevelResult(self, PackageLevelResult): self.PackageLevelResult = PackageLevelResult
    def add_PackageLevelResult(self, value): self.PackageLevelResult.append(value)
    def insert_PackageLevelResult_at(self, index, value): self.PackageLevelResult.insert(index, value)
    def replace_PackageLevelResult_at(self, index, value): self.PackageLevelResult[index] = value
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='void:', name_='VoidShipmentResponse', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='VoidShipmentResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='void:', name_='VoidShipmentResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='void:', name_='VoidShipmentResponse'):
        pass
    def exportChildren(self, outfile, level, namespace_='void:', name_='VoidShipmentResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.SummaryResult is not None:
            self.SummaryResult.export(outfile, level, namespace_, name_='SummaryResult', pretty_print=pretty_print)
        for PackageLevelResult_ in self.PackageLevelResult:
            PackageLevelResult_.export(outfile, level, namespace_, name_='PackageLevelResult', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class PackageLevelResult(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, TrackingNumber=None, Status=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='void:', name_='PackageLevelResult', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PackageLevelResult')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='void:', name_='PackageLevelResult', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='void:', name_='PackageLevelResult'):
        pass
    def exportChildren(self, outfile, level, namespace_='void:', name_='PackageLevelResult', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.TrackingNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<void:TrackingNumber>%s</void:TrackingNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TrackingNumber), input_name='TrackingNumber')), eol_))
...
class VoidShipmentType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ShipmentIdentificationNumber=None, TrackingNumber=None):
        self.original_tagname_ = None
    ...
    def get_TrackingNumber(self): return self.TrackingNumber
    def set_TrackingNumber(self, TrackingNumber): self.TrackingNumber = TrackingNumber
    def add_TrackingNumber(self, value): self.TrackingNumber.append(value)
    def insert_TrackingNumber_at(self, index, value): self.TrackingNumber.insert(index, value)
    def replace_TrackingNumber_at(self, index, value): self.TrackingNumber[index] = value
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='void:', name_='VoidShipmentType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='VoidShipmentType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='void:', name_='VoidShipmentType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='void:', name_='VoidShipmentType'):
        pass
    def exportChildren(self, outfile, level, namespace_='void:', name_='VoidShipmentType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ShipmentIdentificationNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<void:ShipmentIdentificationNumber>%s</void:ShipmentIdentificationNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipmentIdentificationNumber), input_name='ShipmentIdentificationNumber')), eol_))
        for TrackingNumber_ in self.TrackingNumber:
            showIndent(outfile, level, pretty_print)
            outfile.write('<void:TrackingNumber>%s</void:TrackingNumber>%s' % (self.gds_encode(self.gds_format_string(quote_xml(TrackingNumber_), input_name='TrackingNumber')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ShipmentIdentificationNumber':
            ...
            TrackingNumber_ = child_.text
            TrackingNumber_ = self.gds_validate_string(TrackingNumber_, node, 'TrackingNumber')
            self.TrackingNumber.append(TrackingNumber_)
...
class SummaryResultType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='void:', name_='SummaryResultType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SummaryResultType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='void:', name_='SummaryResultType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='void:', name_='SummaryResultType'):
        pass
    def exportChildren(self, outfile, level, namespace_='void:', name_='SummaryResultType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PropertyType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='void:', name_='PropertyType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='void:', name_='PropertyType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='void:', name_='PropertyType'):
        if self.Key is not None and 'Key' not in already_processed:
            already_processed.add('Key')
            outfile.write(' Key=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Key), input_name='Key')), ))
    def exportChildren(self, outfile, level, namespace_='void:', name_='PropertyType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from void import *\n\n')
        sys.stdout.write('import void as model_\n\n')
