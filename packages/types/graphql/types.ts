...
export interface get_user_connections_user_connections_AlliedExpressLocalSettingsType {
  __typename: "AlliedExpressLocalSettingsType" | "DeutschePostSettingsType";
}
