...
export interface GetSystemConnections_system_connections_EShipperXMLSettingsType {
...
export interface GetSystemConnection_system_connection_EShipperXMLSettingsType {
  __typename: "EShipperXMLSettingsType";
  id: string;
  carrier_id: string;
  carrier_name: string;
