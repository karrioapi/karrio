        ...
        <div className="card p-3 mt-6">
          <div className="columns">
            <div className="column is-5 pr-2">
              ...
              <p className="is-size-7 pr-6">
                <strong>Warning:</strong> must be kept securely and never
                exposed to a client application.
              </p>
            </div>
            ...
            <div className="column is-5">
              <div className="field has-addons">
                ...
                <p className="control">
                  <button
                    className="button is-small is-light px-4"
                ...
                <p className="control">
                  <button
                    className="button is-small is-light px-4"
                    title="Click to show or hide the token"
                ...
                <div className="control">
                  <GenerateAPIModal>
                    <button
                      className="button is-primary is-light is-small px-4"
