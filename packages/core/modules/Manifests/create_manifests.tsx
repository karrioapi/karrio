...
export default function Page() {
  const Component = (): JSX.Element => {
    ...
    const compatibleCarrierSelection = (selection: string[]) => {
      const carrier_id = shipments?.edges?.find(({ node: shipment }) =>
    ...
    const computeManifestData = (
      selection: string[],
      current: typeof shipments,
    ): ManifestData => {
      const shipment = (current?.edges || []).find(({ node: shipment }) =>
        selection.includes(shipment.id),
      )?.node;
                          ...
                          <CreateManifestModal
                            ...
                            trigger={
                              <button
                                ...
                                disabled={
                                  !compatibleCarrierSelection(selection)
                                }
                              >
                        ...
                        <div className="icon-text">
                          <CarrierImage
                            carrier_name={
                              ...
                              formatCarrierSlug(metadata.APP_NAME)
                            }
