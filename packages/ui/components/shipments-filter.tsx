...
import { CARRIER_NAMES, SHIPMENT_STATUSES } from '@karrio/types';
          ...
          <div className="p-0">
            ...
            <div className="px-4 py-2">
              <div className="flex items-center space-x-2 mb-1">
                <Checkbox
                  id="hasReference"
                  checked={!isNone(filters?.reference)}
                  onCheckedChange={(checked) => 
                    handleChange('hasReference', 'reference', checked as boolean)
                  }
                />
                <Label htmlFor="hasReference" className="text-sm font-medium">
                  Reference
                </Label>
              </div>
            ...
            <div className="px-4 py-2">
              <div className="flex items-center space-x-2 mb-1">
                <Checkbox
                  id="hasService"
                  checked={!isNone(filters?.service)}
                  onCheckedChange={(checked) => handleChange('hasService', 'service', checked as boolean)}
                />
                <Label htmlFor="hasService" className="text-sm font-medium">
                  Service
                </Label>
              </div>
