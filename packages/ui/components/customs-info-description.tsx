import { formatCustomsLabel, formatRef, isNone, isNoneOrEmpty } from '@karrio/lib';
...
export const CustomsInfoDescription: React.FC<CustomsInfoDescriptionComponent> = ({ customs }) => {
  return (
    <>
