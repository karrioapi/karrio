import { getShipmentCommodities, getUnfulfilledOrderLineItems, isNone } from '@karrio/lib';
...
export const CommoditySummary: React.FC<CommoditySummaryComponent> = ({ shipment, orders, className }) => {
