...
import { isEqual, formatRef, isNone } from "@karrio/lib";
...
export const CustomsInfoForm = ({
  ...
  onChange,
  onTemplateChange,
}: CustomsInfoFormProps): JSX.Element => {
  ...
  const [customs, dispatch] = useReducer(
    (
      state: any,
      { name, value }: { name: string; value: string | boolean | object | any },
    ) => {
      switch (name) {
        case "hasDuty":
  ...
  const handleChange = (
    event: React.ChangeEvent<any> &
      CustomEvent<{ name: keyof CustomsType; value: object }>,
  ) => {
    ...
    try {
      ...
      if (customs.id === undefined && !!shipment?.id && shipment.id !== "new") {
        notify({
          ...
          message: "Customs Declaration successfully added!",
        });
      } else if (customs.id !== undefined) {
        notify({
          type: NotificationType.success,
          message: "Customs Declaration successfully updated!",
        });
      }
    } catch (message: any) {
    ...
    <>
      {!isTemplate && (
        <div className="columns is-multiline mb-0">
          <CheckBoxField
            defaultChecked={isNone(customs)}
            onChange={handleChange}
            name="optOut"
            fieldClass="column mb-0 is-12 px-3 py-3 has-text-weight-semibold"
          >
      ...
      {!isNone(customs) && (
        <form className="pl-1 pr-2 pb-2" onSubmit={handleSubmit} ref={form}>
          {children}
          ...
          <div className="columns is-multiline mb-0 pt-4">
            <CheckBoxField
              ...
              defaultChecked={customs?.commercial_invoice}
              onChange={handleChange}
            ...
            <div
              ...
              style={{
                ...
                display: `${customs?.commercial_invoice ? "block" : "none"}`,
              }}
            >
              <InputField
          ...
          <div className="columns is-multiline mb-0 pt-4">
            ...
            <div
              ...
              style={{
                borderLeft: "solid 2px #ddd",
                display: `${!isNone(customs?.duty) ? "block" : "none"}`,
              }}
            >
              <SelectField
                label="paid by"
                value={customs?.duty?.paid_by}
                name="paid_by"
                className="is-small is-fullwidth"
                fieldClass="column is-5 mb-0 px-1 py-2"
                required={!isNone(customs?.duty)}
                onChange={(e) =>
                  dispatch({
                    name: "duty",
                    value: {
                      ...
                      account_number:
                        e.target.value == PaidByEnum.third_party
              ...
              <SelectField
                ...
                onChange={(e) =>
                  dispatch({
                    name: "duty",
                    value: { ...customs.duty, currency: e.target.value },
                  })
                }
                value={customs?.duty?.currency}
              >
              ...
              <InputField
                ...
                onChange={(e) =>
                  dispatch({
                    name: "duty",
                    value: { ...customs.duty, declared_value: e.target.value },
                  })
                }
          ...
          <div className="columns p-2 my-2">
            <article
              className="panel is-shadowless column is-12 p-0"
              style={{ border: "1px #ddd solid" }}
            >
              <div className="p-2 is-clickable">
                <p
                  className="panel-heading select is-small is-fullwidth p-0 pt-1"
              ...
              <div
                className="columns column is-multiline mb-0 ml-6 my-2 px-2 py-2"
                style={{
                  borderLeft: "solid 2px #ddd",
              ...
              >
                ...
                <InputField
                  ...
                  value={customs?.options?.certificate_number}
                ...
                <InputField
                  ...
                  value={customs?.options?.license_number}
                  name="license_number"
                  className="is-small"
                  wrapperClass="column is-5 px-2 py-1"
                  fieldClass="mb-0 p-0"
                ...
                <InputField
                  ...
                  value={customs?.options?.vat_registration_number}
                ...
                <InputField
                  label="NIP number"
                  value={customs?.options?.nip_number}
                  name="nip_number"
                  className="is-small"
                  wrapperClass="column is-5 px-2 py-1"
                  fieldClass="mb-0 p-0"
                ...
                <InputField
                  label="EORI"
                  value={customs?.options?.eori_number}
                  name="eori_number"
                  className="is-small"
                  wrapperClass="column is-5 px-2 py-1"
                  fieldClass="mb-0 p-0"
          ...
          <div className="columns is-multiline mb-6 pt-2">
            ...
            <CheckBoxField
              defaultChecked={customs?.certify}
              onChange={handleChange}
              name="certify"
