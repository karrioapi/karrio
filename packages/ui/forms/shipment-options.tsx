import { CURRENCY_OPTIONS, NotificationType, ShipmentType } from '@karrio/types';
...
export const ShipmentOptions: React.FC<ShipmentOptionsComponent> = ({ shipment, onSubmit }) => {
