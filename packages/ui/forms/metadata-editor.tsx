import MetadataStateProvider, { MetadataStateContext } from '@karrio/hooks/metadata';
...
export const MetadataEditor: React.FC<MetadataEditorProps> = ({ id, metadata, object_type, children, onChange }) => {
