          ...
          <>
            ...
            <div className="columns mb-1 pl-1">
              <CheckBoxField
                ...
                fieldClass="mb-0 px-2 pt-3 pb-2 is-vcentered"
              >
            ...
            <div className="columns mb-1 pl-1">
              <CheckBoxField
                ...
                fieldClass="mb-0 px-2 pt-3 pb-2"
              >
            ...
            <div className="field mb-2">
              <div className="control">
                <div className="select is-multiple is-small is-fullwidth">
                  <select
                    name="permissions"
                    value={(user as any).permissions}
                    onChange={handleChange}
                    size={6}
                    multiple
                  >
                    {(permission_groups?.edges || []).map(
                      ({ node: permission }) => (
                        <option
                          key={`${permission.id}permission-${Date.now()}`}
