...
const WebhookModalContext = React.createContext<WebhookEditContextType>(
  {} as WebhookEditContextType,
);
          ...
          <section className="modal-card-body modal-form">
            <div className="form-floating-header p-4">
              <span className="has-text-weight-bold is-size-6">
                {isNew ? "Add " : "Update "} a webhook endpoint
              </span>
            </div>
            ...
            <div className="field mb-2">
              ...
              <div className="control">
                <div className="select is-multiple is-fullwidth">
                  <select
                    name="enabled_events"
                    defaultValue={payload?.enabled_events}
                    onChange={handleChange}
                    size={6}
                    multiple
                    required
