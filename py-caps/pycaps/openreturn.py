...
#
# Generated Wed Jun 13 20:24:35 2018 by generateDS.py version 2.29.14.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './pycanada_post/openreturn.py')
#
# Command line arguments:
#   /Users/danielkobina/Documents/FreeLance/API/Documentations/Canada Post/openreturn.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS --no-namespace-defs -o "./pycanada_post/openreturn.py" /Users/danielkobina/Documents/FreeLance/API/Documentations/Canada Post/openreturn.xsd
#
...
class OpenReturnType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, max_number_of_artifacts=None, service_code=None, receiver=None, print_preferences=None, settlement_info=None):
    ...
    def get_max_number_of_artifacts(self): return self.max_number_of_artifacts
    def set_max_number_of_artifacts(self, max_number_of_artifacts): self.max_number_of_artifacts = max_number_of_artifacts
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='OpenReturnType', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='OpenReturnType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='OpenReturnType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='OpenReturnType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='OpenReturnType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.max_number_of_artifacts is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<max-number-of-artifacts>%s</max-number-of-artifacts>%s' % (self.gds_format_integer(self.max_number_of_artifacts, input_name='max-number-of-artifacts'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'max-number-of-artifacts':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            ...
            obj_ = DomesticAddressType.factory()
            obj_.build(child_)
            self.receiver = obj_
...
class OpenReturnDetailsType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, artifacts_remaining=None, open_return=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_artifacts_remaining(self): return self.artifacts_remaining
    def set_artifacts_remaining(self, artifacts_remaining): self.artifacts_remaining = artifacts_remaining
    def get_open_return(self): return self.open_return
    def set_open_return(self, open_return): self.open_return = open_return
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='OpenReturnDetailsType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='OpenReturnDetailsType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='OpenReturnDetailsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='OpenReturnDetailsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='OpenReturnDetailsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.artifacts_remaining is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<artifacts-remaining>%s</artifacts-remaining>%s' % (self.gds_format_integer(self.artifacts_remaining, input_name='artifacts-remaining'), eol_))
        if self.open_return is not None:
            self.open_return.export(outfile, level, namespace_, name_='open-return', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'artifacts-remaining':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
...
class OpenReturnInfoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, artifacts_remaining=None, links=None):
        self.original_tagname_ = None
        self.artifacts_remaining = artifacts_remaining
        self.links = links
    def factory(*args_, **kwargs_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='OpenReturnInfoType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='OpenReturnInfoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='OpenReturnInfoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='OpenReturnInfoType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='OpenReturnInfoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DomesticAddressType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='DomesticAddressType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DomesticAddressType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='DomesticAddressType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DomesticAddressType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='DomesticAddressType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PrintPreferencesType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, output_format=None, customer_input_type=None, encoding=None, show_packing_instructions=None):
        self.original_tagname_ = None
    ...
    def get_customer_input_type(self): return self.customer_input_type
    def set_customer_input_type(self, customer_input_type): self.customer_input_type = customer_input_type
    ...
    def validate_customer_input_typeType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on customer-input-typeType' % {"value" : value} )
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='PrintPreferencesType', fromsubclass_=False, pretty_print=True):
        ...
        if self.customer_input_type is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<customer-input-type>%s</customer-input-type>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.customer_input_type), input_name='customer-input-type')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'output-format':
            ...
            customer_input_type_ = child_.text
            if customer_input_type_:
                customer_input_type_ = re_.sub(String_cleanup_pat_, " ", customer_input_type_).strip()
            else:
                customer_input_type_ = ""
            customer_input_type_ = self.gds_validate_string(customer_input_type_, node, 'customer_input_type')
            self.customer_input_type = customer_input_type_
...
class OpenReturnTemplatesInfoType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='OpenReturnTemplatesInfoType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='OpenReturnTemplatesInfoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='OpenReturnTemplatesInfoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='OpenReturnTemplatesInfoType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='OpenReturnTemplatesInfoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
