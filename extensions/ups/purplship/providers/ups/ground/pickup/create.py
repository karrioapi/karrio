...
from purplship.providers.ups.units import PackagePresets
...
def parse_pickup_response(response: Element, settings: Settings) -> Tuple[PickupDetails, List[Message]]:
    reply = XP.find("FreightPickupResponse", response, FreightPickupResponse, first=True)
    pickup = (
...
def _extract_pickup_details(response: FreightPickupResponse, settings: Settings) -> PickupDetails:
    pass
