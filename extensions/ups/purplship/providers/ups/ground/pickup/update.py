...
from purplship.providers.ups.ground.pickup.create import pickup_request, parse_pickup_response
from purplship.providers.ups.ground.pickup.cancel import pickup_cancel_request
...
def _cancel_pickup_request(
    ...
    new_pickup = XP.find("PickupCreationResponse", XP.to_xml(response), PickupCreationResponse, first=True)
    data = (
