...
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/error.py" ./schemas/Error.xsd
#
...
class Error(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Number':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'HelpContext')
            value_ = self.gds_validate_string(value_, node, 'HelpContext')
            self.HelpContext = value_
