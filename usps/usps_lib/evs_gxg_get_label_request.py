...
#   ('--no-namespace-defs', '')
#   ('-o', './pyusps/evs_gxg_get_label_request.py')
#
# Command line arguments:
#   ./schemas/eVSGXGGetLabelRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./pyusps/evs_gxg_get_label_request.py" ./schemas/eVSGXGGetLabelRequest.xsd
#
