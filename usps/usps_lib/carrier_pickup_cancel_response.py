...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/carrier_pickup_cancel_response.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupCancelResponse.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/carrier_pickup_cancel_response.py" ./schemas/CarrierPickupCancelResponse.xsd
#
