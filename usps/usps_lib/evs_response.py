...
#   ('--no-namespace-defs', '')
#   ('-o', './pyusps/evs_response.py')
#
# Command line arguments:
#   ./schemas/eVSResponse.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./pyusps/evs_response.py" ./schemas/eVSResponse.xsd
#
...
class eVSResponse(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSResponse', fromsubclass_=False, pretty_print=True):
        ...
        if self.RDC is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRDC>%s</%sRDC>%s' % (namespaceprefix_ , self.gds_format_integer(self.RDC, input_name='RDC'), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'RDC' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'RDC')
