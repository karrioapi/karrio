...
CONSTANCE_CONFIG = {
    ...
    'EMAIL_PAGE_DOMAIN': (
        EMAIL_PAGE_DOMAIN, 'The domain attached to links sent in emails. e.g: https://app.purplship.com', str),

    'GOOGLE_CLOUD_API_KEY': (GOOGLE_CLOUD_API_KEY, 'A Google GeoCoding API key', str),
    'CANADAPOST_ADDRESS_COMPLETE_API_KEY': (
        CANADAPOST_ADDRESS_COMPLETE_API_KEY, 'The Canada Post AddressComplete service API Key', str),
}
