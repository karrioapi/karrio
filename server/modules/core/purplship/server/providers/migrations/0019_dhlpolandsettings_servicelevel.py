# Generated by Django 3.2.9 on 2021-11-22 01:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_unit', models.CharField(choices=[('KG', 'KG'), ('LB', 'LB')], max_length=2, null=True)),
                ('dimension_unit', models.CharField(choices=[('CM', 'CM'), ('IN', 'IN')], max_length=2, null=True)),
