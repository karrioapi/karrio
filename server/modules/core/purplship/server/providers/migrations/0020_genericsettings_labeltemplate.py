    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(default=functools.partial(purplship.server.core.models.base.uuid, *(), **{'prefix': 'tpl_'}), editable=False, max_length=50, primary_key=True, serialize=False)),
