...
ORDER_DATA_RETENTION = config("ORDER_DATA_RETENTION", default=180, cast=int)
TRACKER_DATA_RETENTION = config("TRACKER_DATA_RETENTION", default=180, cast=int)
SHIPMENT_DATA_RETENTION = config("SHIPMENT_DATA_RETENTION", default=180, cast=int)
API_LOGS_DATA_RETENTION = config("API_LOGS_DATA_RETENTION", default=60, cast=int)
