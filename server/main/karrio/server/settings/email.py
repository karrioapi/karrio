...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='admin@karrio.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')
EMAIL_HOST = config('EMAIL_HOST', default='smtp.gmail.com')
EMAIL_PORT = config('EMAIL_PORT', default=587, cast=int)

EMAIL_PAGE_DOMAIN = config('DOMAIN', default='https://app.karrio.com')
EMAIL_FROM_ADDRESS = config('EMAIL_FROM_ADDRESS', default='noreply@karrio.com')
