"""
Django settings for purplship.server project.
...
PURPLSHIP_CONF = [
    ...
    for app in [
        ...
        {
            "app": "purplship.server.documents",
            "module": "purplship.server.documents",
            "urls": "purplship.server.documents.urls",
        },
...
DOCUMENTS_MANAGEMENT = (
    importlib.util.find_spec("purplship.server.documents") is not None
)
