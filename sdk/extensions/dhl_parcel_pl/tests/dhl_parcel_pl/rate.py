...
RateRequestXML = f"""<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope"  xmlns:ws="http://ws.onlinerating.canshipws.dhl_parcel_pl.com" xmlns:xsd="http://ws.dto.canshipws.dhl_parcel_pl.com/xsd" xmlns:xsd1="http://dto.canshipws.dhl_parcel_pl.com/xsd">
    <soap:Header/>
    <soap:Body>
        <ws:rateShipment>
            <ws:request>
...
<soapenv:Envelope xmlns:soapenv="http://www.w3.org/2003/05/soap-envelope">
    <soapenv:Body>
        <ns:rateShipmentResponse xmlns:ns="http://ws.onlinerating.canshipws.dhl_parcel_pl.com">
            <ns:return xmlns:ax25="http://ws.dto.canshipws.dhl_parcel_pl.com/xsd" xmlns:ax27="http://dto.canshipws.dhl_parcel_pl.com/xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ax25:RateShipmentRs">
