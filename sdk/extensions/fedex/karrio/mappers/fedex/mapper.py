...
import karrio.providers.fedex as providers
...
class Mapper(mapper.Mapper):
    ...
    def create_address_validation_request(
        ...
        return providers.address_validation_request(payload, self.settings)
    ...
    def create_document_upload_request(
        ...
        return providers.document_upload_request(payload, self.settings)

    def parse_address_validation_response(
        self, response: lib.Deserializable
    ) -> typing.Tuple[models.AddressValidationDetails, typing.List[models.Message]]:
        return providers.parse_address_validation_response(
    ...
    def parse_cancel_pickup_response(
        ...
        return providers.parse_pickup_cancel_response(
            response.deserialize(), self.settings
        )
    ...
    def parse_pickup_update_response(
        ...
        return providers.parse_pickup_update_response(
            response.deserialize(), self.settings
        )
    ...
    def parse_document_upload_response(
        ...
        return providers.parse_document_upload_response(
            response.deserialize(), self.settings
        )
