...
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/evs_first_class_mail_intl_response.py" ./schemas/eVSFirstClassMailIntlResponse.xsd
#
