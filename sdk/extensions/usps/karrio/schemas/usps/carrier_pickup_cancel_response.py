...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/carrier_pickup_cancel_response.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupCancelResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/carrier_pickup_cancel_response.py" ./schemas/CarrierPickupCancelResponse.xsd
#
