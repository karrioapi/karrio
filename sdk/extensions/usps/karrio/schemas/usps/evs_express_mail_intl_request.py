...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps/evs_express_mail_intl_request.py')
#
# Command line arguments:
#   ./schemas/eVSExpressMailIntlRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps/evs_express_mail_intl_request.py" ./schemas/eVSExpressMailIntlRequest.xsd
#
