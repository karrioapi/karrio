...
import karrio.providers.post_nl.error as error
import karrio.providers.post_nl.utils as provider_utils
import karrio.providers.post_nl.units as provider_units
...
def rate_request(
    ...
    request = None  # map data to convert karrio model to post_nl specific type
