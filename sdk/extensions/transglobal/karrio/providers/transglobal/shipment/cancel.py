...
import karrio.providers.transglobal.error as error
import karrio.providers.transglobal.utils as provider_utils
import karrio.providers.transglobal.units as provider_units
...
def shipment_cancel_request(
    ...
    request = None  # map data to convert karrio model to transglobal specific type
