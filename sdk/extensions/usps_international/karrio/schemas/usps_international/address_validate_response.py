...
#
# Generated Sat Oct 14 00:23:37 2023 by generateDS.py version 2.43.2.
# Python 3.10.12 (main, Jun 11 2023, 05:26:28) [GCC 11.4.0]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/address_validate_response.py')
#
# Command line arguments:
#   ./schemas/AddressValidateResponse.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/address_validate_response.py" ./schemas/AddressValidateResponse.xsd
#
...
class AddressValidateResponse(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressValidateResponse', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'AddressValidateResponse':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='AddressValidateResponse')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='AddressValidateResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='AddressValidateResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressValidateResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class AddressType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, FirmName=None, Address1=None, Address2=None, Address2Abbreviation=None, City=None, CityAbbreviation=None, State=None, Urbanization=None, Zip5=None, Zip4=None, DeliveryPoint=None, CarrierRoute=None, Footnotes=None, DPVConfirmation=None, DPVCMRA=None, DPVFootnotes=None, Business=None, CentralDeliveryPoint=None, Vacant=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.Address2Abbreviation_nsprefix_ = None
        self.City = City
        self.City_nsprefix_ = None
        self.CityAbbreviation = CityAbbreviation
        self.CityAbbreviation_nsprefix_ = None
        self.State = State
        ...
        self.Footnotes_nsprefix_ = None
        self.DPVConfirmation = DPVConfirmation
        self.DPVConfirmation_nsprefix_ = None
        self.DPVCMRA = DPVCMRA
        self.DPVCMRA_nsprefix_ = None
        self.DPVFootnotes = DPVFootnotes
        self.DPVFootnotes_nsprefix_ = None
        self.Business = Business
        self.Business_nsprefix_ = None
        self.CentralDeliveryPoint = CentralDeliveryPoint
        self.CentralDeliveryPoint_nsprefix_ = None
        self.Vacant = Vacant
        self.Vacant_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_Address2(self, Address2):
        self.Address2 = Address2
    def get_Address2Abbreviation(self):
        return self.Address2Abbreviation
    def set_Address2Abbreviation(self, Address2Abbreviation):
        self.Address2Abbreviation = Address2Abbreviation
    def get_City(self):
        return self.City
    def set_City(self, City):
        self.City = City
    def get_CityAbbreviation(self):
        return self.CityAbbreviation
    def set_CityAbbreviation(self, CityAbbreviation):
        self.CityAbbreviation = CityAbbreviation
    def get_State(self):
        return self.State
    ...
    def set_Footnotes(self, Footnotes):
        self.Footnotes = Footnotes
    def get_DPVConfirmation(self):
        return self.DPVConfirmation
    def set_DPVConfirmation(self, DPVConfirmation):
        self.DPVConfirmation = DPVConfirmation
    def get_DPVCMRA(self):
        return self.DPVCMRA
    def set_DPVCMRA(self, DPVCMRA):
        self.DPVCMRA = DPVCMRA
    def get_DPVFootnotes(self):
        return self.DPVFootnotes
    def set_DPVFootnotes(self, DPVFootnotes):
        self.DPVFootnotes = DPVFootnotes
    def get_Business(self):
        return self.Business
    def set_Business(self, Business):
        self.Business = Business
    def get_CentralDeliveryPoint(self):
        return self.CentralDeliveryPoint
    def set_CentralDeliveryPoint(self, CentralDeliveryPoint):
        self.CentralDeliveryPoint = CentralDeliveryPoint
    def get_Vacant(self):
        return self.Vacant
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Address2Abbreviation is not None:
            namespaceprefix_ = self.Address2Abbreviation_nsprefix_ + ':' if (UseCapturedNS_ and self.Address2Abbreviation_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAddress2Abbreviation>%s</%sAddress2Abbreviation>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Address2Abbreviation), input_name='Address2Abbreviation')), namespaceprefix_ , eol_))
        if self.City is not None:
            namespaceprefix_ = self.City_nsprefix_ + ':' if (UseCapturedNS_ and self.City_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCity>%s</%sCity>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.City), input_name='City')), namespaceprefix_ , eol_))
        if self.CityAbbreviation is not None:
            namespaceprefix_ = self.CityAbbreviation_nsprefix_ + ':' if (UseCapturedNS_ and self.CityAbbreviation_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCityAbbreviation>%s</%sCityAbbreviation>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.CityAbbreviation), input_name='CityAbbreviation')), namespaceprefix_ , eol_))
        ...
        if self.Footnotes is not None:
            namespaceprefix_ = self.Footnotes_nsprefix_ + ':' if (UseCapturedNS_ and self.Footnotes_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sFootnotes>%s</%sFootnotes>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Footnotes), input_name='Footnotes')), namespaceprefix_ , eol_))
        if self.DPVConfirmation is not None:
            namespaceprefix_ = self.DPVConfirmation_nsprefix_ + ':' if (UseCapturedNS_ and self.DPVConfirmation_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDPVConfirmation>%s</%sDPVConfirmation>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.DPVConfirmation), input_name='DPVConfirmation')), namespaceprefix_ , eol_))
        if self.DPVCMRA is not None:
            namespaceprefix_ = self.DPVCMRA_nsprefix_ + ':' if (UseCapturedNS_ and self.DPVCMRA_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDPVCMRA>%s</%sDPVCMRA>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.DPVCMRA), input_name='DPVCMRA')), namespaceprefix_ , eol_))
        if self.DPVFootnotes is not None:
            namespaceprefix_ = self.DPVFootnotes_nsprefix_ + ':' if (UseCapturedNS_ and self.DPVFootnotes_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDPVFootnotes>%s</%sDPVFootnotes>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.DPVFootnotes), input_name='DPVFootnotes')), namespaceprefix_ , eol_))
        ...
        if self.CentralDeliveryPoint is not None:
            namespaceprefix_ = self.CentralDeliveryPoint_nsprefix_ + ':' if (UseCapturedNS_ and self.CentralDeliveryPoint_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCentralDeliveryPoint>%s</%sCentralDeliveryPoint>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.CentralDeliveryPoint), input_name='CentralDeliveryPoint')), namespaceprefix_ , eol_))
        if self.Vacant is not None:
            namespaceprefix_ = self.Vacant_nsprefix_ + ':' if (UseCapturedNS_ and self.Vacant_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sVacant>%s</%sVacant>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Vacant), input_name='Vacant')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'FirmName':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Address2Abbreviation')
            value_ = self.gds_validate_string(value_, node, 'Address2Abbreviation')
            self.Address2Abbreviation = value_
            self.Address2Abbreviation_nsprefix_ = child_.prefix
        elif nodeName_ == 'City':
            value_ = child_.text
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'CityAbbreviation')
            value_ = self.gds_validate_string(value_, node, 'CityAbbreviation')
            self.CityAbbreviation = value_
            self.CityAbbreviation_nsprefix_ = child_.prefix
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Footnotes')
            value_ = self.gds_validate_string(value_, node, 'Footnotes')
            self.Footnotes = value_
            self.Footnotes_nsprefix_ = child_.prefix
        elif nodeName_ == 'DPVConfirmation':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'DPVConfirmation')
            value_ = self.gds_validate_string(value_, node, 'DPVConfirmation')
            self.DPVConfirmation = value_
            self.DPVConfirmation_nsprefix_ = child_.prefix
        elif nodeName_ == 'DPVCMRA':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'DPVCMRA')
            value_ = self.gds_validate_string(value_, node, 'DPVCMRA')
            self.DPVCMRA = value_
            self.DPVCMRA_nsprefix_ = child_.prefix
        elif nodeName_ == 'DPVFootnotes':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'DPVFootnotes')
            value_ = self.gds_validate_string(value_, node, 'DPVFootnotes')
            self.DPVFootnotes = value_
            self.DPVFootnotes_nsprefix_ = child_.prefix
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'CentralDeliveryPoint')
            value_ = self.gds_validate_string(value_, node, 'CentralDeliveryPoint')
            self.CentralDeliveryPoint = value_
            self.CentralDeliveryPoint_nsprefix_ = child_.prefix
        elif nodeName_ == 'Vacant':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Vacant')
            value_ = self.gds_validate_string(value_, node, 'Vacant')
            self.Vacant = value_
            self.Vacant_nsprefix_ = child_.prefix
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from address_validate_response import *\n\n')
