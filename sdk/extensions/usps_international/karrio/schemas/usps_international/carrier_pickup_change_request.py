...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/usps_international/carrier_pickup_change_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupChangeRequest.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/usps_international/carrier_pickup_change_request.py" ./schemas/CarrierPickupChangeRequest.xsd
#
...
class CarrierPickupChangeRequest(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CarrierPickupChangeRequest', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CarrierPickupChangeRequest')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CarrierPickupChangeRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CarrierPickupChangeRequest'):
