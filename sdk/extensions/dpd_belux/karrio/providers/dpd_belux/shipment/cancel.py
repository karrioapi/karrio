...
import karrio.providers.dpd_belux.error as error
import karrio.providers.dpd_belux.utils as provider_utils
import karrio.providers.dpd_belux.units as provider_units
...
def shipment_cancel_request(
    ...
    request = None  # map data to convert karrio model to dpd_belux specific type
