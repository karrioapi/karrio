...
import karrio.providers.axlehire.error as error
import karrio.providers.axlehire.utils as provider_utils
import karrio.providers.axlehire.units as provider_units
...
def shipment_request(
    ...
    request = None  # map data to convert karrio model to axlehire specific type
