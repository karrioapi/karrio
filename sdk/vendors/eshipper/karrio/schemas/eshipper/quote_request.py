...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper/quote_request.py')
#
# Command line arguments:
#   ./vendor/schemas/quote_request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper/quote_request.py" ./vendor/schemas/quote_request.xsd
#
