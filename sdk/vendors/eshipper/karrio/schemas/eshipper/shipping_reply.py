...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper/shipping_reply.py')
#
# Command line arguments:
#   ./vendor/schemas/shipping_reply.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper/shipping_reply.py" ./vendor/schemas/shipping_reply.xsd
#
