...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio.schemas.eshipper/shipping_request.py')
#
# Command line arguments:
#   ./vendor/schemas/shipping_request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio.schemas.eshipper/shipping_request.py" ./vendor/schemas/shipping_request.xsd
#
