...
#   ('--no-namespace-defs', '')
#   ('-o', './eshipper_lib/shipment_cancel_reply.py')
#
# Command line arguments:
#   ./vendor/schemas/shipment_cancel_reply.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-bridges/eshipper/.venv/eshipper/bin/generateDS --no-namespace-defs -o "./eshipper_lib/shipment_cancel_reply.py" ./vendor/schemas/shipment_cancel_reply.xsd
#
