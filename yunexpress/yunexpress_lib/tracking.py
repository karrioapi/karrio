...
#   ('--no-namespace-defs', '')
#   ('-o', './yunexpress_lib/tracking.py')
#
# Command line arguments:
#   ./schemas/tracking.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./yunexpress_lib/tracking.py" ./schemas/tracking.xsd
#
...
class Response(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ResultCode=None, ResultDesc=None, Item=None, gds_collector_=None, **kwargs_):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Response', fromsubclass_=False, pretty_print=True):
        ...
        if self.ResultCode is not None:
            namespaceprefix_ = self.ResultCode_nsprefix_ + ':' if (UseCapturedNS_ and self.ResultCode_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sResultCode>%s</%sResultCode>%s' % (namespaceprefix_ , self.gds_format_integer(self.ResultCode, input_name='ResultCode'), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'ResultCode' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'ResultCode')
            ival_ = self.gds_validate_integer(ival_, node, 'ResultCode')
            self.ResultCode = ival_
            self.ResultCode_nsprefix_ = child_.prefix
        elif nodeName_ == 'ResultDesc':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ResultDesc')
            value_ = self.gds_validate_string(value_, node, 'ResultDesc')
            self.ResultDesc = value_
            self.ResultDesc_nsprefix_ = child_.prefix
        elif nodeName_ == 'Item':
...
class ItemType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, OrderInfo=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ItemType', fromsubclass_=False, pretty_print=True):
        ...
        if self.OrderInfo is not None:
            namespaceprefix_ = self.OrderInfo_nsprefix_ + ':' if (UseCapturedNS_ and self.OrderInfo_nsprefix_) else ''
            self.OrderInfo.export(outfile, level, namespaceprefix_, namespacedef_='', name_='OrderInfo', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'OrderInfo':
            obj_ = OrderInfoType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.OrderInfo = obj_
            obj_.original_tagname_ = 'OrderInfo'
# end class ItemType


class OrderInfoType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, msg=None, OrderNumber=None, TrackingNumber=None, WayBillNumber=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            self.WayBillNumber is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='OrderInfoType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='OrderInfoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='OrderInfoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='OrderInfoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='OrderInfoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.msg is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smsg>%s</%smsg>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.msg), input_name='msg')), namespaceprefix_ , eol_))
        ...
        if self.TrackingNumber is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTrackingNumber>%s</%sTrackingNumber>%s' % (namespaceprefix_ , self.gds_format_integer(self.TrackingNumber, input_name='TrackingNumber'), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'msg':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'msg')
            value_ = self.gds_validate_string(value_, node, 'msg')
            self.msg = value_
            self.msg_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'TrackingNumber' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'TrackingNumber')
            ival_ = self.gds_validate_integer(ival_, node, 'TrackingNumber')
            self.TrackingNumber = ival_
            self.TrackingNumber_nsprefix_ = child_.prefix
        elif nodeName_ == 'WayBillNumber':
            value_ = child_.text
