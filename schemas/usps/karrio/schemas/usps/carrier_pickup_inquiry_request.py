...
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/carrier_pickup_inquiry_request.py" ./schemas/CarrierPickupInquiryRequest.xsd
#
