...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/first_class_mail_response.py')
#
# Command line arguments:
#   ./schemas/FirstClassMailResponse.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/first_class_mail_response.py" ./schemas/FirstClassMailResponse.xsd
#
