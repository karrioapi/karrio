...
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/priority_mail_response.py" ./schemas/PriorityMailResponse.xsd
#
