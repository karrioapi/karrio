...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/carrier_pickup_cancel_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupCancelRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/carrier_pickup_cancel_request.py" ./schemas/CarrierPickupCancelRequest.xsd
#
