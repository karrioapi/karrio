...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/carrier_pickup_change_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupChangeRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/carrier_pickup_change_request.py" ./schemas/CarrierPickupChangeRequest.xsd
#
...
class CarrierPickupChangeRequest(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CarrierPickupChangeRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CarrierPickupChangeRequest.subclass:
            return CarrierPickupChangeRequest.subclass(*args_, **kwargs_)
        else:
            return CarrierPickupChangeRequest(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CarrierPickupChangeRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CarrierPickupChangeRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CarrierPickupChangeRequest':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CarrierPickupChangeRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CarrierPickupChangeRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CarrierPickupChangeRequest'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CarrierPickupChangeRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class CarrierPickupChangeRequest
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'CarrierPickupChangeRequest'
        rootClass = CarrierPickupChangeRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from carrier_pickup_change_request import *\n\n')
