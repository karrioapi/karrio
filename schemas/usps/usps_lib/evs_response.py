...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/evs_response.py')
#
# Command line arguments:
#   ./schemas/eVSResponse.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/evs_response.py" ./schemas/eVSResponse.xsd
#
...
class eVSResponse(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, BarcodeNumber=None, LabelImage=None, ToName=None, ToFirm=None, ToAddress1=None, ToAddress2=None, ToCity=None, ToState=None, ToZip5=None, ToZip4=None, Postnet=None, RDC=None, Postage=None, ExtraServices=None, Zone=None, CarrierRoute=None, PermitHolderName=None, InductionType=None, LogMessage=None, Commitment=None, gds_collector_=None, **kwargs_):
        ...
        self.Postnet_nsprefix_ = None
        self.RDC = RDC
        self.RDC_nsprefix_ = None
        ...
        self.InductionType_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, eVSResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if eVSResponse.subclass:
            return eVSResponse.subclass(*args_, **kwargs_)
        else:
            return eVSResponse(*args_, **kwargs_)
    ...
    def get_Postnet(self):
        return self.Postnet
    def set_Postnet(self, Postnet):
        self.Postnet = Postnet
    def get_RDC(self):
        return self.RDC
    def set_RDC(self, RDC):
        self.RDC = RDC
    ...
    def set_PermitHolderName(self, PermitHolderName):
        self.PermitHolderName = PermitHolderName
    def get_InductionType(self):
        return self.InductionType
    def set_InductionType(self, InductionType):
        self.InductionType = InductionType
    ...
    def hasContent_(self):
        if (
            ...
            self.Postnet is not None or
            self.RDC is not None or
            ...
            self.InductionType is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('eVSResponse')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'eVSResponse':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='eVSResponse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='eVSResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='eVSResponse'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='eVSResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ToZip5 is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sToZip5>%s</%sToZip5>%s' % (namespaceprefix_ , self.gds_format_integer(self.ToZip5, input_name='ToZip5'), namespaceprefix_ , eol_))
        if self.ToZip4 is not None:
            namespaceprefix_ = self.ToZip4_nsprefix_ + ':' if (UseCapturedNS_ and self.ToZip4_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sToZip4>%s</%sToZip4>%s' % (namespaceprefix_ , self.gds_format_integer(self.ToZip4, input_name='ToZip4'), namespaceprefix_ , eol_))
        if self.Postnet is not None:
            namespaceprefix_ = self.Postnet_nsprefix_ + ':' if (UseCapturedNS_ and self.Postnet_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPostnet>%s</%sPostnet>%s' % (namespaceprefix_ , self.gds_format_integer(self.Postnet, input_name='Postnet'), namespaceprefix_ , eol_))
        if self.RDC is not None:
            namespaceprefix_ = self.RDC_nsprefix_ + ':' if (UseCapturedNS_ and self.RDC_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRDC>%s</%sRDC>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RDC), input_name='RDC')), namespaceprefix_ , eol_))
        ...
        if self.InductionType is not None:
            namespaceprefix_ = self.InductionType_nsprefix_ + ':' if (UseCapturedNS_ and self.InductionType_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInductionType>%s</%sInductionType>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.InductionType), input_name='InductionType')), namespaceprefix_ , eol_))
        ...
        if self.Commitment is not None:
            ...
            self.Commitment.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Commitment', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'BarcodeNumber':
        ...
        elif nodeName_ == 'ToZip5' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'ToZip5')
            ival_ = self.gds_validate_integer(ival_, node, 'ToZip5')
            self.ToZip5 = ival_
            self.ToZip5_nsprefix_ = child_.prefix
        elif nodeName_ == 'ToZip4' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'ToZip4')
            ival_ = self.gds_validate_integer(ival_, node, 'ToZip4')
            self.ToZip4 = ival_
            self.ToZip4_nsprefix_ = child_.prefix
        elif nodeName_ == 'Postnet' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'Postnet')
            ival_ = self.gds_validate_integer(ival_, node, 'Postnet')
            self.Postnet = ival_
            self.Postnet_nsprefix_ = child_.prefix
        elif nodeName_ == 'RDC':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'RDC')
            value_ = self.gds_validate_string(value_, node, 'RDC')
            self.RDC = value_
            self.RDC_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'InductionType':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'InductionType')
            value_ = self.gds_validate_string(value_, node, 'InductionType')
            self.InductionType = value_
            self.InductionType_nsprefix_ = child_.prefix
            ...
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Commitment = obj_
            obj_.original_tagname_ = 'Commitment'
# end class eVSResponse
...
class CommitmentType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CommitmentName=None, ScheduledDeliveryDate=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            self.ScheduledDeliveryDate is not None
        ):
            return True
        else:
            return False
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from evs_response import *\n\n')
