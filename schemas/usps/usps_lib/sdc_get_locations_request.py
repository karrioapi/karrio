...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/sdc_get_locations_request.py')
#
# Command line arguments:
#   ./schemas/SDCGetLocationsRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/sdc_get_locations_request.py" ./schemas/SDCGetLocationsRequest.xsd
#
