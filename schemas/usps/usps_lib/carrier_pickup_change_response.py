...
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio-carriers/.venv/karrio-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/carrier_pickup_change_response.py" ./schemas/CarrierPickupChangeResponse.xsd
#
