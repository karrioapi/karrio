...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/evs_express_mail_intl_response.py')
#
# Command line arguments:
#   ./schemas/eVSExpressMailIntlResponse.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/evs_express_mail_intl_response.py" ./schemas/eVSExpressMailIntlResponse.xsd
#
