...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/track_request.py')
#
# Command line arguments:
#   ./schemas/TrackRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/track_request.py" ./schemas/TrackRequest.xsd
#
...
class TrackRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, USERID=None, TrackID=None, gds_collector_=None, **kwargs_):
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from track_request import *\n\n')
