...
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/evs_priority_mail_intl_response.py" ./schemas/eVSPriorityMailIntlResponse.xsd
#
