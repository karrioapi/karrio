...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/evs_first_class_mail_intl_response.py')
#
# Command line arguments:
#   ./schemas/eVSFirstClassMailIntlResponse.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/evs_first_class_mail_intl_response.py" ./schemas/eVSFirstClassMailIntlResponse.xsd
#
