...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/ptspod_request.py')
#
# Command line arguments:
#   ./schemas/PTSPodRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/ptspod_request.py" ./schemas/PTSPodRequest.xsd
#
...
class PTSPodRequest(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, USERID=None, TrackId=None, ClientIp=None, MpSuffix=None, MpDate=None, RequestType=None, FirstName=None, LastName=None, Email1=None, Email2=None, Email3=None, FaxNumber=None, AddressLine1=None, AddressLine2=None, City=None, State=None, Zip=None, VerifyAddress=None, TableCode=None, CustRegID=None, gds_collector_=None, **kwargs_):
        ...
        self.Email1 = Email1
        self.Email1_nsprefix_ = None
        self.Email2 = Email2
        self.Email2_nsprefix_ = None
        self.Email3 = Email3
        self.Email3_nsprefix_ = None
    ...
    def get_Email2(self):
        return self.Email2
    def set_Email2(self, Email2):
        self.Email2 = Email2
    def get_Email3(self):
        return self.Email3
    def set_Email3(self, Email3):
        self.Email3 = Email3
    ...
    def set_Zip(self, Zip):
        self.Zip = Zip
    def get_VerifyAddress(self):
        return self.VerifyAddress
    ...
    def set_TableCode(self, TableCode):
        self.TableCode = TableCode
    def get_CustRegID(self):
        return self.CustRegID
    def set_CustRegID(self, CustRegID):
        self.CustRegID = CustRegID
    def get_USERID(self):
        return self.USERID
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PTSPodRequest', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PTSPodRequest':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PTSPodRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PTSPodRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PTSPodRequest'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PTSPodRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.TrackId is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTrackId>%s</%sTrackId>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.TrackId), input_name='TrackId')), namespaceprefix_ , eol_))
        ...
        if self.Email1 is not None:
            namespaceprefix_ = self.Email1_nsprefix_ + ':' if (UseCapturedNS_ and self.Email1_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEmail1>%s</%sEmail1>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Email1), input_name='Email1')), namespaceprefix_ , eol_))
        if self.Email2 is not None:
            namespaceprefix_ = self.Email2_nsprefix_ + ':' if (UseCapturedNS_ and self.Email2_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEmail2>%s</%sEmail2>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Email2), input_name='Email2')), namespaceprefix_ , eol_))
        if self.Email3 is not None:
            namespaceprefix_ = self.Email3_nsprefix_ + ':' if (UseCapturedNS_ and self.Email3_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEmail3>%s</%sEmail3>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Email3), input_name='Email3')), namespaceprefix_ , eol_))
        ...
        if self.VerifyAddress is not None:
            namespaceprefix_ = self.VerifyAddress_nsprefix_ + ':' if (UseCapturedNS_ and self.VerifyAddress_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sVerifyAddress>%s</%sVerifyAddress>%s' % (namespaceprefix_ , self.gds_format_boolean(self.VerifyAddress, input_name='VerifyAddress'), namespaceprefix_ , eol_))
        ...
        if self.CustRegID is not None:
            namespaceprefix_ = self.CustRegID_nsprefix_ + ':' if (UseCapturedNS_ and self.CustRegID_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCustRegID>%s</%sCustRegID>%s' % (namespaceprefix_ , self.gds_format_integer(self.CustRegID, input_name='CustRegID'), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'TrackId':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'TrackId')
            value_ = self.gds_validate_string(value_, node, 'TrackId')
            self.TrackId = value_
            self.TrackId_nsprefix_ = child_.prefix
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Email1')
            value_ = self.gds_validate_string(value_, node, 'Email1')
            self.Email1 = value_
            self.Email1_nsprefix_ = child_.prefix
        elif nodeName_ == 'Email2':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Email2')
            value_ = self.gds_validate_string(value_, node, 'Email2')
            self.Email2 = value_
            self.Email2_nsprefix_ = child_.prefix
        elif nodeName_ == 'Email3':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Email3')
            value_ = self.gds_validate_string(value_, node, 'Email3')
            self.Email3 = value_
            self.Email3_nsprefix_ = child_.prefix
            ...
            sval_ = child_.text
            ival_ = self.gds_parse_boolean(sval_, node, 'VerifyAddress')
            ival_ = self.gds_validate_boolean(ival_, node, 'VerifyAddress')
            self.VerifyAddress = ival_
            self.VerifyAddress_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'CustRegID' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'CustRegID')
            ival_ = self.gds_validate_integer(ival_, node, 'CustRegID')
            self.CustRegID = ival_
            self.CustRegID_nsprefix_ = child_.prefix
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from ptspod_request import *\n\n')
