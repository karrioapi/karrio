...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/carrier_pickup_availability_request.py')
#
# Command line arguments:
#   ./schemas/CarrierPickupAvailabilityRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./usps_lib/carrier_pickup_availability_request.py" ./schemas/CarrierPickupAvailabilityRequest.xsd
#
