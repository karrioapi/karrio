...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/ptstpod_request.py')
#
# Command line arguments:
#   ./schemas/PTSTPodRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/ptstpod_request.py" ./schemas/PTSTPodRequest.xsd
#
...
class PTSTPodRequest(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, USERID=None, TrackId=None, ClientIp=None, MpSuffix=None, MpDate=None, RequestType=None, FirstName=None, LastName=None, Email1=None, Email2=None, Email3=None, TableCode=None, CustRegID=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PTSTPodRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PTSTPodRequest.subclass:
            return PTSTPodRequest.subclass(*args_, **kwargs_)
        else:
            return PTSTPodRequest(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PTSTPodRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PTSTPodRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PTSTPodRequest':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PTSTPodRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PTSTPodRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PTSTPodRequest'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PTSTPodRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'PTSTPodRequest'
        rootClass = PTSTPodRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from ptstpod_request import *\n\n')
