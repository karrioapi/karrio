...
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio-carriers/.venv/karrio-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/evs_first_class_mail_intl_request.py" ./schemas/eVSFirstClassMailIntlRequest.xsd
#
