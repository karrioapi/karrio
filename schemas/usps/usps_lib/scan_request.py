...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/scan_request.py')
#
# Command line arguments:
#   ./schemas/SCANRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/scan_request.py" ./schemas/SCANRequest.xsd
#
...
class SCANRequest(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, USERID=None, Option=None, FromName=None, FromFirm=None, FromAddress1=None, FromAddress2=None, FromCity=None, FromState=None, FromZip5=None, FromZip4=None, Shipment=None, MailDate=None, MailTime=None, EntryFacility=None, ImageType=None, CustomerRefNo=None, gds_collector_=None, **kwargs_):
        ...
        self.MailDate_nsprefix_ = None
        self.MailTime = MailTime
        self.MailTime_nsprefix_ = None
        self.EntryFacility = EntryFacility
        self.EntryFacility_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SCANRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SCANRequest.subclass:
            return SCANRequest.subclass(*args_, **kwargs_)
        else:
            return SCANRequest(*args_, **kwargs_)
    ...
    def set_Shipment(self, Shipment):
        self.Shipment = Shipment
    def get_MailDate(self):
        return self.MailDate
    def set_MailDate(self, MailDate):
        self.MailDate = MailDate
    def get_MailTime(self):
        return self.MailTime
    def set_MailTime(self, MailTime):
        self.MailTime = MailTime
    def get_EntryFacility(self):
        return self.EntryFacility
    def set_EntryFacility(self, EntryFacility):
        self.EntryFacility = EntryFacility
    ...
    def hasContent_(self):
        if (
            ...
            self.MailDate is not None or
            self.MailTime is not None or
            self.EntryFacility is not None or
            self.ImageType is not None or
            self.CustomerRefNo is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SCANRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('SCANRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'SCANRequest':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='SCANRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SCANRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SCANRequest'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SCANRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Option is not None:
            ...
            self.Option.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Option', pretty_print=pretty_print)
        ...
        if self.FromZip5 is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sFromZip5>%s</%sFromZip5>%s' % (namespaceprefix_ , self.gds_format_integer(self.FromZip5, input_name='FromZip5'), namespaceprefix_ , eol_))
        if self.FromZip4 is not None:
            namespaceprefix_ = self.FromZip4_nsprefix_ + ':' if (UseCapturedNS_ and self.FromZip4_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sFromZip4>%s</%sFromZip4>%s' % (namespaceprefix_ , self.gds_format_integer(self.FromZip4, input_name='FromZip4'), namespaceprefix_ , eol_))
        ...
        if self.MailDate is not None:
            namespaceprefix_ = self.MailDate_nsprefix_ + ':' if (UseCapturedNS_ and self.MailDate_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMailDate>%s</%sMailDate>%s' % (namespaceprefix_ , self.gds_format_integer(self.MailDate, input_name='MailDate'), namespaceprefix_ , eol_))
        if self.MailTime is not None:
            namespaceprefix_ = self.MailTime_nsprefix_ + ':' if (UseCapturedNS_ and self.MailTime_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMailTime>%s</%sMailTime>%s' % (namespaceprefix_ , self.gds_format_integer(self.MailTime, input_name='MailTime'), namespaceprefix_ , eol_))
        if self.EntryFacility is not None:
            namespaceprefix_ = self.EntryFacility_nsprefix_ + ':' if (UseCapturedNS_ and self.EntryFacility_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEntryFacility>%s</%sEntryFacility>%s' % (namespaceprefix_ , self.gds_format_integer(self.EntryFacility, input_name='EntryFacility'), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'FromZip5' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'FromZip5')
            ival_ = self.gds_validate_integer(ival_, node, 'FromZip5')
            self.FromZip5 = ival_
            self.FromZip5_nsprefix_ = child_.prefix
        elif nodeName_ == 'FromZip4' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'FromZip4')
        ...
        elif nodeName_ == 'MailDate' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'MailDate')
            ival_ = self.gds_validate_integer(ival_, node, 'MailDate')
            self.MailDate = ival_
            self.MailDate_nsprefix_ = child_.prefix
        elif nodeName_ == 'MailTime' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'MailTime')
            ival_ = self.gds_validate_integer(ival_, node, 'MailTime')
            self.MailTime = ival_
            self.MailTime_nsprefix_ = child_.prefix
        elif nodeName_ == 'EntryFacility' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'EntryFacility')
            ival_ = self.gds_validate_integer(ival_, node, 'EntryFacility')
            self.EntryFacility = ival_
            self.EntryFacility_nsprefix_ = child_.prefix
...
class OptionType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='OptionType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Form is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sForm>%s</%sForm>%s' % (namespaceprefix_ , self.gds_format_integer(self.Form, input_name='Form'), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Form' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'Form')
            ival_ = self.gds_validate_integer(ival_, node, 'Form')
            self.Form = ival_
...
class ShipmentType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, PackageDetail=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.PackageDetail_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_PackageDetail(self):
        return self.PackageDetail
    def set_PackageDetail(self, PackageDetail):
        self.PackageDetail = PackageDetail
    def hasContent_(self):
        if (
            self.PackageDetail is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ShipmentType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.PackageDetail is not None:
            namespaceprefix_ = self.PackageDetail_nsprefix_ + ':' if (UseCapturedNS_ and self.PackageDetail_nsprefix_) else ''
            self.PackageDetail.export(outfile, level, namespaceprefix_, namespacedef_='', name_='PackageDetail', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'PackageDetail':
            obj_ = PackageDetailType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.PackageDetail = obj_
            obj_.original_tagname_ = 'PackageDetail'
# end class ShipmentType


class PackageDetailType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, PkgBarcode=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.PkgBarcode = PkgBarcode
        self.PkgBarcode_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PackageDetailType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PackageDetailType.subclass:
            return PackageDetailType.subclass(*args_, **kwargs_)
        else:
            return PackageDetailType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_PkgBarcode(self):
        return self.PkgBarcode
    def set_PkgBarcode(self, PkgBarcode):
        self.PkgBarcode = PkgBarcode
    def hasContent_(self):
        if (
            self.PkgBarcode is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PackageDetailType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PackageDetailType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PackageDetailType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PackageDetailType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PackageDetailType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PackageDetailType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PackageDetailType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.PkgBarcode is not None:
            namespaceprefix_ = self.PkgBarcode_nsprefix_ + ':' if (UseCapturedNS_ and self.PkgBarcode_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPkgBarcode>%s</%sPkgBarcode>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.PkgBarcode), input_name='PkgBarcode')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'PkgBarcode':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'PkgBarcode')
            value_ = self.gds_validate_string(value_, node, 'PkgBarcode')
            self.PkgBarcode = value_
            self.PkgBarcode_nsprefix_ = child_.prefix
# end class PackageDetailType
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from scan_request import *\n\n')
