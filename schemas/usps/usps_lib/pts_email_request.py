...
#   ('--no-namespace-defs', '')
#   ('-o', './usps_lib/pts_email_request.py')
#
# Command line arguments:
#   ./schemas/PTSEmailRequest.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./usps_lib/pts_email_request.py" ./schemas/PTSEmailRequest.xsd
#
...
class PTSEmailRequest(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, USERID=None, TrackId=None, ClientIp=None, MpSuffix=None, MpDate=None, RequestType=None, FirstName=None, LastName=None, Email1=None, Email2=None, Email3=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PTSEmailRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PTSEmailRequest.subclass:
            return PTSEmailRequest.subclass(*args_, **kwargs_)
        else:
            return PTSEmailRequest(*args_, **kwargs_)
    ...
    def set_RequestType(self, RequestType):
        self.RequestType = RequestType
    def add_RequestType(self, value):
        self.RequestType.append(value)
    def insert_RequestType_at(self, index, value):
        self.RequestType.insert(index, value)
    def replace_RequestType_at(self, index, value):
        self.RequestType[index] = value
    ...
    def hasContent_(self):
        if (
            ...
            self.Email3 is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PTSEmailRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PTSEmailRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PTSEmailRequest':
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PTSEmailRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PTSEmailRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PTSEmailRequest'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PTSEmailRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for RequestType_ in self.RequestType:
            namespaceprefix_ = self.RequestType_nsprefix_ + ':' if (UseCapturedNS_ and self.RequestType_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRequestType>%s</%sRequestType>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(RequestType_), input_name='RequestType')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'TrackId':
            ...
            self.RequestType.append(value_)
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'PTSEmailRequest'
        rootClass = PTSEmailRequest
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from pts_email_request import *\n\n')
