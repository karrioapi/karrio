...
class Envelope(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Header=None, Body=None, anytypeobjs_=None, gds_collector_=None, **kwargs_):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Envelope', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'Envelope':
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Envelope', fromsubclass_=False, pretty_print=True):
        ...
        if self.Header is not None:
            ...
            self.Header.export(outfile, level, namespaceprefix_='tns:', namespacedef_='', name_='Header', pretty_print=pretty_print)
...
class Fault(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, faultcode=None, faultstring=None, faultactor=None, detail=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.faultstring_nsprefix_ = None
        self.faultactor = faultactor
        self.faultactor_nsprefix_ = None
        self.detail = detail
    ...
    def set_faultstring(self, faultstring):
        self.faultstring = faultstring
    def get_faultactor(self):
        return self.faultactor
    def set_faultactor(self, faultactor):
        self.faultactor = faultactor
    def get_detail(self):
        return self.detail
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Fault', fromsubclass_=False, pretty_print=True):
        ...
        if self.faultstring is not None:
            namespaceprefix_ = self.faultstring_nsprefix_ + ':' if (UseCapturedNS_ and self.faultstring_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfaultstring>%s</%sfaultstring>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.faultstring), input_name='faultstring')), namespaceprefix_ , eol_))
        if self.faultactor is not None:
            namespaceprefix_ = self.faultactor_nsprefix_ + ':' if (UseCapturedNS_ and self.faultactor_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfaultactor>%s</%sfaultactor>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.faultactor), input_name='faultactor')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'faultcode':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'faultstring')
            value_ = self.gds_validate_string(value_, node, 'faultstring')
            self.faultstring = value_
            self.faultstring_nsprefix_ = child_.prefix
        elif nodeName_ == 'faultactor':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'faultactor')
            value_ = self.gds_validate_string(value_, node, 'faultactor')
            self.faultactor = value_
            self.faultactor_nsprefix_ = child_.prefix
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:tns="http://schemas.xmlsoap.org/soap/envelope/"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from envelope import *\n\n')
        sys.stdout.write('import envelope as model_\n\n')
