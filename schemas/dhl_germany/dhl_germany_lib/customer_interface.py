...
#   ('--no-namespace-defs', '')
#   ('-o', './dhl_germany_lib/customer_interface.py')
#
# Command line arguments:
#   ./schemas/geschaeftskundenversand-api-3.3.2-schema-cis_base.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./dhl_germany_lib/customer_interface.py" ./schemas/geschaeftskundenversand-api-3.3.2-schema-cis_base.xsd
#
