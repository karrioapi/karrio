...
#   ('--no-namespace-defs', '')
#   ('-o', './dhl_germany_lib/tracking_response.py')
#
# Command line arguments:
#   ./schemas/tracking-response.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./dhl_germany_lib/tracking_response.py" ./schemas/tracking-response.xsd
#
...
class data(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, name=None, request_id=None, code=None, piece_identifier=None, _build_time=None, piece_id=None, leitcode=None, data_member=None, gds_collector_=None, **kwargs_):
...
class dataType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, name=None, event_timestamp=None, event_status=None, event_text=None, ice=None, ric=None, event_location=None, event_country=None, standard_event_code=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
