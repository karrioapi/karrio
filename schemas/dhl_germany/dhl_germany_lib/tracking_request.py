...
#   ('--no-namespace-defs', '')
#   ('-o', './dhl_germany_lib/tracking_request.py')
#
# Command line arguments:
#   ./schemas/tracking-request.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./dhl_germany_lib/tracking_request.py" ./schemas/tracking-request.xsd
#
...
class data(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, appname=None, password=None, request=None, language_code=None, piece_id=None, gds_collector_=None, **kwargs_):
