...
#
# Generated Thu Mar  9 15:25:54 2023 by generateDS.py version 2.41.3.
# Python 3.10.6 (main, Nov 14 2022, 16:10:14) [GCC 11.3.0]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './dpd_belux_lib/EndOfDayServiceV10.py')
#
# Command line arguments:
#   ./schemas/EndOfDayServiceV10.xsd
#
# Command line:
#   /home/kserver/Workspace/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./dpd_belux_lib/EndOfDayServiceV10.py" ./schemas/EndOfDayServiceV10.xsd
#
...
class printerLanguageType(str, Enum):
    PDF='PDF'


class endOfDay(GeneratedsSuper):
    """period -- Time period for End of Day manifest.
    printOptions -- The Options which should be used for manifest printing.
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, period=None, printOptions=None, gds_collector_=None, **kwargs_):
        ...
        self.printOptions_nsprefix_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='endOfDay', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='endOfDay')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='endOfDay', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='endOfDay'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='endOfDay', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class period(GeneratedsSuper):
    """period -- Time period for End of Day manifest, for example from 10th of September
    2018 9am to 11th of September 2018 5pm
    dateFrom -- format YYYYMMDD, e.g. 20180910
    timeFrom -- format hhmm, e.g. 0900
    dateTo -- format YYYYMMDD, e.g. 20180911
    timeTo -- format hhmm, e.g. 1700
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, dateFrom=None, timeFrom=None, dateTo=None, timeTo=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.validate_dateFromType(self.dateFrom)
        self.dateFrom_nsprefix_ = None
        self.timeFrom = timeFrom
        self.validate_timeFromType(self.timeFrom)
        self.timeFrom_nsprefix_ = None
        self.dateTo = dateTo
        self.validate_dateToType(self.dateTo)
        self.dateTo_nsprefix_ = None
        self.timeTo = timeTo
        self.validate_timeToType(self.timeTo)
    ...
    def set_timeTo(self, timeTo):
        self.timeTo = timeTo
    def validate_dateFromType(self, value):
        result = True
        # Validate type dateFromType, a restriction on xs:int.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value > 99999999:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on dateFromType' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_timeFromType(self, value):
        result = True
        # Validate type timeFromType, a restriction on xs:int.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (int)' % {"value": value, "lineno": lineno, })
            ...
            if value > 2400:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on timeFromType' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_dateToType(self, value):
        result = True
        # Validate type dateToType, a restriction on xs:int.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (int)' % {"value": value, "lineno": lineno, })
            ...
            if value > 99999999:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on dateToType' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_timeToType(self, value):
        result = True
        # Validate type timeToType, a restriction on xs:int.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (int)' % {"value": value, "lineno": lineno, })
            ...
            if value > 2400:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on timeToType' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='period', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='period'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='period', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        pass
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'dateFrom' and child_.text:
            sval_ = child_.text
...
class printOptions(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, printerLanguage=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.validate_printerLanguageType(self.printerLanguage)
    ...
    def set_printerLanguage(self, printerLanguage):
        self.printerLanguage = printerLanguage
    def validate_printerLanguageType(self, value):
        result = True
        # Validate type printerLanguageType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on printerLanguageType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def _hasContent(self):
        if (
            self.printerLanguage is not None
        ):
            return True
        else:
            return False
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'printerLanguage':
            ...
            # validate type printerLanguageType
            self.validate_printerLanguageType(self.printerLanguage)
# end class printOptions


class endOfDayResponse(GeneratedsSuper):
    """manifestPDF -- Contains end of day manifest PDF data in bytes.
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, manifestPDF=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.manifestPDF = manifestPDF
        self.manifestPDF_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_manifestPDF(self):
        return self.manifestPDF
    def set_manifestPDF(self, manifestPDF):
        self.manifestPDF = manifestPDF
    def _hasContent(self):
        if (
            self.manifestPDF is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='endOfDayResponse', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='endOfDayResponse')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='endOfDayResponse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='endOfDayResponse'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='endOfDayResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.manifestPDF is not None:
            namespaceprefix_ = self.manifestPDF_nsprefix_ + ':' if (UseCapturedNS_ and self.manifestPDF_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smanifestPDF>%s</%smanifestPDF>%s' % (namespaceprefix_ , self.gds_format_base64(self.manifestPDF, input_name='manifestPDF'), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'manifestPDF':
            ...
            if sval_ is not None:
                ...
                bval_ = self.gds_validate_base64(bval_, node, 'manifestPDF')
            else:
                bval_ = None
            self.manifestPDF = bval_
            self.manifestPDF_nsprefix_ = child_.prefix
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:tns="http://dpd.com/common/service/types/EndOfDayService/1.0"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from EndOfDayServiceV10 import *\n\n')
        sys.stdout.write('import EndOfDayServiceV10 as model_\n\n')
...
NamespaceToDefMappings_ = {'http://dpd.com/common/service/types/EndOfDayService/1.0': [('endOfDay',
                                                              './schemas/EndOfDayServiceV10.xsd',
                                                              'CT'),
                                                             ('period',
                                                              './schemas/EndOfDayServiceV10.xsd',
