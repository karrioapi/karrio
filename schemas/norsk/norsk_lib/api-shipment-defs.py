...
#   ('--no-namespace-defs', '')
#   ('-o', './norsk_lib/api-shipment-defs.py')
#
# Command line arguments:
#   ./schemas/api-shipment-defs.xsd
#
# Command line:
#   /home/adam/.local/bin/generateDS --no-namespace-defs -o "./norsk_lib/api-shipment-defs.py" ./schemas/api-shipment-defs.xsd
#
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from api-shipment-defs import *\n\n')
        sys.stdout.write('import api-shipment-defs as model_\n\n')
