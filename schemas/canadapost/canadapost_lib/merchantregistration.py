...
#   ('--no-namespace-defs', '')
#   ('-o', './canadapost_lib/merchantregistration.py')
#
# Command line arguments:
#   ./schemas/merchantregistration.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./canadapost_lib/merchantregistration.py" ./schemas/merchantregistration.xsd
#
