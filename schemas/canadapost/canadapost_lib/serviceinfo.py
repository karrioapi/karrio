...
#   ('--no-namespace-defs', '')
#   ('-o', './canadapost_lib/serviceinfo.py')
#
# Command line arguments:
#   ./schemas/serviceinfo.xsd
#
# Command line:
#   /Users/danielkobina/Workspace/project/purplship-carriers/.venv/purplship-carriers/bin/generateDS --no-namespace-defs -o "./canadapost_lib/serviceinfo.py" ./schemas/serviceinfo.xsd
#
