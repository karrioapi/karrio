...
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./ups_lib/pre_notification_web_service_schema.py" ./schemas/PreNotificationWebServiceSchema.xsd
#
