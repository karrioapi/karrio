...
#
# Command line:
#   /Users/danielkobina/Workspace/project/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./ups_lib/quantum_view_response.py" ./schemas/QuantumViewResponse.xsd
#
