...
class ErrorDetailType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Severity=None, PrimaryErrorCode=None, MinimumRetrySeconds=None, Location=None, SubErrorCode=None, AdditionalInformation=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:error="http://www.ups.com/schema/xpci/1.0/error"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from error_xpci import *\n\n')
        sys.stdout.write('import error_xpci as model_\n\n')
