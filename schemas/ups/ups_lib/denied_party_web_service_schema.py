...
class DeniedPartyScreenerRequest(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Request=None, Party=None, TransactionReferenceID=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DeniedPartyScreenerRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DeniedPartyScreenerRequest.subclass:
            return DeniedPartyScreenerRequest.subclass(*args_, **kwargs_)
        else:
            return DeniedPartyScreenerRequest(*args_, **kwargs_)
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DeniedPartyScreenerRequest', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DeniedPartyScreenerRequest')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DeniedPartyScreenerRequest':
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DeniedPartyScreenerRequest', fromsubclass_=False, pretty_print=True):
        ...
        if self.Party is not None:
            ...
            self.Party.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Party', pretty_print=pretty_print)
...
# end class DeniedPartyScreenerRequest


class DeniedPartyScreenerResponse(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Response=None, TransactionInfo=None, GovernmentList=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DeniedPartyScreenerResponse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DeniedPartyScreenerResponse.subclass:
            return DeniedPartyScreenerResponse.subclass(*args_, **kwargs_)
        else:
            return DeniedPartyScreenerResponse(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_TransactionInfo(self, TransactionInfo):
        self.TransactionInfo = TransactionInfo
    def get_GovernmentList(self):
        return self.GovernmentList
    def set_GovernmentList(self, GovernmentList):
        self.GovernmentList = GovernmentList
    def add_GovernmentList(self, value):
        self.GovernmentList.append(value)
    def insert_GovernmentList_at(self, index, value):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DeniedPartyScreenerResponse', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DeniedPartyScreenerResponse')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DeniedPartyScreenerResponse':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DeniedPartyScreenerResponse', fromsubclass_=False, pretty_print=True):
        ...
        for GovernmentList_ in self.GovernmentList:
            namespaceprefix_ = self.GovernmentList_nsprefix_ + ':' if (UseCapturedNS_ and self.GovernmentList_nsprefix_) else ''
            GovernmentList_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='GovernmentList', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'TransactionInfo':
            obj_ = TransactionInfoType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.TransactionInfo = obj_
            obj_.original_tagname_ = 'TransactionInfo'
        elif nodeName_ == 'GovernmentList':
            obj_ = GovernmentListType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.GovernmentList.append(obj_)
            obj_.original_tagname_ = 'GovernmentList'
# end class DeniedPartyScreenerResponse
...
class ResponseTransportType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Warning=None, DeniedPartySearchStatus=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.DeniedPartySearchStatus_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_DeniedPartySearchStatus(self):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ResponseTransportType', fromsubclass_=False, pretty_print=True):
        ...
        if self.DeniedPartySearchStatus is not None:
            namespaceprefix_ = self.DeniedPartySearchStatus_nsprefix_ + ':' if (UseCapturedNS_ and self.DeniedPartySearchStatus_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDeniedPartySearchStatus>%s</%sDeniedPartySearchStatus>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.DeniedPartySearchStatus), input_name='DeniedPartySearchStatus')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'DeniedPartySearchStatus':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'DeniedPartySearchStatus')
            value_ = self.gds_validate_string(value_, node, 'DeniedPartySearchStatus')
            self.DeniedPartySearchStatus = value_
            self.DeniedPartySearchStatus_nsprefix_ = child_.prefix
...
class PartyType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ScreenType=None, ContactName=None, CompanyName=None, Address=None, MatchLevel=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.ScreenType_nsprefix_ = None
    ...
    def _hasContent(self):
        if (
            ...
            self.MatchLevel is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PartyType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PartyType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PartyType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.ScreenType is not None:
            namespaceprefix_ = self.ScreenType_nsprefix_ + ':' if (UseCapturedNS_ and self.ScreenType_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sScreenType>%s</%sScreenType>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ScreenType), input_name='ScreenType')), namespaceprefix_ , eol_))
        ...
        if self.MatchLevel is not None:
            namespaceprefix_ = self.MatchLevel_nsprefix_ + ':' if (UseCapturedNS_ and self.MatchLevel_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMatchLevel>%s</%sMatchLevel>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.MatchLevel), input_name='MatchLevel')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'ScreenType':
            ...
            value_ = self.gds_validate_string(value_, node, 'ScreenType')
            self.ScreenType = value_
            self.ScreenType_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'MatchLevel':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'MatchLevel')
            value_ = self.gds_validate_string(value_, node, 'MatchLevel')
            self.MatchLevel = value_
            self.MatchLevel_nsprefix_ = child_.prefix
# end class PartyType
...
class AddressType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, AddressLine=None, City=None, State=None, PostalCode=None, County=None, CountryCode=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressType', fromsubclass_=False, pretty_print=True):
        ...
        if self.County is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCounty>%s</%sCounty>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.County), input_name='County')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'AddressLine':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'County')
            value_ = self.gds_validate_string(value_, node, 'County')
            self.County = value_
            self.County_nsprefix_ = child_.prefix
...
class GovernmentListType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, ListDescription=None, DeniedParty=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.ListDescription_nsprefix_ = None
        if DeniedParty is None:
            self.DeniedParty = []
        else:
            self.DeniedParty = DeniedParty
        self.DeniedParty_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GovernmentListType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GovernmentListType.subclass:
            return GovernmentListType.subclass(*args_, **kwargs_)
        else:
            return GovernmentListType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_ListDescription(self):
        return self.ListDescription
    def set_ListDescription(self, ListDescription):
        self.ListDescription = ListDescription
    def get_DeniedParty(self):
        return self.DeniedParty
    def set_DeniedParty(self, DeniedParty):
        self.DeniedParty = DeniedParty
    def add_DeniedParty(self, value):
        self.DeniedParty.append(value)
    def insert_DeniedParty_at(self, index, value):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GovernmentListType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GovernmentListType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'GovernmentListType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GovernmentListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.ListDescription is not None:
            namespaceprefix_ = self.ListDescription_nsprefix_ + ':' if (UseCapturedNS_ and self.ListDescription_nsprefix_) else ''
            self.ListDescription.export(outfile, level, namespaceprefix_, namespacedef_='', name_='ListDescription', pretty_print=pretty_print)
        for DeniedParty_ in self.DeniedParty:
            namespaceprefix_ = self.DeniedParty_nsprefix_ + ':' if (UseCapturedNS_ and self.DeniedParty_nsprefix_) else ''
            DeniedParty_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='DeniedParty', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'ListDescription':
            ...
            obj_.build(child_, gds_collector_=gds_collector_)
            self.ListDescription = obj_
            obj_.original_tagname_ = 'ListDescription'
        elif nodeName_ == 'DeniedParty':
            obj_ = DeniedPartyType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.DeniedParty.append(obj_)
            obj_.original_tagname_ = 'DeniedParty'
# end class GovernmentListType
...
class ListDescriptionType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, ListName=None, Description=None, ControlAgency=None, LastRegulatoryUpdate=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.ListName_nsprefix_ = None
        self.Description = Description
        self.Description_nsprefix_ = None
        self.ControlAgency = ControlAgency
        self.ControlAgency_nsprefix_ = None
        self.LastRegulatoryUpdate = LastRegulatoryUpdate
        self.LastRegulatoryUpdate_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ListDescriptionType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ListDescriptionType.subclass:
            return ListDescriptionType.subclass(*args_, **kwargs_)
        else:
            return ListDescriptionType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Description(self, Description):
        self.Description = Description
    def get_ControlAgency(self):
        return self.ControlAgency
    def set_ControlAgency(self, ControlAgency):
        self.ControlAgency = ControlAgency
    def get_LastRegulatoryUpdate(self):
    ...
    def _hasContent(self):
        if (
            ...
            self.ControlAgency is not None or
            self.LastRegulatoryUpdate is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ListDescriptionType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ListDescriptionType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ListDescriptionType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ListDescriptionType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ListName is not None:
            namespaceprefix_ = self.ListName_nsprefix_ + ':' if (UseCapturedNS_ and self.ListName_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sListName>%s</%sListName>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ListName), input_name='ListName')), namespaceprefix_ , eol_))
        if self.Description is not None:
            namespaceprefix_ = self.Description_nsprefix_ + ':' if (UseCapturedNS_ and self.Description_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDescription>%s</%sDescription>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Description), input_name='Description')), namespaceprefix_ , eol_))
        if self.ControlAgency is not None:
            namespaceprefix_ = self.ControlAgency_nsprefix_ + ':' if (UseCapturedNS_ and self.ControlAgency_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sControlAgency>%s</%sControlAgency>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ControlAgency), input_name='ControlAgency')), namespaceprefix_ , eol_))
        if self.LastRegulatoryUpdate is not None:
            namespaceprefix_ = self.LastRegulatoryUpdate_nsprefix_ + ':' if (UseCapturedNS_ and self.LastRegulatoryUpdate_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sLastRegulatoryUpdate>%s</%sLastRegulatoryUpdate>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.LastRegulatoryUpdate), input_name='LastRegulatoryUpdate')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'ListName':
            ...
            value_ = self.gds_validate_string(value_, node, 'ListName')
            self.ListName = value_
            self.ListName_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'ControlAgency':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'ControlAgency')
            value_ = self.gds_validate_string(value_, node, 'ControlAgency')
            self.ControlAgency = value_
            self.ControlAgency_nsprefix_ = child_.prefix
        elif nodeName_ == 'LastRegulatoryUpdate':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'LastRegulatoryUpdate')
            value_ = self.gds_validate_string(value_, node, 'LastRegulatoryUpdate')
            self.LastRegulatoryUpdate = value_
            self.LastRegulatoryUpdate_nsprefix_ = child_.prefix
# end class ListDescriptionType


class DeniedPartyType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Names=None, Addresses=None, Remarks=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DeniedPartyType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DeniedPartyType.subclass:
            return DeniedPartyType.subclass(*args_, **kwargs_)
        else:
            return DeniedPartyType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DeniedPartyType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DeniedPartyType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DeniedPartyType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DeniedPartyType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Names is not None:
            ...
            self.Names.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Names', pretty_print=pretty_print)
...
class NamesType(GeneratedsSuper):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='NamesType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('NamesType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'NamesType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'DeniedPartyScreenerRequest'
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:dps="http://www.ups.com/schema/xpci/1.0/dps"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from denied_party_web_service_schema import *\n\n')
        sys.stdout.write('import denied_party_web_service_schema as model_\n\n')
