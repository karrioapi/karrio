...
class Errors(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ErrorDetail=None, gds_collector_=None, **kwargs_):
    ...
    def set_ErrorDetail(self, ErrorDetail):
        self.ErrorDetail = ErrorDetail
    def add_ErrorDetail(self, value):
        self.ErrorDetail.append(value)
    def insert_ErrorDetail_at(self, index, value):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Errors', fromsubclass_=False, pretty_print=True):
        ...
        for ErrorDetail_ in self.ErrorDetail:
            namespaceprefix_ = self.ErrorDetail_nsprefix_ + ':' if (UseCapturedNS_ and self.ErrorDetail_nsprefix_) else ''
            ErrorDetail_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='ErrorDetail', pretty_print=pretty_print)
...
class ErrorDetailType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Severity=None, PrimaryErrorCode=None, MinimumRetrySeconds=None, Location=None, SubErrorCode=None, AdditionalInformation=None, ElementLevelInformation=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def set_Severity(self, Severity):
        self.Severity = Severity
    def get_PrimaryErrorCode(self):
        return self.PrimaryErrorCode
    def set_PrimaryErrorCode(self, PrimaryErrorCode):
        self.PrimaryErrorCode = PrimaryErrorCode
    ...
    def set_Location(self, Location):
        self.Location = Location
    def get_SubErrorCode(self):
        return self.SubErrorCode
    def set_SubErrorCode(self, SubErrorCode):
        self.SubErrorCode = SubErrorCode
    def add_SubErrorCode(self, value):
        self.SubErrorCode.append(value)
    def insert_SubErrorCode_at(self, index, value):
        self.SubErrorCode.insert(index, value)
    def replace_SubErrorCode_at(self, index, value):
        self.SubErrorCode[index] = value
    ...
    def set_AdditionalInformation(self, AdditionalInformation):
        self.AdditionalInformation = AdditionalInformation
    def add_AdditionalInformation(self, value):
        self.AdditionalInformation.append(value)
    def insert_AdditionalInformation_at(self, index, value):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ErrorDetailType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ErrorDetailType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ErrorDetailType', fromsubclass_=False, pretty_print=True):
        ...
        if self.PrimaryErrorCode is not None:
            namespaceprefix_ = self.PrimaryErrorCode_nsprefix_ + ':' if (UseCapturedNS_ and self.PrimaryErrorCode_nsprefix_) else ''
            self.PrimaryErrorCode.export(outfile, level, namespaceprefix_, namespacedef_='', name_='PrimaryErrorCode', pretty_print=pretty_print)
        ...
        for SubErrorCode_ in self.SubErrorCode:
            namespaceprefix_ = self.SubErrorCode_nsprefix_ + ':' if (UseCapturedNS_ and self.SubErrorCode_nsprefix_) else ''
            SubErrorCode_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='SubErrorCode', pretty_print=pretty_print)
        for AdditionalInformation_ in self.AdditionalInformation:
            ...
            AdditionalInformation_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='AdditionalInformation', pretty_print=pretty_print)
...
class ElementLevelInformationType(GeneratedsSuper):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ElementLevelInformationType', pretty_print=True):
...
class ElementIdentifierType(GeneratedsSuper):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ElementIdentifierType', pretty_print=True):
...
class CodeType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Code=None, Description=None, Digest=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
class AdditionalInfoType(GeneratedsSuper):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AdditionalInfoType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'AdditionalInfoType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Type':
            ...
            obj_ = AdditionalCodeDescType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class AdditionalCodeDescType(GeneratedsSuper):
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AdditionalCodeDescType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'AdditionalCodeDescType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
...
class LocationType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, LocationElementName=None, XPathOfElement=None, OriginalValue=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.LocationElementName_nsprefix_ = None
        self.XPathOfElement = XPathOfElement
        self.XPathOfElement_nsprefix_ = None
        self.OriginalValue = OriginalValue
        self.OriginalValue_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_LocationElementName(self):
        return self.LocationElementName
    def set_LocationElementName(self, LocationElementName):
        self.LocationElementName = LocationElementName
    def get_XPathOfElement(self):
        return self.XPathOfElement
    def set_XPathOfElement(self, XPathOfElement):
        self.XPathOfElement = XPathOfElement
    def get_OriginalValue(self):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='LocationType', fromsubclass_=False, pretty_print=True):
        ...
        if self.LocationElementName is not None:
            namespaceprefix_ = self.LocationElementName_nsprefix_ + ':' if (UseCapturedNS_ and self.LocationElementName_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sLocationElementName>%s</%sLocationElementName>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.LocationElementName), input_name='LocationElementName')), namespaceprefix_ , eol_))
        if self.XPathOfElement is not None:
            namespaceprefix_ = self.XPathOfElement_nsprefix_ + ':' if (UseCapturedNS_ and self.XPathOfElement_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sXPathOfElement>%s</%sXPathOfElement>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.XPathOfElement), input_name='XPathOfElement')), namespaceprefix_ , eol_))
        if self.OriginalValue is not None:
            namespaceprefix_ = self.OriginalValue_nsprefix_ + ':' if (UseCapturedNS_ and self.OriginalValue_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sOriginalValue>%s</%sOriginalValue>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.OriginalValue), input_name='OriginalValue')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'LocationElementName':
            ...
            value_ = self.gds_validate_string(value_, node, 'LocationElementName')
            self.LocationElementName = value_
            self.LocationElementName_nsprefix_ = child_.prefix
        elif nodeName_ == 'XPathOfElement':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'XPathOfElement')
            value_ = self.gds_validate_string(value_, node, 'XPathOfElement')
            self.XPathOfElement = value_
            self.XPathOfElement_nsprefix_ = child_.prefix
        elif nodeName_ == 'OriginalValue':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'OriginalValue')
            value_ = self.gds_validate_string(value_, node, 'OriginalValue')
            self.OriginalValue = value_
            self.OriginalValue_nsprefix_ = child_.prefix
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from error_1_1 import *\n\n')
        sys.stdout.write('import error_1_1 as model_\n\n')
