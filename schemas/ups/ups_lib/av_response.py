...
#
# Generated Mon Aug  1 09:54:34 2022 by generateDS.py version 2.40.13.
...
#
# Command line:
#   /Users/danielk/Documents/karrio/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./ups_lib/av_response.py" ./schemas/AVResponse.xsd
#
...
class AddressValidationResponse(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Response=None, AddressValidationResult=None, gds_collector_=None, **kwargs_):
        ...
        if AddressValidationResult is None:
            self.AddressValidationResult = []
        else:
            self.AddressValidationResult = AddressValidationResult
        self.AddressValidationResult_nsprefix_ = None
    ...
    def set_Response(self, Response):
        self.Response = Response
    def get_AddressValidationResult(self):
        return self.AddressValidationResult
    def set_AddressValidationResult(self, AddressValidationResult):
        self.AddressValidationResult = AddressValidationResult
    def add_AddressValidationResult(self, value):
        self.AddressValidationResult.append(value)
    def insert_AddressValidationResult_at(self, index, value):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressValidationResponse', fromsubclass_=False, pretty_print=True):
        ...
        for AddressValidationResult_ in self.AddressValidationResult:
            namespaceprefix_ = self.AddressValidationResult_nsprefix_ + ':' if (UseCapturedNS_ and self.AddressValidationResult_nsprefix_) else ''
            AddressValidationResult_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='AddressValidationResult', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'AddressValidationResult':
            obj_ = AddressValidationResultType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.AddressValidationResult.append(obj_)
            obj_.original_tagname_ = 'AddressValidationResult'
# end class AddressValidationResponse


class AddressValidationResultType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Rank=None, Quality=None, Address=None, PostalCodeLowEnd=None, PostalCodeHighEnd=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.PostalCodeLowEnd = PostalCodeLowEnd
        self.PostalCodeLowEnd_nsprefix_ = None
        self.PostalCodeHighEnd = PostalCodeHighEnd
        self.PostalCodeHighEnd_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, AddressValidationResultType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if AddressValidationResultType.subclass:
            return AddressValidationResultType.subclass(*args_, **kwargs_)
        else:
            return AddressValidationResultType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Address(self, Address):
        self.Address = Address
    def get_PostalCodeLowEnd(self):
        return self.PostalCodeLowEnd
    def set_PostalCodeLowEnd(self, PostalCodeLowEnd):
        self.PostalCodeLowEnd = PostalCodeLowEnd
    def get_PostalCodeHighEnd(self):
    ...
    def _hasContent(self):
        if (
            ...
            self.PostalCodeLowEnd is not None or
            self.PostalCodeHighEnd is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressValidationResultType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('AddressValidationResultType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'AddressValidationResultType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AddressValidationResultType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Quality is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sQuality>%s</%sQuality>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Quality), input_name='Quality')), namespaceprefix_ , eol_))
        ...
        if self.PostalCodeLowEnd is not None:
            namespaceprefix_ = self.PostalCodeLowEnd_nsprefix_ + ':' if (UseCapturedNS_ and self.PostalCodeLowEnd_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPostalCodeLowEnd>%s</%sPostalCodeLowEnd>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.PostalCodeLowEnd), input_name='PostalCodeLowEnd')), namespaceprefix_ , eol_))
        if self.PostalCodeHighEnd is not None:
            namespaceprefix_ = self.PostalCodeHighEnd_nsprefix_ + ':' if (UseCapturedNS_ and self.PostalCodeHighEnd_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPostalCodeHighEnd>%s</%sPostalCodeHighEnd>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.PostalCodeHighEnd), input_name='PostalCodeHighEnd')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Rank':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Quality')
            value_ = self.gds_validate_string(value_, node, 'Quality')
            self.Quality = value_
        ...
        elif nodeName_ == 'PostalCodeLowEnd':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'PostalCodeLowEnd')
            value_ = self.gds_validate_string(value_, node, 'PostalCodeLowEnd')
            self.PostalCodeLowEnd = value_
            self.PostalCodeLowEnd_nsprefix_ = child_.prefix
        elif nodeName_ == 'PostalCodeHighEnd':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'PostalCodeHighEnd')
            value_ = self.gds_validate_string(value_, node, 'PostalCodeHighEnd')
            self.PostalCodeHighEnd = value_
            self.PostalCodeHighEnd_nsprefix_ = child_.prefix
# end class AddressValidationResultType
...
class AddressType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, City=None, StateProvinceCode=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from av_response import *\n\n')
        sys.stdout.write('import av_response as model_\n\n')
