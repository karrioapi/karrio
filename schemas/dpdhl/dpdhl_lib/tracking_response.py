...
class data(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, data)
    ...
    def export(
        ...
        self._exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="data"
        )
        if self._hasContent():
    ...
    def _exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="data"
    ):
        ...
        if self.request_id is not None and "request_id" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.request_id), input_name="request-id"
                        )
                    ),
                )
            )
        if self.code is not None and "code" not in already_processed:
            ...
            outfile.write(
                ' code="%s"' % self.gds_format_integer(self.code, input_name="code")
            )
        if (
            self.piece_identifier is not None
            and "piece_identifier" not in already_processed
        ):
            already_processed.add("piece_identifier")
            outfile.write(
                ' piece-identifier="%s"'
                % self.gds_format_integer(
                    self.piece_identifier, input_name="piece-identifier"
                )
            )
        if self._build_time is not None and "_build_time" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self._build_time), input_name="_build-time"
                        )
                    ),
                )
            )
        if self.piece_id is not None and "piece_id" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.piece_id), input_name="piece-id"
                        )
                    ),
                )
            )
        if self.leitcode is not None and "leitcode" not in already_processed:
            ...
            outfile.write(
                ' leitcode="%s"'
                % self.gds_format_integer(self.leitcode, input_name="leitcode")
            )
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and "piece-identifier" not in already_processed:
            ...
            self.piece_identifier = self.gds_parse_integer(
                value, node, "piece-identifier"
            )
...
class dataType(GeneratedsSuper):
    ...
    def _exportAttributes(
        ...
        if (
            ...
            and "event_timestamp" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.event_timestamp),
        ...
        if self.event_status is not None and "event_status" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.event_status), input_name="event-status"
                        )
                    ),
                )
            )
        if self.event_text is not None and "event_text" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.event_text), input_name="event-text"
                        )
                    ),
                )
            )
        if self.ice is not None and "ice" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(quote_attrib(self.ice), input_name="ice")
                    ),
                )
            )
        if self.ric is not None and "ric" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(quote_attrib(self.ric), input_name="ric")
                    ),
                )
            )
        if (
            self.event_location is not None
            and "event_location" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.event_location),
        ...
        if self.event_country is not None and "event_country" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.event_country), input_name="event-country"
                        )
                    ),
                )
            )
        if (
            self.standard_event_code is not None
            and "standard_event_code" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(
                            quote_attrib(self.standard_event_code),
                            input_name="standard-event-code",
                        )
                    ),
                )
            )
