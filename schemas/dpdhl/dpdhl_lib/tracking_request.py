...
class data(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, appname=None, password=None, request=None, language_code=None, piece_code=None, piece_customer_reference=None, tas_order_no=None, from_date=None, to_date=None, gds_collector_=None, **kwargs_):
        ...
        self.tas_order_no = _cast(None, tas_order_no)
        self.tas_order_no_nsprefix_ = None
    ...
    def get_tas_order_no(self):
        return self.tas_order_no
    def set_tas_order_no(self, tas_order_no):
        self.tas_order_no = tas_order_no
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='data'):
        ...
        if self.tas_order_no is not None and 'tas_order_no' not in already_processed:
            already_processed.add('tas_order_no')
            outfile.write(' tas-order-no=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.tas_order_no), input_name='tas-order-no')), ))
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        value = find_attr_value_('tas-order-no', node)
        if value is not None and 'tas-order-no' not in already_processed:
            already_processed.add('tas-order-no')
            self.tas_order_no = value
