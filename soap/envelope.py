...
#
# Generated Tue Mar  6 20:28:25 2018 by generateDS.py version 2.29.5.
...
#   ./xsd/schemas.xmlsoap.org.xml
#
# Command line:
#   generateDS.py -a --no-namespace-defs -o "./lib/soap.py" ./xsd/schemas.xmlsoap.org.xml
#
...
class Envelope(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='Envelope', namespacedef_='', pretty_print=True):
...
class Header(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='Header', namespacedef_='', pretty_print=True):
...
class Body(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='Body', namespacedef_='', pretty_print=True):
...
class Fault(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='Fault', namespacedef_='', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='Fault', fromsubclass_=False, pretty_print=True):
        ...
        if self.faultstring is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:faultstring>%s</tns:faultstring>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.faultstring), input_name='faultstring')), eol_))
        if self.faultactor is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:faultactor>%s</tns:faultactor>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.faultactor), input_name='faultactor')), eol_))
...
class detail(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='detail', namespacedef_='', pretty_print=True):
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from soap import *\n\n')
        sys.stdout.write('import soap as model_\n\n')
