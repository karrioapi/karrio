...
#   ('-o', '../python/FreightEstimatingService.xsd.py')
#
# Command line arguments:
#   FreightEstimatingService.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/FreightEstimatingService.xsd.py" FreightEstimatingService.xsd
#
...
class Shipment(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, SenderInformation=None, ReceiverInformation=None, PaymentInformation=None, ShipmentDetails=None):
        self.original_tagname_ = None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'SenderInformation':
            ...
            obj_ = EstimateInformation.factory()
            obj_.build(child_)
...
class GetEstimateResponseContainer(ResponseContainer):
    ...
    def __init__(self, TariffCode=None, DiscountPoint=None, TransitDays=None, EstimatedDeliveryDate=None, TotalPrice=None, LineItemDetails=None, AccessorialDetails=None, ShipmentTaxes=None):
        self.original_tagname_ = None
        super(GetEstimateResponseContainer, self).__init__()
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='GetEstimateResponseContainer', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GetEstimateResponseContainer')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='GetEstimateResponseContainer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='GetEstimateResponseContainer'):
        super(GetEstimateResponseContainer, self).exportAttributes(outfile, level, already_processed, namespace_, name_='GetEstimateResponseContainer')
    def exportChildren(self, outfile, level, namespace_='tns:', name_='GetEstimateResponseContainer', fromsubclass_=False, pretty_print=True):
        super(GetEstimateResponseContainer, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GetEstimateRequestContainer(RequestContainer):
    ...
    def __init__(self, Estimate=None):
        self.original_tagname_ = None
        super(GetEstimateRequestContainer, self).__init__()
    ...
    factory = staticmethod(factory)
    def get_Estimate(self): return self.Estimate
    def set_Estimate(self, Estimate): self.Estimate = Estimate
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='GetEstimateRequestContainer', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GetEstimateRequestContainer')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='GetEstimateRequestContainer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='GetEstimateRequestContainer'):
        super(GetEstimateRequestContainer, self).exportAttributes(outfile, level, already_processed, namespace_, name_='GetEstimateRequestContainer')
    def exportChildren(self, outfile, level, namespace_='tns:', name_='GetEstimateRequestContainer', fromsubclass_=False, pretty_print=True):
        super(GetEstimateRequestContainer, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Estimate is not None:
            self.Estimate.export(outfile, level, namespace_, name_='Estimate', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from FreightEstimatingService.xsd import *\n\n')
        sys.stdout.write('import FreightEstimatingService.xsd as model_\n\n')
