...
#   ('-o', '../python/FreightShippingService.xsd.py')
#
# Command line arguments:
#   FreightShippingService.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/FreightShippingService.xsd.py" FreightShippingService.xsd
#
...
class Shipment(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, SenderInformation=None, ReceiverInformation=None, ThirdPartyInformation=None, PaymentInformation=None, ShipmentDetails=None, AppointmentFlag=None, AppointmentDate=None, AppointmentStartTime=None, AppointmentEndTime=None, PickupFlag=None, PickupInformation=None, AlertInformation=None):
        self.original_tagname_ = None
        ...
        self.AppointmentFlag = AppointmentFlag
    ...
    def get_AppointmentFlag(self): return self.AppointmentFlag
    def set_AppointmentFlag(self, AppointmentFlag): self.AppointmentFlag = AppointmentFlag
    def get_AppointmentDate(self): return self.AppointmentDate
    def set_AppointmentDate(self, AppointmentDate): self.AppointmentDate = AppointmentDate
    def get_AppointmentStartTime(self): return self.AppointmentStartTime
    def set_AppointmentStartTime(self, AppointmentStartTime): self.AppointmentStartTime = AppointmentStartTime
    def get_AppointmentEndTime(self): return self.AppointmentEndTime
    def set_AppointmentEndTime(self, AppointmentEndTime): self.AppointmentEndTime = AppointmentEndTime
    def get_PickupFlag(self): return self.PickupFlag
    def set_PickupFlag(self, PickupFlag): self.PickupFlag = PickupFlag
    ...
    def get_AlertInformation(self): return self.AlertInformation
    def set_AlertInformation(self, AlertInformation): self.AlertInformation = AlertInformation
    def hasContent_(self):
        if (
            ...
            self.AppointmentFlag is not None or
            self.AppointmentDate is not None or
            self.AppointmentStartTime is not None or
            self.AppointmentEndTime is not None or
            self.PickupFlag is not None or
            self.PickupInformation is not None or
            self.AlertInformation is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='tns:', name_='Shipment', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v1"', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='Shipment', fromsubclass_=False, pretty_print=True):
        ...
        if self.AppointmentFlag is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:AppointmentFlag>%s</tns:AppointmentFlag>%s' % (self.gds_format_boolean(self.AppointmentFlag, input_name='AppointmentFlag'), eol_))
        if self.AppointmentDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:AppointmentDate>%s</tns:AppointmentDate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AppointmentDate), input_name='AppointmentDate')), eol_))
        if self.AppointmentStartTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:AppointmentStartTime>%s</tns:AppointmentStartTime>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AppointmentStartTime), input_name='AppointmentStartTime')), eol_))
        if self.AppointmentEndTime is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:AppointmentEndTime>%s</tns:AppointmentEndTime>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.AppointmentEndTime), input_name='AppointmentEndTime')), eol_))
        if self.PickupFlag is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:PickupFlag>%s</tns:PickupFlag>%s' % (self.gds_format_boolean(self.PickupFlag, input_name='PickupFlag'), eol_))
        ...
        if self.AlertInformation is not None:
            self.AlertInformation.export(outfile, level, namespace_, name_='AlertInformation', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'SenderInformation':
        ...
        elif nodeName_ == 'AppointmentFlag':
            sval_ = child_.text
            if sval_ in ('true', '1'):
                ival_ = True
            ...
            ival_ = self.gds_validate_boolean(ival_, node, 'AppointmentFlag')
            self.AppointmentFlag = ival_
        elif nodeName_ == 'AppointmentDate':
            AppointmentDate_ = child_.text
            AppointmentDate_ = self.gds_validate_string(AppointmentDate_, node, 'AppointmentDate')
            self.AppointmentDate = AppointmentDate_
        elif nodeName_ == 'AppointmentStartTime':
            AppointmentStartTime_ = child_.text
            AppointmentStartTime_ = self.gds_validate_string(AppointmentStartTime_, node, 'AppointmentStartTime')
            self.AppointmentStartTime = AppointmentStartTime_
        elif nodeName_ == 'AppointmentEndTime':
            AppointmentEndTime_ = child_.text
            AppointmentEndTime_ = self.gds_validate_string(AppointmentEndTime_, node, 'AppointmentEndTime')
            self.AppointmentEndTime = AppointmentEndTime_
        elif nodeName_ == 'PickupFlag':
            sval_ = child_.text
            if sval_ in ('true', '1'):
                ival_ = True
            elif sval_ in ('false', '0'):
                ...
                raise_parse_error(child_, 'requires boolean')
            ival_ = self.gds_validate_boolean(ival_, node, 'PickupFlag')
            self.PickupFlag = ival_
        ...
        elif nodeName_ == 'AlertInformation':
            obj_ = AlertInformation.factory()
            obj_.build(child_)
            self.AlertInformation = obj_
            obj_.original_tagname_ = 'AlertInformation'
# end class Shipment
...
class AlertInformation(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, AlertDetails=None):
        self.original_tagname_ = None
        self.AlertDetails = AlertDetails
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, AlertInformation)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if AlertInformation.subclass:
            return AlertInformation.subclass(*args_, **kwargs_)
        else:
            return AlertInformation(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_AlertDetails(self): return self.AlertDetails
    def set_AlertDetails(self, AlertDetails): self.AlertDetails = AlertDetails
    def hasContent_(self):
        if (
            self.AlertDetails is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='tns:', name_='AlertInformation', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v1"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('AlertInformation')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='AlertInformation')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='AlertInformation', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='AlertInformation'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='AlertInformation', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.AlertDetails is not None:
            self.AlertDetails.export(outfile, level, namespace_, name_='AlertDetails', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'AlertDetails':
            obj_ = ArrayOfAlertDetail.factory()
            obj_.build(child_)
            self.AlertDetails = obj_
            obj_.original_tagname_ = 'AlertDetails'
# end class AlertInformation


class ArrayOfAlertDetail(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, AlertDetail=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ArrayOfAlertDetail)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ArrayOfAlertDetail.subclass:
            return ArrayOfAlertDetail.subclass(*args_, **kwargs_)
        else:
            return ArrayOfAlertDetail(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='ArrayOfAlertDetail', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v1"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ArrayOfAlertDetail')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ArrayOfAlertDetail')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='ArrayOfAlertDetail', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='ArrayOfAlertDetail'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='ArrayOfAlertDetail', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'AlertDetail':
            obj_ = AlertDetail.factory()
            obj_.build(child_)
            self.AlertDetail.append(obj_)
            obj_.original_tagname_ = 'AlertDetail'
# end class ArrayOfAlertDetail


class AlertDetail(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Type=None, EmailAddress=None):
        self.original_tagname_ = None
        self.Type = Type
        self.EmailAddress = EmailAddress
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, AlertDetail)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if AlertDetail.subclass:
            return AlertDetail.subclass(*args_, **kwargs_)
        else:
            return AlertDetail(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_Type(self): return self.Type
    def set_Type(self, Type): self.Type = Type
    def get_EmailAddress(self): return self.EmailAddress
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='AlertDetail', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v1"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('AlertDetail')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='AlertDetail')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='AlertDetail', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='AlertDetail'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='AlertDetail', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ArrayOfAccessorialItem(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, AccessorialItem=None):
        self.original_tagname_ = None
        if AccessorialItem is None:
            self.AccessorialItem = []
        else:
            self.AccessorialItem = AccessorialItem
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ArrayOfAccessorialItem)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ArrayOfAccessorialItem.subclass:
            return ArrayOfAccessorialItem.subclass(*args_, **kwargs_)
        else:
            return ArrayOfAccessorialItem(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_AccessorialItem(self): return self.AccessorialItem
    def set_AccessorialItem(self, AccessorialItem): self.AccessorialItem = AccessorialItem
    def add_AccessorialItem(self, value): self.AccessorialItem.append(value)
    def insert_AccessorialItem_at(self, index, value): self.AccessorialItem.insert(index, value)
    def replace_AccessorialItem_at(self, index, value): self.AccessorialItem[index] = value
    def hasContent_(self):
        if (
            self.AccessorialItem
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='ArrayOfAccessorialItem', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v1"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ArrayOfAccessorialItem')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ArrayOfAccessorialItem')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='ArrayOfAccessorialItem', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='ArrayOfAccessorialItem'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='ArrayOfAccessorialItem', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for AccessorialItem_ in self.AccessorialItem:
            AccessorialItem_.export(outfile, level, namespace_, name_='AccessorialItem', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'AccessorialItem':
            obj_ = AccessorialItem.factory()
            obj_.build(child_)
            self.AccessorialItem.append(obj_)
            obj_.original_tagname_ = 'AccessorialItem'
# end class ArrayOfAccessorialItem


class AccessorialItem(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Code=None, Description=None, Charge=None):
        self.original_tagname_ = None
        self.Code = Code
        self.Description = Description
        self.Charge = Charge
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, AccessorialItem)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if AccessorialItem.subclass:
            return AccessorialItem.subclass(*args_, **kwargs_)
        else:
            return AccessorialItem(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_Code(self): return self.Code
    def set_Code(self, Code): self.Code = Code
    def get_Description(self): return self.Description
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='AccessorialItem', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v1"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('AccessorialItem')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='AccessorialItem')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='AccessorialItem', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='AccessorialItem'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='AccessorialItem', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ArrayOfTax(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='ArrayOfTax', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v1"', pretty_print=True):
...
class Tax(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='Tax', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v1"', pretty_print=True):
...
class CreateShipmentResponseContainer(ResponseContainer):
    ...
    def __init__(self, ProNumber=None, PickupNumber=None, TariffCode=None, DiscountPoint=None, TransitDays=None, EstimatedDeliveryDate=None, OriginalTerminalCode=None, DestinationTerminalCode=None, DestinationUniCode=None, TotalPrice=None, ShipmentPINs=None, LineItemDetails=None, AccessorialDetails=None, ShipmentTaxes=None):
        self.original_tagname_ = None
        ...
        self.OriginalTerminalCode = OriginalTerminalCode
        self.DestinationTerminalCode = DestinationTerminalCode
        self.DestinationUniCode = DestinationUniCode
        self.TotalPrice = TotalPrice
        self.ShipmentPINs = ShipmentPINs
        self.LineItemDetails = LineItemDetails
        self.AccessorialDetails = AccessorialDetails
        self.ShipmentTaxes = ShipmentTaxes
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_TariffCode(self): return self.TariffCode
    def set_TariffCode(self, TariffCode): self.TariffCode = TariffCode
    def get_DiscountPoint(self): return self.DiscountPoint
    def set_DiscountPoint(self, DiscountPoint): self.DiscountPoint = DiscountPoint
    def get_TransitDays(self): return self.TransitDays
    def set_TransitDays(self, TransitDays): self.TransitDays = TransitDays
    def get_EstimatedDeliveryDate(self): return self.EstimatedDeliveryDate
    def set_EstimatedDeliveryDate(self, EstimatedDeliveryDate): self.EstimatedDeliveryDate = EstimatedDeliveryDate
    def get_OriginalTerminalCode(self): return self.OriginalTerminalCode
    def set_OriginalTerminalCode(self, OriginalTerminalCode): self.OriginalTerminalCode = OriginalTerminalCode
    def get_DestinationTerminalCode(self): return self.DestinationTerminalCode
    def set_DestinationTerminalCode(self, DestinationTerminalCode): self.DestinationTerminalCode = DestinationTerminalCode
    def get_DestinationUniCode(self): return self.DestinationUniCode
    def set_DestinationUniCode(self, DestinationUniCode): self.DestinationUniCode = DestinationUniCode
    def get_TotalPrice(self): return self.TotalPrice
    def set_TotalPrice(self, TotalPrice): self.TotalPrice = TotalPrice
    def get_ShipmentPINs(self): return self.ShipmentPINs
    def set_ShipmentPINs(self, ShipmentPINs): self.ShipmentPINs = ShipmentPINs
    def get_LineItemDetails(self): return self.LineItemDetails
    def set_LineItemDetails(self, LineItemDetails): self.LineItemDetails = LineItemDetails
    def get_AccessorialDetails(self): return self.AccessorialDetails
    def set_AccessorialDetails(self, AccessorialDetails): self.AccessorialDetails = AccessorialDetails
    def get_ShipmentTaxes(self): return self.ShipmentTaxes
    def set_ShipmentTaxes(self, ShipmentTaxes): self.ShipmentTaxes = ShipmentTaxes
    def hasContent_(self):
        if (
            self.ProNumber is not None or
            self.PickupNumber is not None or
            self.TariffCode is not None or
            self.DiscountPoint is not None or
            self.TransitDays is not None or
            self.EstimatedDeliveryDate is not None or
            self.OriginalTerminalCode is not None or
            self.DestinationTerminalCode is not None or
            self.DestinationUniCode is not None or
            self.TotalPrice is not None or
            self.ShipmentPINs is not None or
            self.LineItemDetails is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='CreateShipmentResponseContainer', fromsubclass_=False, pretty_print=True):
        ...
        if self.TariffCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:TariffCode>%s</tns:TariffCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TariffCode), input_name='TariffCode')), eol_))
        if self.DiscountPoint is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:DiscountPoint>%s</tns:DiscountPoint>%s' % (self.gds_format_float(self.DiscountPoint, input_name='DiscountPoint'), eol_))
        if self.TransitDays is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:TransitDays>%s</tns:TransitDays>%s' % (self.gds_format_integer(self.TransitDays, input_name='TransitDays'), eol_))
        if self.EstimatedDeliveryDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:EstimatedDeliveryDate>%s</tns:EstimatedDeliveryDate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EstimatedDeliveryDate), input_name='EstimatedDeliveryDate')), eol_))
        if self.OriginalTerminalCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:OriginalTerminalCode>%s</tns:OriginalTerminalCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.OriginalTerminalCode), input_name='OriginalTerminalCode')), eol_))
        if self.DestinationTerminalCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:DestinationTerminalCode>%s</tns:DestinationTerminalCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DestinationTerminalCode), input_name='DestinationTerminalCode')), eol_))
        if self.DestinationUniCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:DestinationUniCode>%s</tns:DestinationUniCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DestinationUniCode), input_name='DestinationUniCode')), eol_))
        ...
        if self.ShipmentPINs is not None:
            self.ShipmentPINs.export(outfile, level, namespace_, name_='ShipmentPINs', pretty_print=pretty_print)
        if self.LineItemDetails is not None:
            self.LineItemDetails.export(outfile, level, namespace_, name_='LineItemDetails', pretty_print=pretty_print)
        if self.AccessorialDetails is not None:
            self.AccessorialDetails.export(outfile, level, namespace_, name_='AccessorialDetails', pretty_print=pretty_print)
        if self.ShipmentTaxes is not None:
            self.ShipmentTaxes.export(outfile, level, namespace_, name_='ShipmentTaxes', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ProNumber':
            ...
            TariffCode_ = child_.text
            TariffCode_ = self.gds_validate_string(TariffCode_, node, 'TariffCode')
            self.TariffCode = TariffCode_
        elif nodeName_ == 'DiscountPoint':
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires float or double: %s' % exp)
            fval_ = self.gds_validate_float(fval_, node, 'DiscountPoint')
            self.DiscountPoint = fval_
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'TransitDays')
            self.TransitDays = ival_
        elif nodeName_ == 'EstimatedDeliveryDate':
            EstimatedDeliveryDate_ = child_.text
            EstimatedDeliveryDate_ = self.gds_validate_string(EstimatedDeliveryDate_, node, 'EstimatedDeliveryDate')
            self.EstimatedDeliveryDate = EstimatedDeliveryDate_
        elif nodeName_ == 'OriginalTerminalCode':
            OriginalTerminalCode_ = child_.text
            OriginalTerminalCode_ = self.gds_validate_string(OriginalTerminalCode_, node, 'OriginalTerminalCode')
            self.OriginalTerminalCode = OriginalTerminalCode_
        elif nodeName_ == 'DestinationTerminalCode':
            DestinationTerminalCode_ = child_.text
            DestinationTerminalCode_ = self.gds_validate_string(DestinationTerminalCode_, node, 'DestinationTerminalCode')
            self.DestinationTerminalCode = DestinationTerminalCode_
        elif nodeName_ == 'DestinationUniCode':
            DestinationUniCode_ = child_.text
            DestinationUniCode_ = self.gds_validate_string(DestinationUniCode_, node, 'DestinationUniCode')
            self.DestinationUniCode = DestinationUniCode_
        ...
        elif nodeName_ == 'ShipmentPINs':
            obj_ = ArrayOfPIN.factory()
            obj_.build(child_)
            self.ShipmentPINs = obj_
            obj_.original_tagname_ = 'ShipmentPINs'
        elif nodeName_ == 'LineItemDetails':
            obj_ = ArrayOfLineItem.factory()
            obj_.build(child_)
            self.LineItemDetails = obj_
            obj_.original_tagname_ = 'LineItemDetails'
        elif nodeName_ == 'AccessorialDetails':
            obj_ = ArrayOfAccessorialItem.factory()
            obj_.build(child_)
            self.AccessorialDetails = obj_
            obj_.original_tagname_ = 'AccessorialDetails'
        elif nodeName_ == 'ShipmentTaxes':
...
GDSClassesMapping = {
    'AccessorialItem': AccessorialItem,
    'Address': Address,
    'AlertDetail': AlertDetail,
    'AlertInformation': AlertInformation,
    'ArrayOfAccessorialItem': ArrayOfAccessorialItem,
    'ArrayOfAlertDetail': ArrayOfAlertDetail,
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from FreightShippingService.xsd import *\n\n')
        sys.stdout.write('import FreightShippingService.xsd as model_\n\n')
