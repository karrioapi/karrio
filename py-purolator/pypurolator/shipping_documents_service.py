...
#   ('--no-namespace-defs', '')
#   ('-o', './python/shipping_documents_service.py')
#
# Command line arguments:
#   ./schemas/ShippingDocumentsService.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.sandbox/bin/generateDS --no-namespace-defs -o "./python/shipping_documents_service.py" ./schemas/ShippingDocumentsService.xsd
#
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from shipping_documents_service import *\n\n')
        sys.stdout.write('import shipping_documents_service as model_\n\n')
