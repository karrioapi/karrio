...
#   ('--no-namespace-defs', '')
#   ('-o', './python/freight_pickup_service.py')
#
# Command line arguments:
#   ./schemas/FreightPickupService.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/.sandbox/bin/generateDS --no-namespace-defs -o "./python/freight_pickup_service.py" ./schemas/FreightPickupService.xsd
#
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from freight_pickup_service import *\n\n')
        sys.stdout.write('import freight_pickup_service as model_\n\n')
