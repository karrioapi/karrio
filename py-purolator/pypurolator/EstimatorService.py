...
#
# Generated Thu Dec 13 14:06:20 2018 by generateDS.py version 2.29.5.
# Python 3.6.5 (default, May 19 2018, 11:27:13)  [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.39.2)]
#
# Command line options:
#   ('-o', '../python/EstimatorService.xsd.py')
#
# Command line arguments:
#   EstimatorService.xsd
#
# Command line:
#   /Users/danielkobina/Documents/Open/bin/generateDS -o "../python/EstimatorService.xsd.py" EstimatorService.xsd
#
...
class ArrayOfShipmentEstimate(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ShipmentEstimate=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_ShipmentEstimate(self): return self.ShipmentEstimate
    def set_ShipmentEstimate(self, ShipmentEstimate): self.ShipmentEstimate = ShipmentEstimate
    def add_ShipmentEstimate(self, value): self.ShipmentEstimate.append(value)
    def insert_ShipmentEstimate_at(self, index, value): self.ShipmentEstimate.insert(index, value)
    def replace_ShipmentEstimate_at(self, index, value): self.ShipmentEstimate[index] = value
    def hasContent_(self):
        if (
            self.ShipmentEstimate
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='ArrayOfShipmentEstimate', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ArrayOfShipmentEstimate')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='ArrayOfShipmentEstimate', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='ArrayOfShipmentEstimate'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='ArrayOfShipmentEstimate', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for ShipmentEstimate_ in self.ShipmentEstimate:
            ShipmentEstimate_.export(outfile, level, namespace_, name_='ShipmentEstimate', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ShipmentEstimate(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ServiceID=None, ShipmentDate=None, ExpectedDeliveryDate=None, EstimatedTransitDays=None, BasePrice=None, Surcharges=None, Taxes=None, OptionPrices=None, TotalPrice=None):
        self.original_tagname_ = None
    ...
    def get_ExpectedDeliveryDate(self): return self.ExpectedDeliveryDate
    def set_ExpectedDeliveryDate(self, ExpectedDeliveryDate): self.ExpectedDeliveryDate = ExpectedDeliveryDate
    def get_EstimatedTransitDays(self): return self.EstimatedTransitDays
    def set_EstimatedTransitDays(self, EstimatedTransitDays): self.EstimatedTransitDays = EstimatedTransitDays
    ...
    def get_OptionPrices(self): return self.OptionPrices
    def set_OptionPrices(self, OptionPrices): self.OptionPrices = OptionPrices
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='ShipmentEstimate', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ShipmentEstimate')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='ShipmentEstimate', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='ShipmentEstimate'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='ShipmentEstimate', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ExpectedDeliveryDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:ExpectedDeliveryDate>%s</tns:ExpectedDeliveryDate>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ExpectedDeliveryDate), input_name='ExpectedDeliveryDate')), eol_))
        if self.EstimatedTransitDays is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:EstimatedTransitDays>%s</tns:EstimatedTransitDays>%s' % (self.gds_format_integer(self.EstimatedTransitDays, input_name='EstimatedTransitDays'), eol_))
        ...
        if self.Surcharges is not None:
            self.Surcharges.export(outfile, level, namespace_, name_='Surcharges', pretty_print=pretty_print)
        ...
        if self.OptionPrices is not None:
            self.OptionPrices.export(outfile, level, namespace_, name_='OptionPrices', pretty_print=pretty_print)
        if self.TotalPrice is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:TotalPrice>%s</tns:TotalPrice>%s' % (self.gds_format_float(self.TotalPrice, input_name='TotalPrice'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'EstimatedTransitDays':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
...
class ArrayOfSurcharge(GeneratedsSuper):
    ...
    def add_Surcharge(self, value): self.Surcharge.append(value)
    def insert_Surcharge_at(self, index, value): self.Surcharge.insert(index, value)
    def replace_Surcharge_at(self, index, value): self.Surcharge[index] = value
    def hasContent_(self):
        if (
            self.Surcharge
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='ArrayOfSurcharge', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ArrayOfSurcharge')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='ArrayOfSurcharge', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='ArrayOfSurcharge'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='ArrayOfSurcharge', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Surcharge_ in self.Surcharge:
            Surcharge_.export(outfile, level, namespace_, name_='Surcharge', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class Surcharge(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Amount=None, Type=None, Description=None):
        self.original_tagname_ = None
        self.Amount = Amount
        self.Type = Type
        self.Description = Description
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='Surcharge', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='Surcharge', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='Surcharge'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='Surcharge', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Amount is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:Amount>%s</tns:Amount>%s' % (self.gds_format_float(self.Amount, input_name='Amount'), eol_))
...
class ArrayOfTax(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='ArrayOfTax', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ArrayOfTax')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='ArrayOfTax', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='ArrayOfTax'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='ArrayOfTax', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Tax(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='Tax', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='Tax', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='Tax'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='Tax', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ArrayOfOptionPrice(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, OptionPrice=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_OptionPrice(self): return self.OptionPrice
    def set_OptionPrice(self, OptionPrice): self.OptionPrice = OptionPrice
    def add_OptionPrice(self, value): self.OptionPrice.append(value)
    def insert_OptionPrice_at(self, index, value): self.OptionPrice.insert(index, value)
    def replace_OptionPrice_at(self, index, value): self.OptionPrice[index] = value
    def hasContent_(self):
        if (
            self.OptionPrice
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='ArrayOfOptionPrice', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ArrayOfOptionPrice')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='ArrayOfOptionPrice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='ArrayOfOptionPrice'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='ArrayOfOptionPrice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for OptionPrice_ in self.OptionPrice:
            OptionPrice_.export(outfile, level, namespace_, name_='OptionPrice', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class OptionPrice(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Amount=None, ID=None, Description=None):
        self.original_tagname_ = None
        self.Amount = Amount
        self.ID = ID
        self.Description = Description
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='OptionPrice', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='OptionPrice')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='OptionPrice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='OptionPrice'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='OptionPrice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GetFullEstimateRequestContainer(RequestContainer):
    """GetFullEstimateRequest"""
    subclass = None
    superclass = RequestContainer
    def __init__(self, Shipment=None, ShowAlternativeServicesIndicator=None):
        self.original_tagname_ = None
        super(GetFullEstimateRequestContainer, self).__init__()
        self.Shipment = Shipment
        self.ShowAlternativeServicesIndicator = ShowAlternativeServicesIndicator
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GetFullEstimateRequestContainer)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GetFullEstimateRequestContainer.subclass:
            return GetFullEstimateRequestContainer.subclass(*args_, **kwargs_)
        else:
            return GetFullEstimateRequestContainer(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_Shipment(self): return self.Shipment
    def set_Shipment(self, Shipment): self.Shipment = Shipment
    def get_ShowAlternativeServicesIndicator(self): return self.ShowAlternativeServicesIndicator
    def set_ShowAlternativeServicesIndicator(self, ShowAlternativeServicesIndicator): self.ShowAlternativeServicesIndicator = ShowAlternativeServicesIndicator
    def hasContent_(self):
        if (
            self.Shipment is not None or
            self.ShowAlternativeServicesIndicator is not None or
            super(GetFullEstimateRequestContainer, self).hasContent_()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='tns:', name_='GetFullEstimateRequestContainer', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GetFullEstimateRequestContainer')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GetFullEstimateRequestContainer')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='GetFullEstimateRequestContainer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='GetFullEstimateRequestContainer'):
        super(GetFullEstimateRequestContainer, self).exportAttributes(outfile, level, already_processed, namespace_, name_='GetFullEstimateRequestContainer')
    def exportChildren(self, outfile, level, namespace_='tns:', name_='GetFullEstimateRequestContainer', fromsubclass_=False, pretty_print=True):
        super(GetFullEstimateRequestContainer, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ShowAlternativeServicesIndicator is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:ShowAlternativeServicesIndicator>%s</tns:ShowAlternativeServicesIndicator>%s' % (self.gds_format_boolean(self.ShowAlternativeServicesIndicator, input_name='ShowAlternativeServicesIndicator'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
        ...
        return self
    def buildAttributes(self, node, attrs, already_processed):
        super(GetFullEstimateRequestContainer, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        super(GetFullEstimateRequestContainer, self).buildChildren(child_, node, nodeName_, True)
# end class GetFullEstimateRequestContainer
...
class GetFullEstimateResponseContainer(ResponseContainer):
    """GetFullEstimateResponse"""
    subclass = None
    superclass = ResponseContainer
    def __init__(self, ShipmentEstimates=None, ReturnShipmentEstimates=None):
        self.original_tagname_ = None
        super(GetFullEstimateResponseContainer, self).__init__()
        self.ShipmentEstimates = ShipmentEstimates
        self.ReturnShipmentEstimates = ReturnShipmentEstimates
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GetFullEstimateResponseContainer)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GetFullEstimateResponseContainer.subclass:
            return GetFullEstimateResponseContainer.subclass(*args_, **kwargs_)
        else:
            return GetFullEstimateResponseContainer(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ShipmentEstimates(self): return self.ShipmentEstimates
    def set_ShipmentEstimates(self, ShipmentEstimates): self.ShipmentEstimates = ShipmentEstimates
    def get_ReturnShipmentEstimates(self): return self.ReturnShipmentEstimates
    def set_ReturnShipmentEstimates(self, ReturnShipmentEstimates): self.ReturnShipmentEstimates = ReturnShipmentEstimates
    def hasContent_(self):
        if (
            self.ShipmentEstimates is not None or
            self.ReturnShipmentEstimates is not None or
            super(GetFullEstimateResponseContainer, self).hasContent_()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='tns:', name_='GetFullEstimateResponseContainer', namespacedef_='xmlns:tns="http://purolator.com/pws/datatypes/v2"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GetFullEstimateResponseContainer')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GetFullEstimateResponseContainer')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='GetFullEstimateResponseContainer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='GetFullEstimateResponseContainer'):
        super(GetFullEstimateResponseContainer, self).exportAttributes(outfile, level, already_processed, namespace_, name_='GetFullEstimateResponseContainer')
    def exportChildren(self, outfile, level, namespace_='tns:', name_='GetFullEstimateResponseContainer', fromsubclass_=False, pretty_print=True):
        super(GetFullEstimateResponseContainer, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ShipmentEstimates is not None:
            self.ShipmentEstimates.export(outfile, level, namespace_, name_='ShipmentEstimates', pretty_print=pretty_print)
        if self.ReturnShipmentEstimates is not None:
            self.ReturnShipmentEstimates.export(outfile, level, namespace_, name_='ReturnShipmentEstimates', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
        ...
        return self
    def buildAttributes(self, node, attrs, already_processed):
        super(GetFullEstimateResponseContainer, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ShipmentEstimates':
            obj_ = ArrayOfShipmentEstimate.factory()
            obj_.build(child_)
        ...
        super(GetFullEstimateResponseContainer, self).buildChildren(child_, node, nodeName_, True)
# end class GetFullEstimateResponseContainer


class GetQuickEstimateResponseContainer(ResponseContainer):
    """GetQuickEstimateRespone"""
    subclass = None
    superclass = ResponseContainer
    def __init__(self, ShipmentEstimates=None):
        self.original_tagname_ = None
        super(GetQuickEstimateResponseContainer, self).__init__()
        self.ShipmentEstimates = ShipmentEstimates
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GetQuickEstimateResponseContainer)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GetQuickEstimateResponseContainer.subclass:
            return GetQuickEstimateResponseContainer.subclass(*args_, **kwargs_)
        else:
            return GetQuickEstimateResponseContainer(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ShipmentEstimates(self): return self.ShipmentEstimates
    def set_ShipmentEstimates(self, ShipmentEstimates): self.ShipmentEstimates = ShipmentEstimates
    def hasContent_(self):
        if (
            self.ShipmentEstimates is not None or
            super(GetQuickEstimateResponseContainer, self).hasContent_()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='tns:', name_='GetQuickEstimateResponseContainer', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GetQuickEstimateResponseContainer')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GetQuickEstimateResponseContainer')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='GetQuickEstimateResponseContainer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='GetQuickEstimateResponseContainer'):
        super(GetQuickEstimateResponseContainer, self).exportAttributes(outfile, level, already_processed, namespace_, name_='GetQuickEstimateResponseContainer')
    def exportChildren(self, outfile, level, namespace_='tns:', name_='GetQuickEstimateResponseContainer', fromsubclass_=False, pretty_print=True):
        super(GetQuickEstimateResponseContainer, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node):
        ...
        return self
    def buildAttributes(self, node, attrs, already_processed):
        super(GetQuickEstimateResponseContainer, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ShipmentEstimates':
            obj_ = ArrayOfShipmentEstimate.factory()
            obj_.build(child_)
            self.ShipmentEstimates = obj_
            obj_.original_tagname_ = 'ShipmentEstimates'
        super(GetQuickEstimateResponseContainer, self).buildChildren(child_, node, nodeName_, True)
# end class GetQuickEstimateResponseContainer


class GetQuickEstimateRequestContainer(RequestContainer):
    """GetQuickEstimateRequest"""
    subclass = None
    superclass = RequestContainer
    def __init__(self, BillingAccountNumber=None, SenderPostalCode=None, ReceiverAddress=None, PackageType=None, TotalWeight=None):
        self.original_tagname_ = None
        super(GetQuickEstimateRequestContainer, self).__init__()
        self.BillingAccountNumber = BillingAccountNumber
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GetQuickEstimateRequestContainer)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GetQuickEstimateRequestContainer.subclass:
            return GetQuickEstimateRequestContainer.subclass(*args_, **kwargs_)
        else:
            return GetQuickEstimateRequestContainer(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_BillingAccountNumber(self): return self.BillingAccountNumber
    def set_BillingAccountNumber(self, BillingAccountNumber): self.BillingAccountNumber = BillingAccountNumber
    def get_SenderPostalCode(self): return self.SenderPostalCode
    def set_SenderPostalCode(self, SenderPostalCode): self.SenderPostalCode = SenderPostalCode
    ...
    def hasContent_(self):
        if (
            ...
            self.TotalWeight is not None or
            super(GetQuickEstimateRequestContainer, self).hasContent_()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='tns:', name_='GetQuickEstimateRequestContainer', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GetQuickEstimateRequestContainer')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GetQuickEstimateRequestContainer')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='GetQuickEstimateRequestContainer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='GetQuickEstimateRequestContainer'):
        super(GetQuickEstimateRequestContainer, self).exportAttributes(outfile, level, already_processed, namespace_, name_='GetQuickEstimateRequestContainer')
    def exportChildren(self, outfile, level, namespace_='tns:', name_='GetQuickEstimateRequestContainer', fromsubclass_=False, pretty_print=True):
        super(GetQuickEstimateRequestContainer, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.SenderPostalCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tns:SenderPostalCode>%s</tns:SenderPostalCode>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SenderPostalCode), input_name='SenderPostalCode')), eol_))
    ...
    def build(self, node):
        ...
        return self
    def buildAttributes(self, node, attrs, already_processed):
        super(GetQuickEstimateRequestContainer, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'BillingAccountNumber':
            ...
            SenderPostalCode_ = child_.text
            SenderPostalCode_ = self.gds_validate_string(SenderPostalCode_, node, 'SenderPostalCode')
            self.SenderPostalCode = SenderPostalCode_
            ...
            self.TotalWeight = obj_
            obj_.original_tagname_ = 'TotalWeight'
        super(GetQuickEstimateRequestContainer, self).buildChildren(child_, node, nodeName_, True)
# end class GetQuickEstimateRequestContainer
...
GDSClassesMapping = {
    ...
    'GetFullEstimateRequest': GetFullEstimateRequestContainer,
    'GetFullEstimateRequestContainer': GetFullEstimateRequestContainer,
    'GetFullEstimateResponse': GetFullEstimateResponseContainer,
    'GetFullEstimateResponseContainer': GetFullEstimateResponseContainer,
    'GetQuickEstimateRequest': GetQuickEstimateRequestContainer,
    'GetQuickEstimateRequestContainer': GetQuickEstimateRequestContainer,
    'GetQuickEstimateResponse': GetQuickEstimateResponseContainer,
    'GetQuickEstimateResponseContainer': GetQuickEstimateResponseContainer,
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'GetQuickEstimateRequestContainer'
        rootClass = GetQuickEstimateRequestContainer
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from EstimatorService.xsd import *\n\n')
        sys.stdout.write('import EstimatorService.xsd as model_\n\n')
...
__all__ = [
    ...
    "GetFullEstimateResponseContainer",
    "GetQuickEstimateRequestContainer",
    "GetQuickEstimateResponseContainer",
    "InformationalMessage",
    "InternationalInformation",
    "NotificationInformation",
    "OptionIDValuePair",
